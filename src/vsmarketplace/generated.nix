...
{ fetchgit, fetchurl, fetchFromGitHub }:
{
  ...
  astro-build-astro-vscode = {
    ...
    version = "0.20.1";
    src = fetchurl {
      url = "https://astro-build.gallery.vsassets.io/_apis/public/gallery/publisher/astro-build/extension/astro-vscode/0.20.1/assetbyname/Microsoft.VisualStudio.Services.VSIXPackage";
      name = "astro-vscode-0.20.1.zip";
      sha256 = "sha256-OUV0e4ok0eSmsh3s3W94OB+nJcvrkfeWSOAxWEWL108=";
    };
    license = "MIT";
    name = "astro-vscode";
  ...
  ms-vscode-cpptools = {
    ...
    version = "1.11.3";
    src = fetchurl {
      url = "https://ms-vscode.gallery.vsassets.io/_apis/public/gallery/publisher/ms-vscode/extension/cpptools/1.11.3/assetbyname/Microsoft.VisualStudio.Services.VSIXPackage";
      name = "cpptools-1.11.3.zip";
      sha256 = "sha256-4i6CKbFi4JN+glADpJUf9xUEA7AO3r5uIhDYEm5oSGs=";
    };
    license = "MIT";
    name = "cpptools";
    publisher = "ms-vscode";
