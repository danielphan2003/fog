...
{ fetchgit, fetchurl, fetchFromGitHub }:
{
  ...
  astro-build-astro-vscode = {
    ...
    version = "0.19.2";
    src = fetchurl {
      url = "https://astro-build.gallery.vsassets.io/_apis/public/gallery/publisher/astro-build/extension/astro-vscode/0.19.2/assetbyname/Microsoft.VisualStudio.Services.VSIXPackage";
  ...
  ms-vscode-cpptools = {
    ...
    version = "1.10.6";
    src = fetchurl {
      url = "https://ms-vscode.gallery.vsassets.io/_apis/public/gallery/publisher/ms-vscode/extension/cpptools/1.10.6/assetbyname/Microsoft.VisualStudio.Services.VSIXPackage";
      name = "cpptools-1.10.6.zip";
      sha256 = "sha256-ZVWavtEbZY/WGsN1OYS/mbiyllMZsv9W4PUpSXbcZEE=";
    };
    license = "MIT";
    name = "cpptools";
    publisher = "ms-vscode";
