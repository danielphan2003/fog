...
{ fetchgit, fetchurl, fetchFromGitHub }:
{
  ...
  astro-build-astro-vscode = {
    ...
    version = "0.19.3";
    src = fetchurl {
      url = "https://astro-build.gallery.vsassets.io/_apis/public/gallery/publisher/astro-build/extension/astro-vscode/0.19.3/assetbyname/Microsoft.VisualStudio.Services.VSIXPackage";
      name = "astro-vscode-0.19.3.zip";
      sha256 = "sha256-NaJ4iJKJFgd7BgiRtsQQZ0wiUjz2a3CQLnH4hIIMgBM=";
    };
    license = "MIT";
    name = "astro-vscode";
  ...
  ms-vscode-cpptools = {
    ...
    version = "1.11.0";
    src = fetchurl {
      url = "https://ms-vscode.gallery.vsassets.io/_apis/public/gallery/publisher/ms-vscode/extension/cpptools/1.11.0/assetbyname/Microsoft.VisualStudio.Services.VSIXPackage";
      name = "cpptools-1.11.0.zip";
