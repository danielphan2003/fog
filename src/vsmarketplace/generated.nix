...
{ fetchgit, fetchurl, fetchFromGitHub }:
{
  ...
  astro-build-astro-vscode = {
    ...
    version = "0.19.4";
    src = fetchurl {
      url = "https://astro-build.gallery.vsassets.io/_apis/public/gallery/publisher/astro-build/extension/astro-vscode/0.19.4/assetbyname/Microsoft.VisualStudio.Services.VSIXPackage";
      name = "astro-vscode-0.19.4.zip";
      sha256 = "sha256-+wtcHwfGyFoElmfht6KjAfgmNiiAJ+PokFCN0OdIUzQ=";
    };
    license = "MIT";
    name = "astro-vscode";
  ...
  ms-vscode-cpptools = {
    ...
    version = "1.11.1";
    src = fetchurl {
      url = "https://ms-vscode.gallery.vsassets.io/_apis/public/gallery/publisher/ms-vscode/extension/cpptools/1.11.1/assetbyname/Microsoft.VisualStudio.Services.VSIXPackage";
      name = "cpptools-1.11.1.zip";
      sha256 = "sha256-+7qkrEYpJnJYXONWsa6UssdV2SSxQ1UbPYs1ANyAizE=";
    };
    license = "MIT";
    name = "cpptools";
    publisher = "ms-vscode";
