...
{ fetchgit, fetchurl, fetchFromGitHub, dockerTools }:
{
  ...
  fluffychat = {
    pname = "fluffychat";
    version = "426ca2480f6533db1a0c064fab08b0b8dce9bbcd";
    src = fetchgit {
      url = "https://gitlab.com/famedly/fluffychat";
      rev = "426ca2480f6533db1a0c064fab08b0b8dce9bbcd";
      fetchSubmodules = false;
      deepClone = false;
      leaveDotGit = false;
      sha256 = "sha256-gpZF9ZgVspiKgeeCOAJeezdluZVYcclm3mTeMkVbsDc=";
    };
    date = "2023-01-23";
  };
  flyingfox = {
  ...
  hyprland = {
    pname = "hyprland";
    version = "06b17db22776e613a714e7e936618c16c3f47eaa";
    src = fetchFromGitHub ({
      owner = "hyprwm";
      repo = "hyprland";
      rev = "06b17db22776e613a714e7e936618c16c3f47eaa";
      fetchSubmodules = false;
      sha256 = "sha256-15ukCRGhgDd7T60QBbc3PEeMpOkNVgwduT+u93zmyZM=";
    });
    date = "2023-01-26";
  };
  ibus = {
  ...
  jitsi-meet = {
    ...
    version = "1.0.6942";
    src = fetchurl {
      url = "https://download.jitsi.org/jitsi-meet/src/jitsi-meet-1.0.6942.tar.bz2";
      sha256 = "sha256-oK7sA67xy7uOGB+Gy/b5ttzRBARiBI2AepgEwVigzBM=";
    };
  };
  jitsi-meet-prosody = {
    ...
    version = "1.0.6942";
    src = fetchurl {
      url = "https://download.jitsi.org/unstable/jitsi-meet-prosody_1.0.6942-1_all.deb";
      sha256 = "sha256-AZM52i1FuCRZxcJ4ddP1gE7l6PfgDvr2VaQguqn9N5o=";
    };
  };
  jitsi-videobridge2 = {
  ...
  retroarch = {
    pname = "retroarch";
    version = "951f5a76a5795ca67fe5cba88eeee43b9d2d3552";
    src = fetchFromGitHub ({
      owner = "libretro";
      repo = "retroarch";
      rev = "951f5a76a5795ca67fe5cba88eeee43b9d2d3552";
      fetchSubmodules = false;
      sha256 = "sha256-oQVRXezu+S7taFwa3+6WKM/Qzjy+pXAJi5+EFZ32PfE=";
    });
    date = "2023-01-26";
  };
  rofi-wayland = {
  ...
  rustdesk = {
    pname = "rustdesk";
    version = "dbcdcd210c702312a2fddec9601bff7e996d01d4";
    src = fetchFromGitHub ({
      owner = "rustdesk";
      repo = "rustdesk";
      rev = "dbcdcd210c702312a2fddec9601bff7e996d01d4";
      fetchSubmodules = false;
      sha256 = "sha256-LuH3Au7GwIhS9M2W9HtD6r3ABJvx1ixrGnZ5h6yECv4=";
    });
    cargoLock."Cargo.lock" = {
      lockFile = ./rustdesk-dbcdcd210c702312a2fddec9601bff7e996d01d4/Cargo.lock;
      outputHashes = {
  ...
  tailscale = {
    pname = "tailscale";
    version = "7439bc7ba6bbfb3fb87622746c7ddb904806f12e";
    src = fetchFromGitHub ({
      owner = "tailscale";
      repo = "tailscale";
      rev = "7439bc7ba6bbfb3fb87622746c7ddb904806f12e";
      fetchSubmodules = false;
      sha256 = "sha256-1sg/KIpigqyXDb3yQMMi+oOptylfr2nhti1V8ufipdI=";
    });
    date = "2023-01-25";
  };
  tailscale-systray = {
