...
{ fetchgit, fetchurl, fetchFromGitHub }:
{
  ...
  bottles = {
    pname = "bottles";
    version = "4577f8c0d0491f3c7300cbe395fc05c0e3624ae1";
    src = fetchFromGitHub ({
      owner = "bottlesdevs";
      repo = "Bottles";
      rev = "4577f8c0d0491f3c7300cbe395fc05c0e3624ae1";
      fetchSubmodules = false;
      sha256 = "sha256-kb3FbUPAPsqtS9sqsnIHzaGt/SpLGudfkxXpHVbsuEU=";
    });
  };
  caddy = {
    pname = "caddy";
  ...
  hyprland = {
    pname = "hyprland";
    version = "4b334594dc0d8989d8bb09c7db76694aacc71951";
    src = fetchFromGitHub ({
      owner = "vaxerski";
      repo = "hyprland";
      rev = "4b334594dc0d8989d8bb09c7db76694aacc71951";
      fetchSubmodules = false;
      sha256 = "sha256-bFDGP1FyRtXC7m1LR933shySNSeJ0sgjLusCpIf1gag=";
    });
  };
  ibus = {
    pname = "ibus";
