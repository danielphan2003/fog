...
{ fetchgit, fetchurl, fetchFromGitHub }:
{
  ...
  fx_cast = {
    pname = "fx_cast";
    version = "1da0015c96e6187de6152bb141b945e8ae603884";
    src = fetchFromGitHub ({
      owner = "hensm";
      repo = "fx_cast";
      rev = "1da0015c96e6187de6152bb141b945e8ae603884";
      fetchSubmodules = false;
      sha256 = "sha256-eM+JQuZChFH0HjIS0t24fLTwhfcpr08G8bkwHCIfGp0=";
    });
  };
  godu = {
    pname = "godu";
  ...
  hyprland = {
    pname = "hyprland";
    version = "a74b8033ca97bdfc53a0a8aaf3aec9aec56fa410";
    src = fetchFromGitHub ({
      owner = "hyprwm";
      repo = "hyprland";
      rev = "a74b8033ca97bdfc53a0a8aaf3aec9aec56fa410";
      fetchSubmodules = false;
      sha256 = "sha256-+GN9ZKyCh3p0fVsVYqPaq0csJlIFOohCCqG3QuQJemg=";
    });
  };
  ibus = {
    pname = "ibus";
  ...
  jitsi-meet = {
    ...
    version = "1.0.6528";
    src = fetchurl {
      url = "https://download.jitsi.org/jitsi-meet/src/jitsi-meet-1.0.6528.tar.bz2";
      sha256 = "sha256-gAhQp3nCdUPJnDn3P9ZrNB/2qSbK+KSI42cfrts05xg=";
    };
  };
  jitsi-meet-prosody = {
    ...
    version = "1.0.6528";
    src = fetchurl {
      url = "https://download.jitsi.org/unstable/jitsi-meet-prosody_1.0.6528-1_all.deb";
      sha256 = "sha256-fWsryuNoRvob0ZCJCyk1z01qGuPT6pxG+CeOsjt7wXE=";
    };
  };
  jitsi-videobridge2 = {
  ...
  retroarch = {
    pname = "retroarch";
    version = "87457eb6789472390ad0935b5ead282ed897dbf8";
    src = fetchFromGitHub ({
      owner = "libretro";
      repo = "retroarch";
      rev = "87457eb6789472390ad0935b5ead282ed897dbf8";
      fetchSubmodules = false;
      sha256 = "sha256-e0qhILoeE6dk4fuBr9OY9Y2BHaJ37LkFO6DsmrE8LSg=";
    });
  };
  revanced-cli = {
    pname = "revanced-cli";
  ...
  rustdesk = {
    pname = "rustdesk";
    version = "82acb6a3515755c9f2f6969b11dedc3dc0fcbcaa";
    src = fetchFromGitHub ({
      owner = "rustdesk";
      repo = "rustdesk";
      rev = "82acb6a3515755c9f2f6969b11dedc3dc0fcbcaa";
      fetchSubmodules = false;
      sha256 = "sha256-SlYfFYLrACw0XbRLGA8zIU+cK4brxPXAMWOP2D8WocE=";
    });
    cargoLock."Cargo.lock" = {
      lockFile = ./rustdesk-82acb6a3515755c9f2f6969b11dedc3dc0fcbcaa/Cargo.lock;
      outputHashes = {
