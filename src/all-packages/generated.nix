...
{ fetchgit, fetchurl, fetchFromGitHub }:
{
  ...
  retroarch = {
    pname = "retroarch";
    version = "5872b357e6ef72feb0e96cf70472e844759da786";
    src = fetchFromGitHub ({
      owner = "libretro";
      repo = "retroarch";
      rev = "5872b357e6ef72feb0e96cf70472e844759da786";
      fetchSubmodules = false;
      sha256 = "sha256-zZ8HxFKqY3l/M/Gqvrc1H0M2b4XdrHd7fnHYUE77jDc=";
    });
  };
  rofi-wayland = {
    pname = "rofi-wayland";
  ...
  ulauncher = {
    pname = "ulauncher";
    version = "61667ab48e974f040605e646bfc0d4a184fc756f";
    src = fetchFromGitHub ({
      owner = "Ulauncher";
      repo = "Ulauncher";
      rev = "61667ab48e974f040605e646bfc0d4a184fc756f";
      fetchSubmodules = false;
      sha256 = "sha256-UMsr3oa1Rnf+9OVhQX1otUY1LBY1uKUtRrtSi/+leUA=";
    });
  };
  uniemoji = {
    pname = "uniemoji";
