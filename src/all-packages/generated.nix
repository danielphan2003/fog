...
{ fetchgit, fetchurl, fetchFromGitHub }:
{
  ...
  bottles = {
    pname = "bottles";
    version = "1e67b41f981d3a87d7d869fd9a06f6eb2d88e0e7";
    src = fetchFromGitHub ({
      owner = "bottlesdevs";
      repo = "Bottles";
      rev = "1e67b41f981d3a87d7d869fd9a06f6eb2d88e0e7";
      fetchSubmodules = false;
      sha256 = "sha256-Dyy9cX7x9U1HlMIdKTbyzOucZ2Ld67phYXoIqKh/pE4=";
    });
  };
  caddy = {
    pname = "caddy";
  ...
  fluffychat = {
    pname = "fluffychat";
    version = "98953af8d82d0922ba3df578d4ff4b8fc9256fd2";
    src = fetchgit {
      url = "https://gitlab.com/famedly/fluffychat";
      rev = "98953af8d82d0922ba3df578d4ff4b8fc9256fd2";
      fetchSubmodules = false;
      deepClone = false;
      leaveDotGit = false;
      sha256 = "sha256-fRWSTU1kusmjt37bJA7fJ8l8dp+Y4an0eXi8FskHXxA=";
    };
  };
  flyingfox = {
    pname = "flyingfox";
  ...
  guiscrcpy = {
    pname = "guiscrcpy";
    version = "348c2f2ea56b7abbf54bb120c3854c60f92758c6";
    src = fetchFromGitHub ({
      owner = "srevinsaju";
      repo = "guiscrcpy";
      rev = "348c2f2ea56b7abbf54bb120c3854c60f92758c6";
      fetchSubmodules = false;
      sha256 = "sha256-2W1I5acFQKzZ38Wa1f2U5qv7+Fu8kjLLC/ONb4MQ0Vc=";
    });
  };
  hyprland = {
    pname = "hyprland";
    version = "10303259f7c6f3e64e74e9ca8a31d4223071d5f0";
    src = fetchFromGitHub ({
      owner = "hyprwm";
      repo = "hyprland";
      rev = "10303259f7c6f3e64e74e9ca8a31d4223071d5f0";
      fetchSubmodules = false;
      sha256 = "sha256-UfnSWkp4gWf2AA6hyru9Gv1Rb5Ixvsx1RkZ2iVhgC3w=";
    });
  };
  ibus = {
    pname = "ibus";
  ...
  jitsi-meet = {
    ...
    version = "1.0.6728";
    src = fetchurl {
      url = "https://download.jitsi.org/jitsi-meet/src/jitsi-meet-1.0.6728.tar.bz2";
      sha256 = "sha256-8fP/s5YxxkoPGybv28iMRavap4c/NeMxdtF2xidPPpI=";
    };
  };
  jitsi-meet-prosody = {
    ...
    version = "1.0.6728";
    src = fetchurl {
      url = "https://download.jitsi.org/unstable/jitsi-meet-prosody_1.0.6728-1_all.deb";
      sha256 = "sha256-a5TdXLgKXQTc+KO1JXBXvnkJvaDLVqtvT784cpos4EU=";
    };
  };
  jitsi-videobridge2 = {
  ...
  rustdesk = {
    pname = "rustdesk";
    version = "a2cb295a11c41b1b35bcdc23c0e7875f0e9dea81";
    src = fetchFromGitHub ({
      owner = "rustdesk";
      repo = "rustdesk";
      rev = "a2cb295a11c41b1b35bcdc23c0e7875f0e9dea81";
      fetchSubmodules = false;
      sha256 = "sha256-1dCQwG5H3VtSkCVdY6TuwmmQVW/iwhCffmAf+DSvz+A=";
    });
    cargoLock."Cargo.lock" = {
      lockFile = ./rustdesk-a2cb295a11c41b1b35bcdc23c0e7875f0e9dea81/Cargo.lock;
      outputHashes = {
  ...
  tailscale = {
    pname = "tailscale";
    version = "4597ec10372eddbad2ca6e139898bc3110c96486";
    src = fetchFromGitHub ({
      owner = "tailscale";
      repo = "tailscale";
      rev = "4597ec10372eddbad2ca6e139898bc3110c96486";
      fetchSubmodules = false;
      sha256 = "sha256-63ZKrcPHkBvSm6wBUQMzturUQpCgWHuw1mthfN/Ijxk=";
    });
  };
  tailscale-systray = {
