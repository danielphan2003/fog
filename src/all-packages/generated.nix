...
{ fetchgit, fetchurl, fetchFromGitHub }:
{
  ...
  bottles = {
    pname = "bottles";
    version = "c4193524c042c58df40c6f80432cc56decdfb44f";
    src = fetchFromGitHub ({
      owner = "bottlesdevs";
      repo = "Bottles";
      rev = "c4193524c042c58df40c6f80432cc56decdfb44f";
      fetchSubmodules = false;
      sha256 = "sha256-iCjcOlfEdXJua5aghqhVaMjLQxln7z5CL3MyqGGI/AM=";
    });
  };
  caddy = {
    pname = "caddy";
  ...
  ibus = {
    pname = "ibus";
    version = "19ca10651890ce0d88ec613de0e8930090105dc8";
    src = fetchFromGitHub ({
      owner = "ibus";
      repo = "ibus";
      rev = "19ca10651890ce0d88ec613de0e8930090105dc8";
      fetchSubmodules = false;
      sha256 = "sha256-epRavl3jCgB5czJb+Qox70KfPyJziqB9N2+wfT7mVrA=";
    });
  };
  ibus-bamboo = {
    pname = "ibus-bamboo";
