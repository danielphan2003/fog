...
{ fetchgit, fetchurl, fetchFromGitHub }:
{
  ...
  retroarch = {
    pname = "retroarch";
    version = "7ca0d36169aef3a824c000bdbfad22f6873a4b43";
    src = fetchFromGitHub ({
      owner = "libretro";
      repo = "retroarch";
      rev = "7ca0d36169aef3a824c000bdbfad22f6873a4b43";
      fetchSubmodules = false;
      sha256 = "sha256-YXeDdNx8Tjg9KmBJjzoSGOjgFm1pWxQ0+KfiRJJ/qFA=";
    });
  };
  revanced-cli = {
    pname = "revanced-cli";
  ...
  tailscale = {
    pname = "tailscale";
    version = "235309adc4dd5bcfed2ddf09464de67432b37631";
    src = fetchFromGitHub ({
      owner = "tailscale";
      repo = "tailscale";
      rev = "235309adc4dd5bcfed2ddf09464de67432b37631";
      fetchSubmodules = false;
      sha256 = "sha256-3c0SqSyKxjfCfAq6q5LCuOJoLjRo5BlU6VeNNzUUKqo=";
    });
  };
  tailscale-systray = {
