...
{ fetchgit, fetchurl, fetchFromGitHub }:
{
  ...
  caddy-git = {
    pname = "caddy-git";
    version = "8f6a88e2b02221b9a332abd2f68f586ac3544778";
    src = fetchFromGitHub ({
      owner = "caddyserver";
      repo = "caddy";
      rev = "8f6a88e2b02221b9a332abd2f68f586ac3544778";
      fetchSubmodules = false;
      sha256 = "sha256-ntubKGUbvociwVaLEFz1JIBzYG1FdHzFBLwgixkCQfw=";
    });
  };
  cinny = {
    pname = "cinny";
  ...
  fx_cast = {
    pname = "fx_cast";
    version = "989c798f69a9c9a9897254b72a7ad3b1b4f2d48c";
    src = fetchFromGitHub ({
      owner = "hensm";
      repo = "fx_cast";
      rev = "989c798f69a9c9a9897254b72a7ad3b1b4f2d48c";
      fetchSubmodules = false;
      sha256 = "sha256-QdDwV8LGIzxpeN9qZ+ZeaJCb3MYd+eqAVItUO9FgEbs=";
    });
  };
  godu = {
    pname = "godu";
  ...
  retroarch = {
    pname = "retroarch";
    version = "84f599503d10b6f9ce2f377b08685365110f80f5";
    src = fetchFromGitHub ({
      owner = "libretro";
      repo = "retroarch";
      rev = "84f599503d10b6f9ce2f377b08685365110f80f5";
      fetchSubmodules = false;
      sha256 = "sha256-U8RkOcUuvnrCqEjtrd6iSoUR38pGH17wA89Iyr+g3X0=";
    });
  };
  revanced-cli = {
    pname = "revanced-cli";
