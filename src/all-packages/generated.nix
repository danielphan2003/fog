...
{ fetchgit, fetchurl, fetchFromGitHub }:
{
  ...
  hyprland = {
    pname = "hyprland";
    version = "8f0b963729fbce703222defdb1598bdb6f08849e";
    src = fetchFromGitHub ({
      owner = "vaxerski";
      repo = "hyprland";
      rev = "8f0b963729fbce703222defdb1598bdb6f08849e";
      fetchSubmodules = false;
      sha256 = "sha256-XUlDEbp1vFCb9cB6Gar4MSG7+c++eF0seveBDBWM0wE=";
    });
  };
  ibus = {
    pname = "ibus";
  ...
  tailscale = {
    pname = "tailscale";
    version = "d8c05fc1b24732b7966c73af3db20bbdea4f8ae9";
    src = fetchFromGitHub ({
      owner = "tailscale";
      repo = "tailscale";
      rev = "d8c05fc1b24732b7966c73af3db20bbdea4f8ae9";
      fetchSubmodules = false;
      sha256 = "sha256-pQKl5mvyxiy38CHwqZ4E0coCR1taucktYRqyF5pw99o=";
    });
  };
  tailscale-systray = {
