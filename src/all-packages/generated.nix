...
{ fetchgit, fetchurl, fetchFromGitHub }:
{
  ...
  bottles = {
    pname = "bottles";
    version = "e842ba54a68561ff9a4aee95c54f15d706d67e49";
    src = fetchFromGitHub ({
      owner = "bottlesdevs";
      repo = "Bottles";
      rev = "e842ba54a68561ff9a4aee95c54f15d706d67e49";
      fetchSubmodules = false;
      sha256 = "sha256-w9OI7kL+KV39XvHoy7IJJdHGJd47ViFwN3vPkaWrdgg=";
    });
  };
  caddy = {
    pname = "caddy";
  ...
  hyprland = {
    pname = "hyprland";
    version = "cb2989cec50dc15ff0dab16888b38a25f2d4f081";
    src = fetchFromGitHub ({
      owner = "vaxerski";
      repo = "hyprland";
      rev = "cb2989cec50dc15ff0dab16888b38a25f2d4f081";
      fetchSubmodules = false;
      sha256 = "sha256-jykQq9Z+xoRPMGvUr8Y14Dc5a9JP9bz/0/O67GfFiZY=";
    });
  };
  ibus = {
    pname = "ibus";
  ...
  picom = {
    pname = "picom";
    version = "d621f7a3e2e3e8104910d820a89a64905c874c20";
    src = fetchFromGitHub ({
      owner = "yshui";
      repo = "picom";
      rev = "d621f7a3e2e3e8104910d820a89a64905c874c20";
      fetchSubmodules = false;
      sha256 = "sha256-cXbHYKlzhv7JWWmTVwIaGV2oJNZkPBtXJsmaZTBtAH4=";
    });
  };
  playit-agent = {
    pname = "playit-agent";
  ...
  retroarch = {
    pname = "retroarch";
    version = "78c286471f3190689900ebf1718ef087565fa30a";
    src = fetchFromGitHub ({
      owner = "libretro";
      repo = "retroarch";
      rev = "78c286471f3190689900ebf1718ef087565fa30a";
      fetchSubmodules = false;
      sha256 = "sha256-UV07kfWG+rpGRm2AK/z4b2l6V8cu8SUOfEfYNNcd8q4=";
    });
  };
  revanced-cli = {
    pname = "revanced-cli";
  ...
  revanced-integrations = {
    ...
    version = "0.25.0";
    src = fetchurl {
      url = "https://github.com/revanced/revanced-integrations/releases/download/v0.25.0/app-release-unsigned.apk";
      sha256 = "sha256-5jG9HxGDA5csm9Wp5tOf64E9gZbULDyLPrfXZdm3MXA=";
    };
  };
  revanced-patches-dex = {
    ...
    version = "2.15.0";
    src = fetchurl {
      url = "https://github.com/revanced/revanced-patches/releases/download/v2.15.0/revanced-patches-2.15.0.dex";
      sha256 = "sha256-G0StrluCyC/qg3+PfSgouhMbEIDiJsWmHm3MMqEpx0Q=";
    };
  };
  revanced-patches-jar = {
    ...
    version = "2.15.0";
    src = fetchurl {
      url = "https://github.com/revanced/revanced-patches/releases/download/v2.15.0/revanced-patches-2.15.0.jar";
      sha256 = "sha256-pqVGWUQ3T2OXqj7iVIdVMkdoHWKJRohu+0FqRXJHxOw=";
    };
  };
  rofi-wayland = {
    pname = "rofi-wayland";
  ...
  snui = {
    pname = "snui";
    version = "ce26770b9e8f14518c560717b5684d44471e7408";
    src = fetchgit {
      url = "https://gitlab.com/snakedye/snui";
      rev = "ce26770b9e8f14518c560717b5684d44471e7408";
      fetchSubmodules = false;
      deepClone = false;
      leaveDotGit = false;
      sha256 = "sha256-620xx1fyN+oVfazI3fsTrjhxdC+d79fEneSjghbhVpA=";
    };
  };
  spicetify-cli = {
    pname = "spicetify-cli";
  ...
  spicetify-marketplace = {
    ...
    version = "fc51ce1acd5b0163b832b66f9ca75b76e4f6cc55";
    src = fetchFromGitHub ({
      owner = "spicetify";
      repo = "spicetify-marketplace";
      rev = "fc51ce1acd5b0163b832b66f9ca75b76e4f6cc55";
      fetchSubmodules = false;
      sha256 = "sha256-leTYcJRrqYUfsghFUNmjxh6UziszK570n6muWwvEdpo=";
    });
  };
  spicetify-themes = {
  ...
  ulauncher = {
    pname = "ulauncher";
    version = "7e2844359b35276f5085c7245169a9ca5f116a73";
    src = fetchFromGitHub ({
      owner = "Ulauncher";
      repo = "Ulauncher";
      rev = "7e2844359b35276f5085c7245169a9ca5f116a73";
      fetchSubmodules = false;
      sha256 = "sha256-4OAHSKpM4zXMxUisDsNSHEk12jBNFudYyvicpG4kspQ=";
    });
  };
  ultimmc = {
    pname = "ultimmc";
  ...
  whitesur-gtk-theme = {
    ...
    version = "2df7bc8467c4d2efe5241a72514a0c9600ab02d2";
    src = fetchFromGitHub ({
      owner = "vinceliuice";
      repo = "whitesur-gtk-theme";
      rev = "2df7bc8467c4d2efe5241a72514a0c9600ab02d2";
      fetchSubmodules = false;
      sha256 = "sha256-NT+2jGE0O43f0QFuI2CFZbRg+gu+t9l4gKlpJPakz0g=";
    });
  };
  whitesur-icon-theme = {
