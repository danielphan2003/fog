...
{ fetchgit, fetchurl, fetchFromGitHub }:
{
  ...
  arkenfox-userjs = {
    ...
    version = "db04bc44f2982ae8e39f10d056bc7cfe7804d4fd";
    src = fetchFromGitHub ({
      owner = "arkenfox";
      repo = "user.js";
  ...
  bottles = {
    pname = "bottles";
    version = "b33a7f5e005b692feb7a379e910c9e04e7178ee4";
    src = fetchFromGitHub ({
      owner = "bottlesdevs";
      repo = "Bottles";
      rev = "b33a7f5e005b692feb7a379e910c9e04e7178ee4";
      fetchSubmodules = false;
      sha256 = "sha256-JLqR4vJThCEHVvTO5udSLGRuH02ccdkUiJqKTiV1V/E=";
    });
  };
  caddy = {
    pname = "caddy";
  ...
  caddy-git = {
    pname = "caddy-git";
    version = "b4e28af953aa02fb44f88c155956488b1f473348";
    src = fetchFromGitHub ({
      owner = "caddyserver";
      repo = "caddy";
      rev = "b4e28af953aa02fb44f88c155956488b1f473348";
      fetchSubmodules = false;
      sha256 = "sha256-/t87YIvfczTpQOwuuqRNSaNw3bRS/8d/vU7sxnCh3EQ=";
    });
  };
  cinny = {
    pname = "cinny";
    version = "8ea2b0b63b286af39bc9e95859e4c489053442b2";
    src = fetchFromGitHub ({
      owner = "cinnyapp";
      repo = "cinny";
      rev = "8ea2b0b63b286af39bc9e95859e4c489053442b2";
      fetchSubmodules = false;
      sha256 = "sha256-YMRag9aKdl1g7BftL+IQye7mqbtxFGQhPj2nYBfHwlg=";
    });
  };
  cinny-bin = {
    pname = "cinny-bin";
  ...
  flameshot = {
    pname = "flameshot";
    version = "134117b558571c60926d97dfe585143643448113";
    src = fetchFromGitHub ({
      owner = "flameshot-org";
      repo = "flameshot";
      rev = "134117b558571c60926d97dfe585143643448113";
      fetchSubmodules = false;
      sha256 = "sha256-9v+Qv8xiDMDtTkkdDrToCoPG3Vfo8rNsqTRuSPV967E=";
    });
  };
  fluffychat = {
    pname = "fluffychat";
  ...
  hyprland = {
    pname = "hyprland";
    version = "1468001d3b62107988432df745f78f3403fa7a81";
    src = fetchFromGitHub ({
      owner = "hyprwm";
      repo = "hyprland";
      rev = "1468001d3b62107988432df745f78f3403fa7a81";
      fetchSubmodules = false;
      sha256 = "sha256-5yyp79E7vCQgaWiXpShVtiGvJOpY56OAPZ4AkPP/LZk=";
    });
  };
  ibus = {
    pname = "ibus";
  ...
  jicofo = {
    ...
    version = "1.0-945";
    src = fetchurl {
      url = "https://download.jitsi.org/unstable/jicofo_1.0-945-1_all.deb";
      sha256 = "sha256-24gkXXwO5xVqcg49ZiAyUNaRgk0GwRd2LawBOHFAnWM=";
    };
  };
  jitsi-meet = {
    pname = "jitsi-meet";
    version = "1.0.6669";
    src = fetchurl {
      url = "https://download.jitsi.org/jitsi-meet/src/jitsi-meet-1.0.6669.tar.bz2";
      sha256 = "sha256-T9ngH4iQ4kvLD1MwOxj9OrbzT4Hd1b8b0UwDG4XBXAY=";
    };
  };
  jitsi-meet-prosody = {
    ...
    version = "1.0.6669";
    src = fetchurl {
      url = "https://download.jitsi.org/unstable/jitsi-meet-prosody_1.0.6669-1_all.deb";
      sha256 = "sha256-Olzf7WAyRh0ut9Or/o1Yo6PD9DlNHiTNoMRR3vNqvEw=";
    };
  };
  jitsi-videobridge2 = {
    pname = "jitsi-videobridge2";
    version = "2.2-46-gf19f7758";
    src = fetchurl {
      url = "https://download.jitsi.org/unstable/jitsi-videobridge2_2.2-46-gf19f7758-1_all.deb";
      sha256 = "sha256-5hp4sYW7mmF81FLc8b2bTrCYx7cUgoy4BQ2igJonQgA=";
    };
  };
  layout-machi = {
    pname = "layout-machi";
  ...
  netdata-go-d-plugin = {
    ...
    version = "0.40.3";
    src = fetchurl {
      url = "https://github.com/netdata/go.d.plugin/archive/refs/tags/v0.40.3.tar.gz";
      sha256 = "sha256-q1yjLjf//FMsn0zhHjXCh5RG0c21xvCCiacGWLl8otw=";
    };
  };
  nix-zsh-completions = {
  ...
  pmbootstrap-test = {
    ...
    version = "248fe447bdc0611ca55a0379939aaa15ab8d166c";
    src = fetchgit {
      url = "https://gitlab.com/postmarketOS/pmbootstrap";
      rev = "248fe447bdc0611ca55a0379939aaa15ab8d166c";
      fetchSubmodules = false;
      deepClone = false;
      leaveDotGit = false;
      sha256 = "sha256-4QOBacL2lNjp0pMhlUogyyNbkp8AjRAQ+d/aavbbSOM=";
    };
  };
  pure = {
    pname = "pure";
  ...
  retroarch = {
    pname = "retroarch";
    version = "f40d15757104fee3bcf508cff72b0aa9e0dcf213";
    src = fetchFromGitHub ({
      owner = "libretro";
      repo = "retroarch";
      rev = "f40d15757104fee3bcf508cff72b0aa9e0dcf213";
      fetchSubmodules = false;
      sha256 = "sha256-yoM+GuVBv2tS8HeE0WC8ieksQMTakQ0c02zIAMxMSjg=";
    });
  };
  revanced-cli = {
    pname = "revanced-cli";
  ...
  revanced-patches-jar = {
    ...
    version = "2.81.0";
    src = fetchurl {
      url = "https://github.com/revanced/revanced-patches/releases/download/v2.81.0/revanced-patches-2.81.0.jar";
      sha256 = "sha256-eKmkhwDTpmjO0on9DE8r8mMySWMfztzw41uGt/a1uRM=";
    };
  };
  rofi-wayland = {
    pname = "rofi-wayland";
  ...
  rustdesk = {
    pname = "rustdesk";
    version = "8e9f1bed647358370688d6df7aa779e20e5292ae";
    src = fetchFromGitHub ({
      owner = "rustdesk";
      repo = "rustdesk";
      rev = "8e9f1bed647358370688d6df7aa779e20e5292ae";
      fetchSubmodules = false;
      sha256 = "sha256-PMwbRpuxicssGiDf3olhbmPQtZtrhD//3AlejsA2DoE=";
    });
    cargoLock."Cargo.lock" = {
      lockFile = ./rustdesk-8e9f1bed647358370688d6df7aa779e20e5292ae/Cargo.lock;
      outputHashes = {
  ...
  snui = {
    pname = "snui";
    version = "00b6847e7dfd6dd4c5dad6fbc1175a2cd1a8946e";
    src = fetchgit {
      url = "https://gitlab.com/snakedye/snui";
      rev = "00b6847e7dfd6dd4c5dad6fbc1175a2cd1a8946e";
      fetchSubmodules = false;
      deepClone = false;
      leaveDotGit = false;
      sha256 = "sha256-czBzHX+3yl/5nDV4le3WkaCWrvQxbx/1ySd5UY3hl78=";
    };
  };
  spicetify-cli = {
    pname = "spicetify-cli";
    version = "a5a18e658a7a9e9c3b655b9fa1397c5465ec711a";
    src = fetchFromGitHub ({
      owner = "spicetify";
      repo = "spicetify-cli";
      rev = "a5a18e658a7a9e9c3b655b9fa1397c5465ec711a";
      fetchSubmodules = false;
      sha256 = "sha256-TRrFjZ6i19k7DfcR6ob/GiOxqOdf8gYLvHD5FdspMlY=";
    });
  };
  ...
  tailscale = {
    pname = "tailscale";
    version = "82f5f438e0ada551d8e93cc130bb5c8b7d47a0d4";
    src = fetchFromGitHub ({
      owner = "tailscale";
      repo = "tailscale";
      rev = "82f5f438e0ada551d8e93cc130bb5c8b7d47a0d4";
      fetchSubmodules = false;
      sha256 = "sha256-DzDUxTECPBDdtu9jSFrsUsyooR8frg/IRQenXvhYLrw=";
    });
  };
  tailscale-systray = {
  ...
  whitesur-gtk-theme = {
    ...
    version = "a69ecbc49d1a58737a29018e6506383c4faac26c";
    src = fetchFromGitHub ({
      owner = "vinceliuice";
      repo = "whitesur-gtk-theme";
      rev = "a69ecbc49d1a58737a29018e6506383c4faac26c";
      fetchSubmodules = false;
      sha256 = "sha256-/maEIrMUwtU9dx2tWz4/aPrm3lV5mSklF/g7tkXADCw=";
    });
  };
  whitesur-icon-theme = {
