...
{ fetchgit, fetchurl, fetchFromGitHub, dockerTools }:
{
  ...
  bottles = {
    pname = "bottles";
    version = "31c794e78745dd358290d42a8283d7bf5d6b0599";
    src = fetchFromGitHub ({
      owner = "bottlesdevs";
      repo = "Bottles";
      rev = "31c794e78745dd358290d42a8283d7bf5d6b0599";
      fetchSubmodules = false;
      sha256 = "sha256-82q9pwTShmbBSDKeHzd0GTzzxFHGYKmh0DtDYSXJwa8=";
    });
    date = "2023-01-12";
  };
  caddy = {
  ...
  hyprland = {
    pname = "hyprland";
    version = "cbd31ba481c5be65e015647851eef4b396869073";
    src = fetchFromGitHub ({
      owner = "hyprwm";
      repo = "hyprland";
      rev = "cbd31ba481c5be65e015647851eef4b396869073";
      fetchSubmodules = false;
      sha256 = "sha256-GukJtWwrkkf3ApkBTc7tW7DcsS1gKHWWs7OJYnv9om8=";
    });
    date = "2023-01-12";
  };
  ibus = {
  ...
  jitsi-meet = {
    ...
    version = "1.0.6916";
    src = fetchurl {
      url = "https://download.jitsi.org/jitsi-meet/src/jitsi-meet-1.0.6916.tar.bz2";
      sha256 = "sha256-29ngW2ApsA+YhcZcxp/k95OVTyQhTshKJP8z/LQAUS0=";
    };
  };
  jitsi-meet-prosody = {
    ...
    version = "1.0.6916";
    src = fetchurl {
      url = "https://download.jitsi.org/unstable/jitsi-meet-prosody_1.0.6916-1_all.deb";
      sha256 = "sha256-3rW4VBOH2N5UeqNju0LiNhBHzntLDOOOcF/7ZJeCc3M=";
    };
  };
  jitsi-videobridge2 = {
