...
{ fetchgit, fetchurl, fetchFromGitHub }:
{
  ...
  bottles = {
    pname = "bottles";
    version = "2f8f15ab5f3ce5915d8e73a1da7caa995cafc382";
    src = fetchFromGitHub ({
      owner = "bottlesdevs";
      repo = "Bottles";
      rev = "2f8f15ab5f3ce5915d8e73a1da7caa995cafc382";
      fetchSubmodules = false;
      sha256 = "sha256-bCVTVEeXx7XUehJ7Lpq8zDyEGOBMjlv50zxdZ+MyIuY=";
    });
  };
  caddy = {
    pname = "caddy";
  ...
  cinny = {
    pname = "cinny";
    version = "b3bff6b43ff964a88e185fb50ddb4dc74ac93cfa";
    src = fetchFromGitHub ({
      owner = "cinnyapp";
      repo = "cinny";
      rev = "b3bff6b43ff964a88e185fb50ddb4dc74ac93cfa";
      fetchSubmodules = false;
      sha256 = "sha256-qWINzk8WmeVvvIN0uh5c50SBtax2bMl637uAiPVeFKM=";
    });
  };
  cinny-bin = {
    pname = "cinny-bin";
  ...
  eww = {
    pname = "eww";
    version = "6657ef493efe5268e45103eb1a250b66d088e2b3";
    src = fetchFromGitHub ({
      owner = "elkowar";
      repo = "eww";
      rev = "6657ef493efe5268e45103eb1a250b66d088e2b3";
      fetchSubmodules = false;
      sha256 = "sha256-nnqipai8+bpAciwJayFVOCENMngJp99fiAHMzOpKSEc=";
    });
    cargoLock."Cargo.lock" = {
      lockFile = ./eww-6657ef493efe5268e45103eb1a250b66d088e2b3/Cargo.lock;
      outputHashes = {
  ...
  fluffychat = {
    pname = "fluffychat";
    version = "959f901c45b26aa813f7a891b12dfb2700d618d7";
    src = fetchgit {
      url = "https://gitlab.com/famedly/fluffychat";
      rev = "959f901c45b26aa813f7a891b12dfb2700d618d7";
      fetchSubmodules = false;
      deepClone = false;
      leaveDotGit = false;
      sha256 = "sha256-e6/JXynl/FBgvMu8l0fHFn4FdlY7Vv/SiqiNR0LD2Gg=";
    };
  };
  flyingfox = {
    pname = "flyingfox";
  ...
  fx_cast = {
    pname = "fx_cast";
    version = "cbc039a355846255829e034600bf14ecac94e137";
    src = fetchFromGitHub ({
      owner = "hensm";
      repo = "fx_cast";
      rev = "cbc039a355846255829e034600bf14ecac94e137";
      fetchSubmodules = false;
      sha256 = "sha256-R4Z9DH8F8hofKXUXJI/ogbrvH2/sv/WaH0vdveEoRQ8=";
    });
  };
  godu = {
    pname = "godu";
  ...
  hyprland = {
    pname = "hyprland";
    version = "f273ebed9cab738b2f6000a73df7fad08a279c15";
    src = fetchFromGitHub ({
      owner = "hyprwm";
      repo = "hyprland";
      rev = "f273ebed9cab738b2f6000a73df7fad08a279c15";
      fetchSubmodules = false;
      sha256 = "sha256-hs3ezJHIO7wnol2RuLUtxXYFO+qD01koCrU9gS0eDZA=";
    });
  };
  ibus = {
    pname = "ibus";
  ...
  picom = {
    pname = "picom";
    version = "9f01d0dfbe660fcfa321e1648c1b1b135d2825f4";
    src = fetchFromGitHub ({
      owner = "yshui";
      repo = "picom";
      rev = "9f01d0dfbe660fcfa321e1648c1b1b135d2825f4";
      fetchSubmodules = false;
      sha256 = "sha256-ucbyh2EBJ99SOFtFasSb6OXn6LtD65vTC19RZ1bOmYM=";
    });
  };
  playit-agent = {
    pname = "playit-agent";
  ...
  pmbootstrap-test = {
    ...
    version = "3567b7c1233d636503c6f0ae24a44fe4232ea38c";
    src = fetchgit {
      url = "https://gitlab.com/postmarketOS/pmbootstrap";
      rev = "3567b7c1233d636503c6f0ae24a44fe4232ea38c";
      fetchSubmodules = false;
      deepClone = false;
      leaveDotGit = false;
      sha256 = "sha256-dUqD1uIzJ6jtQLMmE7eE3O4rdIxtba577HYkSSCy2iM=";
    };
  };
  pure = {
    pname = "pure";
  ...
  retroarch = {
    pname = "retroarch";
    version = "a96d12e8bcf4ea191a1fa4871f5c878ce1b9abac";
    src = fetchFromGitHub ({
      owner = "libretro";
      repo = "retroarch";
      rev = "a96d12e8bcf4ea191a1fa4871f5c878ce1b9abac";
      fetchSubmodules = false;
      sha256 = "sha256-Q6+lvjvrC512qG1ySSPuwhTJHXNagVBW5gg0mWnqmRA=";
    });
  };
  revanced-cli = {
    pname = "revanced-cli";
  ...
  revanced-integrations = {
    ...
    version = "0.34.0";
    src = fetchurl {
      url = "https://github.com/revanced/revanced-integrations/releases/download/v0.34.0/app-release-unsigned.apk";
      sha256 = "sha256-FbCK+p6Ci9w+Yth6mqMT4bEI/2yj7eHxXrtD0uyPD2k=";
    };
  };
  revanced-patches-jar = {
    ...
    version = "2.40.0";
    src = fetchurl {
      url = "https://github.com/revanced/revanced-patches/releases/download/v2.40.0/revanced-patches-2.40.0.jar";
      sha256 = "sha256-bqcJeBAQJZXWxHL6qshsXfZwnnsWtwou7aZIAbDg4hI=";
    };
  };
  rofi-wayland = {
    pname = "rofi-wayland";
  ...
  rustdesk = {
    pname = "rustdesk";
    version = "3394975aa2d7a8381fabbab65beea9332248061d";
    src = fetchFromGitHub ({
      owner = "rustdesk";
      repo = "rustdesk";
      rev = "3394975aa2d7a8381fabbab65beea9332248061d";
      fetchSubmodules = false;
      sha256 = "sha256-DpymANubuaqaX+96ebQe/+xFmSNYtpj95pIUDvqbkhM=";
    });
    cargoLock."Cargo.lock" = {
      lockFile = ./rustdesk-3394975aa2d7a8381fabbab65beea9332248061d/Cargo.lock;
      outputHashes = {
  ...
  tailscale = {
    pname = "tailscale";
    version = "f983962fc62368808ff3375c2b65af9ed7e4d77d";
    src = fetchFromGitHub ({
      owner = "tailscale";
      repo = "tailscale";
      rev = "f983962fc62368808ff3375c2b65af9ed7e4d77d";
      fetchSubmodules = false;
      sha256 = "sha256-i3QkCTnJwCJHy5b181jt4cHy+8/GPFr0dJTZK7ZRaBg=";
    });
  };
  tailscale-systray = {
  ...
  whitesur-gtk-theme = {
    ...
    version = "29b5231db8a5ffab8205d33a355f9dd0b477f3ea";
    src = fetchFromGitHub ({
      owner = "vinceliuice";
      repo = "whitesur-gtk-theme";
      rev = "29b5231db8a5ffab8205d33a355f9dd0b477f3ea";
      fetchSubmodules = false;
      sha256 = "sha256-V1Vi/rsjkyOala64aRgrIq/CJaU4AEnue+oR+SsqX/Q=";
    });
  };
  whitesur-icon-theme = {
