...
{ fetchgit, fetchurl, fetchFromGitHub, dockerTools }:
{
  ...
  jicofo = {
    ...
    version = "1.0-984";
    src = fetchurl {
      url = "https://download.jitsi.org/unstable/jicofo_1.0-984-1_all.deb";
      sha256 = "sha256-77gZ1Oo+iYzqf9xojG+UubEx//qvvlDHRdtxd1ihPQs=";
    };
  };
  jitsi-meet = {
    pname = "jitsi-meet";
  ...
  rustdesk = {
    pname = "rustdesk";
    version = "aac12c2b21be369354a5df3e5074cfe96284863f";
    src = fetchFromGitHub ({
      owner = "rustdesk";
      repo = "rustdesk";
      rev = "aac12c2b21be369354a5df3e5074cfe96284863f";
      fetchSubmodules = false;
      sha256 = "sha256-CrDfb0foalSxwdxgiqKosX0XK/+u5jrvaVMXipJ1Rv8=";
    });
    cargoLock."Cargo.lock" = {
      lockFile = ./rustdesk-aac12c2b21be369354a5df3e5074cfe96284863f/Cargo.lock;
      outputHashes = {
  ...
  tailscale = {
    pname = "tailscale";
    version = "71a7b8581d1da7f29b33ed45564e3b53680ea995";
    src = fetchFromGitHub ({
      owner = "tailscale";
      repo = "tailscale";
      rev = "71a7b8581d1da7f29b33ed45564e3b53680ea995";
      fetchSubmodules = false;
      sha256 = "sha256-Bv/+x5S3WXKpuH2AX47PQNH1km0e7S7QXOyjzwoxYVM=";
    });
    date = "2023-01-19";
  };
  tailscale-systray = {
  ...
  waydroid = {
    pname = "waydroid";
    version = "d9a7823c54a36d7bec61dc5ed2921789da371fcf";
    src = fetchFromGitHub ({
      owner = "waydroid";
      repo = "waydroid";
      rev = "d9a7823c54a36d7bec61dc5ed2921789da371fcf";
      fetchSubmodules = false;
      sha256 = "sha256-foSFuiLR+y0MVIBA8vncC7KVxng1Qyi7bj5tIiTiZNs=";
    });
    date = "2023-01-19";
  };
  wgcf = {
