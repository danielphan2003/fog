...
{ fetchgit, fetchurl, fetchFromGitHub }:
{
  ...
  caddy-git = {
    pname = "caddy-git";
    version = "8cc8f9fddd2ea717633528322e1bef938bee2415";
    src = fetchFromGitHub ({
      owner = "caddyserver";
      repo = "caddy";
      rev = "8cc8f9fddd2ea717633528322e1bef938bee2415";
      fetchSubmodules = false;
      sha256 = "sha256-rCqv/amKfF8WJge+OYiZ8GD2uAXJCNczhXrrcLbR05w=";
    });
  };
  cinny = {
    pname = "cinny";
  ...
  tailscale = {
    pname = "tailscale";
    version = "1f959edeb0c6ad3a82fcdaa4ca65a02571493cc6";
    src = fetchFromGitHub ({
      owner = "tailscale";
      repo = "tailscale";
      rev = "1f959edeb0c6ad3a82fcdaa4ca65a02571493cc6";
      fetchSubmodules = false;
      sha256 = "sha256-M/t+7DszIkyXiwiEGNn/CrU+b0C0/mxSiKzR57fOpN0=";
    });
  };
  tailscale-systray = {
