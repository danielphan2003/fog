...
{ fetchgit, fetchurl, fetchFromGitHub }:
{
  ...
  flameshot = {
    pname = "flameshot";
    version = "96c2c82e62bdabad6c20b97004c493f69f90a986";
    src = fetchFromGitHub ({
      owner = "flameshot-org";
      repo = "flameshot";
      rev = "96c2c82e62bdabad6c20b97004c493f69f90a986";
      fetchSubmodules = false;
      sha256 = "sha256-CETHdmta+A9gTNhxlcQWmZND15No1MWaf96MuY5ScEI=";
    });
  };
  fluffychat = {
    pname = "fluffychat";
  ...
  retroarch = {
    pname = "retroarch";
    version = "7043873fbafc075c95cc5780be7d8d7382db9fae";
    src = fetchFromGitHub ({
      owner = "libretro";
      repo = "retroarch";
      rev = "7043873fbafc075c95cc5780be7d8d7382db9fae";
      fetchSubmodules = false;
      sha256 = "sha256-2qogEruTz9n68j2tM/seOME4m1tT/qIduEHpN5LpzH8=";
    });
  };
  revanced-cli = {
    pname = "revanced-cli";
