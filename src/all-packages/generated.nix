...
{ fetchgit, fetchurl, fetchFromGitHub }:
{
  ...
  hyprland = {
    pname = "hyprland";
    version = "4c1dba643e1c25d681d121adaf3ac992681be985";
    src = fetchFromGitHub ({
      owner = "hyprwm";
      repo = "hyprland";
      rev = "4c1dba643e1c25d681d121adaf3ac992681be985";
      fetchSubmodules = false;
      sha256 = "sha256-cL2w9eacd+M3opPdkdxwjYn63EaVYQJEHh/IapnfXbI=";
    });
  };
  ibus = {
    pname = "ibus";
  ...
  jitsi-meet = {
    ...
    version = "1.0.6469";
    src = fetchurl {
      url = "https://download.jitsi.org/jitsi-meet/src/jitsi-meet-1.0.6469.tar.bz2";
      sha256 = "sha256-v/BaeCN/ZHwag8fEM1l8MGL8sqvUm1NsvmoKH/VEJ20=";
    };
  };
  jitsi-meet-prosody = {
    ...
    version = "1.0.6469";
    src = fetchurl {
      url = "https://download.jitsi.org/unstable/jitsi-meet-prosody_1.0.6469-1_all.deb";
      sha256 = "sha256-4RSbIr5Q0HtXIPcXS+G8pr6z8/wNpfOAOB/obMw3XC8=";
    };
  };
  jitsi-videobridge2 = {
  ...
  retroarch = {
    pname = "retroarch";
    version = "46bafd6e46772d17cf0ac2615f8d83b304a5ce05";
    src = fetchFromGitHub ({
      owner = "libretro";
      repo = "retroarch";
      rev = "46bafd6e46772d17cf0ac2615f8d83b304a5ce05";
      fetchSubmodules = false;
      sha256 = "sha256-XM94iGGO4uZ3PXWrJ4sMardqxgTKcCeTK+YTGfOwPwY=";
    });
  };
  revanced-cli = {
    pname = "revanced-cli";
  ...
  swhkd = {
    pname = "swhkd";
    version = "33c05a05c4b83d1dc6b322c908e5675f655d4f6b";
    src = fetchFromGitHub ({
      owner = "waycrate";
      repo = "swhkd";
      rev = "33c05a05c4b83d1dc6b322c908e5675f655d4f6b";
      fetchSubmodules = false;
      sha256 = "sha256-fFWlcGTyszh8Q73y9AapM/LXgIVzUeICkP8xqi1tEfg=";
    });
    cargoLock."Cargo.lock" = {
      lockFile = ./swhkd-33c05a05c4b83d1dc6b322c908e5675f655d4f6b/Cargo.lock;
      outputHashes = {
  ...
  tailscale = {
    pname = "tailscale";
    version = "03f7e4e57735fd598c8e119e031369bfa69cee87";
    src = fetchFromGitHub ({
      owner = "tailscale";
      repo = "tailscale";
      rev = "03f7e4e57735fd598c8e119e031369bfa69cee87";
      fetchSubmodules = false;
      sha256 = "sha256-o1yj6SFIL+aEMfxKZN1PlMNQk4diHx/DeQt4Wo6FB3c=";
    });
  };
  tailscale-systray = {
