...
{ fetchgit, fetchurl, fetchFromGitHub }:
{
  ...
  caddy-git = {
    pname = "caddy-git";
    version = "498f32bab96ba00e1a7d04c6bc8b367c97d8a335";
    src = fetchFromGitHub ({
      owner = "caddyserver";
      repo = "caddy";
      rev = "498f32bab96ba00e1a7d04c6bc8b367c97d8a335";
      fetchSubmodules = false;
      sha256 = "sha256-pUQWgvAR2vju/4+j7g9x4VDyFNX5ZBmiStuxHoA6/JM=";
    });
  };
  cinny = {
    pname = "cinny";
  ...
  hyprland = {
    pname = "hyprland";
    version = "28a6e0ce3178527e54070fb3ee19d90239110bf7";
    src = fetchFromGitHub ({
      owner = "hyprwm";
      repo = "hyprland";
      rev = "28a6e0ce3178527e54070fb3ee19d90239110bf7";
      fetchSubmodules = false;
      sha256 = "sha256-f5K1N8Fwi+FlU7Kt/p0J+eQILwL/fT3bLOlrj9N4CwQ=";
    });
  };
  ibus = {
    pname = "ibus";
  ...
  jitsi-meet = {
    ...
    version = "1.0.6663";
    src = fetchurl {
      url = "https://download.jitsi.org/jitsi-meet/src/jitsi-meet-1.0.6663.tar.bz2";
      sha256 = "sha256-Yu21Amf7H0SXSU3RlAIaWigIK+hKhHuQwvXSk6PHENs=";
    };
  };
  jitsi-meet-prosody = {
    ...
    version = "1.0.6663";
    src = fetchurl {
      url = "https://download.jitsi.org/unstable/jitsi-meet-prosody_1.0.6663-1_all.deb";
      sha256 = "sha256-8XdU331twodwGkMvP7s9kY/pQXTX6hs1YgKB183E5s0=";
    };
  };
  jitsi-videobridge2 = {
  ...
  pmbootstrap-test = {
    ...
    version = "aaeff96d23a4313d68589e284263361399a02ac6";
    src = fetchgit {
      url = "https://gitlab.com/postmarketOS/pmbootstrap";
      rev = "aaeff96d23a4313d68589e284263361399a02ac6";
      fetchSubmodules = false;
      deepClone = false;
      leaveDotGit = false;
      sha256 = "sha256-lqSPahTkiIuQNAycH0yvaMXuPMThZqsewOyJ/qqFf+s=";
    };
  };
  pure = {
    pname = "pure";
  ...
  retroarch = {
    pname = "retroarch";
    version = "91119d038fb51908caee6bba7ca156f31bdcc1f8";
    src = fetchFromGitHub ({
      owner = "libretro";
      repo = "retroarch";
      rev = "91119d038fb51908caee6bba7ca156f31bdcc1f8";
      fetchSubmodules = false;
      sha256 = "sha256-Jp7Zrx11HnexUsm9oYI661pxyRxUDy2r5RZHS7HoC5U=";
    });
  };
  revanced-cli = {
    pname = "revanced-cli";
  ...
  rustdesk = {
    pname = "rustdesk";
    version = "e733666f55e6b5e0814d4a89f41fd6b6017d6b0e";
    src = fetchFromGitHub ({
      owner = "rustdesk";
      repo = "rustdesk";
      rev = "e733666f55e6b5e0814d4a89f41fd6b6017d6b0e";
      fetchSubmodules = false;
      sha256 = "sha256-2VzL9eNZF40v87ZhOIjeDjgeTh1UOLMcTWxrfLgW6y0=";
    });
    cargoLock."Cargo.lock" = {
      lockFile = ./rustdesk-e733666f55e6b5e0814d4a89f41fd6b6017d6b0e/Cargo.lock;
      outputHashes = {
