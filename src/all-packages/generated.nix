...
{ fetchgit, fetchurl, fetchFromGitHub }:
{
  ...
  ibus = {
    pname = "ibus";
    version = "db2ef5d08ec61df156ca13beb63df7f7fed38829";
    src = fetchFromGitHub ({
      owner = "ibus";
      repo = "ibus";
      rev = "db2ef5d08ec61df156ca13beb63df7f7fed38829";
      fetchSubmodules = false;
      sha256 = "sha256-Zun2a2OKKhh/6hs6OTXETriDRjfhwHlXlL8RQiqp2RQ=";
    });
  };
  ibus-bamboo = {
    pname = "ibus-bamboo";
  ...
  tailscale = {
    pname = "tailscale";
    version = "b7f1fe7b0d53de487274392148fd8612a9e5c25f";
    src = fetchFromGitHub ({
      owner = "tailscale";
      repo = "tailscale";
      rev = "b7f1fe7b0d53de487274392148fd8612a9e5c25f";
      fetchSubmodules = false;
      sha256 = "sha256-eFz8YrexMwZTbES4rsnUGWKaIqOEBuQFyhqSM0yJZgo=";
    });
  };
  tailscale-systray = {
