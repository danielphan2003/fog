...
{ fetchgit, fetchurl, fetchFromGitHub }:
{
  ...
  bottles = {
    pname = "bottles";
    version = "99278e2b0eccf041b2eafca8c987d2689835bb80";
    src = fetchFromGitHub ({
      owner = "bottlesdevs";
      repo = "Bottles";
      rev = "99278e2b0eccf041b2eafca8c987d2689835bb80";
      fetchSubmodules = false;
      sha256 = "sha256-NdGkmgaYoNnZG+I4jLXGTxngqP/eU5cHVfNQELiG1QI=";
    });
  };
  caddy = {
    pname = "caddy";
  ...
  hyprland = {
    pname = "hyprland";
    version = "11c88e2503e10f17997bde8db072beac3b965410";
    src = fetchFromGitHub ({
      owner = "vaxerski";
      repo = "hyprland";
      rev = "11c88e2503e10f17997bde8db072beac3b965410";
      fetchSubmodules = false;
      sha256 = "sha256-SiTc235D600+Onkcv0di56RcD9jkC3B0kcn2AaqZAPU=";
    });
  };
  ibus = {
    pname = "ibus";
