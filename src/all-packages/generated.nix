...
{ fetchgit, fetchurl, fetchFromGitHub }:
{
  ...
  arkenfox-userjs = {
    ...
    version = "95ecd3e328eb9be993b23d876d8b2e142e306322";
    src = fetchFromGitHub ({
      owner = "arkenfox";
      repo = "user.js";
      rev = "95ecd3e328eb9be993b23d876d8b2e142e306322";
      fetchSubmodules = false;
      sha256 = "sha256-DKYk/UWQBDFlNW8UOrnpUfD3uxPQRK1Tnh/mkMfHyB0=";
    });
  };
  asusctl = {
    pname = "asusctl";
  ...
  jitsi-meet = {
    ...
    version = "1.0.6635";
    src = fetchurl {
      url = "https://download.jitsi.org/jitsi-meet/src/jitsi-meet-1.0.6635.tar.bz2";
      sha256 = "sha256-fsHxN3Z4e4ZmKfEHzOCLnw4rtJVOY44dTTO/6sQKO/s=";
    };
  };
  jitsi-meet-prosody = {
    ...
    version = "1.0.6635";
    src = fetchurl {
      url = "https://download.jitsi.org/unstable/jitsi-meet-prosody_1.0.6635-1_all.deb";
      sha256 = "sha256-OwVA3N0CxnLVA4a9oV5iinQqDy7tnl3JoWs2Fo1m0HU=";
    };
  };
  jitsi-videobridge2 = {
  ...
  retroarch = {
    pname = "retroarch";
    version = "d774256e0d11badc88fb50c79f15320b053175a9";
    src = fetchFromGitHub ({
      owner = "libretro";
      repo = "retroarch";
      rev = "d774256e0d11badc88fb50c79f15320b053175a9";
      fetchSubmodules = false;
      sha256 = "sha256-u9jnbNzxuhDLo30ny0YVzfQhmWIp+Hlv5+88tmKCQrQ=";
    });
  };
  revanced-cli = {
    pname = "revanced-cli";
