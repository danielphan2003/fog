...
{ fetchgit, fetchurl, fetchFromGitHub }:
{
  ...
  bottles = {
    pname = "bottles";
    version = "3dabe110c7051fa3b1980d47a5013d0cbb24562f";
    src = fetchFromGitHub ({
      owner = "bottlesdevs";
      repo = "Bottles";
      rev = "3dabe110c7051fa3b1980d47a5013d0cbb24562f";
      fetchSubmodules = false;
      sha256 = "sha256-lT8sOLa//oq7XnKhumHBXciY7VKZ0ArDce41XCFUgJc=";
    });
  };
  caddy = {
    pname = "caddy";
  ...
  caddy-git = {
    pname = "caddy-git";
    version = "d6b3c7d2623d9a809abda367fb93dc48b0ba7d7c";
    src = fetchFromGitHub ({
      owner = "caddyserver";
      repo = "caddy";
      rev = "d6b3c7d2623d9a809abda367fb93dc48b0ba7d7c";
      fetchSubmodules = false;
      sha256 = "sha256-LmUrw9sAq7+gToGfkBXXCQPAagUmvvUbVUDouJWbFRw=";
    });
  };
  cinny = {
    pname = "cinny";
    version = "ac155bbf4cac3324b29d66311289bbb06c0a1534";
    src = fetchFromGitHub ({
      owner = "cinnyapp";
      repo = "cinny";
      rev = "ac155bbf4cac3324b29d66311289bbb06c0a1534";
      fetchSubmodules = false;
      sha256 = "sha256-dyH5Q1NWY8sXkalp+iR/HznO0xObaDxl1xvsbNhLQyU=";
    });
  };
  cinny-bin = {
    pname = "cinny-bin";
  ...
  eww = {
    pname = "eww";
    version = "89ea0a1fbcbf3d786696d75daed824d3e822a7c4";
    src = fetchFromGitHub ({
      owner = "elkowar";
      repo = "eww";
      rev = "89ea0a1fbcbf3d786696d75daed824d3e822a7c4";
      fetchSubmodules = false;
      sha256 = "sha256-Pg0DpUG72/aFaFPOMlXqydkn00VzpdimyhaiVQS0bIA=";
    });
    cargoLock."Cargo.lock" = {
      lockFile = ./eww-89ea0a1fbcbf3d786696d75daed824d3e822a7c4/Cargo.lock;
      outputHashes = {
  ...
  fluffychat = {
    pname = "fluffychat";
    version = "89b3c82ee63eb203b2d3f870a5f4f7247f2ab193";
    src = fetchgit {
      url = "https://gitlab.com/famedly/fluffychat";
      rev = "89b3c82ee63eb203b2d3f870a5f4f7247f2ab193";
      fetchSubmodules = false;
      deepClone = false;
      leaveDotGit = false;
      sha256 = "sha256-k2YbfkMP8Q4etxXr6QThIu3n6OzOqu8liuUpT+g/joI=";
    };
  };
  flyingfox = {
    pname = "flyingfox";
  ...
  fx_cast = {
    pname = "fx_cast";
    version = "62a351072e471841d599892f64de1bd35786a851";
    src = fetchFromGitHub ({
      owner = "hensm";
      repo = "fx_cast";
      rev = "62a351072e471841d599892f64de1bd35786a851";
      fetchSubmodules = false;
      sha256 = "sha256-f27i84ZeMyHnpCSlv51Frqtr4RtvqEl/GZjxbb9UTwY=";
    });
  };
  godu = {
    pname = "godu";
  ...
  hyprland = {
    pname = "hyprland";
    version = "f4add0ac6d633379ade7470a5e6b4afd45f4a073";
    src = fetchFromGitHub ({
      owner = "hyprwm";
      repo = "hyprland";
      rev = "f4add0ac6d633379ade7470a5e6b4afd45f4a073";
      fetchSubmodules = false;
      sha256 = "sha256-XKf6sxoTCxMjEMM+4GdDnk+K05i4Hy04jFNItZf0kEM=";
    });
  };
  ibus = {
    pname = "ibus";
  ...
  jitsi-meet = {
    ...
    version = "1.0.6525";
    src = fetchurl {
      url = "https://download.jitsi.org/jitsi-meet/src/jitsi-meet-1.0.6525.tar.bz2";
      sha256 = "sha256-ISe0qBTOO/pbVGXEYK1acBivQSgt7eQp/2pZuA0s/sc=";
    };
  };
  jitsi-meet-prosody = {
    ...
    version = "1.0.6525";
    src = fetchurl {
      url = "https://download.jitsi.org/unstable/jitsi-meet-prosody_1.0.6525-1_all.deb";
      sha256 = "sha256-+FNXLHZCqN0sJGPUkqT4X6shPQPLYqIl+w6woVOW9Lk=";
    };
  };
  jitsi-videobridge2 = {
  ...
  retroarch = {
    pname = "retroarch";
    version = "532840c4b80d36cbf48190ca6e38f6acb74449d5";
    src = fetchFromGitHub ({
      owner = "libretro";
      repo = "retroarch";
      rev = "532840c4b80d36cbf48190ca6e38f6acb74449d5";
      fetchSubmodules = false;
      sha256 = "sha256-PHiOl+RCnX8FSjarwXbMBuD2GeXN3359TzIRhDbb60I=";
    });
  };
  revanced-cli = {
    pname = "revanced-cli";
  ...
  spicetify-marketplace = {
    ...
    version = "7b327ce04592101c8afe67b61779fd480d0de5cb";
    src = fetchFromGitHub ({
      owner = "spicetify";
      repo = "spicetify-marketplace";
      rev = "7b327ce04592101c8afe67b61779fd480d0de5cb";
      fetchSubmodules = false;
      sha256 = "sha256-YI0bgBXElA2dd1Azi8uL+AKO2X1F0s9XYUecVgAjxys=";
    });
  };
  spicetify-themes = {
  ...
  tailscale = {
    pname = "tailscale";
    version = "3344c3b89bd105231db7d2409a5b1564ed4130e9";
    src = fetchFromGitHub ({
      owner = "tailscale";
      repo = "tailscale";
      rev = "3344c3b89bd105231db7d2409a5b1564ed4130e9";
      fetchSubmodules = false;
      sha256 = "sha256-tanMShc44lUPenfVZUPKyIYphfQSTEUzYMlQWmQohRc=";
    });
  };
  tailscale-systray = {
  ...
  waydroid = {
    pname = "waydroid";
    version = "70cfd0ab2b36a3de4773f36c3cc3d0b4dc0705ad";
    src = fetchFromGitHub ({
      owner = "waydroid";
      repo = "waydroid";
      rev = "70cfd0ab2b36a3de4773f36c3cc3d0b4dc0705ad";
      fetchSubmodules = false;
      sha256 = "sha256-ZuRWQs53046DLRTMBYNIBmcN4J2PBJg2tFR/u8YPEoE=";
    });
  };
  wgcf = {
    pname = "wgcf";
