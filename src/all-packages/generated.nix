...
{ fetchgit, fetchurl, fetchFromGitHub, dockerTools }:
{
  ...
  retroarch = {
    pname = "retroarch";
    version = "6b184a185741e281e3fbc7c222e71010ebaa7fc2";
    src = fetchFromGitHub ({
      owner = "libretro";
      repo = "retroarch";
      rev = "6b184a185741e281e3fbc7c222e71010ebaa7fc2";
      fetchSubmodules = false;
      sha256 = "sha256-4KcYND3WTk5fkSi5P10pOF8+jNZomexUZ0iG1ctrDDI=";
    });
    date = "2023-01-24";
  };
  rofi-wayland = {
  ...
  rustdesk = {
    pname = "rustdesk";
    version = "efa7b52f49dcd0c39d6b7971785ede8558a0495c";
    src = fetchFromGitHub ({
      owner = "rustdesk";
      repo = "rustdesk";
      rev = "efa7b52f49dcd0c39d6b7971785ede8558a0495c";
      fetchSubmodules = false;
      sha256 = "sha256-+XTg6VPBMleVFofoa+t43+i/xCaxyomhomJkmcEfonw=";
    });
    cargoLock."Cargo.lock" = {
      lockFile = ./rustdesk-efa7b52f49dcd0c39d6b7971785ede8558a0495c/Cargo.lock;
      outputHashes = {
  ...
  tailscale = {
    pname = "tailscale";
    version = "140b9aad5c7c2540f8284d3affab628e23cd95d4";
    src = fetchFromGitHub ({
      owner = "tailscale";
      repo = "tailscale";
      rev = "140b9aad5c7c2540f8284d3affab628e23cd95d4";
      fetchSubmodules = false;
      sha256 = "sha256-2JP1iaQDUyh2vtafISjXaShmgHYg8gE6pk2NDYLrQ10=";
    });
    date = "2023-01-23";
  };
  tailscale-systray = {
  ...
  waydroid = {
    pname = "waydroid";
    version = "1e1d5755e3f46a0ff228cd11df8cc3979b2e99a9";
    src = fetchFromGitHub ({
      owner = "waydroid";
      repo = "waydroid";
      rev = "1e1d5755e3f46a0ff228cd11df8cc3979b2e99a9";
      fetchSubmodules = false;
      sha256 = "sha256-oUUGQDOJEqKBNoTTTZuNP1LeLCfU5rdmlGA0c2i5qxE=";
    });
    date = "2023-01-23";
  };
  wgcf = {
