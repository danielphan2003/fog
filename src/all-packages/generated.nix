...
{ fetchgit, fetchurl, fetchFromGitHub }:
{
  ...
  bottles = {
    pname = "bottles";
    version = "df2a47e72cbbd352c87ecc714622b53768222ed8";
    src = fetchFromGitHub ({
      owner = "bottlesdevs";
      repo = "Bottles";
      rev = "df2a47e72cbbd352c87ecc714622b53768222ed8";
      fetchSubmodules = false;
      sha256 = "sha256-d76SmHLqRhuBdmI4DSiBB26FkTJnCK9HoIF66WP97h4=";
    });
  };
  caddy = {
    pname = "caddy";
  ...
  caddy-git = {
    pname = "caddy-git";
    version = "1c9c8f6a13f99817cb35a9b100287da81255be21";
    src = fetchFromGitHub ({
      owner = "caddyserver";
      repo = "caddy";
      rev = "1c9c8f6a13f99817cb35a9b100287da81255be21";
      fetchSubmodules = false;
      sha256 = "sha256-LulP+nlIqFKeTMMVUaUp6RhZylJ620w7FcmohnWWmh4=";
    });
  };
  cinny = {
    pname = "cinny";
    version = "19f674cf5f20f2a2f933107ca728b8cc0cd6bd61";
    src = fetchFromGitHub ({
      owner = "cinnyapp";
      repo = "cinny";
      rev = "19f674cf5f20f2a2f933107ca728b8cc0cd6bd61";
      fetchSubmodules = false;
      sha256 = "sha256-qxFgESKhqQHVfczbwZMTyEK+Rb9V4ypQzTpWviVWWEc=";
    });
  };
  cinny-bin = {
    pname = "cinny-bin";
  ...
  fluffychat = {
    pname = "fluffychat";
    version = "28976ecdefe83511ea50150eda0d36f6eb7d8eb2";
    src = fetchgit {
      url = "https://gitlab.com/famedly/fluffychat";
      rev = "28976ecdefe83511ea50150eda0d36f6eb7d8eb2";
      fetchSubmodules = false;
      deepClone = false;
      leaveDotGit = false;
      sha256 = "sha256-50L+pPA62NOuNP4LWbl4LC/irrkayu6oyahp7udK2Ps=";
    };
  };
  flyingfox = {
    pname = "flyingfox";
  ...
  hyprland = {
    pname = "hyprland";
    version = "1d631c8a233257738a08b3e5aebc8df22d3253fe";
    src = fetchFromGitHub ({
      owner = "hyprwm";
      repo = "hyprland";
      rev = "1d631c8a233257738a08b3e5aebc8df22d3253fe";
      fetchSubmodules = false;
      sha256 = "sha256-k7RaZdGKe22eBZMNDP/9LcRrp98Ncb7Vnedt6lSxp8w=";
    });
  };
  ibus = {
    pname = "ibus";
  ...
  jitsi-meet = {
    ...
    version = "1.0.6534";
    src = fetchurl {
      url = "https://download.jitsi.org/jitsi-meet/src/jitsi-meet-1.0.6534.tar.bz2";
      sha256 = "sha256-Ju7xhTtc5XoTkXIdL8BOG+aR5uAkxA2j/w2mMTQ2xco=";
    };
  };
  jitsi-meet-prosody = {
    ...
    version = "1.0.6534";
    src = fetchurl {
      url = "https://download.jitsi.org/unstable/jitsi-meet-prosody_1.0.6534-1_all.deb";
      sha256 = "sha256-fsCZociVqnoaCN1thvfUFg8lOM3V2N08+aEQX/6fh8k=";
    };
  };
  jitsi-videobridge2 = {
  ...
  microsoft-edge-stable = {
    ...
    version = "105.0.1343.27";
    src = fetchurl {
      url = "https://packages.microsoft.com/repos/edge/pool/main/m/microsoft-edge-stable/microsoft-edge-stable_105.0.1343.27-1_amd64.deb";
      sha256 = "sha256-VZx6QF0oRVT7EKZk4lOm8zf3TAotJg3QNKB9RDpR1Js=";
    };
  };
  minecraft-wayland = {
  ...
  retroarch = {
    pname = "retroarch";
    version = "4806105a2c1e1d67bb813cf60415b21997b1c72f";
    src = fetchFromGitHub ({
      owner = "libretro";
      repo = "retroarch";
      rev = "4806105a2c1e1d67bb813cf60415b21997b1c72f";
      fetchSubmodules = false;
      sha256 = "sha256-RqfiPmMrRn9oC+Y3YmjHShvOwSZPKlQDCgSKqLa1/pg=";
    });
  };
  revanced-cli = {
    pname = "revanced-cli";
  ...
  snui = {
    pname = "snui";
    version = "e96a100688f1fa8393c77285e2c93c8fd00f63af";
    src = fetchgit {
      url = "https://gitlab.com/snakedye/snui";
      rev = "e96a100688f1fa8393c77285e2c93c8fd00f63af";
      fetchSubmodules = false;
      deepClone = false;
      leaveDotGit = false;
      sha256 = "sha256-bsssp08XrYZKWXNkLtQ5194JIfec5c1BY1v+2aGfgB0=";
    };
  };
  spicetify-cli = {
    pname = "spicetify-cli";
  ...
  spicetify-marketplace = {
    ...
    version = "4abf047a669d8d70470ada4dd02b605e939b6e75";
    src = fetchFromGitHub ({
      owner = "spicetify";
      repo = "spicetify-marketplace";
      rev = "4abf047a669d8d70470ada4dd02b605e939b6e75";
      fetchSubmodules = false;
      sha256 = "sha256-087jRtmWO4A/WUUmmBxaiGFozO94UNtKVyZFWZUJs74=";
    });
  };
  spicetify-themes = {
  ...
  tailscale = {
    pname = "tailscale";
    version = "9c8bbc7888d8886e1b47d1bf1fec151eecfd2b4d";
    src = fetchFromGitHub ({
      owner = "tailscale";
      repo = "tailscale";
      rev = "9c8bbc7888d8886e1b47d1bf1fec151eecfd2b4d";
      fetchSubmodules = false;
      sha256 = "sha256-HcKj25KrW0spe4UAB3+OdhhDmiumG9qOVDzMxwdqB3U=";
    });
  };
  tailscale-systray = {
  ...
  waydroid = {
    pname = "waydroid";
    version = "7046fb2fd32b73fde5642187c914c2f637e666b1";
    src = fetchFromGitHub ({
      owner = "waydroid";
      repo = "waydroid";
      rev = "7046fb2fd32b73fde5642187c914c2f637e666b1";
      fetchSubmodules = false;
      sha256 = "sha256-BAYRrKV4IyoBcnFTr+3/Sm4uJhMl4qH+EDWu7fD/Xnc=";
    });
  };
  wgcf = {
    pname = "wgcf";
  ...
  whitesur-gtk-theme = {
    ...
    version = "0f4e0c89ecb7a76bf83f099d18e91b9e8e83d064";
    src = fetchFromGitHub ({
      owner = "vinceliuice";
      repo = "whitesur-gtk-theme";
      rev = "0f4e0c89ecb7a76bf83f099d18e91b9e8e83d064";
      fetchSubmodules = false;
      sha256 = "sha256-bFgeoSAZMfm5+vbdWuo1ZXfjDRPUp+cGo+YBguFr5zg=";
    });
  };
  whitesur-icon-theme = {
