...
{ fetchgit, fetchurl, fetchFromGitHub }:
{
  ...
  hyprland = {
    pname = "hyprland";
    version = "2659afee3cbb8ee5362e0acff2a384c7c7d474fe";
    src = fetchFromGitHub ({
      owner = "vaxerski";
      repo = "hyprland";
      rev = "2659afee3cbb8ee5362e0acff2a384c7c7d474fe";
      fetchSubmodules = false;
      sha256 = "sha256-UWbE2VkgmrxvRdqUSURLTIUQz6BBVwaZ98urtcREv2E=";
    });
  };
  ibus = {
    pname = "ibus";
  ...
  tailscale = {
    pname = "tailscale";
    version = "cfa484e1a2dcb40514152d5591df2a3134f9016b";
    src = fetchFromGitHub ({
      owner = "tailscale";
      repo = "tailscale";
      rev = "cfa484e1a2dcb40514152d5591df2a3134f9016b";
      fetchSubmodules = false;
      sha256 = "sha256-zHLvI9cgUgUx1tFuB57x55oWMkiFtAAUWTLIPzN13mI=";
    });
  };
  tailscale-systray = {
