...
{ fetchgit, fetchurl, fetchFromGitHub }:
{
  ...
  bottles = {
    pname = "bottles";
    version = "94481ab844455486ce61edbe2e6002b3c444de72";
    src = fetchFromGitHub ({
      owner = "bottlesdevs";
      repo = "Bottles";
      rev = "94481ab844455486ce61edbe2e6002b3c444de72";
      fetchSubmodules = false;
      sha256 = "sha256-xiiIgmo5CTE/gqxkuLJu1d2NXFiSGw0IUW5TuJgHkFg=";
    });
  };
  caddy = {
    pname = "caddy";
  ...
  hyprland = {
    pname = "hyprland";
    version = "78bf88ba607d0efff0e270bc16562e2081a34037";
    src = fetchFromGitHub ({
      owner = "vaxerski";
      repo = "hyprland";
      rev = "78bf88ba607d0efff0e270bc16562e2081a34037";
      fetchSubmodules = false;
      sha256 = "sha256-jUGISLJaSI3QQkyyNlMUCmgVYo0918v2t6tEHR9OyqM=";
    });
  };
  ibus = {
    pname = "ibus";
  ...
  retroarch = {
    pname = "retroarch";
    version = "38f6ad95f41a2a17034b5617ae7fbf48b9de4c8c";
    src = fetchFromGitHub ({
      owner = "libretro";
      repo = "retroarch";
      rev = "38f6ad95f41a2a17034b5617ae7fbf48b9de4c8c";
      fetchSubmodules = false;
      sha256 = "sha256-KTtEWSJDQjQkTkmKw1qJQxu7WOku5c4LWLNykH2x1VI=";
    });
  };
  rofi-wayland = {
    pname = "rofi-wayland";
  ...
  tailscale = {
    pname = "tailscale";
    version = "1d04e01d1e62e0f83a24c0e2963c1b74db33c00d";
    src = fetchFromGitHub ({
      owner = "tailscale";
      repo = "tailscale";
      rev = "1d04e01d1e62e0f83a24c0e2963c1b74db33c00d";
      fetchSubmodules = false;
      sha256 = "sha256-MnXL5BWDCDdofQ6IcQbYrjqDAHKBqvcd/oAKEjlreGg=";
    });
  };
  tailscale-systray = {
  ...
  xwayland = {
    pname = "xwayland";
    version = "b00cf4aef881e00533f995c141c3586749cd7ca1";
    src = fetchgit {
      url = "git://anongit.freedesktop.org/xorg/xserver";
      rev = "b00cf4aef881e00533f995c141c3586749cd7ca1";
      fetchSubmodules = false;
      deepClone = false;
      leaveDotGit = false;
      sha256 = "sha256-2qlD14lFt4CM2H/TG0k8xGOXJvGiDi/u2t417USrXNY=";
    };
  };
  ydotool = {
    pname = "ydotool";
