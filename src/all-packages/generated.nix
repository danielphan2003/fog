...
{ fetchgit, fetchurl, fetchFromGitHub }:
{
  ...
  jitsi-meet = {
    ...
    version = "1.0.6633";
    src = fetchurl {
      url = "https://download.jitsi.org/jitsi-meet/src/jitsi-meet-1.0.6633.tar.bz2";
      sha256 = "sha256-1Ck6X5tcUHHa1ELeGfVjI24mflsFnhwMKA0Pp9CDtsc=";
    };
  };
  jitsi-meet-prosody = {
    ...
    version = "1.0.6633";
    src = fetchurl {
      url = "https://download.jitsi.org/unstable/jitsi-meet-prosody_1.0.6633-1_all.deb";
      sha256 = "sha256-OjCGLpGldcHMR/47YZ8fnrNKFHgThNkZMHPf38dELB8=";
    };
  };
  jitsi-videobridge2 = {
  ...
  retroarch = {
    pname = "retroarch";
    version = "4251eb5f61cc8051fa040fef83db77746b76f0f1";
    src = fetchFromGitHub ({
      owner = "libretro";
      repo = "retroarch";
      rev = "4251eb5f61cc8051fa040fef83db77746b76f0f1";
      fetchSubmodules = false;
      sha256 = "sha256-a0b++wj9uZ6YfOHg5RSqLiO0SaisWrUvZvKP2+Xi1nw=";
    });
  };
  revanced-cli = {
    pname = "revanced-cli";
  ...
  spotifyd = {
    pname = "spotifyd";
    version = "6a12d5d68eca0cd27b82c4c48858ad5ff2bc4d68";
    src = fetchFromGitHub ({
      owner = "Spotifyd";
      repo = "spotifyd";
      rev = "6a12d5d68eca0cd27b82c4c48858ad5ff2bc4d68";
      fetchSubmodules = false;
      sha256 = "sha256-53BDCO63aBvs4Rt9uoxlHWH91VnQpf4IeX0zvG3CKU8=";
    });
    cargoLock."Cargo.lock" = {
      lockFile = ./spotifyd-6a12d5d68eca0cd27b82c4c48858ad5ff2bc4d68/Cargo.lock;
      outputHashes = {
  ...
  tailscale = {
    pname = "tailscale";
    version = "a7efc7bd17ef4f790225b450b350cd74501738f6";
    src = fetchFromGitHub ({
      owner = "tailscale";
      repo = "tailscale";
      rev = "a7efc7bd17ef4f790225b450b350cd74501738f6";
      fetchSubmodules = false;
      sha256 = "sha256-DJ3gTwaJGcoiHgkyq8RCEL+CqfG4LjTliDO/ZQLgG9k=";
    });
  };
  tailscale-systray = {
