...
{ fetchgit, fetchurl, fetchFromGitHub }:
{
  ...
  retroarch = {
    pname = "retroarch";
    version = "e9a6252fc77a41566ab4d49d44a9812d72553083";
    src = fetchFromGitHub ({
      owner = "libretro";
      repo = "retroarch";
      rev = "e9a6252fc77a41566ab4d49d44a9812d72553083";
      fetchSubmodules = false;
      sha256 = "sha256-w0f8PSErw7BygXhGUKF8w47dIP8yPUryClptYWCM+00=";
    });
  };
  revanced-cli = {
    pname = "revanced-cli";
  ...
  rustdesk = {
    pname = "rustdesk";
    version = "aabe08d657fc28d7b6229b48dbdc2b6639d5bedc";
    src = fetchFromGitHub ({
      owner = "rustdesk";
      repo = "rustdesk";
      rev = "aabe08d657fc28d7b6229b48dbdc2b6639d5bedc";
      fetchSubmodules = false;
      sha256 = "sha256-z8RRXWXRokm4tk1BSkt1ESL/IEZ7CRc1QZJTnJB4GeY=";
    });
    cargoLock."Cargo.lock" = {
      lockFile = ./rustdesk-aabe08d657fc28d7b6229b48dbdc2b6639d5bedc/Cargo.lock;
      outputHashes = {
  ...
  spicetify-marketplace = {
    ...
    version = "7faf66c689fbfc901ef4ce9b80bf4a4d115bd4ff";
    src = fetchFromGitHub ({
      owner = "spicetify";
      repo = "spicetify-marketplace";
      rev = "7faf66c689fbfc901ef4ce9b80bf4a4d115bd4ff";
      fetchSubmodules = false;
      sha256 = "sha256-3lLqjWyxR7vfgNgzjcIaagrpaqy48qUwRdN7YtmmjFo=";
    });
  };
  spicetify-themes = {
  ...
  trackma = {
    pname = "trackma";
    version = "5c32e365d2af51b083ab966133306d75e0fec65d";
    src = fetchurl {
