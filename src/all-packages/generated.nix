...
{ fetchgit, fetchurl, fetchFromGitHub }:
{
  ...
  hyprland = {
    pname = "hyprland";
    version = "4070e1a148663962ba8f2eff4eeaf018fe6d863b";
    src = fetchFromGitHub ({
      owner = "hyprwm";
      repo = "hyprland";
      rev = "4070e1a148663962ba8f2eff4eeaf018fe6d863b";
      fetchSubmodules = false;
      sha256 = "sha256-UhLtfkw8RYHa07rsrqj3BncIzBocP0XsQgdfN0vUOnQ=";
    });
  };
  ibus = {
    pname = "ibus";
  ...
  tailscale = {
    pname = "tailscale";
    version = "832031d54bedecb067200a3ccb85e4601101fd03";
    src = fetchFromGitHub ({
      owner = "tailscale";
      repo = "tailscale";
      rev = "832031d54bedecb067200a3ccb85e4601101fd03";
      fetchSubmodules = false;
      sha256 = "sha256-7pM+YIqfFE0O/8pcjPB1vXwpSALb6JFqO2UiYPXypFE=";
    });
  };
  tailscale-systray = {
