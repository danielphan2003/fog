...
{ fetchgit, fetchurl, fetchFromGitHub }:
{
  ...
  bottles = {
    pname = "bottles";
    version = "9bdbc1b27714af96f351df59a3fea95472b8a97f";
    src = fetchFromGitHub ({
      owner = "bottlesdevs";
      repo = "Bottles";
      rev = "9bdbc1b27714af96f351df59a3fea95472b8a97f";
      fetchSubmodules = false;
      sha256 = "sha256-OIMDutCWbpcrKkD7z00WvyXh9hvhjN6GJR9ZD5cvXiw=";
    });
  };
  caddy = {
    pname = "caddy";
  ...
  hyprland = {
    pname = "hyprland";
    version = "3e9a8a7bc8952c086f41eb4ecf6d031368ad2487";
    src = fetchFromGitHub ({
      owner = "hyprwm";
      repo = "hyprland";
      rev = "3e9a8a7bc8952c086f41eb4ecf6d031368ad2487";
      fetchSubmodules = false;
      sha256 = "sha256-8xT0dZBaBN9sg0uQ/TzJHL7tdaXUwJxOWAGT6z9pWj8=";
    });
  };
  ibus = {
    pname = "ibus";
  ...
  picom = {
    pname = "picom";
    version = "5d6326ae2892718a0d3680f9503364d00dc5859c";
    src = fetchFromGitHub ({
      owner = "yshui";
      repo = "picom";
      rev = "5d6326ae2892718a0d3680f9503364d00dc5859c";
      fetchSubmodules = false;
      sha256 = "sha256-cQskKWSB7NNN1U6wv79SjzIikwzyUnpqlQvjGhN7zQs=";
    });
  };
  playit-agent = {
    pname = "playit-agent";
  ...
  retroarch = {
    pname = "retroarch";
    version = "e1a139ec0f26aed87c1ff9042e733e2c4b1df39b";
    src = fetchFromGitHub ({
      owner = "libretro";
      repo = "retroarch";
      rev = "e1a139ec0f26aed87c1ff9042e733e2c4b1df39b";
      fetchSubmodules = false;
      sha256 = "sha256-JCihO/Hjw1+ZSq7u4TxfBfgvlAlCO6yT6odXK667sS0=";
    });
  };
  revanced-cli = {
    pname = "revanced-cli";
  ...
  revanced-patches-jar = {
    ...
    version = "2.39.1";
    src = fetchurl {
      url = "https://github.com/revanced/revanced-patches/releases/download/v2.39.1/revanced-patches-2.39.1.jar";
      sha256 = "sha256-wxchYF0JVs4IwBdItBLA5L4U65xFPulbJOESBBSKeU0=";
    };
  };
  rofi-wayland = {
    pname = "rofi-wayland";
