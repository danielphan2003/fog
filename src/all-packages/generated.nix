...
{ fetchgit, fetchurl, fetchFromGitHub }:
{
  ...
  hyprland = {
    pname = "hyprland";
    version = "a2b8e3b34edcd443bcda47f4209296c9ad1e4fa2";
    src = fetchFromGitHub ({
      owner = "hyprwm";
      repo = "hyprland";
      rev = "a2b8e3b34edcd443bcda47f4209296c9ad1e4fa2";
      fetchSubmodules = false;
      sha256 = "sha256-LwBFpS4PeJI+NRdRixkfGRBQ6jYCByAQPbE6A6ZHsvk=";
    });
  };
  ibus = {
    pname = "ibus";
  ...
  rustdesk = {
    pname = "rustdesk";
    version = "5cb195920c9196c31ca165d17d272cc1e6bb73bd";
    src = fetchFromGitHub ({
      owner = "rustdesk";
      repo = "rustdesk";
      rev = "5cb195920c9196c31ca165d17d272cc1e6bb73bd";
      fetchSubmodules = false;
      sha256 = "sha256-Wjjf0lN02hStbNFGqeMYEGnoqZ+qpDpR3g/ORaMv4OQ=";
    });
    cargoLock."Cargo.lock" = {
      lockFile = ./rustdesk-5cb195920c9196c31ca165d17d272cc1e6bb73bd/Cargo.lock;
      outputHashes = {
  ...
  tailscale = {
    pname = "tailscale";
    version = "06b55ab50f54c67e4b9f06f8955286b34f39ad30";
    src = fetchFromGitHub ({
      owner = "tailscale";
      repo = "tailscale";
      rev = "06b55ab50f54c67e4b9f06f8955286b34f39ad30";
      fetchSubmodules = false;
      sha256 = "sha256-Aynos9xz5Bn1dm9x2QYV+8JWbjH4fkEQ+jnAKjhv1Pw=";
    });
  };
  tailscale-systray = {
