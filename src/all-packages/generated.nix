...
{ fetchgit, fetchurl, fetchFromGitHub }:
{
  ...
  dnscrypt-proxy2 = {
    ...
    version = "442f2e15cbf58a94ccbebd4299a3b5c3d57f11d3";
    src = fetchFromGitHub ({
      owner = "DNSCrypt";
      repo = "dnscrypt-proxy";
      rev = "442f2e15cbf58a94ccbebd4299a3b5c3d57f11d3";
      fetchSubmodules = false;
      sha256 = "sha256-s3711Bbnj7AzgqP1HaVy3IvO9T2d/l6UFjCjbY1KTb4=";
    });
  };
  doggo = {
    pname = "doggo";
  ...
  flameshot = {
    pname = "flameshot";
    version = "3464da752b546b60e5581475dd9bb2f3376f0a20";
    src = fetchFromGitHub ({
      owner = "flameshot-org";
      repo = "flameshot";
      rev = "3464da752b546b60e5581475dd9bb2f3376f0a20";
      fetchSubmodules = false;
      sha256 = "sha256-Fg1nQ8MVZSpxYSmxtujLaVkbojbz6pd26iLA4G+D9YI=";
    });
  };
  fluffychat = {
    pname = "fluffychat";
  ...
  guiscrcpy = {
    pname = "guiscrcpy";
    version = "e5cdd414655e5bf0eaf2511c9da215b70572957f";
    src = fetchFromGitHub ({
      owner = "srevinsaju";
      repo = "guiscrcpy";
      rev = "e5cdd414655e5bf0eaf2511c9da215b70572957f";
      fetchSubmodules = false;
      sha256 = "sha256-27cBznQSxL/uKXbxDPFH0RHYqXm9xq9l3/tkE2ZrhUs=";
    });
  };
  hyprland = {
    pname = "hyprland";
  ...
  retroarch = {
    pname = "retroarch";
    version = "35d6c31b5b11d30ac0422e1b699a14952a4fa87d";
    src = fetchFromGitHub ({
      owner = "libretro";
      repo = "retroarch";
      rev = "35d6c31b5b11d30ac0422e1b699a14952a4fa87d";
      fetchSubmodules = false;
      sha256 = "sha256-GWi6jEmq+Mm792Lpqx6ehXv60N9Z2bRlpcTLoJT88Nw=";
    });
  };
  revanced-cli = {
    pname = "revanced-cli";
