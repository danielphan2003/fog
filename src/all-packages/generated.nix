...
{ fetchgit, fetchurl, fetchFromGitHub }:
{
  ...
  flameshot = {
    pname = "flameshot";
    version = "bd3431a9f5af89f013966c45933115a6bb56eaae";
    src = fetchFromGitHub ({
      owner = "flameshot-org";
      repo = "flameshot";
      rev = "bd3431a9f5af89f013966c45933115a6bb56eaae";
      fetchSubmodules = false;
      sha256 = "sha256-oG8Hh2YeJ+ioCylMd9iWPD41JA60zX04NSvACgZYp5w=";
    });
  };
  fluffychat = {
    pname = "fluffychat";
  ...
  hyprland = {
    pname = "hyprland";
    version = "574d950145a332491dc391aaee5c505f9fd45747";
    src = fetchFromGitHub ({
      owner = "vaxerski";
      repo = "hyprland";
      rev = "574d950145a332491dc391aaee5c505f9fd45747";
      fetchSubmodules = false;
      sha256 = "sha256-JbDC1dZDdVMwpUU2dZC59dXqGWIDlHpaoUcEO1ZJvAU=";
    });
  };
  ibus = {
    pname = "ibus";
