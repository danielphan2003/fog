...
{ fetchgit, fetchurl, fetchFromGitHub }:
{
  ...
  asusctl = {
    pname = "asusctl";
    version = "5ab24a624eb6d01432643f0458def2e8827bf192";
    src = fetchgit {
      url = "https://gitlab.com/asus-linux/asusctl";
      rev = "5ab24a624eb6d01432643f0458def2e8827bf192";
      fetchSubmodules = false;
      deepClone = false;
      leaveDotGit = false;
    ...
    cargoLock."Cargo.lock" = {
      lockFile = ./asusctl-5ab24a624eb6d01432643f0458def2e8827bf192/Cargo.lock;
      outputHashes = {
  ...
  bottles = {
    pname = "bottles";
    version = "ee39a4ff26c2bb08816e111ceeeaadd9bfa7c838";
    src = fetchFromGitHub ({
      owner = "bottlesdevs";
      repo = "Bottles";
      rev = "ee39a4ff26c2bb08816e111ceeeaadd9bfa7c838";
      fetchSubmodules = false;
      sha256 = "sha256-pp3GlnFTclaogvF8lzpT/CwHQGnLVFTSvWgKdf+Fbqw=";
    });
  };
  caddy = {
    pname = "caddy";
