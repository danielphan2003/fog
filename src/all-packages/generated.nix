...
{ fetchgit, fetchurl, fetchFromGitHub }:
{
  ...
  hyprland = {
    pname = "hyprland";
    version = "8b5c64c8fd1e911965a217ee4980a327208afdf7";
    src = fetchFromGitHub ({
      owner = "hyprwm";
      repo = "hyprland";
      rev = "8b5c64c8fd1e911965a217ee4980a327208afdf7";
      fetchSubmodules = false;
      sha256 = "sha256-oDd/mpI9+AxGFFzpE1RdU+RQ5Mr03MAvSDWuK72IkQ4=";
    });
  };
  ibus = {
    pname = "ibus";
  ...
  tailscale = {
    pname = "tailscale";
    version = "e1738ea78edde07ff45a3ea8a234d1ea3d772c57";
    src = fetchFromGitHub ({
      owner = "tailscale";
      repo = "tailscale";
      rev = "e1738ea78edde07ff45a3ea8a234d1ea3d772c57";
      fetchSubmodules = false;
      sha256 = "sha256-EJmlLCuwwsP/ATqXQ1K9xeciI32kNSUtyGTIfkbPcSY=";
    });
  };
  tailscale-systray = {
