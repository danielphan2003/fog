...
{ fetchgit, fetchurl, fetchFromGitHub }:
{
  ...
  retroarch = {
    pname = "retroarch";
    version = "fcdb383dc6f31b3551d03edb45952fff82ae88ca";
    src = fetchFromGitHub ({
      owner = "libretro";
      repo = "retroarch";
      rev = "fcdb383dc6f31b3551d03edb45952fff82ae88ca";
      fetchSubmodules = false;
      sha256 = "sha256-Zxs/U0hq0btE0agA/AVfKijE7IEUi6HRMZJ78964vio=";
    });
  };
  revanced-cli = {
    pname = "revanced-cli";
  ...
  revanced-patches-jar = {
    ...
    version = "2.73.0";
    src = fetchurl {
      url = "https://github.com/revanced/revanced-patches/releases/download/v2.73.0/revanced-patches-2.73.0.jar";
      sha256 = "sha256-G39AYAqeQ/o+/ocQLC1AHAe79Wr27+xEe5sVcpM1kns=";
    };
  };
  rofi-wayland = {
    pname = "rofi-wayland";
