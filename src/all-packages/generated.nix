...
{ fetchgit, fetchurl, fetchFromGitHub }:
{
  ...
  caddy-git = {
    pname = "caddy-git";
    version = "0950ba4f0b77f2a9134188386345fccdfddb80ad";
    src = fetchFromGitHub ({
      owner = "caddyserver";
      repo = "caddy";
      rev = "0950ba4f0b77f2a9134188386345fccdfddb80ad";
      fetchSubmodules = false;
      sha256 = "sha256-ymGNENe2dKxSoKDCF2GNxszSxN6mkY9yOEMyD4eG09s=";
    });
  };
  cinny = {
    pname = "cinny";
  ...
  hyprland = {
    pname = "hyprland";
    version = "a8943246a79faff415f2da7e210e80ae51b00d95";
    src = fetchFromGitHub ({
      owner = "hyprwm";
      repo = "hyprland";
      rev = "a8943246a79faff415f2da7e210e80ae51b00d95";
      fetchSubmodules = false;
      sha256 = "sha256-E/TgcXiKhVynyc68bBKm1NuQYQ6sqwI9W7UBA3ohBwY=";
    });
  };
  ibus = {
    pname = "ibus";
  ...
  jicofo = {
    ...
    version = "1.0-929";
    src = fetchurl {
      url = "https://download.jitsi.org/unstable/jicofo_1.0-929-1_all.deb";
      sha256 = "sha256-Qndqgcw2omaMD3VFsuU7Z017IMkv9xu9mJof6QW+BB0=";
    };
  };
  jitsi-meet = {
    pname = "jitsi-meet";
  ...
  tailscale = {
    pname = "tailscale";
    version = "8158dd2edc0e51625e25a106cc316965f2c9e521";
    src = fetchFromGitHub ({
      owner = "tailscale";
      repo = "tailscale";
      rev = "8158dd2edc0e51625e25a106cc316965f2c9e521";
      fetchSubmodules = false;
      sha256 = "sha256-lkcNYKiMBTJVhyOMVWJ8zPwu34gFCJmGNJ4d27JUhp8=";
    });
  };
  tailscale-systray = {
