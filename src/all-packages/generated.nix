...
{ fetchgit, fetchurl, fetchFromGitHub }:
{
  ...
  bottles = {
    pname = "bottles";
    version = "363a1b8a337be7819b7e71b97310c00cc0fdab85";
    src = fetchFromGitHub ({
      owner = "bottlesdevs";
      repo = "Bottles";
      rev = "363a1b8a337be7819b7e71b97310c00cc0fdab85";
      fetchSubmodules = false;
      sha256 = "sha256-iA6dxUo5J5VEebMUwXavFbbylr0IgKmiXfvC8wCQs88=";
    });
  };
  caddy = {
    pname = "caddy";
  ...
  hyprland = {
    pname = "hyprland";
    version = "d504c1e5ab84bcbf7648350e867ccdda9b38b9c4";
    src = fetchFromGitHub ({
      owner = "hyprwm";
      repo = "hyprland";
      rev = "d504c1e5ab84bcbf7648350e867ccdda9b38b9c4";
      fetchSubmodules = false;
      sha256 = "sha256-4xBCexof83T4eFR2EP6HGfpHGLPJf3x6hsWt8LlhIHU=";
    });
  };
  ibus = {
    pname = "ibus";
  ...
  jitsi-meet = {
    ...
    version = "1.0.6823";
    src = fetchurl {
      url = "https://download.jitsi.org/jitsi-meet/src/jitsi-meet-1.0.6823.tar.bz2";
      sha256 = "sha256-sNc9NPofSnYrOkFtG4DyRAhhNohsoapx+pYqg22neCo=";
    };
  };
  jitsi-meet-prosody = {
    ...
    version = "1.0.6823";
    src = fetchurl {
      url = "https://download.jitsi.org/unstable/jitsi-meet-prosody_1.0.6823-1_all.deb";
      sha256 = "sha256-fGvtfJ1+BHvVCkswp24Xrn0+3rpek7FCxww95xojE58=";
    };
  };
  jitsi-videobridge2 = {
  ...
  picom = {
    pname = "picom";
    version = "a9db7ab41eeaa8e1040550d23981a6edb0f71b61";
    src = fetchFromGitHub ({
      owner = "yshui";
      repo = "picom";
      rev = "a9db7ab41eeaa8e1040550d23981a6edb0f71b61";
      fetchSubmodules = false;
      sha256 = "sha256-pWD6xlX+ytPVlrHID1muTGrIhcISNr4Z9lNY/7liZf8=";
    });
  };
  playit-agent = {
    pname = "playit-agent";
  ...
  retroarch = {
    pname = "retroarch";
    version = "1c9d3ad0bfcffb0327f558387973fa4767d2392f";
    src = fetchFromGitHub ({
      owner = "libretro";
      repo = "retroarch";
      rev = "1c9d3ad0bfcffb0327f558387973fa4767d2392f";
      fetchSubmodules = false;
      sha256 = "sha256-90+piH+zwWQAIGugkiwq2SdUInHUTsgTN+BQXQwWUug=";
    });
  };
  revanced-cli = {
    pname = "revanced-cli";
  ...
  revanced-integrations = {
    ...
    version = "0.74.1";
    src = fetchurl {
      url = "https://github.com/revanced/revanced-integrations/releases/download/v0.74.1/app-release-unsigned.apk";
      sha256 = "sha256-QOS/0/xtWtczAmpEgCXTBU4F+f1TqjAxbkcmWEmnUN4=";
    };
  };
  revanced-patches-jar = {
    ...
    version = "2.117.0";
    src = fetchurl {
      url = "https://github.com/revanced/revanced-patches/releases/download/v2.117.0/revanced-patches-2.117.0.jar";
      sha256 = "sha256-pUa7N18ZUfqbOm8/sZQjSjKnyEw+4LRm1FsepMRmR3k=";
    };
  };
  rofi-wayland = {
    pname = "rofi-wayland";
  ...
  tailscale = {
    pname = "tailscale";
    version = "bdd8ce66920b4aaded3b08b46fa5890d9ba192ca";
    src = fetchFromGitHub ({
      owner = "tailscale";
      repo = "tailscale";
      rev = "bdd8ce66920b4aaded3b08b46fa5890d9ba192ca";
      fetchSubmodules = false;
      sha256 = "sha256-qTl7WHWst0QmJoF7I85YT6mfFN8c1vOCAx1atZ6hCC0=";
    });
  };
  tailscale-systray = {
