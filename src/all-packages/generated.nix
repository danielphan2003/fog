...
{ fetchgit, fetchurl, fetchFromGitHub }:
{
  ...
  asusctl = {
    pname = "asusctl";
    version = "b41fdf5cfe89f22b71e0bf28cc6356dab1e3ad46";
    src = fetchgit {
      url = "https://gitlab.com/asus-linux/asusctl";
      rev = "b41fdf5cfe89f22b71e0bf28cc6356dab1e3ad46";
      fetchSubmodules = false;
      deepClone = false;
      leaveDotGit = false;
      sha256 = "sha256-kNEvZR+0LD2ZBteMRdg4ub9yJHvxC9lr8CHg9Y0g57I=";
    };
    cargoLock."Cargo.lock" = {
      lockFile = ./asusctl-b41fdf5cfe89f22b71e0bf28cc6356dab1e3ad46/Cargo.lock;
      outputHashes = {
  ...
  bottles = {
    pname = "bottles";
    version = "74c965871d3a164d362121ad22ee70d0f71c95b3";
    src = fetchFromGitHub ({
      owner = "bottlesdevs";
      repo = "Bottles";
      rev = "74c965871d3a164d362121ad22ee70d0f71c95b3";
      fetchSubmodules = false;
      sha256 = "sha256-A1kZd3M6TkFb10Eq9EUJDvRDNA9tTJ/xWI5uhzGm5gU=";
    });
  };
  caddy = {
    pname = "caddy";
  ...
  hyprland = {
    pname = "hyprland";
    version = "fcb5037a1d22d05d9f58b8a43d75b1870d93b896";
    src = fetchFromGitHub ({
      owner = "hyprwm";
      repo = "hyprland";
      rev = "fcb5037a1d22d05d9f58b8a43d75b1870d93b896";
      fetchSubmodules = false;
      sha256 = "sha256-yYNJ9Py4op+bCzuy4j1f0KZnEDhWVTukj3RsKcZhpYk=";
    });
  };
  ibus = {
    pname = "ibus";
  ...
  jitsi-meet = {
    ...
    version = "1.0.6802";
    src = fetchurl {
      url = "https://download.jitsi.org/jitsi-meet/src/jitsi-meet-1.0.6802.tar.bz2";
      sha256 = "sha256-3Hia5TY1QDJdzQ6QeSFTev+uva2/hsSateyOwEmK8lM=";
    };
  };
  jitsi-meet-prosody = {
    ...
    version = "1.0.6802";
    src = fetchurl {
      url = "https://download.jitsi.org/unstable/jitsi-meet-prosody_1.0.6802-1_all.deb";
      sha256 = "sha256-MlWqvX8xB9czey+WTVH4YBriWTLfoKUUn43aNdFekF8=";
    };
  };
  jitsi-videobridge2 = {
  ...
  retroarch = {
    pname = "retroarch";
    version = "030c3cba4468cf7b5aa027d4c6c1986e317d5eb1";
    src = fetchFromGitHub ({
      owner = "libretro";
      repo = "retroarch";
      rev = "030c3cba4468cf7b5aa027d4c6c1986e317d5eb1";
      fetchSubmodules = false;
      sha256 = "sha256-thATiS3d1+lTPE/iwHnDNcvfsgaAayXHcRPslT2f2/Q=";
    });
  };
  revanced-cli = {
    pname = "revanced-cli";
  ...
  revanced-integrations = {
    ...
    version = "0.69.2";
    src = fetchurl {
      url = "https://github.com/revanced/revanced-integrations/releases/download/v0.69.2/app-release-unsigned.apk";
      sha256 = "sha256-gUGHQ7GEw3ZfOR4RZYvlz2QjYbJ0GZD7r/ouuHWJT1s=";
    };
  };
  ...
  rustdesk = {
    pname = "rustdesk";
    version = "366e287113c6932a765b65afcf9d5cff18f40924";
    src = fetchFromGitHub ({
      owner = "rustdesk";
      repo = "rustdesk";
      rev = "366e287113c6932a765b65afcf9d5cff18f40924";
      fetchSubmodules = false;
      sha256 = "sha256-bTNa0qRHmAmWV0W2y1axtSVTO9py9R6eORxWoNadStg=";
    });
    cargoLock."Cargo.lock" = {
      lockFile = ./rustdesk-366e287113c6932a765b65afcf9d5cff18f40924/Cargo.lock;
      outputHashes = {
  ...
  sddm = {
    pname = "sddm";
    version = "1d156897ab763d1442b0d6b0341c091f0c38b496";
    src = fetchFromGitHub ({
      owner = "sddm";
      repo = "sddm";
      rev = "1d156897ab763d1442b0d6b0341c091f0c38b496";
      fetchSubmodules = false;
      sha256 = "sha256-nSNp82kmnUaKS5xBVXG3+2QgJ48QnuRihXK3mCw1LC8=";
    });
  };
  sddm-chili = {
    pname = "sddm-chili";
  ...
  spicetify-marketplace = {
    ...
    version = "eca3d9c064ed565d2bdf50793175ba7794917ec5";
    src = fetchFromGitHub ({
      owner = "spicetify";
      repo = "spicetify-marketplace";
      rev = "eca3d9c064ed565d2bdf50793175ba7794917ec5";
      fetchSubmodules = false;
      sha256 = "sha256-bmMPAC8v+gdxRglSCbJK3WVhMatD2wuUQA1gAxIXviQ=";
    });
  };
  spicetify-themes = {
  ...
  tailscale = {
    pname = "tailscale";
    version = "1950e56478150728f8ad41436b1cd11afdde5dbe";
    src = fetchFromGitHub ({
      owner = "tailscale";
      repo = "tailscale";
      rev = "1950e56478150728f8ad41436b1cd11afdde5dbe";
      fetchSubmodules = false;
      sha256 = "sha256-4+0tGltPdF+v7MnBaqfQWAAGvb8qt/DR92qttooSJXw=";
    });
  };
  tailscale-systray = {
