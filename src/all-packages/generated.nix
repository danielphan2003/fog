...
{ fetchgit, fetchurl, fetchFromGitHub }:
{
  ...
  fx_cast = {
    pname = "fx_cast";
    version = "12ac28830d198da5f886fca05184d7fd5ce140f4";
    src = fetchFromGitHub ({
      owner = "hensm";
      repo = "fx_cast";
      rev = "12ac28830d198da5f886fca05184d7fd5ce140f4";
      fetchSubmodules = false;
      sha256 = "sha256-q5qTho3C/0xzprB8XQZKavUxW2eAT55i/6O3kcL5fHo=";
    });
  };
  godu = {
    pname = "godu";
  ...
  hyprland = {
    pname = "hyprland";
    version = "d94fe3d063a910cab64fbdc132f6aa168a52e14d";
    src = fetchFromGitHub ({
      owner = "hyprwm";
      repo = "hyprland";
      rev = "d94fe3d063a910cab64fbdc132f6aa168a52e14d";
      fetchSubmodules = false;
      sha256 = "sha256-NCavxa3knCEJHwP4J0Om15ZfL6BqH+ksz+LbgpYV4ac=";
    });
  };
  ibus = {
    pname = "ibus";
  ...
  tailscale = {
    pname = "tailscale";
    version = "ed2b8b3e1d192a63c04d38cac43b0622312789ce";
    src = fetchFromGitHub ({
      owner = "tailscale";
      repo = "tailscale";
      rev = "ed2b8b3e1d192a63c04d38cac43b0622312789ce";
      fetchSubmodules = false;
      sha256 = "sha256-UEFzOZFpc8NNyjYQTPeE+/DryuL4HMJt9R0aWmcJvb0=";
    });
  };
  tailscale-systray = {
