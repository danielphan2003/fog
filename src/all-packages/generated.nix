...
{ fetchgit, fetchurl, fetchFromGitHub }:
{
  ...
  hyprland = {
    pname = "hyprland";
    version = "381d7a430072c7b29bc5f5eb808ffbb86abefbd1";
    src = fetchFromGitHub ({
      owner = "hyprwm";
      repo = "hyprland";
      rev = "381d7a430072c7b29bc5f5eb808ffbb86abefbd1";
      fetchSubmodules = false;
      sha256 = "sha256-WG22dHBjZF0YXLy0OvzSvbkt6NSGiDq62+FfSP+gsrI=";
    });
  };
  ibus = {
    pname = "ibus";
  ...
  rustdesk = {
    pname = "rustdesk";
    version = "f7559e000832f3315d899638eeb2b054c280ba14";
    src = fetchFromGitHub ({
      owner = "rustdesk";
      repo = "rustdesk";
      rev = "f7559e000832f3315d899638eeb2b054c280ba14";
      fetchSubmodules = false;
      sha256 = "sha256-20n3W2FJ/o8IQVtzr7nch9jqoh+RAM7GCjMFfJnQjWE=";
    });
    cargoLock."Cargo.lock" = {
      lockFile = ./rustdesk-f7559e000832f3315d899638eeb2b054c280ba14/Cargo.lock;
      outputHashes = {
  ...
  spicetify-marketplace = {
    ...
    version = "348c79b00d704eb039e4937e04993a09b4792c7b";
    src = fetchFromGitHub ({
      owner = "spicetify";
      repo = "spicetify-marketplace";
      rev = "348c79b00d704eb039e4937e04993a09b4792c7b";
      fetchSubmodules = false;
      sha256 = "sha256-tdb3guaTI0C/Vt7FfMrRP41S6zacQuv2wiBN4R0X9TU=";
    });
  };
  spicetify-themes = {
  ...
  tailscale = {
    pname = "tailscale";
    version = "699b39dec1f99f3f28fbfd2f0a6ee931e10d4234";
    src = fetchFromGitHub ({
      owner = "tailscale";
      repo = "tailscale";
      rev = "699b39dec1f99f3f28fbfd2f0a6ee931e10d4234";
      fetchSubmodules = false;
      sha256 = "sha256-4/6mSPlPWPXx6GrzeYi/mMjqNg6zCfIk6vzdiKgKuVo=";
    });
  };
  tailscale-systray = {
