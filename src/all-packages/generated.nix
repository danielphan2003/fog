...
{ fetchgit, fetchurl, fetchFromGitHub, dockerTools }:
{
  ...
  bottles = {
    pname = "bottles";
    version = "cde89f07e0281b5277ad2879e2ea1f5afcb3828c";
    src = fetchFromGitHub ({
      owner = "bottlesdevs";
      repo = "Bottles";
      rev = "cde89f07e0281b5277ad2879e2ea1f5afcb3828c";
      fetchSubmodules = false;
      sha256 = "sha256-rBKDj0gpv2BTCEl94HJcXIUTTlWsO0J4oeFb7364mwM=";
    });
    date = "2023-02-04";
  };
  caddy = {
  ...
  dnscrypt-proxy2 = {
    ...
    version = "2edfdc48b83366856f0a51b89a59f3ba99aae696";
    src = fetchFromGitHub ({
      owner = "DNSCrypt";
      repo = "dnscrypt-proxy";
      rev = "2edfdc48b83366856f0a51b89a59f3ba99aae696";
      fetchSubmodules = false;
      sha256 = "sha256-W+jnC2RY5tAXQJxney0AyzRo4tBBOpJ/2uKjMSwBLYc=";
    });
    date = "2023-02-06";
  };
  doggo = {
  ...
  fluffychat = {
    pname = "fluffychat";
    version = "da91c2bd9fe3bd90171046273abcb950b5116d72";
    src = fetchgit {
      url = "https://gitlab.com/famedly/fluffychat";
      rev = "da91c2bd9fe3bd90171046273abcb950b5116d72";
      fetchSubmodules = false;
      deepClone = false;
      leaveDotGit = false;
      sha256 = "sha256-tGQZi3WBJjGWrPgbJH7kI/v+oRZySfUPb8yLOO8OeYE=";
    };
    date = "2023-02-06";
  };
  flyingfox = {
  ...
  hyprland = {
    pname = "hyprland";
    version = "863812a0979646fbc1a51b6593fa25fbad77a7be";
    src = fetchFromGitHub ({
      owner = "hyprwm";
      repo = "hyprland";
      rev = "863812a0979646fbc1a51b6593fa25fbad77a7be";
      fetchSubmodules = false;
      sha256 = "sha256-UyCVZVhkZiisMPjfDTAzQIe0YpIkN1Gic97bie3Kf0A=";
    });
    date = "2023-02-06";
  };
  ibus = {
  ...
  jitsi-meet = {
    ...
    version = "1.0.6964";
    src = fetchurl {
      url = "https://download.jitsi.org/jitsi-meet/src/jitsi-meet-1.0.6964.tar.bz2";
      sha256 = "sha256-w8erjsLpUkWGmIndAB6Tg/5PcSkbtt9dKthnRrD0SuI=";
    };
  };
  jitsi-meet-prosody = {
    ...
    version = "1.0.6964";
    src = fetchurl {
      url = "https://download.jitsi.org/unstable/jitsi-meet-prosody_1.0.6964-1_all.deb";
      sha256 = "sha256-tLuxAvlaKYyh9178FT9LfdcrvUNeirUOhmQmSMOmeJc=";
    };
  };
  jitsi-videobridge2 = {
  ...
  rustdesk = {
    pname = "rustdesk";
    version = "4965ecda127fa3f6b124beb9c5163927ec782358";
    src = fetchFromGitHub ({
      owner = "rustdesk";
      repo = "rustdesk";
      rev = "4965ecda127fa3f6b124beb9c5163927ec782358";
      fetchSubmodules = false;
      sha256 = "sha256-BTxv9dTIMmD4qkf/oMNQ/SrmnYL7mJH4PKjlQR4JLi4=";
    });
    cargoLock."Cargo.lock" = {
      lockFile = ./rustdesk-4965ecda127fa3f6b124beb9c5163927ec782358/Cargo.lock;
      outputHashes = {
  ...
  rustdesk-server = {
    ...
    version = "6a83ffea6296dc83e735edb664cd0a950ca66f69";
    src = fetchFromGitHub ({
      owner = "rustdesk";
      repo = "rustdesk-server";
      rev = "6a83ffea6296dc83e735edb664cd0a950ca66f69";
      fetchSubmodules = false;
      sha256 = "sha256-BK2GNvPTxt6TPlFCLUODb29TeuQ0wsrzYRlXX2FPZd8=";
    });
    cargoLock."Cargo.lock" = {
      lockFile = ./rustdesk-server-6a83ffea6296dc83e735edb664cd0a950ca66f69/Cargo.lock;
      outputHashes = {
        "confy-0.4.0" = "sha256-e91cvEixhpPzIthAxzTa3fDY6eCsHUy/eZQAqs7QTDo=";
  ...
  sddm = {
    pname = "sddm";
    version = "58d5c256911490eabbda429226565728040fab82";
    src = fetchFromGitHub ({
      owner = "sddm";
      repo = "sddm";
      rev = "58d5c256911490eabbda429226565728040fab82";
      fetchSubmodules = false;
      sha256 = "sha256-qF/pASM/kpel9A1zqU+kCoaQlGnIVshSDG++eklYREI=";
    });
    date = "2023-02-06";
  };
  sddm-chili = {
  ...
  tailscale = {
    pname = "tailscale";
    version = "99b9d7a621c8f094f83bf56b716e6d29dbebbc01";
    src = fetchFromGitHub ({
      owner = "tailscale";
      repo = "tailscale";
      rev = "99b9d7a621c8f094f83bf56b716e6d29dbebbc01";
      fetchSubmodules = false;
      sha256 = "sha256-ejI3FLDiT/ixCJRxzcKItsUDTlw2zcQQb5tcUm8BEF0=";
    });
    date = "2023-02-04";
  };
  tailscale-systray = {
