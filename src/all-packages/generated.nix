...
{ fetchgit, fetchurl, fetchFromGitHub }:
{
  ...
  fx_cast = {
    pname = "fx_cast";
    version = "50ed7ca500b2cf23740ecb47c3332c50145cc72c";
    src = fetchFromGitHub ({
      owner = "hensm";
      repo = "fx_cast";
      rev = "50ed7ca500b2cf23740ecb47c3332c50145cc72c";
      fetchSubmodules = false;
      sha256 = "sha256-nT3zxFFqV16u8VxKgrP08A+BwUk2zPbfZZM82b0u/Zc=";
    });
  };
  godu = {
    pname = "godu";
  ...
  jitsi-meet = {
    ...
    version = "1.0.6523";
    src = fetchurl {
      url = "https://download.jitsi.org/jitsi-meet/src/jitsi-meet-1.0.6523.tar.bz2";
      sha256 = "sha256-mIlrpEDW8wyEcwCncuuUqDuDcX2QMcNFhDXKTWxaPHs=";
    };
  };
  jitsi-meet-prosody = {
    ...
    version = "1.0.6523";
    src = fetchurl {
      url = "https://download.jitsi.org/unstable/jitsi-meet-prosody_1.0.6523-1_all.deb";
      sha256 = "sha256-cS+pRhz9w09RvL6+6AHNOht1Zd0qleI8CNU0SYg+k38=";
    };
  };
  jitsi-videobridge2 = {
