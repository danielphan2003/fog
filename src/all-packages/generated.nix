...
{ fetchgit, fetchurl, fetchFromGitHub }:
{
  ...
  guiscrcpy = {
    pname = "guiscrcpy";
    version = "be39e54541909f08dd51c5d593525dd1ca5f16f0";
    src = fetchFromGitHub ({
      owner = "srevinsaju";
      repo = "guiscrcpy";
      rev = "be39e54541909f08dd51c5d593525dd1ca5f16f0";
      fetchSubmodules = false;
      sha256 = "sha256-fK8Oh2AeGP1g/jEGmRXaXsU9pmRhBGidzYBKdSWkgso=";
    });
  };
  hyprland = {
    pname = "hyprland";
    version = "b6699487370a3884fc4e82eefc8c5b03ec23b57b";
    src = fetchFromGitHub ({
      owner = "vaxerski";
      repo = "hyprland";
      rev = "b6699487370a3884fc4e82eefc8c5b03ec23b57b";
      fetchSubmodules = false;
      sha256 = "sha256-9U8atvdSe+xLYtgORZ1O3OQClHWpAKTspCdRyNf7WoE=";
    });
  };
  ibus = {
    pname = "ibus";
  ...
  jitsi-meet = {
    ...
    version = "1.0.6360";
    src = fetchurl {
      url = "https://download.jitsi.org/jitsi-meet/src/jitsi-meet-1.0.6360.tar.bz2";
      sha256 = "sha256-KuIv7JOsxKibHM+HaTEAP6WRqLUHWMRgk1SCUSdmq+4=";
    };
  };
  jitsi-meet-prosody = {
    ...
    version = "1.0.6360";
    src = fetchurl {
      url = "https://download.jitsi.org/unstable/jitsi-meet-prosody_1.0.6360-1_all.deb";
      sha256 = "sha256-podCR/Ir383Q/nmbrS6y3tM7oFYqiW8Q6ra42FF0Frk=";
    };
  };
  jitsi-videobridge2 = {
  ...
  retroarch = {
    pname = "retroarch";
    version = "87240556ea884549e04bf5a5531167085a886e0c";
    src = fetchFromGitHub ({
      owner = "libretro";
      repo = "retroarch";
      rev = "87240556ea884549e04bf5a5531167085a886e0c";
      fetchSubmodules = false;
      sha256 = "sha256-o3y6nY3qA9vija6+wYQjw94YMUSc5pEvX0E0G4JCRUA=";
    });
  };
  revanced-cli = {
    pname = "revanced-cli";
  ...
  revanced-integrations = {
    ...
    version = "0.27.1";
    src = fetchurl {
      url = "https://github.com/revanced/revanced-integrations/releases/download/v0.27.1/app-release-unsigned.apk";
      sha256 = "sha256-JKu1jRNHHljVVXZg3nHKh3YU2Vkp+Ytpe4yvLFgDi70=";
    };
  };
  revanced-patches-dex = {
    ...
    version = "2.18.1";
    src = fetchurl {
      url = "https://github.com/revanced/revanced-patches/releases/download/v2.18.1/revanced-patches-2.18.1.dex";
      sha256 = "sha256-1i+mIWri4GiceuUTdtBxHSjUZw0GiFGdK/76x6LEZSY=";
    };
  };
  revanced-patches-jar = {
    ...
    version = "2.18.1";
    src = fetchurl {
      url = "https://github.com/revanced/revanced-patches/releases/download/v2.18.1/revanced-patches-2.18.1.jar";
      sha256 = "sha256-Ftc+/54B90jPpnSqdtLJTABG4Cs7rVTjln/Y6FTTW1M=";
    };
  };
  rofi-wayland = {
    pname = "rofi-wayland";
  ...
  tailscale = {
    pname = "tailscale";
    version = "3c892d106c2e184d86c1dc242694f010e1f70a79";
    src = fetchFromGitHub ({
      owner = "tailscale";
      repo = "tailscale";
      rev = "3c892d106c2e184d86c1dc242694f010e1f70a79";
      fetchSubmodules = false;
      sha256 = "sha256-F+6t451IXHrO6EO72HpNjFDWY8k3iRy2f690+umwuqg=";
    });
  };
  tailscale-systray = {
  ...
  whitesur-gtk-theme = {
    ...
    version = "43f20210e19f01e83a2fecae559f8b194bf111cb";
    src = fetchFromGitHub ({
      owner = "vinceliuice";
      repo = "whitesur-gtk-theme";
      rev = "43f20210e19f01e83a2fecae559f8b194bf111cb";
      fetchSubmodules = false;
      sha256 = "sha256-jUrcsz2xQvoduqj+i3F0RNH9ErKxrd9jhO97gI0mNE0=";
    });
  };
  whitesur-icon-theme = {
