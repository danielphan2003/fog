...
{ fetchgit, fetchurl, fetchFromGitHub }:
{
  ...
  jitsi-meet = {
    ...
    version = "1.0.6710";
    src = fetchurl {
      url = "https://download.jitsi.org/jitsi-meet/src/jitsi-meet-1.0.6710.tar.bz2";
      sha256 = "sha256-n1uq1VcIHofUysecbTiQHoATz4b5Z43YMHssuRL+8rA=";
    };
  };
  jitsi-meet-prosody = {
    ...
    version = "1.0.6710";
    src = fetchurl {
      url = "https://download.jitsi.org/unstable/jitsi-meet-prosody_1.0.6710-1_all.deb";
      sha256 = "sha256-e7NKSfrS/cPtTKsu/vO7/RCSRP9Bmo/439zx5bEoJ6A=";
    };
  };
  jitsi-videobridge2 = {
  ...
  pmbootstrap-test = {
    ...
    version = "66706f896dec72ace5fc7ca5ab81d1b2df6f369e";
    src = fetchgit {
      url = "https://gitlab.com/postmarketOS/pmbootstrap";
      rev = "66706f896dec72ace5fc7ca5ab81d1b2df6f369e";
      fetchSubmodules = false;
      deepClone = false;
      leaveDotGit = false;
      sha256 = "sha256-IMd+t8/aMkYHVBVhRnUDBU+4jylTKlGOfBfRqFuxhlk=";
    };
  };
  pure = {
    pname = "pure";
  ...
  retroarch = {
    pname = "retroarch";
    version = "03c901dfb8a19470187a8eae91523a0349c6f2a0";
    src = fetchFromGitHub ({
      owner = "libretro";
      repo = "retroarch";
      rev = "03c901dfb8a19470187a8eae91523a0349c6f2a0";
      fetchSubmodules = false;
      sha256 = "sha256-eCHDvrKqKrN9pcULajz7851yTvPO50w1nFrglCnMj1w=";
    });
  };
  revanced-cli = {
    pname = "revanced-cli";
  ...
  rustdesk = {
    pname = "rustdesk";
    version = "4a295d844cd22843932e12bc38c3773a8596d1f9";
    src = fetchFromGitHub ({
      owner = "rustdesk";
      repo = "rustdesk";
      rev = "4a295d844cd22843932e12bc38c3773a8596d1f9";
      fetchSubmodules = false;
      sha256 = "sha256-pouNCfSB8iHB1NAfCCn8o+eeAfP41wK+6QlVWhuUowI=";
    });
    cargoLock."Cargo.lock" = {
      lockFile = ./rustdesk-4a295d844cd22843932e12bc38c3773a8596d1f9/Cargo.lock;
      outputHashes = {
  ...
  tailscale = {
    pname = "tailscale";
    version = "d00b095f14263635c4764c6358a62aff36d2574c";
    src = fetchFromGitHub ({
      owner = "tailscale";
      repo = "tailscale";
      rev = "d00b095f14263635c4764c6358a62aff36d2574c";
      fetchSubmodules = false;
      sha256 = "sha256-Td1X5A/+InzIyal8491bmmvOAHPYzPoHDgy1duamkGk=";
    });
  };
  tailscale-systray = {
