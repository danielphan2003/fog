...
{ fetchgit, fetchurl, fetchFromGitHub, dockerTools }:
{
  ...
  retroarch = {
    pname = "retroarch";
    version = "d5dc405ac1e58410b02de49e12e63450c253ea2d";
    src = fetchFromGitHub ({
      owner = "libretro";
      repo = "retroarch";
      rev = "d5dc405ac1e58410b02de49e12e63450c253ea2d";
      fetchSubmodules = false;
      sha256 = "sha256-O+2SlF69Y5/SZTuKcyKCREPCR3nmZY+iyyBP/yS28bo=";
    });
    date = "2023-02-10";
  };
  rofi-wayland = {
  ...
  rustdesk = {
    pname = "rustdesk";
    version = "70c9ef6494137e945770aa838d34d37249212b00";
    src = fetchFromGitHub ({
      owner = "rustdesk";
      repo = "rustdesk";
      rev = "70c9ef6494137e945770aa838d34d37249212b00";
      fetchSubmodules = false;
      sha256 = "sha256-In7qCWE5BVmtVgi1zZT4g/ZItpZG2If2JQaNlSj5508=";
    });
    cargoLock."Cargo.lock" = {
      lockFile = ./rustdesk-70c9ef6494137e945770aa838d34d37249212b00/Cargo.lock;
      outputHashes = {
  ...
  tailscale = {
    pname = "tailscale";
    version = "78980a4ccff5fc10a036544dfea20d206d152451";
    src = fetchFromGitHub ({
      owner = "tailscale";
      repo = "tailscale";
      rev = "78980a4ccff5fc10a036544dfea20d206d152451";
      fetchSubmodules = false;
      sha256 = "sha256-ChF0caPzW9bx76tfqPRdISHhKt8KnAI23KnbjJxbs+s=";
    });
    date = "2023-02-09";
  };
  tailscale-systray = {
