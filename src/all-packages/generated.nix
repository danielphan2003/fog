...
{ fetchgit, fetchurl, fetchFromGitHub }:
{
  ...
  bottles = {
    pname = "bottles";
    version = "976a2e549e76207c19c4d7b7884a1f133f9c6a04";
    src = fetchFromGitHub ({
      owner = "bottlesdevs";
      repo = "Bottles";
      rev = "976a2e549e76207c19c4d7b7884a1f133f9c6a04";
      fetchSubmodules = false;
      sha256 = "sha256-Ws+Ns3f+MUJVElZt7WGAt77kaNz5mllEAEdwLT1oWiM=";
    });
  };
  caddy = {
    pname = "caddy";
  ...
  rustdesk = {
    pname = "rustdesk";
    version = "3e9ab2278dda0a278c3b80509c46d18d9ab7c0df";
    src = fetchFromGitHub ({
      owner = "rustdesk";
      repo = "rustdesk";
      rev = "3e9ab2278dda0a278c3b80509c46d18d9ab7c0df";
      fetchSubmodules = false;
      sha256 = "sha256-uOdxh1ErvNlwIgFn4fS6fNtFh3hgk7vlRdlsnHZJcIw=";
    });
    cargoLock."Cargo.lock" = {
      lockFile = ./rustdesk-3e9ab2278dda0a278c3b80509c46d18d9ab7c0df/Cargo.lock;
      outputHashes = {
  ...
  rustdesk-server = {
    ...
    version = "55fcf241c643d5b90e9ff5d83721c1a35d88d91a";
    src = fetchFromGitHub ({
      owner = "rustdesk";
      repo = "rustdesk-server";
      rev = "55fcf241c643d5b90e9ff5d83721c1a35d88d91a";
      fetchSubmodules = false;
      sha256 = "sha256-Wu8FBcNPNC+xspv3MQrlp+x63oARRts1tySXc1cAdM4=";
    });
    cargoLock."Cargo.lock" = {
      lockFile = ./rustdesk-server-55fcf241c643d5b90e9ff5d83721c1a35d88d91a/Cargo.lock;
      outputHashes = {
        "confy-0.4.0" = "sha256-e91cvEixhpPzIthAxzTa3fDY6eCsHUy/eZQAqs7QTDo=";
  ...
  tailscale = {
    pname = "tailscale";
    version = "1116602d4cfd5dada720e006d5df401e1fc73be8";
    src = fetchFromGitHub ({
      owner = "tailscale";
      repo = "tailscale";
      rev = "1116602d4cfd5dada720e006d5df401e1fc73be8";
      fetchSubmodules = false;
      sha256 = "sha256-LawqiBuJeokmTq9pHnoqGxd/wtllybPNbFJVuua0IP0=";
    });
  };
  tailscale-systray = {
