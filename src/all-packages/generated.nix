...
{ fetchgit, fetchurl, fetchFromGitHub }:
{
  ...
  cinny = {
    pname = "cinny";
    version = "3c1cc59d599bb5dcb2adf327d059601ada5bb5e4";
    src = fetchFromGitHub ({
      owner = "cinnyapp";
      repo = "cinny";
      rev = "3c1cc59d599bb5dcb2adf327d059601ada5bb5e4";
      fetchSubmodules = false;
      sha256 = "sha256-7A4mpFHdKj+0MnZGw6MeIwe4lBYCZwby2yFGWpC9PIs=";
    });
  };
  cinny-bin = {
    pname = "cinny-bin";
  ...
  tailscale = {
    pname = "tailscale";
    version = "77a92f326d3cd82334c5fb1aabf777303254c0b4";
    src = fetchFromGitHub ({
      owner = "tailscale";
      repo = "tailscale";
      rev = "77a92f326d3cd82334c5fb1aabf777303254c0b4";
      fetchSubmodules = false;
      sha256 = "sha256-CSIFactywMCqimpHS5Jbj89NAnyRlxS0yrkhLOl9UPs=";
    });
  };
  tailscale-systray = {
