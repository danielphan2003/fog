...
{ fetchgit, fetchurl, fetchFromGitHub, dockerTools }:
{
  ...
  bottles = {
    pname = "bottles";
    version = "48014686a6856d4dd6a9bca24e5e4a4efcbe207e";
    src = fetchFromGitHub ({
      owner = "bottlesdevs";
      repo = "Bottles";
      rev = "48014686a6856d4dd6a9bca24e5e4a4efcbe207e";
      fetchSubmodules = false;
      sha256 = "sha256-feIOUj/32+/VeH/TJ8KTpPAL+E0HISMm6Fq2B3D26SA=";
    });
    date = "2023-01-09";
  };
  caddy = {
  ...
  fluffychat = {
    pname = "fluffychat";
    version = "b76f270e24230f814ee10c057a16064183b49a0b";
    src = fetchgit {
      url = "https://gitlab.com/famedly/fluffychat";
      rev = "b76f270e24230f814ee10c057a16064183b49a0b";
      fetchSubmodules = false;
      deepClone = false;
      leaveDotGit = false;
      sha256 = "sha256-tUOqasfni/s1JDQUeBzCPxe+7GG/jt5uA2vGBGo+3u4=";
    };
    date = "2023-01-08";
  };
  flyingfox = {
  ...
  hyprland = {
    pname = "hyprland";
    version = "20a1a47e665da336a87caa3036682bd142aa02b8";
    src = fetchFromGitHub ({
      owner = "hyprwm";
      repo = "hyprland";
      rev = "20a1a47e665da336a87caa3036682bd142aa02b8";
      fetchSubmodules = false;
      sha256 = "sha256-8x+awd811HWf3ipRq680WZhaU6UUjCjyJj8PgCEMgoo=";
    });
    date = "2023-01-09";
  };
  ibus = {
  ...
  jitsi-meet = {
    ...
    version = "1.0.6898";
    src = fetchurl {
      url = "https://download.jitsi.org/jitsi-meet/src/jitsi-meet-1.0.6898.tar.bz2";
      sha256 = "sha256-o2hQ07DuhETww3vp39ydO9yoCU0AZYq2zO2EhQLWAKw=";
    };
  };
  jitsi-meet-prosody = {
    ...
    version = "1.0.6898";
    src = fetchurl {
      url = "https://download.jitsi.org/unstable/jitsi-meet-prosody_1.0.6898-1_all.deb";
      sha256 = "sha256-ARwztZIaK67wl3qUQ1UlNJk2ujtT/pmQIdgJTcdmCYA=";
    };
  };
  jitsi-videobridge2 = {
  ...
  ouch = {
    pname = "ouch";
    version = "38e19536af617cc1ef2742d967b4776b6eebbaf7";
    src = fetchFromGitHub ({
      owner = "ouch-org";
      repo = "ouch";
      rev = "38e19536af617cc1ef2742d967b4776b6eebbaf7";
      fetchSubmodules = false;
      sha256 = "sha256-PMP2iD4se8pDGznDWrAzOsFM076qWM7LYjkV551+bZM=";
    });
    cargoLock."Cargo.lock" = {
      lockFile = ./ouch-38e19536af617cc1ef2742d967b4776b6eebbaf7/Cargo.lock;
      outputHashes = {
  ...
  rustdesk = {
    pname = "rustdesk";
    version = "8369026c5106821d4432cfa8e7f2ff3d1ff29dca";
    src = fetchFromGitHub ({
      owner = "rustdesk";
      repo = "rustdesk";
      rev = "8369026c5106821d4432cfa8e7f2ff3d1ff29dca";
      fetchSubmodules = false;
      sha256 = "sha256-So7tzqyy2DafU0DsDAB4JSKZe1fQz/zXO1U/xi0qt9M=";
    });
    cargoLock."Cargo.lock" = {
      lockFile = ./rustdesk-8369026c5106821d4432cfa8e7f2ff3d1ff29dca/Cargo.lock;
      outputHashes = {
  ...
  rustdesk-server = {
    ...
    version = "86a75451d8c580b158ee2de684ffb88d065e6783";
    src = fetchFromGitHub ({
      owner = "rustdesk";
      repo = "rustdesk-server";
      rev = "86a75451d8c580b158ee2de684ffb88d065e6783";
      fetchSubmodules = false;
      sha256 = "sha256-9/l/G/Zv2Ilg38YLxI/vwvabsnNnLqj+gpocCTyVcrM=";
    });
    cargoLock."Cargo.lock" = {
      lockFile = ./rustdesk-server-86a75451d8c580b158ee2de684ffb88d065e6783/Cargo.lock;
      outputHashes = {
        "confy-0.4.0" = "sha256-e91cvEixhpPzIthAxzTa3fDY6eCsHUy/eZQAqs7QTDo=";
  ...
  waydroid = {
    pname = "waydroid";
    version = "094a4d970ccefa2e6409c8147c1edbdaaa74df0f";
    src = fetchFromGitHub ({
      owner = "waydroid";
      repo = "waydroid";
      rev = "094a4d970ccefa2e6409c8147c1edbdaaa74df0f";
      fetchSubmodules = false;
      sha256 = "sha256-q4FeJUjHT2eMll3/HluMlxykCe8rM7MGLyXwzEz6v9k=";
    });
    date = "2023-01-06";
  };
  wgcf = {
  ...
  whitesur-gtk-theme = {
    ...
    version = "b1a9e41dfadcac7e18962aa78a08f16ea3487ca5";
    src = fetchFromGitHub ({
      owner = "vinceliuice";
      repo = "whitesur-gtk-theme";
      rev = "b1a9e41dfadcac7e18962aa78a08f16ea3487ca5";
      fetchSubmodules = false;
      sha256 = "sha256-1SZ2ChqP9LUcGzOk8XaHG06GTjNJg+2IlYjH6l7hwJA=";
    });
    date = "2023-01-10";
  };
  whitesur-icon-theme = {
    pname = "whitesur-icon-theme";
    version = "c7cce74a4c7038ac0761dfcab7c8229194b7e353";
    src = fetchFromGitHub ({
      owner = "vinceliuice";
      repo = "whitesur-icon-theme";
      rev = "c7cce74a4c7038ac0761dfcab7c8229194b7e353";
      fetchSubmodules = false;
      sha256 = "sha256-xqKGZPlGl8kNZ4AQYZWAywL+6UxwGzYOZ9WvB85JKZk=";
    });
    date = "2023-01-08";
  };
  widevine-cdm = {
