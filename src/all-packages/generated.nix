...
{ fetchgit, fetchurl, fetchFromGitHub }:
{
  ...
  spicetify-cli = {
    pname = "spicetify-cli";
    version = "b4f5f2002859c8d8eefe16dd9f46ccb394500a83";
    src = fetchFromGitHub ({
      owner = "khanhas";
      repo = "spicetify-cli";
      rev = "b4f5f2002859c8d8eefe16dd9f46ccb394500a83";
      fetchSubmodules = false;
      sha256 = "sha256-zazbSWc55tR6ZJTnV9YiBBXc7MyAL8UrxLnxKQmoC3o=";
    });
  };
  ...
  tailscale = {
    pname = "tailscale";
    version = "393a229de98969d435ea3d403ebb992d3c9f8324";
    src = fetchFromGitHub ({
      owner = "tailscale";
      repo = "tailscale";
      rev = "393a229de98969d435ea3d403ebb992d3c9f8324";
      fetchSubmodules = false;
      sha256 = "sha256-+0pluFJRdxZsODk7uItFkZBcbwnGxYN1jOAB4IPrz4c=";
    });
  };
  tailscale-systray = {
  ...
  whitesur-icon-theme = {
    ...
    version = "e852c2ebe26463a8db1e6b512969c9af2a58e225";
    src = fetchFromGitHub ({
      owner = "vinceliuice";
      repo = "whitesur-icon-theme";
      rev = "e852c2ebe26463a8db1e6b512969c9af2a58e225";
      fetchSubmodules = false;
      sha256 = "sha256-8XuyZQ0MGJUprwFQn546T15fws7JmJjVaSjHCwKBsRA=";
    });
  };
  widevine-cdm = {
    pname = "widevine-cdm";
