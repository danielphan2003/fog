...
{ fetchgit, fetchurl, fetchFromGitHub }:
{
  ...
  eww = {
    pname = "eww";
    version = "37fc231761be466bfb003b33652dd8482ddbbc19";
    src = fetchFromGitHub ({
      owner = "elkowar";
      repo = "eww";
      rev = "37fc231761be466bfb003b33652dd8482ddbbc19";
      fetchSubmodules = false;
      sha256 = "sha256-vOudfOvh2GXqOvXMJzhl/oFm9eoTIV931wbHpoeocIo=";
    });
    cargoLock."Cargo.lock" = {
      lockFile = ./eww-37fc231761be466bfb003b33652dd8482ddbbc19/Cargo.lock;
      outputHashes = {
  ...
  hyprland = {
    pname = "hyprland";
    version = "590fbf808b60baceef3b021050dae4c409121bf5";
    src = fetchFromGitHub ({
      owner = "hyprwm";
      repo = "hyprland";
      rev = "590fbf808b60baceef3b021050dae4c409121bf5";
      fetchSubmodules = false;
      sha256 = "sha256-ogDblDyvM8KgJEmidcmrQbBEFVYleAPLeoyuioCXYa4=";
    });
  };
  ibus = {
    pname = "ibus";
  ...
  retroarch = {
    pname = "retroarch";
    version = "6be8dccd46ac77f659cb6ecd269ef253c7f57e3f";
    src = fetchFromGitHub ({
      owner = "libretro";
      repo = "retroarch";
      rev = "6be8dccd46ac77f659cb6ecd269ef253c7f57e3f";
      fetchSubmodules = false;
      sha256 = "sha256-ObfE6srkSL0BZAc9/jzuHzXBxZFSOZqgKqfVOw8+2SI=";
    });
  };
  revanced-cli = {
    pname = "revanced-cli";
