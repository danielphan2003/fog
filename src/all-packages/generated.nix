...
{ fetchgit, fetchurl, fetchFromGitHub }:
{
  ...
  hyprland = {
    pname = "hyprland";
    version = "f9a7b6bf26eec22448c90f1967d6d85835dcae70";
    src = fetchFromGitHub ({
      owner = "hyprwm";
      repo = "hyprland";
      rev = "f9a7b6bf26eec22448c90f1967d6d85835dcae70";
      fetchSubmodules = false;
      sha256 = "sha256-/r/BvG3ZOM1KUL6MdVIw5gh9b1vZbKgFDLg0Otv8Bo0=";
    });
  };
  ibus = {
    pname = "ibus";
  ...
  jitsi-meet = {
    ...
    version = "1.0.6735";
    src = fetchurl {
      url = "https://download.jitsi.org/jitsi-meet/src/jitsi-meet-1.0.6735.tar.bz2";
      sha256 = "sha256-H1l+EFnVty6vJpbPFHKGmY5+3aT3/5xuPa1k4QSN/J4=";
    };
  };
  jitsi-meet-prosody = {
    ...
    version = "1.0.6735";
    src = fetchurl {
      url = "https://download.jitsi.org/unstable/jitsi-meet-prosody_1.0.6735-1_all.deb";
      sha256 = "sha256-xKJTNrZ5d+7bLSo7ZboVD9m4IgQOUicBtjj/wdnuCDo=";
    };
  };
  jitsi-videobridge2 = {
    pname = "jitsi-videobridge2";
    version = "2.2-53-g07e368f0";
    src = fetchurl {
      url = "https://download.jitsi.org/unstable/jitsi-videobridge2_2.2-53-g07e368f0-1_all.deb";
      sha256 = "sha256-9IMRHOIkzdY+ihHiBhSAeDE7IGzpjKQWmCravk+Cl4k=";
    };
  };
  layout-machi = {
    pname = "layout-machi";
  ...
  netdata-go-d-plugin = {
    ...
    version = "0.41.1";
    src = fetchurl {
      url = "https://github.com/netdata/go.d.plugin/archive/refs/tags/v0.41.1.tar.gz";
      sha256 = "sha256-cdQnnZv16PPnxe8T6GbCDWj0zky21yZ9wv5rQhzDnGA=";
    };
  };
  nix-zsh-completions = {
  ...
  revanced-integrations = {
    ...
    version = "0.58.0";
    src = fetchurl {
      url = "https://github.com/revanced/revanced-integrations/releases/download/v0.58.0/app-release-unsigned.apk";
      sha256 = "sha256-BCzRWLvjaR0brHOSkR93x8FA5E4sv0nMvrFDy+Qfh4U=";
    };
  };
  revanced-patches-jar = {
    ...
    version = "2.89.0";
    src = fetchurl {
      url = "https://github.com/revanced/revanced-patches/releases/download/v2.89.0/revanced-patches-2.89.0.jar";
      sha256 = "sha256-TMzBUNCAsHzzTdJWbqOUZrxnc3Vry/Q+QaXK0xIvdfM=";
    };
  };
  rofi-wayland = {
    pname = "rofi-wayland";
