...
{ fetchgit, fetchurl, fetchFromGitHub, dockerTools }:
{
  ...
  bottles = {
    pname = "bottles";
    version = "41d1f3c616897c015f7e70b7d11d263da9294ee1";
    src = fetchFromGitHub ({
      owner = "bottlesdevs";
      repo = "Bottles";
      rev = "41d1f3c616897c015f7e70b7d11d263da9294ee1";
      fetchSubmodules = false;
      sha256 = "sha256-3TWcXAAsFsW8LC4nS+X2sySiN9AJj6ZcSHvUIU3IT/Q=";
    });
    date = "2023-01-20";
  };
  caddy = {
  ...
  hyprland = {
    pname = "hyprland";
    version = "d5913a23acd36eeaa46a99380afe8b2a78492f2e";
    src = fetchFromGitHub ({
      owner = "hyprwm";
      repo = "hyprland";
      rev = "d5913a23acd36eeaa46a99380afe8b2a78492f2e";
      fetchSubmodules = false;
      sha256 = "sha256-cKEi71FVCPKcjU48YD9Hpw+sBR6UMltCQiDo6lJp554=";
    });
    date = "2023-01-20";
  };
  ibus = {
  ...
  retroarch = {
    pname = "retroarch";
    version = "993d4ee64f1ca040e87065535c5e4e50ef31d7e5";
    src = fetchFromGitHub ({
      owner = "libretro";
      repo = "retroarch";
      rev = "993d4ee64f1ca040e87065535c5e4e50ef31d7e5";
      fetchSubmodules = false;
      sha256 = "sha256-EqWpBDQfi0j8dkBIJrqpkDRgX+jS8C6xgfBFgH8mkw0=";
    });
    date = "2023-01-20";
  };
  rofi-wayland = {
  ...
  tailscale = {
    pname = "tailscale";
    version = "fec888581a0d786ce6f2eb020206b07e7ea158e2";
    src = fetchFromGitHub ({
      owner = "tailscale";
      repo = "tailscale";
      rev = "fec888581a0d786ce6f2eb020206b07e7ea158e2";
      fetchSubmodules = false;
      sha256 = "sha256-A7//AQaKelVjIEsup38z53jO5ehfA+YWBXX4sEAqqcA=";
    });
    date = "2023-01-20";
  };
  tailscale-systray = {
