...
{ fetchgit, fetchurl, fetchFromGitHub }:
{
  ...
  bottles = {
    pname = "bottles";
    version = "a20c83ea584dffafee6291ea22f24dff4b1e8a6d";
    src = fetchFromGitHub ({
      owner = "bottlesdevs";
      repo = "Bottles";
      rev = "a20c83ea584dffafee6291ea22f24dff4b1e8a6d";
      fetchSubmodules = false;
      sha256 = "sha256-fxxo9MH09Zbg++w6KB/8zvjppJcODjcyXz90Zbo489s=";
    });
  };
  caddy = {
    pname = "caddy";
  ...
  hyprland = {
    pname = "hyprland";
    version = "5e1f2539cb24b10cad50eba4c3131190022d5ee0";
    src = fetchFromGitHub ({
      owner = "hyprwm";
      repo = "hyprland";
      rev = "5e1f2539cb24b10cad50eba4c3131190022d5ee0";
      fetchSubmodules = false;
      sha256 = "sha256-0S42Sr8uHM227T3rq1fK6EhhWLz72esgRQPfC7xoCCY=";
    });
  };
  ibus = {
    pname = "ibus";
  ...
  ntfs2btrfs = {
    pname = "ntfs2btrfs";
    version = "be933ee5f3a007e49a3b632f3dc18ef1f0c2efd8";
    src = fetchFromGitHub ({
      owner = "maharmstone";
      repo = "ntfs2btrfs";
      rev = "be933ee5f3a007e49a3b632f3dc18ef1f0c2efd8";
      fetchSubmodules = false;
      sha256 = "sha256-ecXYr4k/GkevKia1cHids5QKonznLM1/duXjXkp3Vw4=";
    });
  };
  nwg-drawer = {
    pname = "nwg-drawer";
