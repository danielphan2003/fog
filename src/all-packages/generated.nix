...
{ fetchgit, fetchurl, fetchFromGitHub }:
{
  ...
  fluffychat = {
    pname = "fluffychat";
    version = "f477d40013d57ad863f7ac22b5703f78174734d8";
    src = fetchgit {
      url = "https://gitlab.com/famedly/fluffychat";
      rev = "f477d40013d57ad863f7ac22b5703f78174734d8";
      fetchSubmodules = false;
      deepClone = false;
      leaveDotGit = false;
      sha256 = "sha256-FkioVkkejsOKGQ+LpUsj+lGn2ND6mbjQSsBz/drREcw=";
    };
  };
  flyingfox = {
    pname = "flyingfox";
  ...
  hyprland = {
    pname = "hyprland";
    version = "575bfa40e5db57944e7d38e8561c17270ef9a635";
    src = fetchFromGitHub ({
      owner = "hyprwm";
      repo = "hyprland";
      rev = "575bfa40e5db57944e7d38e8561c17270ef9a635";
      fetchSubmodules = false;
      sha256 = "sha256-bA3GU1r+gNd/Lv1PAfNrPydWXY4x8JfZMiJjpc3JCcs=";
    });
  };
  ibus = {
    pname = "ibus";
  ...
  jitsi-videobridge2 = {
    ...
    version = "2.2-33-g26bbe31f";
    src = fetchurl {
      url = "https://download.jitsi.org/unstable/jitsi-videobridge2_2.2-33-g26bbe31f-1_all.deb";
      sha256 = "sha256-1kvzaHCEZnGSw8hlCWdwqmfDzFPBi6OjYeaUnrU+rMw=";
    };
  };
  layout-machi = {
    pname = "layout-machi";
  ...
  tailscale = {
    pname = "tailscale";
    version = "5d559141d53c0f8941759f9e9f2b319a84b24177";
    src = fetchFromGitHub ({
      owner = "tailscale";
      repo = "tailscale";
      rev = "5d559141d53c0f8941759f9e9f2b319a84b24177";
      fetchSubmodules = false;
      sha256 = "sha256-Wd9fK3X4cR857DPxHIdfD4hxkrZUYwN7EFOk0rMFPQA=";
    });
  };
  tailscale-systray = {
