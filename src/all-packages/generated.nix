...
{ fetchgit, fetchurl, fetchFromGitHub }:
{
  ...
  bottles = {
    pname = "bottles";
    version = "3bb2fa8f72e9d137a81cb9e3e4f704a39470ccee";
    src = fetchFromGitHub ({
      owner = "bottlesdevs";
      repo = "Bottles";
      rev = "3bb2fa8f72e9d137a81cb9e3e4f704a39470ccee";
      fetchSubmodules = false;
      sha256 = "sha256-qR9fXN/8f5yFmmNkaloVpO5qO6zicpU7T7Ub6vBGJaY=";
    });
  };
  caddy = {
    pname = "caddy";
  ...
  caddy-git = {
    pname = "caddy-git";
    version = "a379fa4c6c5d58aa6b812bb21a879ce0944c1ccb";
    src = fetchFromGitHub ({
      owner = "caddyserver";
      repo = "caddy";
      rev = "a379fa4c6c5d58aa6b812bb21a879ce0944c1ccb";
      fetchSubmodules = false;
      sha256 = "sha256-fjdQ6GTiD+hw1jmcMg+0KAmS89rnnwu2ZDyKj2ZFmqo=";
    });
  };
  cinny = {
    pname = "cinny";
  ...
  hyprland = {
    pname = "hyprland";
    version = "a0be6e19d8b381d93cfcc614cfa93fb2f6a8e615";
    src = fetchFromGitHub ({
      owner = "vaxerski";
      repo = "hyprland";
      rev = "a0be6e19d8b381d93cfcc614cfa93fb2f6a8e615";
      fetchSubmodules = false;
      sha256 = "sha256-9Yea1D3taa+rV755EaI+Nz2ZGB2R9Ot3ZQ0saBEXLFk=";
    });
  };
  ibus = {
    pname = "ibus";
  ...
  tailscale = {
    pname = "tailscale";
    version = "904723691bafd15f32c0b998e4e8c8ef908ac516";
    src = fetchFromGitHub ({
      owner = "tailscale";
      repo = "tailscale";
      rev = "904723691bafd15f32c0b998e4e8c8ef908ac516";
      fetchSubmodules = false;
      sha256 = "sha256-5UJ5sz6FnCAjBhPi/KJiwPQfWzTBY6oyQTeG9RTx7jI=";
    });
  };
  tailscale-systray = {
