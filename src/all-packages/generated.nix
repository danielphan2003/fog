...
{ fetchgit, fetchurl, fetchFromGitHub, dockerTools }:
{
  ...
  hyprland = {
    pname = "hyprland";
    version = "d81f45e54a423cf3af522ca901a2f356d63100c0";
    src = fetchFromGitHub ({
      owner = "hyprwm";
      repo = "hyprland";
      rev = "d81f45e54a423cf3af522ca901a2f356d63100c0";
      fetchSubmodules = false;
      sha256 = "sha256-hH1ZfuzAnhsGoMmFC2RMGHkWj9G/X0H0om6mhBOoT0A=";
    });
    date = "2023-02-03";
  };
  ibus = {
  ...
  jitsi-meet = {
    ...
    version = "1.0.6963";
    src = fetchurl {
      url = "https://download.jitsi.org/jitsi-meet/src/jitsi-meet-1.0.6963.tar.bz2";
      sha256 = "sha256-LbabvZ9V0QPydi+hbZMVuTtip9jrkwRlVPE5Bzyrfeo=";
    };
  };
  jitsi-meet-prosody = {
    ...
    version = "1.0.6963";
    src = fetchurl {
      url = "https://download.jitsi.org/unstable/jitsi-meet-prosody_1.0.6963-1_all.deb";
      sha256 = "sha256-hGYJNl7UpNYG6eHzaouW2oSnrtXkPgpWc4PTIWFC1NY=";
    };
  };
  jitsi-videobridge2 = {
  ...
  rustdesk = {
    pname = "rustdesk";
    version = "a7f0b63623b5bac5eb2e7ba94671a38aa54eeb13";
    src = fetchFromGitHub ({
      owner = "rustdesk";
      repo = "rustdesk";
      rev = "a7f0b63623b5bac5eb2e7ba94671a38aa54eeb13";
      fetchSubmodules = false;
      sha256 = "sha256-C95QkKSFoUDjt/vYpIPF/Dmd2zW3CVKwpJ8IxcLKYHs=";
    });
    cargoLock."Cargo.lock" = {
      lockFile = ./rustdesk-a7f0b63623b5bac5eb2e7ba94671a38aa54eeb13/Cargo.lock;
      outputHashes = {
  ...
  spicetify-marketplace = {
    ...
    version = "ca620e410931c563fe1b908e10bdc256416cad88";
    src = fetchFromGitHub ({
      owner = "spicetify";
      repo = "spicetify-marketplace";
      rev = "ca620e410931c563fe1b908e10bdc256416cad88";
      fetchSubmodules = false;
      sha256 = "sha256-NrC6So/LNV4dYNQ2ytHBx7vLOB05DdB/nOT7YciFvVQ=";
    });
    date = "2023-02-03";
  };
  spicetify-themes = {
  ...
  tailscale = {
    pname = "tailscale";
    version = "880a41bfccd4460de553d122b16c1f4996117bf1";
    src = fetchFromGitHub ({
      owner = "tailscale";
      repo = "tailscale";
      rev = "880a41bfccd4460de553d122b16c1f4996117bf1";
      fetchSubmodules = false;
      sha256 = "sha256-jH/AesxAkqroap25ZgwjpsCp9GjKB62QDEESQ0dKLt8=";
    });
    date = "2023-02-03";
  };
  tailscale-systray = {
