...
{ fetchgit, fetchurl, fetchFromGitHub }:
{
  ...
  jitsi-meet = {
    ...
    version = "1.0.6465";
    src = fetchurl {
      url = "https://download.jitsi.org/jitsi-meet/src/jitsi-meet-1.0.6465.tar.bz2";
      sha256 = "sha256-ZbY+vdrkVvPNPGePxR9lMXfVgXZN1POjMhQmOcZLv3g=";
    };
  };
  jitsi-meet-prosody = {
    ...
    version = "1.0.6465";
    src = fetchurl {
      url = "https://download.jitsi.org/unstable/jitsi-meet-prosody_1.0.6465-1_all.deb";
      sha256 = "sha256-WUceYOpn+y/GlspAYpmrSsKqKGehJEP+tBnkdrDm190=";
    };
  };
  jitsi-videobridge2 = {
  ...
  swhkd = {
    pname = "swhkd";
    version = "a2cdceedbaaa301433f153b2dd948a3c3fb049fc";
    src = fetchFromGitHub ({
      owner = "waycrate";
      repo = "swhkd";
      rev = "a2cdceedbaaa301433f153b2dd948a3c3fb049fc";
      fetchSubmodules = false;
      sha256 = "sha256-KNu6NCPI0dsvjYAd4EZQfq2Wuz5Q0mOkrNmvWqV7mMY=";
    });
    cargoLock."Cargo.lock" = {
      lockFile = ./swhkd-a2cdceedbaaa301433f153b2dd948a3c3fb049fc/Cargo.lock;
      outputHashes = {
