...
{ fetchgit, fetchurl, fetchFromGitHub }:
{
  ...
  fx_cast = {
    pname = "fx_cast";
    version = "d0fe96ffe00927d614793cac076dd474ac4a4019";
    src = fetchFromGitHub ({
      owner = "hensm";
      repo = "fx_cast";
      rev = "d0fe96ffe00927d614793cac076dd474ac4a4019";
      fetchSubmodules = false;
      sha256 = "sha256-YdJW/5y4tZXNeHKnGgOIsElEpCbnVhiImG8dsFYlvDY=";
    });
  };
  godu = {
    pname = "godu";
  ...
  hyprland = {
    pname = "hyprland";
    version = "a648b452ddc64f1f9507f4f4ec995fb5c6764b9a";
    src = fetchFromGitHub ({
      owner = "hyprwm";
      repo = "hyprland";
      rev = "a648b452ddc64f1f9507f4f4ec995fb5c6764b9a";
      fetchSubmodules = false;
      sha256 = "sha256-TiTwSpkXiyAswDZ9KyQuTamcChAD94AqeYYzitzfyGk=";
    });
  };
  ibus = {
    pname = "ibus";
  ...
  retroarch = {
    pname = "retroarch";
    version = "c0221ae340a19ee06e97a238bfe83223c4de599b";
    src = fetchFromGitHub ({
      owner = "libretro";
      repo = "retroarch";
      rev = "c0221ae340a19ee06e97a238bfe83223c4de599b";
      fetchSubmodules = false;
      sha256 = "sha256-ziRcVH3e57zRcRyAEVnHF6bt9aF6L+BswY8NeDx5Or8=";
    });
  };
  revanced-cli = {
    pname = "revanced-cli";
  ...
  rustdesk = {
    pname = "rustdesk";
    version = "ba8addbe2f7a26a99bf997f62df39810936951b9";
    src = fetchFromGitHub ({
      owner = "rustdesk";
      repo = "rustdesk";
      rev = "ba8addbe2f7a26a99bf997f62df39810936951b9";
      fetchSubmodules = false;
      sha256 = "sha256-UZ+7MYsoFA6F/sRmmHEZ6M/jX0RD/3Czl1k5bSHc3CU=";
    });
    cargoLock."Cargo.lock" = {
      lockFile = ./rustdesk-ba8addbe2f7a26a99bf997f62df39810936951b9/Cargo.lock;
      outputHashes = {
  ...
  tailscale = {
    pname = "tailscale";
    version = "70f9fc8c7a0b23ab2732e917601cc12ac39b1493";
    src = fetchFromGitHub ({
      owner = "tailscale";
      repo = "tailscale";
      rev = "70f9fc8c7a0b23ab2732e917601cc12ac39b1493";
      fetchSubmodules = false;
      sha256 = "sha256-A4HaE41p963Wk7o4Ez6B4Tx/vmguPucxgYZvv8dVrPw=";
    });
  };
  tailscale-systray = {
