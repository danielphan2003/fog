...
{ fetchgit, fetchurl, fetchFromGitHub, dockerTools }:
{
  ...
  bottles = {
    pname = "bottles";
    version = "80386bda1c4bca07dbe4f581f86ee701f0163377";
    src = fetchFromGitHub ({
      owner = "bottlesdevs";
      repo = "Bottles";
      rev = "80386bda1c4bca07dbe4f581f86ee701f0163377";
      fetchSubmodules = false;
      sha256 = "sha256-3MZWzsB/b6qa0nvd2Pbmk/3ZWtCRiQXwF9ZTRK3l7gc=";
    });
    date = "2023-01-14";
  };
  caddy = {
  ...
  cinny-desktop = {
    pname = "cinny-desktop";
    version = "dd5ddd1a7bd48d8b596df8b0eb48a7a8d48d5659";
    src = fetchFromGitHub ({
      owner = "cinnyapp";
      repo = "cinny-desktop";
      rev = "dd5ddd1a7bd48d8b596df8b0eb48a7a8d48d5659";
      fetchSubmodules = true;
      sha256 = "sha256-6HAYxFZvWrM5Bw1aDfMfUkgFVmjsNg0u64x+VeZPZi0=";
    });
    cargoLock."src-tauri/Cargo.lock" = {
      lockFile = ./cinny-desktop-dd5ddd1a7bd48d8b596df8b0eb48a7a8d48d5659/src-tauri/Cargo.lock;
      outputHashes = {
  ...
  tailscale = {
    pname = "tailscale";
    version = "3386a59cf1c2778f1d1be1f275d430f779e6d253";
    src = fetchFromGitHub ({
      owner = "tailscale";
      repo = "tailscale";
      rev = "3386a59cf1c2778f1d1be1f275d430f779e6d253";
      fetchSubmodules = false;
      sha256 = "sha256-XLKR9WO/nglEzzy0PkwZZKoRcULn3KcNBzaRufDTCDo=";
    });
    date = "2023-01-14";
  };
  tailscale-systray = {
  ...
  ulauncher = {
    pname = "ulauncher";
    version = "46c2db278b278e9bbbdef31fcc4eabd5aa5258f9";
    src = fetchFromGitHub ({
      owner = "Ulauncher";
      repo = "Ulauncher";
      rev = "46c2db278b278e9bbbdef31fcc4eabd5aa5258f9";
      fetchSubmodules = false;
      sha256 = "sha256-VIrwXL8yg2dvSYWpdqSHt8OfBhTeu0qQeC8r33A3beQ=";
    });
    date = "2023-01-14";
  };
  uniemoji = {
