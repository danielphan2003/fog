...
{ fetchgit, fetchurl, fetchFromGitHub }:
{
  ...
  bottles = {
    pname = "bottles";
    version = "cb7b0f4b35ae12170d7cd055f6c4400828c90e77";
    src = fetchFromGitHub ({
      owner = "bottlesdevs";
      repo = "Bottles";
      rev = "cb7b0f4b35ae12170d7cd055f6c4400828c90e77";
      fetchSubmodules = false;
      sha256 = "sha256-MWH2V0MUVMBJ7VhDxruMTntdZx9hcZiRUpLjLcp2U2k=";
    });
  };
  caddy = {
    pname = "caddy";
  ...
  ibus-bamboo = {
    pname = "ibus-bamboo";
    version = "52a05226194be8a52ae155a98c2cb940c65c8f1f";
    src = fetchFromGitHub ({
      owner = "BambooEngine";
      repo = "ibus-bamboo";
      rev = "52a05226194be8a52ae155a98c2cb940c65c8f1f";
      fetchSubmodules = false;
      sha256 = "sha256-W0WXu8Y+U/ooosIc4SBjG6JiDa3UAKu+jt+5ChNlKfo=";
    });
  };
  inih = {
    pname = "inih";
  ...
  jitsi-meet = {
    ...
    version = "1.0.6749";
    src = fetchurl {
      url = "https://download.jitsi.org/jitsi-meet/src/jitsi-meet-1.0.6749.tar.bz2";
      sha256 = "sha256-eZ4E7eek/y059h3dNzM7lFUdQnoSsQjS8JIoBpI2KTg=";
    };
  };
  jitsi-meet-prosody = {
    ...
    version = "1.0.6749";
    src = fetchurl {
      url = "https://download.jitsi.org/unstable/jitsi-meet-prosody_1.0.6749-1_all.deb";
      sha256 = "sha256-y1gcuBQggJ2tH4fs5jhj6trImF0/P7S8UAqmgzOvvEg=";
    };
  };
  jitsi-videobridge2 = {
  ...
  rustdesk = {
    pname = "rustdesk";
    version = "e263acef3e980353858157b12ac9e710ed301f92";
    src = fetchFromGitHub ({
      owner = "rustdesk";
      repo = "rustdesk";
      rev = "e263acef3e980353858157b12ac9e710ed301f92";
      fetchSubmodules = false;
      sha256 = "sha256-qfYtVyX25Gsl5beLNpZXYEmxHIvmBB/VR8IhqzMBFc4=";
    });
    cargoLock."Cargo.lock" = {
      lockFile = ./rustdesk-e263acef3e980353858157b12ac9e710ed301f92/Cargo.lock;
      outputHashes = {
  ...
  tailscale = {
    pname = "tailscale";
    version = "3336d08d599420c3f4c85ef327666cc264abdd41";
    src = fetchFromGitHub ({
      owner = "tailscale";
      repo = "tailscale";
      rev = "3336d08d599420c3f4c85ef327666cc264abdd41";
      fetchSubmodules = false;
      sha256 = "sha256-KPFPNtBFVuxvFfqwVyh+wzJMHVIIYeCvA9CKMAUxMNI=";
    });
  };
  tailscale-systray = {
