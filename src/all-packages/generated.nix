...
{ fetchgit, fetchurl, fetchFromGitHub }:
{
  ...
  bottles = {
    pname = "bottles";
    version = "140991f62a7da0e74ab2da740bbcbaecd31018fc";
    src = fetchFromGitHub ({
      owner = "bottlesdevs";
      repo = "Bottles";
      rev = "140991f62a7da0e74ab2da740bbcbaecd31018fc";
      fetchSubmodules = false;
      sha256 = "sha256-Tpnh2U9Wv/3VmgqW0/bIqke84yMqqV6KYTenXjvmCrg=";
    });
  };
  caddy = {
    pname = "caddy";
  ...
  caddy-git = {
    pname = "caddy-git";
    version = "dc62d468e9645f52a5e1b4f6093dff65137ab3fe";
    src = fetchFromGitHub ({
      owner = "caddyserver";
      repo = "caddy";
      rev = "dc62d468e9645f52a5e1b4f6093dff65137ab3fe";
      fetchSubmodules = false;
      sha256 = "sha256-/+oY2HnspavLhZRDR8LVDPik7BfXF+TWNuFswAvcofk=";
    });
  };
  cinny = {
    pname = "cinny";
  ...
  retroarch = {
    pname = "retroarch";
    version = "b32ec3613045eae7ca8ba61344ea653b6af8f866";
    src = fetchFromGitHub ({
      owner = "libretro";
      repo = "retroarch";
      rev = "b32ec3613045eae7ca8ba61344ea653b6af8f866";
      fetchSubmodules = false;
      sha256 = "sha256-pWxEuuKy2NOlgMJ8dkALtsmQplbVoW8SgjXjpSakk8w=";
    });
  };
  revanced-cli = {
    pname = "revanced-cli";
  ...
  revanced-patches-dex = {
    ...
    version = "2.37.0";
    src = fetchurl {
      url = "https://github.com/revanced/revanced-patches/releases/download/v2.37.0/revanced-patches-2.37.0.dex";
      sha256 = "sha256-S2SVlsiqMYPOfMpKarKj5djp7jkzLMZkOr54iEs3RKg=";
    };
  };
  revanced-patches-jar = {
    ...
    version = "2.37.0";
    src = fetchurl {
      url = "https://github.com/revanced/revanced-patches/releases/download/v2.37.0/revanced-patches-2.37.0.jar";
      sha256 = "sha256-s5i+uGfShkprAudK6j/2ZyjZhc8gtQLUQc6fq53A1/g=";
    };
  };
  rofi-wayland = {
    pname = "rofi-wayland";
  ...
  tailscale = {
    pname = "tailscale";
    version = "766ea96adf8ca2188d07c8bbf65dc74bc4753f84";
    src = fetchFromGitHub ({
      owner = "tailscale";
      repo = "tailscale";
      rev = "766ea96adf8ca2188d07c8bbf65dc74bc4753f84";
      fetchSubmodules = false;
      sha256 = "sha256-mM/wHAhdSlvW/5Fk1yZrxMUWfnY3iEyNYAvvVvE09FA=";
    });
  };
  tailscale-systray = {
