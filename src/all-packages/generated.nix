...
{ fetchgit, fetchurl, fetchFromGitHub }:
{
  ...
  bottles = {
    pname = "bottles";
    version = "b622a51fdb12b08d216e68b719eaffa9534f3cd1";
    src = fetchFromGitHub ({
      owner = "bottlesdevs";
      repo = "Bottles";
      rev = "b622a51fdb12b08d216e68b719eaffa9534f3cd1";
      fetchSubmodules = false;
      sha256 = "sha256-KmLz5QeLqSoKelMQmqapVp8x+gECWezUdKF/Kp8mkSE=";
    });
  };
  caddy = {
    pname = "caddy";
  ...
  retroarch = {
    pname = "retroarch";
    version = "6ff82319fbc3f4cb57b3e523941196f1e1d46c55";
    src = fetchFromGitHub ({
      owner = "libretro";
      repo = "retroarch";
      rev = "6ff82319fbc3f4cb57b3e523941196f1e1d46c55";
      fetchSubmodules = false;
      sha256 = "sha256-QtvObueGZ9SFzxzi4gb4wRhUEgGLiFW0lgU0nnlfNVw=";
    });
  };
  revanced-cli = {
    pname = "revanced-cli";
  ...
  sddm = {
    pname = "sddm";
    version = "9a5c0eec69e5da18af95603442cfd1ad70f38ef8";
    src = fetchFromGitHub ({
      owner = "sddm";
      repo = "sddm";
      rev = "9a5c0eec69e5da18af95603442cfd1ad70f38ef8";
      fetchSubmodules = false;
