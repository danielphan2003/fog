...
{ fetchgit, fetchurl, fetchFromGitHub }:
{
  ...
  caddy-git = {
    pname = "caddy-git";
    version = "63c7720e84176184698730fed0ca7c402c53481a";
    src = fetchFromGitHub ({
      owner = "caddyserver";
      repo = "caddy";
      rev = "63c7720e84176184698730fed0ca7c402c53481a";
      fetchSubmodules = false;
      sha256 = "sha256-UsUKhCCv24o5UI+QD1+rxk/8Jc6uvOt0R3xZ4bqQf6U=";
    });
  };
  cinny = {
    pname = "cinny";
    version = "fa4c95a9b6249f6cc54f5fbd89f58290f0a23c7b";
    src = fetchFromGitHub ({
      owner = "cinnyapp";
      repo = "cinny";
      rev = "fa4c95a9b6249f6cc54f5fbd89f58290f0a23c7b";
      fetchSubmodules = false;
      sha256 = "sha256-uGBwKcnI0nWhKa8FcorEEUKegeoUWCJH4y8m+QlBzLo=";
    });
  };
  cinny-bin = {
    pname = "cinny-bin";
  ...
  hyprland = {
    pname = "hyprland";
    version = "b9be405d326697df81f5bafd736b817b47aea3a1";
    src = fetchFromGitHub ({
      owner = "hyprwm";
      repo = "hyprland";
      rev = "b9be405d326697df81f5bafd736b817b47aea3a1";
      fetchSubmodules = false;
      sha256 = "sha256-LaIvfwtPr8HbAmOpdJ3UwC0O93MzM5b1/LA04K7pZMo=";
    });
  };
  ibus = {
    pname = "ibus";
  ...
  jitsi-meet = {
    ...
    version = "1.0.6424";
    src = fetchurl {
      url = "https://download.jitsi.org/jitsi-meet/src/jitsi-meet-1.0.6424.tar.bz2";
      sha256 = "sha256-tb/c7wNuf0AVztUDLgfoUTYY6gaya8ol356UdsFOkng=";
    };
  };
  jitsi-meet-prosody = {
    ...
    version = "1.0.6424";
    src = fetchurl {
      url = "https://download.jitsi.org/unstable/jitsi-meet-prosody_1.0.6424-1_all.deb";
      sha256 = "sha256-XfHW/YmtLKDHSChyDyml0v5s2KySjcB6qeBq49SswYY=";
    };
  };
  jitsi-videobridge2 = {
  ...
  retroarch = {
    pname = "retroarch";
    version = "53d2fdbd973c2da85dfaec62d17da76b2d93e0df";
    src = fetchFromGitHub ({
      owner = "libretro";
      repo = "retroarch";
      rev = "53d2fdbd973c2da85dfaec62d17da76b2d93e0df";
      fetchSubmodules = false;
      sha256 = "sha256-4ny7SdT9+A+LjHhDL39Q1DXVNG3IFzsolcjqBK4J/Dk=";
    });
  };
  revanced-cli = {
    pname = "revanced-cli";
  ...
  revanced-patches-dex = {
    ...
    version = "2.30.1";
    src = fetchurl {
      url = "https://github.com/revanced/revanced-patches/releases/download/v2.30.1/revanced-patches-2.30.1.dex";
      sha256 = "sha256-4jre2MeUpC8n6o6L7KwH9FUDh6eyov+7SNvCjg07uJ4=";
    };
  };
  revanced-patches-jar = {
    ...
    version = "2.30.1";
    src = fetchurl {
      url = "https://github.com/revanced/revanced-patches/releases/download/v2.30.1/revanced-patches-2.30.1.jar";
      sha256 = "sha256-HCDLcKN2QfF9rXNY5fSP0Gsb4K9sVDesKdjHZhS7FxE=";
    };
  };
  rofi-wayland = {
    pname = "rofi-wayland";
  ...
  tailscale = {
    pname = "tailscale";
    version = "5f6abcfa6f15cde7ab4dc4c94ec49b80e4639f8c";
    src = fetchFromGitHub ({
      owner = "tailscale";
      repo = "tailscale";
      rev = "5f6abcfa6f15cde7ab4dc4c94ec49b80e4639f8c";
      fetchSubmodules = false;
      sha256 = "sha256-C72PAveCTHiw4U4PJ/37GMeQq5Sco7IGR5EnVF4VNAU=";
    });
  };
  tailscale-systray = {
