...
{ fetchgit, fetchurl, fetchFromGitHub }:
{
  ...
  hyprland = {
    pname = "hyprland";
    version = "250d61e0b3e23ed7088dd7a309b3a5b3a2d6577c";
    src = fetchFromGitHub ({
      owner = "hyprwm";
      repo = "hyprland";
      rev = "250d61e0b3e23ed7088dd7a309b3a5b3a2d6577c";
      fetchSubmodules = false;
      sha256 = "sha256-mZSsFXG8dXjbAMtNsU22l2zNrb2y2lbUd5uwFFu/xBg=";
    });
  };
  ibus = {
    pname = "ibus";
  ...
  revanced-patches-jar = {
    ...
    version = "2.111.3";
    src = fetchurl {
      url = "https://github.com/revanced/revanced-patches/releases/download/v2.111.3/revanced-patches-2.111.3.jar";
      sha256 = "sha256-xx34i+WiaLynPHYvfdqck3deA1j1mn8GWHYMcfkZq2c=";
    };
  };
  rofi-wayland = {
    pname = "rofi-wayland";
  ...
  rustdesk = {
    pname = "rustdesk";
    version = "7b939a88f03bdd1dea4b64134c5532a80b5dc382";
    src = fetchFromGitHub ({
      owner = "rustdesk";
      repo = "rustdesk";
      rev = "7b939a88f03bdd1dea4b64134c5532a80b5dc382";
      fetchSubmodules = false;
      sha256 = "sha256-1XMDSuNEO+zOEJ3D37gFEcIBTYF1sjeLA35HcIhuhiA=";
    });
    cargoLock."Cargo.lock" = {
      lockFile = ./rustdesk-7b939a88f03bdd1dea4b64134c5532a80b5dc382/Cargo.lock;
      outputHashes = {
  ...
  tailscale = {
    pname = "tailscale";
    version = "2847dd2aef3ad05c1871b0b72ee7d1dca3f5dcbe";
    src = fetchFromGitHub ({
      owner = "tailscale";
      repo = "tailscale";
      rev = "2847dd2aef3ad05c1871b0b72ee7d1dca3f5dcbe";
      fetchSubmodules = false;
      sha256 = "sha256-qF6M28U9rGl6IpDv4VY/PZI1Ipy4tDSZVJSwEZSeT8I=";
    });
  };
  tailscale-systray = {
