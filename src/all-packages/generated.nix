...
{ fetchgit, fetchurl, fetchFromGitHub }:
{
  ...
  caddy-git = {
    pname = "caddy-git";
    version = "66959d9f18768beb9531d51241978731bff8a305";
    src = fetchFromGitHub ({
      owner = "caddyserver";
      repo = "caddy";
      rev = "66959d9f18768beb9531d51241978731bff8a305";
      fetchSubmodules = false;
      sha256 = "sha256-WxvHPuxULnVhgD8QbZVv+ypYI1VFKnUKMfbt8dGIfkA=";
    });
  };
  cinny = {
    pname = "cinny";
  ...
  fx_cast = {
    pname = "fx_cast";
    version = "d5eb78f881d3931db7b83d6410f89e321f2c022c";
    src = fetchFromGitHub ({
      owner = "hensm";
      repo = "fx_cast";
      rev = "d5eb78f881d3931db7b83d6410f89e321f2c022c";
      fetchSubmodules = false;
      sha256 = "sha256-QlTUFVHv0MxYMobAITpwnfi3hnkQs2MyUJgIMd7Oimo=";
    });
  };
  godu = {
    pname = "godu";
  ...
  retroarch = {
    pname = "retroarch";
    version = "8c3acb7adb8ee5bd23cb0e7bd6cf642018df4ed7";
    src = fetchFromGitHub ({
      owner = "libretro";
      repo = "retroarch";
      rev = "8c3acb7adb8ee5bd23cb0e7bd6cf642018df4ed7";
      fetchSubmodules = false;
      sha256 = "sha256-7H9lf+Q995oVo7REssAEjhpn9tcfGIK917YBqf2smHY=";
    });
  };
  revanced-cli = {
    pname = "revanced-cli";
  ...
  rustdesk = {
    pname = "rustdesk";
    version = "5a8fc529edb17c46d011e833422c9a96cb429bea";
    src = fetchFromGitHub ({
      owner = "rustdesk";
      repo = "rustdesk";
      rev = "5a8fc529edb17c46d011e833422c9a96cb429bea";
      fetchSubmodules = false;
      sha256 = "sha256-ev9268e9QLgFffTQHihuXgxaIdev8DYHuzmX0MwZ7gI=";
    });
    cargoLock."Cargo.lock" = {
      lockFile = ./rustdesk-5a8fc529edb17c46d011e833422c9a96cb429bea/Cargo.lock;
      outputHashes = {
  ...
  tailscale = {
    pname = "tailscale";
    version = "19008a3023b3a19de225b5e57633891a00098e8c";
    src = fetchFromGitHub ({
      owner = "tailscale";
      repo = "tailscale";
      rev = "19008a3023b3a19de225b5e57633891a00098e8c";
      fetchSubmodules = false;
      sha256 = "sha256-BWBXF8U8cpdLWyCT4TD6zgbtq00icz2AHYtjQCOSsOQ=";
    });
  };
  tailscale-systray = {
