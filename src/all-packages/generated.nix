...
{ fetchgit, fetchurl, fetchFromGitHub }:
{
  ...
  bottles = {
    pname = "bottles";
    version = "12185de8161493303a1af7ee685fa9fb79db67a7";
    src = fetchFromGitHub ({
      owner = "bottlesdevs";
      repo = "Bottles";
      rev = "12185de8161493303a1af7ee685fa9fb79db67a7";
      fetchSubmodules = false;
      sha256 = "sha256-7MSp7/Zgn44Pr8yDDUmeJjuK+V4LlJ/UR9Ohtl8HT3U=";
    });
  };
  caddy = {
    pname = "caddy";
  ...
  caddy-git = {
    pname = "caddy-git";
    version = "fe61209df2d8ecbff7371703ae2dfa58342d2ed9";
    src = fetchFromGitHub ({
      owner = "caddyserver";
      repo = "caddy";
      rev = "fe61209df2d8ecbff7371703ae2dfa58342d2ed9";
      fetchSubmodules = false;
      sha256 = "sha256-3teEIxhgb9jbOrfj1QWh+EJ1Hw4sZY8s3t1/YxV/FoE=";
    });
  };
  cinny = {
    pname = "cinny";
    version = "9f99320fdad1a89387057dcd6ddb9b995a65d3dd";
    src = fetchFromGitHub ({
      owner = "cinnyapp";
      repo = "cinny";
      rev = "9f99320fdad1a89387057dcd6ddb9b995a65d3dd";
      fetchSubmodules = false;
      sha256 = "sha256-3sIecNd4AUrDyGo7g442KgAwbbi98druhLnCEMpW9B8=";
    });
  };
  cinny-bin = {
    pname = "cinny-bin";
    version = "2.1.1";
    src = fetchurl {
      url = "https://github.com/cinnyapp/cinny/releases/download/v2.1.1/cinny-v2.1.1.tar.gz";
      sha256 = "sha256-1Ra+6UWOD7bvRL7Vlw/cu7S3CwLqCXTUUHKI5kE672M=";
    };
  };
  cinny-desktop = {
    pname = "cinny-desktop";
    version = "c98cb286b759b5f00c91240dbe0cf50ec988fb03";
    src = fetchFromGitHub ({
      owner = "cinnyapp";
      repo = "cinny-desktop";
      rev = "c98cb286b759b5f00c91240dbe0cf50ec988fb03";
      fetchSubmodules = true;
      sha256 = "sha256-fG/RiVRriPe65R7v2Sepn/plctHkVdTzhnTTKrljLp8=";
    });
    cargoLock."src-tauri/Cargo.lock" = {
      lockFile = ./cinny-desktop-c98cb286b759b5f00c91240dbe0cf50ec988fb03/src-tauri/Cargo.lock;
      outputHashes = {
  ...
  cinny-desktop-bin = {
    ...
    version = "2.1.1";
    src = fetchurl {
      url = "https://github.com/cinnyapp/cinny-desktop/releases/download/v2.1.1/Cinny_desktop-x86_64.AppImage";
      sha256 = "sha256-pSaYyf2EQ+jb4uvr4DiFSjdmdHJP2IIOE1iqeZy7FEw=";
    };
  };
  conduit = {
    pname = "conduit";
  ...
  fluffychat = {
    pname = "fluffychat";
    version = "90e2052946b2e5e0c703fbbd81aadc4cd9cdf1ce";
    src = fetchgit {
      url = "https://gitlab.com/famedly/fluffychat";
      rev = "90e2052946b2e5e0c703fbbd81aadc4cd9cdf1ce";
      fetchSubmodules = false;
      deepClone = false;
      leaveDotGit = false;
      sha256 = "sha256-irZmySX+Wpl6LvK/fR1J4lVzZEGUqRjqTaWYocTdm1c=";
    };
  };
  flyingfox = {
    pname = "flyingfox";
  ...
  fx_cast = {
    pname = "fx_cast";
    version = "2d954e9a5e13a7cd3c41c8ec71b30c1de6a2bd52";
    src = fetchFromGitHub ({
      owner = "hensm";
      repo = "fx_cast";
      rev = "2d954e9a5e13a7cd3c41c8ec71b30c1de6a2bd52";
      fetchSubmodules = false;
      sha256 = "sha256-nooDGixoV2dDlEbAQBq7YYVdxUMI6vFj7PRyUREb9vg=";
    });
  };
  guiscrcpy = {
    pname = "guiscrcpy";
  ...
  hyprland = {
    pname = "hyprland";
    version = "ecce027c02bda91277ae8b9a9d95508c4e93eb73";
    src = fetchFromGitHub ({
      owner = "hyprwm";
      repo = "hyprland";
      rev = "ecce027c02bda91277ae8b9a9d95508c4e93eb73";
      fetchSubmodules = false;
      sha256 = "sha256-M+hEI9TgALauql6s6AxBvntSOBJ5H01S2gZVBW9O0Ok=";
    });
  };
  ibus = {
    pname = "ibus";
  ...
  jitsi-meet = {
    ...
    version = "1.0.6445";
    src = fetchurl {
      url = "https://download.jitsi.org/jitsi-meet/src/jitsi-meet-1.0.6445.tar.bz2";
      sha256 = "sha256-8CoL4JA+v8Wgrh1hOTerT2KUp0IXOtavzKo7hn92wxw=";
    };
  };
  jitsi-meet-prosody = {
    ...
    version = "1.0.6445";
    src = fetchurl {
      url = "https://download.jitsi.org/unstable/jitsi-meet-prosody_1.0.6445-1_all.deb";
      sha256 = "sha256-cWbHd2hmmXpPpGrxq8ccx+c7QUjDSdXvw2E4X6p0ef0=";
    };
  };
  jitsi-videobridge2 = {
  ...
  matrix-appservice-discord = {
    ...
    version = "a7e1bc0c5d0db8af971ce53f64f0e9058537de7a";
    src = fetchFromGitHub ({
      owner = "matrix-org";
      repo = "matrix-appservice-discord";
      rev = "a7e1bc0c5d0db8af971ce53f64f0e9058537de7a";
      fetchSubmodules = false;
      sha256 = "sha256-xRt+ppxkk+3HR5aeDkS0RAfxvD9arHUQKVV45QavWUg=";
    });
  };
  microsoft-edge-beta = {
  ...
  retroarch = {
    pname = "retroarch";
    version = "440a67e4b874a07fdb819a491e641c4d76741cb1";
    src = fetchFromGitHub ({
      owner = "libretro";
      repo = "retroarch";
      rev = "440a67e4b874a07fdb819a491e641c4d76741cb1";
      fetchSubmodules = false;
      sha256 = "sha256-7TNKC+MXx1aHhuH4hszRspuPgV+gjBwtvFB7AIdNFBQ=";
    });
  };
  revanced-cli = {
    pname = "revanced-cli";
    version = "2.9.2";
    src = fetchurl {
      url = "https://github.com/revanced/revanced-cli/releases/download/v2.9.2/revanced-cli-2.9.2-all.jar";
      sha256 = "sha256-kinbycE0hB4rnTkrOFQ4mG59vuIIZSFNM+3NEA7PEVc=";
    };
  };
  ...
  revanced-patches-dex = {
    ...
    version = "2.33.2";
    src = fetchurl {
      url = "https://github.com/revanced/revanced-patches/releases/download/v2.33.2/revanced-patches-2.33.2.dex";
      sha256 = "sha256-zxRpkN3wHHAnYf21lT6AHYu429u4cNM3IzpjkiRTz38=";
    };
  };
  revanced-patches-jar = {
    ...
    version = "2.33.2";
    src = fetchurl {
      url = "https://github.com/revanced/revanced-patches/releases/download/v2.33.2/revanced-patches-2.33.2.jar";
      sha256 = "sha256-Ki1rD11PW6/vgm/x0uRtuY2oEIkbhYM/GSC3dPsWBag=";
    };
  };
  rofi-wayland = {
    pname = "rofi-wayland";
  ...
  snui = {
    pname = "snui";
    version = "9c02fb870b3c9da07db56b43a6787badf4b87ffb";
    src = fetchgit {
      url = "https://gitlab.com/snakedye/snui";
      rev = "9c02fb870b3c9da07db56b43a6787badf4b87ffb";
      fetchSubmodules = false;
      deepClone = false;
      leaveDotGit = false;
      sha256 = "sha256-Y6UEzHgK5uZ8uaZswLZiQTPoQRnmwPb3PKcc1IZ4iXU=";
    };
  };
  spicetify-cli = {
    pname = "spicetify-cli";
  ...
  tailscale = {
    pname = "tailscale";
    version = "ab159f748bdb965797cf9d80dcbbdf876829b12b";
    src = fetchFromGitHub ({
      owner = "tailscale";
      repo = "tailscale";
      rev = "ab159f748bdb965797cf9d80dcbbdf876829b12b";
      fetchSubmodules = false;
      sha256 = "sha256-sgZMq6Muq/BqfxxeKWbrcM1X94D2RuRxHG8r9jRtFcQ=";
    });
  };
  tailscale-systray = {
  ...
  ulauncher = {
    pname = "ulauncher";
    version = "3f0420a84dde64545f4ca0dc90e3ed7b93284a67";
    src = fetchFromGitHub ({
      owner = "Ulauncher";
      repo = "Ulauncher";
      rev = "3f0420a84dde64545f4ca0dc90e3ed7b93284a67";
      fetchSubmodules = false;
      sha256 = "sha256-cVSzP/kXf4hWLmSHCN8MXioKgcXEpS/4NGbyg7rqlVI=";
    });
  };
  uniemoji = {
    pname = "uniemoji";
