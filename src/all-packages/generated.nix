...
{ fetchgit, fetchurl, fetchFromGitHub }:
{
  ...
  jitsi-meet = {
    ...
    version = "1.0.6609";
    src = fetchurl {
      url = "https://download.jitsi.org/jitsi-meet/src/jitsi-meet-1.0.6609.tar.bz2";
      sha256 = "sha256-KgGYXD/Ci75Ij2yJHLdpwG4M0zTcuFGe5sGIZOjfL/Y=";
    };
  };
  jitsi-meet-prosody = {
    ...
    version = "1.0.6609";
    src = fetchurl {
      url = "https://download.jitsi.org/unstable/jitsi-meet-prosody_1.0.6609-1_all.deb";
      sha256 = "sha256-iD06Ds5qZG2t6L54zuxDuCb2QLh9zrMssqD2A9CFLYk=";
    };
  };
  jitsi-videobridge2 = {
  ...
  retroarch = {
    pname = "retroarch";
    version = "3cdccb6b907822016741064c535107061db99ec3";
    src = fetchFromGitHub ({
      owner = "libretro";
      repo = "retroarch";
      rev = "3cdccb6b907822016741064c535107061db99ec3";
      fetchSubmodules = false;
      sha256 = "sha256-klmfAff+ueoIhmwk7x5mtIa2o5gKCCehdcTyPdAOgKo=";
    });
  };
  revanced-cli = {
    pname = "revanced-cli";
  ...
  rustdesk = {
    pname = "rustdesk";
    version = "e9b9fc8cf3a0716fd67ffda7ea3148d8ba65a569";
    src = fetchFromGitHub ({
      owner = "rustdesk";
      repo = "rustdesk";
      rev = "e9b9fc8cf3a0716fd67ffda7ea3148d8ba65a569";
      fetchSubmodules = false;
      sha256 = "sha256-eYOfdujKHuqyKEr4XsxYgVL8se/nTdMEbDzxK8ph8IM=";
    });
    cargoLock."Cargo.lock" = {
      lockFile = ./rustdesk-e9b9fc8cf3a0716fd67ffda7ea3148d8ba65a569/Cargo.lock;
      outputHashes = {
  ...
  spotifyd = {
    pname = "spotifyd";
    version = "e523711c9835202ef9cca83dd147684cd7efe0da";
    src = fetchFromGitHub ({
      owner = "Spotifyd";
      repo = "spotifyd";
      rev = "e523711c9835202ef9cca83dd147684cd7efe0da";
      fetchSubmodules = false;
      sha256 = "sha256-Z+x70+/SRzhX+omjjbHQBTSNvebvBzzl2BDl5dGC+Vg=";
    });
    cargoLock."Cargo.lock" = {
      lockFile = ./spotifyd-e523711c9835202ef9cca83dd147684cd7efe0da/Cargo.lock;
      outputHashes = {
  ...
  tailscale = {
    pname = "tailscale";
    version = "e97d5634bffc3876cb5580fdbd59d9f6e8b2d2fa";
    src = fetchFromGitHub ({
      owner = "tailscale";
      repo = "tailscale";
      rev = "e97d5634bffc3876cb5580fdbd59d9f6e8b2d2fa";
      fetchSubmodules = false;
      sha256 = "sha256-HsrFcC2Z9wAWpVbrgkR4FryjTtKae31bltTkUOjJ3GE=";
    });
  };
  tailscale-systray = {
