...
{ fetchgit, fetchurl, fetchFromGitHub }:
{
  ...
  conduit = {
    pname = "conduit";
    version = "8105c5cc60912afc487a6d045c67a7dada76322e";
    src = fetchgit {
      url = "https://gitlab.com/famedly/conduit";
      rev = "8105c5cc60912afc487a6d045c67a7dada76322e";
      fetchSubmodules = false;
      deepClone = false;
      leaveDotGit = false;
      sha256 = "sha256-ZjrcnMUhb+gFMh5qa9tPd7Lvbl3oSdXpnbQQrnhkJI4=";
    };
    cargoLock."Cargo.lock" = {
      lockFile = ./conduit-8105c5cc60912afc487a6d045c67a7dada76322e/Cargo.lock;
      outputHashes = {
        "ruma-0.7.4" = "sha256-RyeZAmqA4IDCT6FEfDDUCOkmQYS4voEcPT6wCbot+ng=";
  ...
  jitsi-meet = {
    ...
    version = "1.0.6679";
    src = fetchurl {
      url = "https://download.jitsi.org/jitsi-meet/src/jitsi-meet-1.0.6679.tar.bz2";
      sha256 = "sha256-xYSXTHgq93DSF23YmT+mgtGbCK99uYW8v2zeNfzRbYA=";
    };
  };
  jitsi-meet-prosody = {
    ...
    version = "1.0.6679";
    src = fetchurl {
      url = "https://download.jitsi.org/unstable/jitsi-meet-prosody_1.0.6679-1_all.deb";
      sha256 = "sha256-bvdJHcDNWQQ8KTsuAB/R1lya+22yeI9DAImVpTAF5vA=";
    };
  };
  jitsi-videobridge2 = {
  ...
  ouch = {
    pname = "ouch";
    version = "f8e6075ee4b5bded5a969f95ffa428054e5b49c3";
    src = fetchFromGitHub ({
      owner = "ouch-org";
      repo = "ouch";
      rev = "f8e6075ee4b5bded5a969f95ffa428054e5b49c3";
      fetchSubmodules = false;
      sha256 = "sha256-JzaaxtDx5spjzzAbCGMnyC7C0AcwCrmqXH2eRelGSeQ=";
    });
    cargoLock."Cargo.lock" = {
      lockFile = ./ouch-f8e6075ee4b5bded5a969f95ffa428054e5b49c3/Cargo.lock;
      outputHashes = {
  ...
  tailscale = {
    pname = "tailscale";
    version = "c070d39287d7febcadaf6958b0667e7bcb001af0";
    src = fetchFromGitHub ({
      owner = "tailscale";
      repo = "tailscale";
      rev = "c070d39287d7febcadaf6958b0667e7bcb001af0";
      fetchSubmodules = false;
      sha256 = "sha256-pU6s7Iwce/slaPjJck6Eyr99JFqtiLlMPPum1tloguE=";
    });
  };
  tailscale-systray = {
