...
{ fetchgit, fetchurl, fetchFromGitHub }:
{
  ...
  asusctl = {
    pname = "asusctl";
    version = "bbc520a7f2a6c14cf359135a608ddc54f6740f21";
    src = fetchgit {
      url = "https://gitlab.com/asus-linux/asusctl";
      rev = "bbc520a7f2a6c14cf359135a608ddc54f6740f21";
      fetchSubmodules = false;
      deepClone = false;
      leaveDotGit = false;
      sha256 = "sha256-wR1omMn7/l24By6Bw/cgvsti51KgL/FoYgkOshNvQFk=";
    };
    cargoLock."Cargo.lock" = {
      lockFile = ./asusctl-bbc520a7f2a6c14cf359135a608ddc54f6740f21/Cargo.lock;
      outputHashes = {
  ...
  bottles = {
    pname = "bottles";
    version = "57bbe195fb3569de35a7e9092a2bbb9d466b2474";
    src = fetchFromGitHub ({
      owner = "bottlesdevs";
      repo = "Bottles";
      rev = "57bbe195fb3569de35a7e9092a2bbb9d466b2474";
      fetchSubmodules = false;
      sha256 = "sha256-CiEoP6tUbKjK5/fNWzAerf707lCY6NMzYBnWVlQZU+A=";
    });
  };
  caddy = {
    pname = "caddy";
  ...
  caddy-git = {
    pname = "caddy-git";
    version = "1e18afb5c862d62be130d563785de5c58f08ae8e";
    src = fetchFromGitHub ({
      owner = "caddyserver";
      repo = "caddy";
      rev = "1e18afb5c862d62be130d563785de5c58f08ae8e";
      fetchSubmodules = false;
      sha256 = "sha256-BryQIpS7OlOZIe5V1kd84lmPpc8DkvKrQnfKzx6hU7k=";
    });
  };
  cinny = {
    pname = "cinny";
  ...
  hyprland = {
    pname = "hyprland";
    version = "d04f36c57d231e4736de750b1a86d6e971350224";
    src = fetchFromGitHub ({
      owner = "vaxerski";
      repo = "hyprland";
      rev = "d04f36c57d231e4736de750b1a86d6e971350224";
      fetchSubmodules = false;
      sha256 = "sha256-bE2jiD/dSSD+vGko5COYYEp++Z67iFVzPifK88yEUuw=";
    });
  };
  ibus = {
    pname = "ibus";
  ...
  jitsi-meet = {
    ...
    version = "1.0.6381";
    src = fetchurl {
      url = "https://download.jitsi.org/jitsi-meet/src/jitsi-meet-1.0.6381.tar.bz2";
      sha256 = "sha256-h5DRh25lEJBKjrK+vVZcBJ2lkeuFrXuaUgfTqIQED9A=";
    };
  };
  jitsi-meet-prosody = {
    ...
    version = "1.0.6381";
    src = fetchurl {
      url = "https://download.jitsi.org/unstable/jitsi-meet-prosody_1.0.6381-1_all.deb";
      sha256 = "sha256-VkWMqZX3HSqqLJPdaKemPP6Tvr4vfrAzPvRVhoGUtM8=";
    };
  };
  jitsi-videobridge2 = {
  ...
  revanced-patches-dex = {
    ...
    version = "2.22.1";
    src = fetchurl {
      url = "https://github.com/revanced/revanced-patches/releases/download/v2.22.1/revanced-patches-2.22.1.dex";
      sha256 = "sha256-AcwDoBrS060V+eBtcuBQe7vKGZvvCvWWqBciU4a2Gig=";
    };
  };
  revanced-patches-jar = {
    ...
    version = "2.22.1";
    src = fetchurl {
      url = "https://github.com/revanced/revanced-patches/releases/download/v2.22.1/revanced-patches-2.22.1.jar";
      sha256 = "sha256-MlGzC15tE/QG+oLHQHhCOotEVESZrp1Y4Hb6zn9u1N8=";
    };
  };
  rofi-wayland = {
    pname = "rofi-wayland";
  ...
  ulauncher = {
    pname = "ulauncher";
    version = "1228b2aa67a7cbf4418fa5b1d6bfe54f9685d004";
    src = fetchFromGitHub ({
      owner = "Ulauncher";
      repo = "Ulauncher";
      rev = "1228b2aa67a7cbf4418fa5b1d6bfe54f9685d004";
      fetchSubmodules = false;
      sha256 = "sha256-HG2OsTkh5/oSkIeSXM4WlhYX+aBlrA/7Shi6kUtc+OE=";
    });
  };
  ultimmc = {
    pname = "ultimmc";
