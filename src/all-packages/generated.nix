...
{ fetchgit, fetchurl, fetchFromGitHub }:
{
  ...
  bottles = {
    pname = "bottles";
    version = "5dc6df52c2b3b40c0cea4c489781ecdf1c94005f";
    src = fetchFromGitHub ({
      owner = "bottlesdevs";
      repo = "Bottles";
      rev = "5dc6df52c2b3b40c0cea4c489781ecdf1c94005f";
      fetchSubmodules = false;
      sha256 = "sha256-t2vkgzQoy7G98mp3kZgjPz/94+BmYyUTG2o7EIPLld8=";
    });
  };
  caddy = {
    pname = "caddy";
  ...
  fake-background-webcam = {
    ...
    version = "9cc3657558d9e18fe2a9716808dee5eaee297bf5";
    src = fetchFromGitHub ({
      owner = "fangfufu";
      repo = "Linux-Fake-Background-Webcam";
      rev = "9cc3657558d9e18fe2a9716808dee5eaee297bf5";
      fetchSubmodules = false;
      sha256 = "sha256-qVY+7sPWCXKIiSR24xNHVEisR7iH5xwSzNLXWkIr680=";
    });
  };
  flameshot = {
    pname = "flameshot";
  ...
  hyprland = {
    pname = "hyprland";
    version = "36ea12b315c86e3a1448fe3e695bc5e8bca385a7";
    src = fetchFromGitHub ({
      owner = "vaxerski";
      repo = "hyprland";
      rev = "36ea12b315c86e3a1448fe3e695bc5e8bca385a7";
      fetchSubmodules = false;
      sha256 = "sha256-u7WGmNBExPaND/GZUp5YUustKurDEfxQnra+AeAXAJo=";
    });
  };
  ibus = {
    pname = "ibus";
  ...
  tailscale = {
    pname = "tailscale";
    version = "4005134263db39b5a9e0f13f6db0e260f871a5c7";
    src = fetchFromGitHub ({
      owner = "tailscale";
      repo = "tailscale";
      rev = "4005134263db39b5a9e0f13f6db0e260f871a5c7";
      fetchSubmodules = false;
      sha256 = "sha256-TqtqTlz8mscVmBAT/AOcP3X/TQrF9uAi4tLGqrCpbkU=";
    });
  };
  tailscale-systray = {
