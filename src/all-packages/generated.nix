...
{ fetchgit, fetchurl, fetchFromGitHub }:
{
  ...
  adl = {
    pname = "adl";
    version = "551a979844802ddc71694896f26684ef5a53ca73";
    src = fetchFromGitHub ({
      owner = "RaitaroH";
      repo = "adl";
      rev = "551a979844802ddc71694896f26684ef5a53ca73";
      fetchSubmodules = false;
      sha256 = "sha256-c/rAD9fvBqlOsjSsu9Xqkv8ckGiOIcW+Yhawe/bungI=";
    });
  };
  age-plugin-yubikey = {
  ...
  bottles = {
    pname = "bottles";
    version = "06b13f081c7a53f7d3f2be92980ec5d8cbe62e24";
    src = fetchFromGitHub ({
      owner = "bottlesdevs";
      repo = "Bottles";
      rev = "06b13f081c7a53f7d3f2be92980ec5d8cbe62e24";
      fetchSubmodules = false;
      sha256 = "sha256-EAWJRmB+DkDmjSjjr9viCkQjcFrWObFVLMMbI2JD6R8=";
    });
  };
  caddy = {
    pname = "caddy";
  ...
  hyprland = {
    pname = "hyprland";
    version = "afe688e6ab3e021feca8c398d31469109a32a41b";
    src = fetchFromGitHub ({
      owner = "hyprwm";
      repo = "hyprland";
      rev = "afe688e6ab3e021feca8c398d31469109a32a41b";
      fetchSubmodules = false;
      sha256 = "sha256-lVIaG6Liifzd8yq4ZuuX/O9Hwov1kzf5hakT7/jk8wo=";
    });
  };
  ibus = {
    pname = "ibus";
  ...
  retroarch = {
    pname = "retroarch";
    version = "82ca2a8267b460c8f69b780f4b680ff1b5e53f57";
    src = fetchFromGitHub ({
      owner = "libretro";
      repo = "retroarch";
      rev = "82ca2a8267b460c8f69b780f4b680ff1b5e53f57";
      fetchSubmodules = false;
      sha256 = "sha256-MwPW7+y6fxtvRxNk8LTX3KUX2ggALmGlW/FwXaScjA8=";
    });
  };
  revanced-cli = {
    pname = "revanced-cli";
  ...
  revanced-patches-jar = {
    ...
    version = "2.125.0";
    src = fetchurl {
      url = "https://github.com/revanced/revanced-patches/releases/download/v2.125.0/revanced-patches-2.125.0.jar";
      sha256 = "sha256-yqtdB7Qj/TixozQFQhZXDtTdtVOX/mt9wOMCXdftKBk=";
    };
  };
  rofi-wayland = {
    pname = "rofi-wayland";
  ...
  rustdesk = {
    pname = "rustdesk";
    version = "7ab1655e633afb89c461ae0467bd7a3d2bc1d175";
    src = fetchFromGitHub ({
      owner = "rustdesk";
      repo = "rustdesk";
      rev = "7ab1655e633afb89c461ae0467bd7a3d2bc1d175";
      fetchSubmodules = false;
      sha256 = "sha256-Co/NLvXHQpeFu+5bk98NXXIhalNNgCsSbU90mA+Y7x4=";
    });
    cargoLock."Cargo.lock" = {
      lockFile = ./rustdesk-7ab1655e633afb89c461ae0467bd7a3d2bc1d175/Cargo.lock;
      outputHashes = {
  ...
  tailscale = {
    pname = "tailscale";
    version = "b0545873e5b78f28543286247763ce6837173e6d";
    src = fetchFromGitHub ({
      owner = "tailscale";
      repo = "tailscale";
      rev = "b0545873e5b78f28543286247763ce6837173e6d";
      fetchSubmodules = false;
      sha256 = "sha256-VEvW6PVTwcY53L1UQxh7KM+e7yN0EDskmv6iPBYY29k=";
    });
  };
  tailscale-systray = {
