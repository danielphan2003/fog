...
{ fetchgit, fetchurl, fetchFromGitHub, dockerTools }:
{
  ...
  hyprland = {
    pname = "hyprland";
    version = "428063ff2304962387803fd59e5da8b9b82710cc";
    src = fetchFromGitHub ({
      owner = "hyprwm";
      repo = "hyprland";
      rev = "428063ff2304962387803fd59e5da8b9b82710cc";
      fetchSubmodules = false;
      sha256 = "sha256-00cRYxCYmZvncLyCsVYrhQsCzFnjkZi+23TC2FpQU/U=";
    });
    date = "2023-01-18";
  };
  ibus = {
  ...
  jicofo = {
    ...
    version = "1.0-982";
    src = fetchurl {
      url = "https://download.jitsi.org/unstable/jicofo_1.0-982-1_all.deb";
      sha256 = "sha256-zfvjGCkowLhN0TAgP/JyV8QBV/tk/iOl1zrBkYBJstQ=";
    };
  };
  jitsi-meet = {
    pname = "jitsi-meet";
  ...
  tailscale = {
    pname = "tailscale";
    version = "aea251d42a2f953fdd5771d95888b3b051f93b8c";
    src = fetchFromGitHub ({
      owner = "tailscale";
      repo = "tailscale";
      rev = "aea251d42a2f953fdd5771d95888b3b051f93b8c";
      fetchSubmodules = false;
      sha256 = "sha256-NZmCQbH3O92UbN3N0+MTCrEjmROqFkugI0Nz7fCiV1Q=";
    });
    date = "2023-01-18";
  };
  tailscale-systray = {
