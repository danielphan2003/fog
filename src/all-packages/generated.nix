...
{ fetchgit, fetchurl, fetchFromGitHub }:
{
  ...
  caddy-git = {
    pname = "caddy-git";
    version = "258bc82b69ccb0f514fc62ec8ecd7273458ab2e4";
    src = fetchFromGitHub ({
      owner = "caddyserver";
      repo = "caddy";
      rev = "258bc82b69ccb0f514fc62ec8ecd7273458ab2e4";
      fetchSubmodules = false;
      sha256 = "sha256-Ujav4pvacp6IN0uVbT6j0CKSxQIyoHgOJ1P54YYIrLE=";
    });
  };
  cinny = {
    pname = "cinny";
  ...
  dnscrypt-proxy2 = {
    ...
    version = "08d44241b90f4be7a1c5057678754018df8d27b3";
    src = fetchFromGitHub ({
      owner = "DNSCrypt";
      repo = "dnscrypt-proxy";
      rev = "08d44241b90f4be7a1c5057678754018df8d27b3";
      fetchSubmodules = false;
      sha256 = "sha256-55Oeq/Hr9Va3jycxsYpwGVEFokgEqfbLejiud+LopJk=";
    });
  };
  doggo = {
    pname = "doggo";
  ...
  hyprland = {
    pname = "hyprland";
    version = "1cf46fd6a26cb16104a39a4fe73ca7ccd6c1ba36";
    src = fetchFromGitHub ({
      owner = "hyprwm";
      repo = "hyprland";
      rev = "1cf46fd6a26cb16104a39a4fe73ca7ccd6c1ba36";
      fetchSubmodules = false;
      sha256 = "sha256-7oRh2X4lyykcFlHSppIo7fB1fuc8HguxxfZOTexkFQA=";
    });
  };
  ibus = {
    pname = "ibus";
  ...
  rustdesk = {
    pname = "rustdesk";
    version = "694896abdaada5267f4a9f8c0497d49ecd70e30a";
    src = fetchFromGitHub ({
      owner = "rustdesk";
      repo = "rustdesk";
      rev = "694896abdaada5267f4a9f8c0497d49ecd70e30a";
      fetchSubmodules = false;
      sha256 = "sha256-hW3aAEng1HCKzcZRD6B5o5w7dv/HFF3DrV60hHzLjnI=";
    });
    cargoLock."Cargo.lock" = {
      lockFile = ./rustdesk-694896abdaada5267f4a9f8c0497d49ecd70e30a/Cargo.lock;
      outputHashes = {
  ...
  tailscale = {
    pname = "tailscale";
    version = "70ed22ccf9aac94724057aa4e5b219cf8e79201b";
    src = fetchFromGitHub ({
      owner = "tailscale";
      repo = "tailscale";
      rev = "70ed22ccf9aac94724057aa4e5b219cf8e79201b";
      fetchSubmodules = false;
      sha256 = "sha256-2sk5Ik2DlQPIVT5rBYT3Jz4irHL6Rot0qyxzechGY2Q=";
    });
  };
  tailscale-systray = {
