...
{ fetchgit, fetchurl, fetchFromGitHub, dockerTools }:
{
  ...
  caddy-git = {
    pname = "caddy-git";
    version = "0a3efd1641f07ceaa2035cedec1ba43448b2d520";
    src = fetchFromGitHub ({
      owner = "caddyserver";
      repo = "caddy";
      rev = "0a3efd1641f07ceaa2035cedec1ba43448b2d520";
      fetchSubmodules = false;
      sha256 = "sha256-sy30XSv0N9ZLf2cwTf3VDD1iyzgnJ3O5IFxFNDEv7dI=";
    });
    date = "2023-01-30";
  };
  cinny = {
  ...
  tailscale = {
    pname = "tailscale";
    version = "01e736e1d5d9ed20b2df763dac0f99461c551c99";
    src = fetchFromGitHub ({
      owner = "tailscale";
      repo = "tailscale";
      rev = "01e736e1d5d9ed20b2df763dac0f99461c551c99";
      fetchSubmodules = false;
      sha256 = "sha256-aKftA8DwJwUSgf1BA/jGmu8LVvxRwy8nleA0STyxV48=";
    });
    date = "2023-01-30";
  };
  tailscale-systray = {
