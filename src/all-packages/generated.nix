...
{ fetchgit, fetchurl, fetchFromGitHub }:
{
  ...
  tailscale = {
    pname = "tailscale";
    version = "fb4e23506fbcd3527daf2bf2f6e9158710db308a";
    src = fetchFromGitHub ({
      owner = "tailscale";
      repo = "tailscale";
      rev = "fb4e23506fbcd3527daf2bf2f6e9158710db308a";
      fetchSubmodules = false;
      sha256 = "sha256-1zJqzUa26m61agl3KCcq4/2YdYyqy7oUdvghRHeeDL8=";
    });
  };
  tailscale-systray = {
  ...
  ulauncher = {
    pname = "ulauncher";
    version = "46ad331a75fc3c8d371d16b157086003deb18655";
    src = fetchFromGitHub ({
      owner = "Ulauncher";
      repo = "Ulauncher";
      rev = "46ad331a75fc3c8d371d16b157086003deb18655";
      fetchSubmodules = false;
      sha256 = "sha256-Ae84h3LhrAy34T0izazB3ommMbVfG0KgfbZr+3C2Gv4=";
    });
  };
  uniemoji = {
    pname = "uniemoji";
