...
{ fetchgit, fetchurl, fetchFromGitHub }:
{
  ...
  hyprland = {
    pname = "hyprland";
    version = "d0ec2b72aec8a91a904b7678ab093e648bd59cf2";
    src = fetchFromGitHub ({
      owner = "hyprwm";
      repo = "hyprland";
      rev = "d0ec2b72aec8a91a904b7678ab093e648bd59cf2";
      fetchSubmodules = false;
      sha256 = "sha256-7T0CeEpANEiXr2/3RTLGi1ipHDBRbMJETyqpq8kQUek=";
    });
  };
  ibus = {
    pname = "ibus";
  ...
  jitsi-meet = {
    ...
    version = "1.0.6477";
    src = fetchurl {
      url = "https://download.jitsi.org/jitsi-meet/src/jitsi-meet-1.0.6477.tar.bz2";
      sha256 = "sha256-3peb3IIAFyJFqXlp5AjP0mvzjsbuOJDRbwuu6/qaWos=";
    };
  };
  jitsi-meet-prosody = {
    ...
    version = "1.0.6477";
    src = fetchurl {
      url = "https://download.jitsi.org/unstable/jitsi-meet-prosody_1.0.6477-1_all.deb";
      sha256 = "sha256-rEUfMFanBv9r0Kw7MU7f6Emmagz9ML9rUK1hbVs2XIE=";
    };
  };
  jitsi-videobridge2 = {
  ...
  picom = {
    pname = "picom";
    version = "748cd665f4ed8fe5914631c575da08735e834f47";
    src = fetchFromGitHub ({
      owner = "yshui";
      repo = "picom";
      rev = "748cd665f4ed8fe5914631c575da08735e834f47";
      fetchSubmodules = false;
      sha256 = "sha256-Tf43wjevVOKYt7EM8cVGXeouihUmTdKth5HINQ2UjrU=";
    });
  };
  playit-agent = {
    pname = "playit-agent";
  ...
  pmbootstrap-test = {
    ...
    version = "e5d580e98a96da7a59e47f34028e5f9082236fd6";
    src = fetchgit {
      url = "https://gitlab.com/postmarketOS/pmbootstrap";
      rev = "e5d580e98a96da7a59e47f34028e5f9082236fd6";
      fetchSubmodules = false;
      deepClone = false;
      leaveDotGit = false;
      sha256 = "sha256-T1SxTqF6lScxAyV8Gg7PZnv91uvVlJfsK4LSRow270g=";
    };
  };
  pure = {
    pname = "pure";
  ...
  retroarch = {
    pname = "retroarch";
    version = "f5e5a1b2017d16fd0a9305494d30bb3f3b6e160c";
    src = fetchFromGitHub ({
      owner = "libretro";
      repo = "retroarch";
      rev = "f5e5a1b2017d16fd0a9305494d30bb3f3b6e160c";
      fetchSubmodules = false;
      sha256 = "sha256-9hAfaSlme1r9M5mzBhPSSAVMCli11q3iRSzELwsJnMc=";
    });
  };
  revanced-cli = {
    pname = "revanced-cli";
  ...
  revanced-integrations = {
    ...
    version = "0.35.0";
    src = fetchurl {
      url = "https://github.com/revanced/revanced-integrations/releases/download/v0.35.0/app-release-unsigned.apk";
      sha256 = "sha256-zsjsppplnc7lHy+QMO6qu5GxfiugNnvvmGoA/ElW7Xw=";
    };
  };
  revanced-patches-jar = {
    ...
    version = "2.41.0";
    src = fetchurl {
      url = "https://github.com/revanced/revanced-patches/releases/download/v2.41.0/revanced-patches-2.41.0.jar";
      sha256 = "sha256-fTf0wxJ2mAZiximGVwhfrXUnVgPJYnq7ELK1/AiR+1E=";
    };
  };
  rofi-wayland = {
    pname = "rofi-wayland";
