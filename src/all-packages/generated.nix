...
{ fetchgit, fetchurl, fetchFromGitHub }:
{
  ...
  awesome = {
    pname = "awesome";
    version = "42542031007822131661b3256b3e910389b56572";
    src = fetchFromGitHub ({
      owner = "awesomeWM";
      repo = "awesome";
      rev = "42542031007822131661b3256b3e910389b56572";
      fetchSubmodules = false;
      sha256 = "sha256-e7buPwnjV4aG5Qc6BGYo6vmrvzn+sUrsBociKtwa3V0=";
    });
  };
  awestore = {
    pname = "awestore";
  ...
  bottles = {
    pname = "bottles";
    version = "009ba9f5cd8d2f05882afd70dced59ab4d436ed2";
    src = fetchFromGitHub ({
      owner = "bottlesdevs";
      repo = "Bottles";
      rev = "009ba9f5cd8d2f05882afd70dced59ab4d436ed2";
      fetchSubmodules = false;
      sha256 = "sha256-Q7/wRKWFAFvgyYv8bIidUefCQIJr8yQfi2ES69CWau0=";
    });
  };
  caddy = {
    pname = "caddy";
  ...
  conduit = {
    pname = "conduit";
    version = "566dc0a6a2b1aec4c64000392e518ecfe0e3e450";
    src = fetchgit {
      url = "https://gitlab.com/famedly/conduit";
      rev = "566dc0a6a2b1aec4c64000392e518ecfe0e3e450";
      fetchSubmodules = false;
      deepClone = false;
      leaveDotGit = false;
      sha256 = "sha256-rxf4e0e1VP3gjy0lRYafIqzlVukxb2mfZMDbwz54x8M=";
    };
    cargoLock."Cargo.lock" = {
      lockFile = ./conduit-566dc0a6a2b1aec4c64000392e518ecfe0e3e450/Cargo.lock;
      outputHashes = {
  ...
  flameshot = {
    pname = "flameshot";
    version = "adb58e247b1c733210788d95d25891160d678153";
    src = fetchFromGitHub ({
      owner = "flameshot-org";
      repo = "flameshot";
      rev = "adb58e247b1c733210788d95d25891160d678153";
      fetchSubmodules = false;
      sha256 = "sha256-O9EpOoDdupv2XBIAU4QGragT1E2U6HNQfDQSQ/ARqeg=";
    });
  };
  flyingfox = {
    pname = "flyingfox";
  ...
  hyprland = {
    pname = "hyprland";
    version = "f7bdc2e87020ea7308035bceaa2ab659af91d2de";
    src = fetchFromGitHub ({
      owner = "vaxerski";
      repo = "hyprland";
      rev = "f7bdc2e87020ea7308035bceaa2ab659af91d2de";
      fetchSubmodules = false;
      sha256 = "sha256-B1P/EDJvho3lBxqtGAXKBlPDXlF/7bLHeC+h2aTPkWc=";
    });
  };
  ibus = {
    pname = "ibus";
  ...
  retroarch = {
    pname = "retroarch";
    version = "0008691aa080eae4bf9acc3a7d2187e1ed265b12";
    src = fetchFromGitHub ({
      owner = "libretro";
      repo = "retroarch";
      rev = "0008691aa080eae4bf9acc3a7d2187e1ed265b12";
      fetchSubmodules = false;
      sha256 = "sha256-F4wqdkGn9Pm7yyN8qdMhPBPv1it7ou+h4kSotbVw6CM=";
    });
  };
  rofi-wayland = {
    pname = "rofi-wayland";
  ...
  spicetify-cli = {
    pname = "spicetify-cli";
    version = "d55884064c132d45e454210bbf815e7bc58eccb9";
    src = fetchFromGitHub ({
      owner = "khanhas";
      repo = "spicetify-cli";
      rev = "d55884064c132d45e454210bbf815e7bc58eccb9";
      fetchSubmodules = false;
      sha256 = "sha256-nt58bLABar7pprMk+CjQlrt+hPrWj9a43KYBbibhaD0=";
    });
  };
  spicetify-themes = {
  ...
  tailscale = {
    pname = "tailscale";
    version = "467eb2eca09dbf191954a9b432f84db0694203f2";
    src = fetchFromGitHub ({
      owner = "tailscale";
      repo = "tailscale";
      rev = "467eb2eca09dbf191954a9b432f84db0694203f2";
      fetchSubmodules = false;
      sha256 = "sha256-BwedU5ytGQ24RO24ZzOTWe46CKGR/fLiTao/eXz1tZg=";
    });
  };
  tailscale-systray = {
  ...
  ulauncher = {
    pname = "ulauncher";
    version = "f1ce912b5ede7b20db5ed369f78382ba0e55eb8e";
    src = fetchFromGitHub ({
      owner = "Ulauncher";
      repo = "Ulauncher";
      rev = "f1ce912b5ede7b20db5ed369f78382ba0e55eb8e";
      fetchSubmodules = false;
      sha256 = "sha256-xSgYQ+3jiQdStoC3gbuUrYoeYANWiKnRpAjXAGQoKHk=";
    });
  };
  ultimmc = {
    pname = "ultimmc";
