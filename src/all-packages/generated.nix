...
{ fetchgit, fetchurl, fetchFromGitHub }:
{
  ...
  awesome = {
    pname = "awesome";
    version = "17eee18d8bd500ac6dc4907701c5ccdb71174c0c";
    src = fetchFromGitHub ({
      owner = "awesomeWM";
      repo = "awesome";
      rev = "17eee18d8bd500ac6dc4907701c5ccdb71174c0c";
      fetchSubmodules = false;
      sha256 = "sha256-DvegG6reL3Qaw08ZzWJS08GpeiILv0IyJXHxlbVpIus=";
    });
  };
  awestore = {
    pname = "awestore";
  ...
  spicetify-marketplace = {
    ...
    version = "05b170642c013217f339fe4dde5c1ec14e0fb4ff";
    src = fetchFromGitHub ({
      owner = "spicetify";
      repo = "spicetify-marketplace";
      rev = "05b170642c013217f339fe4dde5c1ec14e0fb4ff";
      fetchSubmodules = false;
      sha256 = "sha256-KapbtHcVN2eQ+a0FARJJbKCjquZyvjIkGFuATFCGuJw=";
    });
  };
  spicetify-themes = {
  ...
  tailscale = {
    pname = "tailscale";
    version = "a255a08ea61ba918ddeeacfdfbc3ca5e489481aa";
    src = fetchFromGitHub ({
      owner = "tailscale";
      repo = "tailscale";
      rev = "a255a08ea61ba918ddeeacfdfbc3ca5e489481aa";
      fetchSubmodules = false;
      sha256 = "sha256-wf32piV0vaek6PkzIqs30Q4BcU73ll896KhlOWwLxkA=";
    });
  };
  tailscale-systray = {
