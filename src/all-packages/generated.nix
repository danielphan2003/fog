...
{ fetchgit, fetchurl, fetchFromGitHub }:
{
  ...
  caddy-git = {
    pname = "caddy-git";
    version = "253d97c93dce9a3365e67d0360b2e47dd165578e";
    src = fetchFromGitHub ({
      owner = "caddyserver";
      repo = "caddy";
      rev = "253d97c93dce9a3365e67d0360b2e47dd165578e";
      fetchSubmodules = false;
      sha256 = "sha256-wJtDgaVEF5RGiAlBYTO7MtreSu5hPzAh4gAErtVfyPE=";
    });
  };
  cinny = {
    pname = "cinny";
  ...
  hyprland = {
    pname = "hyprland";
    version = "0d702b556d0a52f1df53ac1e52fac11b8302783b";
    src = fetchFromGitHub ({
      owner = "hyprwm";
      repo = "hyprland";
      rev = "0d702b556d0a52f1df53ac1e52fac11b8302783b";
      fetchSubmodules = false;
      sha256 = "sha256-TIhY37rQgfle2jYrMDQpEKsrGnsTh1SvnS8iduIua70=";
    });
  };
  ibus = {
    pname = "ibus";
  ...
  jitsi-meet = {
    ...
    version = "1.0.6646";
    src = fetchurl {
      url = "https://download.jitsi.org/jitsi-meet/src/jitsi-meet-1.0.6646.tar.bz2";
      sha256 = "sha256-DgTOICF9vtVLjMd4ZojVav5xZy4QT2iPqazStT2lt2Y=";
    };
  };
  jitsi-meet-prosody = {
    ...
    version = "1.0.6646";
    src = fetchurl {
      url = "https://download.jitsi.org/unstable/jitsi-meet-prosody_1.0.6646-1_all.deb";
      sha256 = "sha256-OZWxaYS3d+6g4xTHPnkjBkfV581nx77OphT3uJXxb+M=";
    };
  };
  jitsi-videobridge2 = {
  ...
  pmbootstrap-test = {
    ...
    version = "dac8b27738cc883495b53b83dece8b31c6cb9dbb";
    src = fetchgit {
      url = "https://gitlab.com/postmarketOS/pmbootstrap";
      rev = "dac8b27738cc883495b53b83dece8b31c6cb9dbb";
      fetchSubmodules = false;
      deepClone = false;
      leaveDotGit = false;
      sha256 = "sha256-J0F+iU1RvDHQhebC3RDOGKuiPFNnaGIoaNoWcOAa6X0=";
    };
  };
  pure = {
    pname = "pure";
  ...
  retroarch = {
    pname = "retroarch";
    version = "e9ad1e494f93eb7afb77a8d87daf33b915b2eebb";
    src = fetchFromGitHub ({
      owner = "libretro";
      repo = "retroarch";
      rev = "e9ad1e494f93eb7afb77a8d87daf33b915b2eebb";
      fetchSubmodules = false;
      sha256 = "sha256-5/2RYvChvOtjDrZPqeeq5FjksKawVfKUdBYfsUNJxiE=";
    });
  };
  revanced-cli = {
    pname = "revanced-cli";
  ...
  rustdesk = {
    pname = "rustdesk";
    version = "048fc408820fbc64037c4c9707b5026d9df31c14";
    src = fetchFromGitHub ({
      owner = "rustdesk";
      repo = "rustdesk";
      rev = "048fc408820fbc64037c4c9707b5026d9df31c14";
      fetchSubmodules = false;
      sha256 = "sha256-BQOHTZSw2l+oEW/F/8oVa9oS+pahT//fZMUSROEq2jY=";
    });
    cargoLock."Cargo.lock" = {
      lockFile = ./rustdesk-048fc408820fbc64037c4c9707b5026d9df31c14/Cargo.lock;
      outputHashes = {
  ...
  tailscale = {
    pname = "tailscale";
    version = "c5ce3557567d05cce21aba5341d97cd99af6e43a";
    src = fetchFromGitHub ({
      owner = "tailscale";
      repo = "tailscale";
      rev = "c5ce3557567d05cce21aba5341d97cd99af6e43a";
      fetchSubmodules = false;
      sha256 = "sha256-B2SIzrfPLthcjjDgjoy350JvzbWkK9It/JcStFq9Xqo=";
    });
  };
  tailscale-systray = {
