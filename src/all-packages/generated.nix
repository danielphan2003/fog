...
{ fetchgit, fetchurl, fetchFromGitHub, dockerTools }:
{
  ...
  hyprland = {
    pname = "hyprland";
    version = "129e99a6f60eac7ece31a1ccd1e781075fd53050";
    src = fetchFromGitHub ({
      owner = "hyprwm";
      repo = "hyprland";
      rev = "129e99a6f60eac7ece31a1ccd1e781075fd53050";
      fetchSubmodules = false;
      sha256 = "sha256-Zpmx/aZu1/RJBARAPoys84TWPi/dulkQzoJQ0utWa7I=";
    });
    date = "2023-02-03";
  };
  ibus = {
  ...
  jitsi-meet = {
    ...
    version = "1.0.6961";
    src = fetchurl {
      url = "https://download.jitsi.org/jitsi-meet/src/jitsi-meet-1.0.6961.tar.bz2";
      sha256 = "sha256-yudR9rU/RBGmLjZxkwMHz4Qn7/7sxsrjoz5mF6l6OI8=";
    };
  };
  jitsi-meet-prosody = {
    ...
    version = "1.0.6961";
    src = fetchurl {
      url = "https://download.jitsi.org/unstable/jitsi-meet-prosody_1.0.6961-1_all.deb";
      sha256 = "sha256-t9ZO+qxpeStMz4DfScfyCFQE+tMf8Y2SCTTNjl5BN/k=";
    };
  };
  jitsi-videobridge2 = {
  ...
  retroarch = {
    pname = "retroarch";
    version = "78326188c4dd99e87f5620d3cde50a853d934f65";
    src = fetchFromGitHub ({
      owner = "libretro";
      repo = "retroarch";
      rev = "78326188c4dd99e87f5620d3cde50a853d934f65";
      fetchSubmodules = false;
      sha256 = "sha256-+2pn8dbIvDgsRJdHP4k2x7mw92nkJhY0pLOy/Hr+8hk=";
    });
    date = "2023-02-03";
  };
  rofi-wayland = {
  ...
  rustdesk = {
    pname = "rustdesk";
    version = "1ad55d99149421157711410a9469e26a33147d9e";
    src = fetchFromGitHub ({
      owner = "rustdesk";
      repo = "rustdesk";
      rev = "1ad55d99149421157711410a9469e26a33147d9e";
      fetchSubmodules = false;
      sha256 = "sha256-vQRbdgoEOT6vc4A9N+QJlFG1Ik24zCfWEzJnvGd8DQk=";
    });
    cargoLock."Cargo.lock" = {
      lockFile = ./rustdesk-1ad55d99149421157711410a9469e26a33147d9e/Cargo.lock;
      outputHashes = {
  ...
  sddm = {
    pname = "sddm";
    version = "9896dea10339ec478574f6ef7f9809854a0a8986";
    src = fetchFromGitHub ({
      owner = "sddm";
      repo = "sddm";
      rev = "9896dea10339ec478574f6ef7f9809854a0a8986";
      fetchSubmodules = false;
      sha256 = "sha256-h9vTmfVM0A/h+25M2PjOrPqYnKf6LBOx9BUD0pZ+LnQ=";
    });
    date = "2023-02-02";
  };
  sddm-chili = {
  ...
  tailscale = {
    pname = "tailscale";
    version = "0aa7b495d5a6a4ebfae6a700df832366185718e5";
    src = fetchFromGitHub ({
      owner = "tailscale";
      repo = "tailscale";
      rev = "0aa7b495d5a6a4ebfae6a700df832366185718e5";
      fetchSubmodules = false;
      sha256 = "sha256-2KH0e6UymOLv51Lf5JURDZNNcWWJCr0Y82Lq/vqvL5M=";
    });
    date = "2023-02-02";
  };
  tailscale-systray = {
