...
{ fetchgit, fetchurl, fetchFromGitHub, dockerTools }:
{
  ...
  fluffychat = {
    pname = "fluffychat";
    version = "cef5fbe3c8f9cdb788556d618b81418e163f1a7a";
    src = fetchgit {
      url = "https://gitlab.com/famedly/fluffychat";
      rev = "cef5fbe3c8f9cdb788556d618b81418e163f1a7a";
      fetchSubmodules = false;
      deepClone = false;
      leaveDotGit = false;
      sha256 = "sha256-ovOZm8aKgAD72H+AESUIlucIRH96R9QKnV6gEqZqBMs=";
    };
    date = "2023-02-05";
  };
  flyingfox = {
  ...
  hyprland = {
    pname = "hyprland";
    version = "760b37f71d200643d3e267472e5cc290d38d1a53";
    src = fetchFromGitHub ({
      owner = "hyprwm";
      repo = "hyprland";
      rev = "760b37f71d200643d3e267472e5cc290d38d1a53";
      fetchSubmodules = false;
      sha256 = "sha256-PcC5DqF2+P2kOewPCg9KM1S/+aS2msrs8ofeJWB68GU=";
    });
    date = "2023-02-04";
  };
  ibus = {
  ...
  retroarch = {
    pname = "retroarch";
    version = "568ffac8f632354f9802b277b647fd1ed6c6b73b";
    src = fetchFromGitHub ({
      owner = "libretro";
      repo = "retroarch";
      rev = "568ffac8f632354f9802b277b647fd1ed6c6b73b";
      fetchSubmodules = false;
      sha256 = "sha256-iPLmST6H/Hg10aUm8Cz1+N09p2YIzT4uUg7pxzr60Gw=";
    });
    date = "2023-02-05";
  };
  rofi-wayland = {
  ...
  rustdesk = {
    pname = "rustdesk";
    version = "255c58ef7b725ea64012073ae8d8cb48720d7b98";
    src = fetchFromGitHub ({
      owner = "rustdesk";
      repo = "rustdesk";
      rev = "255c58ef7b725ea64012073ae8d8cb48720d7b98";
      fetchSubmodules = false;
      sha256 = "sha256-R8xfeDPaMm+UMl48h6gbyhzgQp17nTS9HLUWXWALnpo=";
    });
    cargoLock."Cargo.lock" = {
      lockFile = ./rustdesk-255c58ef7b725ea64012073ae8d8cb48720d7b98/Cargo.lock;
      outputHashes = {
  ...
  spicetify-marketplace = {
    ...
    version = "d667b37f8b3103679fb1fc01a164008cc539dbfe";
    src = fetchFromGitHub ({
      owner = "spicetify";
      repo = "spicetify-marketplace";
      rev = "d667b37f8b3103679fb1fc01a164008cc539dbfe";
      fetchSubmodules = false;
      sha256 = "sha256-s0NGd2ooH5Nza5PCFg82l12CVi5by0ZyxqfZgjyLbiY=";
    });
    date = "2023-02-04";
  };
  spicetify-themes = {
