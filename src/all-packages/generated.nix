...
{ fetchgit, fetchurl, fetchFromGitHub, dockerTools }:
{
  ...
  fluffychat = {
    pname = "fluffychat";
    version = "90482009fc330ce5819cfdef14242fc2e92ce424";
    src = fetchgit {
      url = "https://gitlab.com/famedly/fluffychat";
      rev = "90482009fc330ce5819cfdef14242fc2e92ce424";
      fetchSubmodules = false;
      deepClone = false;
      leaveDotGit = false;
      sha256 = "sha256-bCpm35eM7h4F9MVTKgPgoQ72utpQ5RT+lJ62TwYbGIY=";
    };
    date = "2023-02-04";
  };
  flyingfox = {
  ...
  retroarch = {
    pname = "retroarch";
    version = "1134b895a2f3d4695bce8261b881a402b4245015";
    src = fetchFromGitHub ({
      owner = "libretro";
      repo = "retroarch";
      rev = "1134b895a2f3d4695bce8261b881a402b4245015";
      fetchSubmodules = false;
      sha256 = "sha256-kk9fRzCjDABQSrz3NU3MZpVjxKTvNh+9O0Ygs/jNy6Y=";
    });
    date = "2023-02-04";
  };
  rofi-wayland = {
  ...
  rustdesk = {
    pname = "rustdesk";
    version = "8197f47d1b43be68a823d3e7a8ddf2a46652080e";
    src = fetchFromGitHub ({
      owner = "rustdesk";
      repo = "rustdesk";
      rev = "8197f47d1b43be68a823d3e7a8ddf2a46652080e";
      fetchSubmodules = false;
      sha256 = "sha256-GShCcr0rQoOGununABag6hvWlBrDvQoe5i7xu9kjowo=";
    });
    cargoLock."Cargo.lock" = {
      lockFile = ./rustdesk-8197f47d1b43be68a823d3e7a8ddf2a46652080e/Cargo.lock;
      outputHashes = {
  ...
  spicetify-marketplace = {
    ...
    version = "3cb38fa3bef7c533f369fb1f96d6ebceb897ba69";
    src = fetchFromGitHub ({
      owner = "spicetify";
      repo = "spicetify-marketplace";
      rev = "3cb38fa3bef7c533f369fb1f96d6ebceb897ba69";
      fetchSubmodules = false;
      sha256 = "sha256-0sBTGiVebpzd6AtYf4vujthGqq2t9LhDna4F38J6doI=";
    });
    date = "2023-02-03";
  };
  spicetify-themes = {
  ...
  tailscale = {
    pname = "tailscale";
    version = "4daba23cd4e688f14479369c81f64bfd12607242";
    src = fetchFromGitHub ({
      owner = "tailscale";
      repo = "tailscale";
      rev = "4daba23cd4e688f14479369c81f64bfd12607242";
      fetchSubmodules = false;
      sha256 = "sha256-36ol/ZCDJ4dSSuQ1PFkut4xJHFbCLCwqG018rEHrqzw=";
    });
    date = "2023-02-03";
  };
  tailscale-systray = {
