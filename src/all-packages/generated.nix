...
{ fetchgit, fetchurl, fetchFromGitHub }:
{
  ...
  awesome = {
    pname = "awesome";
    version = "d3c3380168b4c2aaf5e638b520fed82c761ee650";
    src = fetchFromGitHub ({
      owner = "awesomeWM";
      repo = "awesome";
      rev = "d3c3380168b4c2aaf5e638b520fed82c761ee650";
      fetchSubmodules = false;
      sha256 = "sha256-8UuFwn4SFfxEa5lgr+Rq9uIOev586bc+iSppoJRLPDM=";
    });
  };
  awestore = {
    pname = "awestore";
  ...
  retroarch = {
    pname = "retroarch";
    version = "3a817dd95643a494c9ee7bb6a02e766a6d63d253";
    src = fetchFromGitHub ({
      owner = "libretro";
      repo = "retroarch";
      rev = "3a817dd95643a494c9ee7bb6a02e766a6d63d253";
      fetchSubmodules = false;
      sha256 = "sha256-X07t0lY/VUMApnMcLJX4NCmFs/Ua9QkSgrxDcrgwDVM=";
    });
  };
  revanced-cli = {
    pname = "revanced-cli";
  ...
  rustdesk = {
    pname = "rustdesk";
    version = "12390a66e82e5e58dd23987e4c9da8b39c978b96";
    src = fetchFromGitHub ({
      owner = "rustdesk";
      repo = "rustdesk";
      rev = "12390a66e82e5e58dd23987e4c9da8b39c978b96";
      fetchSubmodules = false;
      sha256 = "sha256-TAttA/2iQJ4FNxz3okOuwew6MoS437rIotglou/sQFE=";
    });
    cargoLock."Cargo.lock" = {
      lockFile = ./rustdesk-12390a66e82e5e58dd23987e4c9da8b39c978b96/Cargo.lock;
      outputHashes = {
  ...
  tailscale = {
    pname = "tailscale";
    version = "b63094431b8fd5cf13f183c2c715c307fb231f44";
    src = fetchFromGitHub ({
      owner = "tailscale";
      repo = "tailscale";
      rev = "b63094431b8fd5cf13f183c2c715c307fb231f44";
      fetchSubmodules = false;
      sha256 = "sha256-3plOC4Jw70LmRqCtpMoArwcMBsNfe8bCIFWMqzxZkko=";
    });
  };
  tailscale-systray = {
