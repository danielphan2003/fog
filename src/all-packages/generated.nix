...
{ fetchgit, fetchurl, fetchFromGitHub }:
{
  ...
  bottles = {
    pname = "bottles";
    version = "51b1fc1c1fc045669a15327698739d676791f6c5";
    src = fetchFromGitHub ({
      owner = "bottlesdevs";
      repo = "Bottles";
      rev = "51b1fc1c1fc045669a15327698739d676791f6c5";
      fetchSubmodules = false;
      sha256 = "sha256-5kCb+jlWASAM106BVyleN0zUl6aVdgbxnpteKc56aJc=";
    });
  };
  caddy = {
    pname = "caddy";
  ...
  hyprland = {
    pname = "hyprland";
    version = "0ad261aa9c408aa43b8ff846acf9dab97e29b927";
    src = fetchFromGitHub ({
      owner = "hyprwm";
      repo = "hyprland";
      rev = "0ad261aa9c408aa43b8ff846acf9dab97e29b927";
      fetchSubmodules = false;
      sha256 = "sha256-/qMWX2/jplrtMoh1/6saFjNzU84IVTDV0iEXZ1y0UM0=";
    });
  };
  ibus = {
    pname = "ibus";
