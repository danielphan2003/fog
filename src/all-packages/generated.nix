...
{ fetchgit, fetchurl, fetchFromGitHub }:
{
  ...
  hyprland = {
    pname = "hyprland";
    version = "cc146f03441bd1512f42d768a321a3fad110671e";
    src = fetchFromGitHub ({
      owner = "vaxerski";
      repo = "hyprland";
      rev = "cc146f03441bd1512f42d768a321a3fad110671e";
      fetchSubmodules = false;
      sha256 = "sha256-v6JLKiwBKhhvbWM/3d+UHv6HlX2lVsNUL6D8Yk1jbJ4=";
    });
  };
  ibus = {
    pname = "ibus";
  ...
  tailscale = {
    pname = "tailscale";
    version = "7c671b0220a5a42303dd68c8b63a5baedcce885e";
    src = fetchFromGitHub ({
      owner = "tailscale";
      repo = "tailscale";
      rev = "7c671b0220a5a42303dd68c8b63a5baedcce885e";
      fetchSubmodules = false;
      sha256 = "sha256-F4qN50epAP0Mo+MENdfXYJr12uxtbsW9AByRVxEwgyI=";
    });
  };
  tailscale-systray = {
