...
{ fetchgit, fetchurl, fetchFromGitHub, dockerTools }:
{
  ...
  bottles = {
    pname = "bottles";
    version = "c40eff3113ee8a844bfe3220d5af96645cbbb232";
    src = fetchFromGitHub ({
      owner = "bottlesdevs";
      repo = "Bottles";
      rev = "c40eff3113ee8a844bfe3220d5af96645cbbb232";
      fetchSubmodules = false;
      sha256 = "sha256-NoAogECkZuDdOzWZbOImXW6M8RclTDwsQXJULCFxMbE=";
    });
    date = "2023-01-18";
  };
  caddy = {
  ...
  caddy-git = {
    pname = "caddy-git";
    version = "e8ad9b32c9730ddb162b6fb1443fc0b36fcef7dc";
    src = fetchFromGitHub ({
      owner = "caddyserver";
      repo = "caddy";
      rev = "e8ad9b32c9730ddb162b6fb1443fc0b36fcef7dc";
      fetchSubmodules = false;
      sha256 = "sha256-lR+EKHnUDtfp/WZz6tRW2I5+SED+NiZkmWocyBa1iB4=";
    });
    date = "2023-01-17";
  };
  cinny = {
  ...
  hyprland = {
    pname = "hyprland";
    version = "31ab2349f9f0cad25c9804b5a585617d04cb2a43";
    src = fetchFromGitHub ({
      owner = "hyprwm";
      repo = "hyprland";
      rev = "31ab2349f9f0cad25c9804b5a585617d04cb2a43";
      fetchSubmodules = false;
      sha256 = "sha256-GYogrIN4qw4p8zGzrHieJcoHHp3I23F3QJZ54D0hMMI=";
    });
    date = "2023-01-18";
  };
  ibus = {
  ...
  jitsi-meet = {
    ...
    version = "1.0.6924";
    src = fetchurl {
      url = "https://download.jitsi.org/jitsi-meet/src/jitsi-meet-1.0.6924.tar.bz2";
      sha256 = "sha256-UQqCDmcl8jqmLPvauA4+rQJa/rtTqgnO6PK19aZmHdo=";
    };
  };
  jitsi-meet-prosody = {
    ...
    version = "1.0.6924";
    src = fetchurl {
      url = "https://download.jitsi.org/unstable/jitsi-meet-prosody_1.0.6924-1_all.deb";
      sha256 = "sha256-KHT9reX+SXgABMG7HbB/AWfx675yxgrBoV0khw+G5ZY=";
    };
  };
  jitsi-videobridge2 = {
  ...
  rustdesk = {
    pname = "rustdesk";
    version = "8e4735127003222c1d913d73e12ddab95932b9c2";
    src = fetchFromGitHub ({
      owner = "rustdesk";
      repo = "rustdesk";
      rev = "8e4735127003222c1d913d73e12ddab95932b9c2";
      fetchSubmodules = false;
      sha256 = "sha256-r1IHzxWvJI8bFGOQLiMR9HhqcZgm9Rnsm8IQCQownIo=";
    });
    cargoLock."Cargo.lock" = {
      lockFile = ./rustdesk-8e4735127003222c1d913d73e12ddab95932b9c2/Cargo.lock;
      outputHashes = {
