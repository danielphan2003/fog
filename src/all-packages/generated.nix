...
{ fetchgit, fetchurl, fetchFromGitHub, dockerTools }:
{
  ...
  hyprland = {
    pname = "hyprland";
    version = "11afb660102198abb1e74fffdffd00f8c1a11cd9";
    src = fetchFromGitHub ({
      owner = "hyprwm";
      repo = "hyprland";
      rev = "11afb660102198abb1e74fffdffd00f8c1a11cd9";
      fetchSubmodules = false;
      sha256 = "sha256-vL9AhYPCMP1/8va2pdmLn0vmCdsxbgYSSQHm4kaQjHs=";
    });
    date = "2023-01-11";
  };
  ibus = {
  ...
  jitsi-meet = {
    ...
    version = "1.0.6910";
    src = fetchurl {
      url = "https://download.jitsi.org/jitsi-meet/src/jitsi-meet-1.0.6910.tar.bz2";
      sha256 = "sha256-j94hgigB6mJlb2iV8X23Vd2ekezBqjnNbyiekAXHXaY=";
    };
  };
  jitsi-meet-prosody = {
    ...
    version = "1.0.6910";
    src = fetchurl {
      url = "https://download.jitsi.org/unstable/jitsi-meet-prosody_1.0.6910-1_all.deb";
      sha256 = "sha256-Cor4eaAArBUAo508iGH7R3J8LzF8gTHcuxTEj4zdWmQ=";
    };
  };
  jitsi-videobridge2 = {
  ...
  ydotool = {
    pname = "ydotool";
    version = "e9d4ed823ff3ee8fb51fa50294bf915c0ea159c5";
    src = fetchFromGitHub ({
      owner = "ReimuNotMoe";
      repo = "ydotool";
      rev = "e9d4ed823ff3ee8fb51fa50294bf915c0ea159c5";
      fetchSubmodules = false;
      sha256 = "sha256-JQs0QxzpbuZvf2MXhb5aTdPH7nyUdwgFENTxXSjPJeA=";
    });
    date = "2023-01-11";
  };
  yubikey-agent = {
