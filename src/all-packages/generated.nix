...
{ fetchgit, fetchurl, fetchFromGitHub }:
{
  ...
  hyprland = {
    pname = "hyprland";
    version = "9bbae5b8e2e593b04f6505c9f35c7e9affa9ab6f";
    src = fetchFromGitHub ({
      owner = "hyprwm";
      repo = "hyprland";
      rev = "9bbae5b8e2e593b04f6505c9f35c7e9affa9ab6f";
      fetchSubmodules = false;
      sha256 = "sha256-n133KFE2gR7SNJLM/LcMyWTxwqiFYysKkw/ngbHI3Io=";
    });
  };
  ibus = {
    pname = "ibus";
  ...
  jitsi-meet = {
    ...
    version = "1.0.6645";
    src = fetchurl {
      url = "https://download.jitsi.org/jitsi-meet/src/jitsi-meet-1.0.6645.tar.bz2";
      sha256 = "sha256-fdlD3mtEKD/nWhExAfjPvGalodkC+IxYMcjWH7wHmmA=";
    };
  };
  jitsi-meet-prosody = {
    ...
    version = "1.0.6645";
    src = fetchurl {
      url = "https://download.jitsi.org/unstable/jitsi-meet-prosody_1.0.6645-1_all.deb";
      sha256 = "sha256-qo5h6w8C2uPMIaNdrHXoph04RXbUc/6KwbWaB20XkU8=";
    };
  };
  jitsi-videobridge2 = {
  ...
  revanced-integrations = {
    ...
    version = "0.49.0";
    src = fetchurl {
      url = "https://github.com/revanced/revanced-integrations/releases/download/v0.49.0/app-release-unsigned.apk";
      sha256 = "sha256-JUR7OpjSdKmPJ80BXOXyjGpyN8+dXIVwz9/WsP7mt+Y=";
    };
  };
  ...
  tailscale = {
    pname = "tailscale";
    version = "e5636997c599863501dfc371359f6648bcc1b044";
    src = fetchFromGitHub ({
      owner = "tailscale";
      repo = "tailscale";
      rev = "e5636997c599863501dfc371359f6648bcc1b044";
      fetchSubmodules = false;
      sha256 = "sha256-Wk7uWCYyFO1OhxkhhK0cAcxliv5X5wEiFUKsZx85sgg=";
    });
  };
  tailscale-systray = {
