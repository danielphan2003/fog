...
{ fetchgit, fetchurl, fetchFromGitHub }:
{
  ...
  arkenfox-userjs = {
    ...
    version = "4bc98005ec0ae56726a38d0854c645b407194278";
    src = fetchFromGitHub ({
      owner = "arkenfox";
      repo = "user.js";
      rev = "4bc98005ec0ae56726a38d0854c645b407194278";
      fetchSubmodules = false;
      sha256 = "sha256-jBgIICxPD/QDPsvmBZEzFJDPoh4VIM9bKcdH+8Snw0s=";
    });
  };
  asusctl = {
    pname = "asusctl";
  ...
  caddy-git = {
    pname = "caddy-git";
    version = "b1d04f5b39df58e092ad503e9ccd0584b30936a1";
    src = fetchFromGitHub ({
      owner = "caddyserver";
      repo = "caddy";
      rev = "b1d04f5b39df58e092ad503e9ccd0584b30936a1";
      fetchSubmodules = false;
      sha256 = "sha256-G2FRR66guMjEsnm3PtcQYsY5a8UvUxFI6DCKrvnTeFc=";
    });
  };
  cinny = {
    pname = "cinny";
  ...
  hyprland = {
    pname = "hyprland";
    version = "a97621b1cb203b0e3a7dd07d88c5422b798cbfd8";
    src = fetchFromGitHub ({
      owner = "hyprwm";
      repo = "hyprland";
      rev = "a97621b1cb203b0e3a7dd07d88c5422b798cbfd8";
      fetchSubmodules = false;
      sha256 = "sha256-Qi7fh9jD0PeQw80YBjAv191Ye+MecudUOTYFwByH3CU=";
    });
  };
  ibus = {
    pname = "ibus";
  ...
  retroarch = {
    pname = "retroarch";
    version = "0033224c25a54db1cb5841f999b0a988d36a02d5";
    src = fetchFromGitHub ({
      owner = "libretro";
      repo = "retroarch";
      rev = "0033224c25a54db1cb5841f999b0a988d36a02d5";
      fetchSubmodules = false;
      sha256 = "sha256-ezPVU2rm7SJJHOyOw4WZj9DZybxUqUA55Jw7vwLCNeE=";
    });
  };
  revanced-cli = {
    pname = "revanced-cli";
  ...
  rustdesk = {
    pname = "rustdesk";
    version = "551c5ecddfd6d5a7adff261f36592fece2874d27";
    src = fetchFromGitHub ({
      owner = "rustdesk";
      repo = "rustdesk";
      rev = "551c5ecddfd6d5a7adff261f36592fece2874d27";
      fetchSubmodules = false;
      sha256 = "sha256-tKNyqKhRSfgES5CbmZgMD/DGxu3p8Q9MROpLgg+xyYs=";
    });
    cargoLock."Cargo.lock" = {
      lockFile = ./rustdesk-551c5ecddfd6d5a7adff261f36592fece2874d27/Cargo.lock;
      outputHashes = {
  ...
  spicetify-cli = {
    pname = "spicetify-cli";
    version = "91ec5e21dd52756cc71df1abb0750c2af67c9b46";
    src = fetchFromGitHub ({
      owner = "spicetify";
      repo = "spicetify-cli";
      rev = "91ec5e21dd52756cc71df1abb0750c2af67c9b46";
      fetchSubmodules = false;
      sha256 = "sha256-LaPNqt0VDkvOH6k2z3hWzihWMSCWeprxRQ3HmxcT+h8=";
    });
  };
  ...
  tailscale = {
    pname = "tailscale";
    version = "4102a687e3b95e0dc9904a05241dfe5dfc13228b";
    src = fetchFromGitHub ({
      owner = "tailscale";
      repo = "tailscale";
      rev = "4102a687e3b95e0dc9904a05241dfe5dfc13228b";
      fetchSubmodules = false;
      sha256 = "sha256-xdJYUsNILS7zYVVmKRYweqOLL1UBzDpJ/9+64eIpURs=";
    });
  };
  tailscale-systray = {
  ...
  whitesur-gtk-theme = {
    ...
    version = "b904f9510e5f9b8b4a5903b19a745ad30b4d07fb";
    src = fetchFromGitHub ({
      owner = "vinceliuice";
      repo = "whitesur-gtk-theme";
      rev = "b904f9510e5f9b8b4a5903b19a745ad30b4d07fb";
      fetchSubmodules = false;
      sha256 = "sha256-XEZ5Jfv1gLvZdOQAutj8QwRMhwON5NzVQbgNnZwHvYU=";
    });
  };
  whitesur-icon-theme = {
