...
{ fetchgit, fetchurl, fetchFromGitHub }:
{
  ...
  caddy-git = {
    pname = "caddy-git";
    version = "20d487be573424e7647b5a157754f6e284554e23";
    src = fetchFromGitHub ({
      owner = "caddyserver";
      repo = "caddy";
      rev = "20d487be573424e7647b5a157754f6e284554e23";
      fetchSubmodules = false;
      sha256 = "sha256-xQuxIuVic6aybNb06QMkozu4yOjwvtK7bcS0NWDgDOQ=";
    });
  };
  cinny = {
    pname = "cinny";
  ...
  hyprland = {
    pname = "hyprland";
    version = "e518adf1ac3db14e85fd3b8ceab71c22eab9d1c7";
    src = fetchFromGitHub ({
      owner = "hyprwm";
      repo = "hyprland";
      rev = "e518adf1ac3db14e85fd3b8ceab71c22eab9d1c7";
      fetchSubmodules = false;
      sha256 = "sha256-FFfeRv9AQlJnrCua/EUFNWHlxJ+gbqqMP8bNbPueKX8=";
    });
  };
  ibus = {
    pname = "ibus";
  ...
  retroarch = {
    pname = "retroarch";
    version = "ce8389d4a6825dd99545d47d252936771bde0f53";
    src = fetchFromGitHub ({
      owner = "libretro";
      repo = "retroarch";
      rev = "ce8389d4a6825dd99545d47d252936771bde0f53";
      fetchSubmodules = false;
      sha256 = "sha256-w/Ht1nEHEt9TipLbGlzYVd80L26ZoonOvplMRtA1X2A=";
    });
  };
  revanced-cli = {
    pname = "revanced-cli";
  ...
  rustdesk = {
    pname = "rustdesk";
    version = "f4bc27f9697b10ef1aa2620aa11b13667e911096";
    src = fetchFromGitHub ({
      owner = "rustdesk";
      repo = "rustdesk";
      rev = "f4bc27f9697b10ef1aa2620aa11b13667e911096";
      fetchSubmodules = false;
      sha256 = "sha256-MQjhJaIzCLN/AjSh8qU7acTOqIlOJKg6VyHDejO78zQ=";
    });
    cargoLock."Cargo.lock" = {
      lockFile = ./rustdesk-f4bc27f9697b10ef1aa2620aa11b13667e911096/Cargo.lock;
      outputHashes = {
  ...
  sddm = {
    pname = "sddm";
    version = "53c247cc2438122b5ad1578905cb3c39482fa582";
    src = fetchFromGitHub ({
      owner = "sddm";
      repo = "sddm";
      rev = "53c247cc2438122b5ad1578905cb3c39482fa582";
      fetchSubmodules = false;
  ...
  snui = {
    pname = "snui";
    version = "a9a2675c896908ba80806d6aac7ab1f67fe85220";
    src = fetchgit {
      url = "https://gitlab.com/snakedye/snui";
      rev = "a9a2675c896908ba80806d6aac7ab1f67fe85220";
      fetchSubmodules = false;
      deepClone = false;
      leaveDotGit = false;
      sha256 = "sha256-vBhuNdj9R8KzZa2ReptCBhHD9ZDE07Yzfsmn6j2SOzw=";
    };
  };
  spicetify-cli = {
    pname = "spicetify-cli";
  ...
  tailscale = {
    pname = "tailscale";
    version = "f6da2220d30943181def1b48c97e95cbd1ddc01e";
    src = fetchFromGitHub ({
      owner = "tailscale";
      repo = "tailscale";
      rev = "f6da2220d30943181def1b48c97e95cbd1ddc01e";
      fetchSubmodules = false;
      sha256 = "sha256-fkQ++EO0y11dcQS14plOHPecYdcM8rVDJcmAQJDUr7Y=";
    });
  };
  tailscale-systray = {
