...
{ fetchgit, fetchurl, fetchFromGitHub }:
{
  ...
  fluffychat = {
    pname = "fluffychat";
    version = "b1d06c065c135f58e34c92303398214f64945ab4";
    src = fetchgit {
      url = "https://gitlab.com/famedly/fluffychat";
      rev = "b1d06c065c135f58e34c92303398214f64945ab4";
      fetchSubmodules = false;
      deepClone = false;
      leaveDotGit = false;
      sha256 = "sha256-mBa3TFCAdcYoxGr0Tl5QL5BUQHD++gRLRXWio67SOAc=";
    };
  };
  flyingfox = {
    pname = "flyingfox";
  ...
  fx_cast = {
    pname = "fx_cast";
    version = "77b67f205e0152dfae172271694b1394a5a4d67f";
    src = fetchFromGitHub ({
      owner = "hensm";
      repo = "fx_cast";
      rev = "77b67f205e0152dfae172271694b1394a5a4d67f";
      fetchSubmodules = false;
      sha256 = "sha256-5mODORBwLCFtR7kmhqxlrIUOc6GzAV3CPMvAWn/APZI=";
    });
  };
  godu = {
    pname = "godu";
  ...
  hyprland = {
    pname = "hyprland";
    version = "a09c614c2d2e4317cf6b9bd797784ab2ac94bcf0";
    src = fetchFromGitHub ({
      owner = "hyprwm";
      repo = "hyprland";
      rev = "a09c614c2d2e4317cf6b9bd797784ab2ac94bcf0";
      fetchSubmodules = false;
      sha256 = "sha256-9gh/4IFVQ7tvi7qoSLcpK5qYOtVnOqfrlVfFiZG1eLs=";
    });
  };
  ibus = {
    pname = "ibus";
  ...
  jitsi-meet = {
    ...
    version = "1.0.6548";
    src = fetchurl {
      url = "https://download.jitsi.org/jitsi-meet/src/jitsi-meet-1.0.6548.tar.bz2";
      sha256 = "sha256-KBZOvZZVtq+j4wN1R19Pkna09umHDKQFYtaaIzNkoTg=";
    };
  };
  jitsi-meet-prosody = {
    ...
    version = "1.0.6548";
    src = fetchurl {
      url = "https://download.jitsi.org/unstable/jitsi-meet-prosody_1.0.6548-1_all.deb";
      sha256 = "sha256-V8N0MP4rcbiD/NMFIjUPzoAUgQ4Wso1ozDim1KjJa/U=";
    };
  };
  jitsi-videobridge2 = {
  ...
  snui = {
    pname = "snui";
    version = "749bf7c46d08aee5fac79cda142c5a03c541e316";
    src = fetchgit {
      url = "https://gitlab.com/snakedye/snui";
      rev = "749bf7c46d08aee5fac79cda142c5a03c541e316";
      fetchSubmodules = false;
      deepClone = false;
      leaveDotGit = false;
      sha256 = "sha256-D5b7gWLR9J1kTLVSOdqZKVZYGIVsyJtCqYOdt1DxfvU=";
    };
  };
  spicetify-cli = {
    pname = "spicetify-cli";
  ...
  tailscale = {
    pname = "tailscale";
    version = "16939f0d56e4543a5f9e3f9295a806029e8d45d0";
    src = fetchFromGitHub ({
      owner = "tailscale";
      repo = "tailscale";
      rev = "16939f0d56e4543a5f9e3f9295a806029e8d45d0";
      fetchSubmodules = false;
      sha256 = "sha256-JgFF1Fzlff4sfnZG3zaBQqQ5hQi3gieh8sK0wgxKziE=";
    });
  };
  tailscale-systray = {
