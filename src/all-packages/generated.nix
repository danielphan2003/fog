...
{ fetchgit, fetchurl, fetchFromGitHub, dockerTools }:
{
  ...
  fluffychat = {
    pname = "fluffychat";
    version = "a1f60b7ff9569f46430afff2f24183f241282a36";
    src = fetchgit {
      url = "https://gitlab.com/famedly/fluffychat";
      rev = "a1f60b7ff9569f46430afff2f24183f241282a36";
      fetchSubmodules = false;
      deepClone = false;
      leaveDotGit = false;
      sha256 = "sha256-gRW7C901+BXDFSKKPs02fNzj5zeERjsf2duaLba/He0=";
    };
    date = "2023-01-13";
  };
  flyingfox = {
  ...
  hyprland = {
    pname = "hyprland";
    version = "b3012d97ab32abb6915f6ed496a04e206a9f0b0b";
    src = fetchFromGitHub ({
      owner = "hyprwm";
      repo = "hyprland";
      rev = "b3012d97ab32abb6915f6ed496a04e206a9f0b0b";
      fetchSubmodules = false;
      sha256 = "sha256-Mpm+0CQVAhMnhyrQv07L2cC3qQELwsTMFzycDZWNtWo=";
    });
    date = "2023-01-13";
  };
  ibus = {
  ...
  microsoft-edge-stable = {
    ...
    version = "109.0.1518.49";
    src = fetchurl {
      url = "https://packages.microsoft.com/repos/edge/pool/main/m/microsoft-edge-stable/microsoft-edge-stable_109.0.1518.49-1_amd64.deb";
      sha256 = "sha256-VSUjgASU/nEDsneLyMpgEUjmaiXRk8G6Qei2ZWi/Wa8=";
    };
  };
  minecraft-wayland = {
  ...
  retroarch = {
    pname = "retroarch";
    version = "3b6aef23e191cd45bf6372f2a1dac9c74f5326de";
    src = fetchFromGitHub ({
      owner = "libretro";
      repo = "retroarch";
      rev = "3b6aef23e191cd45bf6372f2a1dac9c74f5326de";
      fetchSubmodules = false;
      sha256 = "sha256-FWuQJmwXzUjGPOpb6IaGGWR8JaQym9UbqfSvwYyAl3M=";
    });
    date = "2023-01-13";
  };
  rofi-wayland = {
  ...
  rustdesk = {
    pname = "rustdesk";
    version = "741e5eeb0ee7c59c19960fd1fb9c23ec849eb02c";
    src = fetchFromGitHub ({
      owner = "rustdesk";
      repo = "rustdesk";
      rev = "741e5eeb0ee7c59c19960fd1fb9c23ec849eb02c";
      fetchSubmodules = false;
      sha256 = "sha256-Ni35c/ySOqLJj4tqx9LMA0KkswWpdmwC0ebx2a6lw7s=";
    });
    cargoLock."Cargo.lock" = {
      lockFile = ./rustdesk-741e5eeb0ee7c59c19960fd1fb9c23ec849eb02c/Cargo.lock;
      outputHashes = {
  ...
  tailscale = {
    pname = "tailscale";
    version = "355c3b2be7fe275480a5c3e5cecfe32693256da3";
    src = fetchFromGitHub ({
      owner = "tailscale";
      repo = "tailscale";
      rev = "355c3b2be7fe275480a5c3e5cecfe32693256da3";
      fetchSubmodules = false;
      sha256 = "sha256-VmshjslaBhp9Wi2O2shdoJ/SUxgjaKNyghVBL2ONamE=";
    });
    date = "2023-01-13";
  };
  tailscale-systray = {
