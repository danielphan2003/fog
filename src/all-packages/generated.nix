...
{ fetchgit, fetchurl, fetchFromGitHub }:
{
  ...
  fluffychat = {
    pname = "fluffychat";
    version = "edfd8f36ab9ac0d829bb0fc1c08d6f0e0552421a";
    src = fetchgit {
      url = "https://gitlab.com/famedly/fluffychat";
      rev = "edfd8f36ab9ac0d829bb0fc1c08d6f0e0552421a";
      fetchSubmodules = false;
      deepClone = false;
      leaveDotGit = false;
      sha256 = "sha256-X+kCGKO56sOR6Ku4CwfcXAUzLFsx3Q21EjSPaUNE+fc=";
    };
  };
  flyingfox = {
    pname = "flyingfox";
  ...
  hyprland = {
    pname = "hyprland";
    version = "7525818097f92a99b2b8d02ea43bd0f8ccabd51c";
    src = fetchFromGitHub ({
      owner = "hyprwm";
      repo = "hyprland";
      rev = "7525818097f92a99b2b8d02ea43bd0f8ccabd51c";
      fetchSubmodules = false;
      sha256 = "sha256-fxpb2GM2Zi4DU119b7c1g8RN/jF7WXD5UcjXN7lxPJ8=";
    });
  };
  ibus = {
    pname = "ibus";
  ...
  rustdesk = {
    pname = "rustdesk";
    version = "0dcf10616d0f0e45a1f15341d72f34ba86413326";
    src = fetchFromGitHub ({
      owner = "rustdesk";
      repo = "rustdesk";
      rev = "0dcf10616d0f0e45a1f15341d72f34ba86413326";
      fetchSubmodules = false;
      sha256 = "sha256-yKAlcqk0KWpthjQQEU1URJR4fGznBFskEB+ZfpmyPq0=";
    });
    cargoLock."Cargo.lock" = {
      lockFile = ./rustdesk-0dcf10616d0f0e45a1f15341d72f34ba86413326/Cargo.lock;
      outputHashes = {
  ...
  ulauncher = {
    pname = "ulauncher";
    version = "81671e75660b92465ae07a84b7ae46870589cc37";
    src = fetchFromGitHub ({
      owner = "Ulauncher";
      repo = "Ulauncher";
      rev = "81671e75660b92465ae07a84b7ae46870589cc37";
      fetchSubmodules = false;
      sha256 = "sha256-V1ayX4wef+mMY4ICH+PqMmJs+TlGkUcheQTctpeClnA=";
    });
  };
  uniemoji = {
    pname = "uniemoji";
  ...
  waydroid = {
    pname = "waydroid";
    version = "fc08b71b971ad6a4a9d6575d3a3b2271f26a8ed1";
    src = fetchFromGitHub ({
      owner = "waydroid";
      repo = "waydroid";
      rev = "fc08b71b971ad6a4a9d6575d3a3b2271f26a8ed1";
      fetchSubmodules = false;
      sha256 = "sha256-9LFcfF+AizC0WCbZPbIRPOk/1DFjpczke+znWZgR4Us=";
    });
  };
  wgcf = {
    pname = "wgcf";
