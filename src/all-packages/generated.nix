...
{ fetchgit, fetchurl, fetchFromGitHub, dockerTools }:
{
  ...
  retroarch = {
    pname = "retroarch";
    version = "321a215c47e76af4c16c992546a1247e14a53014";
    src = fetchFromGitHub ({
      owner = "libretro";
      repo = "retroarch";
      rev = "321a215c47e76af4c16c992546a1247e14a53014";
      fetchSubmodules = false;
      sha256 = "sha256-3B705Did6PtJbrzjJJV6xPdn8miEZPBD6sAnS+sGBR4=";
    });
    date = "2023-01-20";
  };
  rofi-wayland = {
  ...
  rustdesk = {
    pname = "rustdesk";
    version = "45c0e10102925c16cc6882b6c9542a396d50bf73";
    src = fetchFromGitHub ({
      owner = "rustdesk";
      repo = "rustdesk";
      rev = "45c0e10102925c16cc6882b6c9542a396d50bf73";
      fetchSubmodules = false;
      sha256 = "sha256-x/1nAgLR2f1B7MZ09Rhv8HxVbowQce9eUqCTizJze3M=";
    });
    cargoLock."Cargo.lock" = {
      lockFile = ./rustdesk-45c0e10102925c16cc6882b6c9542a396d50bf73/Cargo.lock;
      outputHashes = {
