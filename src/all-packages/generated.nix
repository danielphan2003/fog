...
{ fetchgit, fetchurl, fetchFromGitHub }:
{
  ...
  hyprland = {
    pname = "hyprland";
    version = "869f0a023888b6c9a214814c56192e922542c970";
    src = fetchFromGitHub ({
      owner = "hyprwm";
      repo = "hyprland";
      rev = "869f0a023888b6c9a214814c56192e922542c970";
      fetchSubmodules = false;
      sha256 = "sha256-7T5/OyMSbABvkQmkMOxdVGE5EEcfGFk6wIL6tCf7Oeg=";
    });
  };
  ibus = {
    pname = "ibus";
  ...
  revanced-integrations = {
    ...
    version = "0.79.0";
    src = fetchurl {
      url = "https://github.com/revanced/revanced-integrations/releases/download/v0.79.0/app-release-unsigned.apk";
      sha256 = "sha256-wszl7J6u68AJ6Dzo0wNn4SUhbB8qxOOtE1kPsay3osE=";
    };
  };
