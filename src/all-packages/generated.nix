...
{ fetchgit, fetchurl, fetchFromGitHub }:
{
  ...
  asusctl = {
    pname = "asusctl";
    version = "1fc12d98557781e3355c5fc822d825af21f4e0e1";
    src = fetchgit {
      url = "https://gitlab.com/asus-linux/asusctl";
      rev = "1fc12d98557781e3355c5fc822d825af21f4e0e1";
      fetchSubmodules = false;
      deepClone = false;
      leaveDotGit = false;
      sha256 = "sha256-sgwMcE98FEEp9qGeCRH+Z+IItgohph19fZ8UpJhrx6A=";
    };
    cargoLock."Cargo.lock" = {
      lockFile = ./asusctl-1fc12d98557781e3355c5fc822d825af21f4e0e1/Cargo.lock;
      outputHashes = {
  ...
  guiscrcpy = {
    pname = "guiscrcpy";
    version = "1c578eae04418c4287cc892fe74d515ae27136b1";
    src = fetchFromGitHub ({
      owner = "srevinsaju";
      repo = "guiscrcpy";
      rev = "1c578eae04418c4287cc892fe74d515ae27136b1";
      fetchSubmodules = false;
      sha256 = "sha256-BwcRvCuwqTwjR98DKtSBzN5OHkqcaGHZIQ3uIV40hfY=";
    });
  };
  hyprland = {
    pname = "hyprland";
    version = "1626707b7f4fd3d2b313e78cb3a41783f072f73b";
    src = fetchFromGitHub ({
      owner = "vaxerski";
      repo = "hyprland";
      rev = "1626707b7f4fd3d2b313e78cb3a41783f072f73b";
      fetchSubmodules = false;
      sha256 = "sha256-IfB2BBTk2oUxKNb+vOWxGcK90M7zp8arph5UIo5Qs1I=";
    });
  };
  ibus = {
    pname = "ibus";
  ...
  retroarch = {
    pname = "retroarch";
    version = "5c98caa7fde65cf46528deda2f01063074ad9550";
    src = fetchFromGitHub ({
      owner = "libretro";
      repo = "retroarch";
      rev = "5c98caa7fde65cf46528deda2f01063074ad9550";
      fetchSubmodules = false;
      sha256 = "sha256-StcrYjSE7KoypoELOa8kbMoktaUI6iKU9j6V+FMrvcI=";
    });
  };
  revanced-cli = {
    pname = "revanced-cli";
