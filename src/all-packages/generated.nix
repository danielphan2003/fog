...
{ fetchgit, fetchurl, fetchFromGitHub }:
{
  ...
  bottles = {
    pname = "bottles";
    version = "d03a816ca74d612746b811435c4b7ea25cce745c";
    src = fetchFromGitHub ({
      owner = "bottlesdevs";
      repo = "Bottles";
      rev = "d03a816ca74d612746b811435c4b7ea25cce745c";
      fetchSubmodules = false;
      sha256 = "sha256-gTbKsJYLn2/i64hxM4j8NxIDtl4hwjTfrwC4Kpq2dGQ=";
    });
  };
  caddy = {
    pname = "caddy";
  ...
  tailscale = {
    pname = "tailscale";
    version = "774fa72d325c9664f8c476ea0005634f9aa1ff40";
    src = fetchFromGitHub ({
      owner = "tailscale";
      repo = "tailscale";
      rev = "774fa72d325c9664f8c476ea0005634f9aa1ff40";
      fetchSubmodules = false;
      sha256 = "sha256-HUSNp9z9rNCJn21F3+xS+Oa6n/lyi/47rMUbgAREvfQ=";
    });
  };
  tailscale-systray = {
