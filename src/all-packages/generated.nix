...
{ fetchgit, fetchurl, fetchFromGitHub, dockerTools }:
{
  ...
  jitsi-meet = {
    ...
    version = "1.0.6947";
    src = fetchurl {
      url = "https://download.jitsi.org/jitsi-meet/src/jitsi-meet-1.0.6947.tar.bz2";
      sha256 = "sha256-EEXjEyiH5zKIFF6y3aHRMLYmn0pzThh7dUZl4A485ls=";
    };
  };
  jitsi-meet-prosody = {
    ...
    version = "1.0.6947";
    src = fetchurl {
      url = "https://download.jitsi.org/unstable/jitsi-meet-prosody_1.0.6947-1_all.deb";
      sha256 = "sha256-qEdpMXz4WmGquFTNmDxX77RCnXJ4csKZcIsc8ArkVhY=";
    };
  };
  jitsi-videobridge2 = {
  ...
  rustdesk = {
    pname = "rustdesk";
    version = "f4d030524231c7150044bef2cea45928fd55ac35";
    src = fetchFromGitHub ({
      owner = "rustdesk";
      repo = "rustdesk";
      rev = "f4d030524231c7150044bef2cea45928fd55ac35";
      fetchSubmodules = false;
      sha256 = "sha256-61BSIdreytvw1EWVi1TT0NLEvsXpMt7W9TsLITQ8YX0=";
    });
    cargoLock."Cargo.lock" = {
      lockFile = ./rustdesk-f4d030524231c7150044bef2cea45928fd55ac35/Cargo.lock;
      outputHashes = {
  ...
  spicetify-cli = {
    pname = "spicetify-cli";
    version = "b2aecb88ffc2a8803354cccaf6761e06fe7caaf7";
    src = fetchFromGitHub ({
      owner = "spicetify";
      repo = "spicetify-cli";
      rev = "b2aecb88ffc2a8803354cccaf6761e06fe7caaf7";
      fetchSubmodules = false;
      sha256 = "sha256-po02126M1xSQ8faWLTS9a4djCENODVQ70niPutTefEI=";
    });
    date = "2023-01-30";
  };
