...
{ fetchgit, fetchurl, fetchFromGitHub, dockerTools }:
{
  ...
  bottles = {
    pname = "bottles";
    version = "6b4b493d31280ae3c92085b1127967e18bd091c9";
    src = fetchFromGitHub ({
      owner = "bottlesdevs";
      repo = "Bottles";
      rev = "6b4b493d31280ae3c92085b1127967e18bd091c9";
      fetchSubmodules = false;
      sha256 = "sha256-mNSWAp81D2t6Vyge7qaBlb2YzS95sBfwAZCd3MdhQQg=";
    });
    date = "2023-01-18";
  };
  caddy = {
  ...
  hyprland = {
    pname = "hyprland";
    version = "32c11bb212dd88e4fe8e573f35649448f7d8911c";
    src = fetchFromGitHub ({
      owner = "hyprwm";
      repo = "hyprland";
      rev = "32c11bb212dd88e4fe8e573f35649448f7d8911c";
      fetchSubmodules = false;
      sha256 = "sha256-VkhsLIKY/evIu/FRB9ughThrjva0YfJ8N8C0IYCJRPg=";
    });
    date = "2023-01-18";
  };
  ibus = {
