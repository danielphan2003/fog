...
{ fetchgit, fetchurl, fetchFromGitHub }:
{
  ...
  bottles = {
    pname = "bottles";
    version = "ca2aa03afca730cfa2d47961a4c21d774dedd2ec";
    src = fetchFromGitHub ({
      owner = "bottlesdevs";
      repo = "Bottles";
      rev = "ca2aa03afca730cfa2d47961a4c21d774dedd2ec";
      fetchSubmodules = false;
      sha256 = "sha256-VvkrxtBiaEq3Yb0S3hLYOHbwQ/DR0cqGEFnt+vZkH74=";
    });
  };
  caddy = {
    pname = "caddy";
  ...
  caddy-git = {
    pname = "caddy-git";
    version = "005c5a63823b19382aa918f1e1f3288e66446225";
    src = fetchFromGitHub ({
      owner = "caddyserver";
      repo = "caddy";
      rev = "005c5a63823b19382aa918f1e1f3288e66446225";
      fetchSubmodules = false;
      sha256 = "sha256-kbIjk/Om6v+c47vk5+IdQsovI5bze/eGL9B5M9iA2v0=";
    });
  };
  cinny = {
    pname = "cinny";
  ...
  eww = {
    pname = "eww";
    version = "956f96fd76cff7af5bf7207f2e6deb24e5f8bf17";
    src = fetchFromGitHub ({
      owner = "elkowar";
      repo = "eww";
      rev = "956f96fd76cff7af5bf7207f2e6deb24e5f8bf17";
      fetchSubmodules = false;
      sha256 = "sha256-AjAgsEAP35VxUsSUTM+N94GTOpsnzS4twvoQP2f0D+w=";
    });
    cargoLock."Cargo.lock" = {
      lockFile = ./eww-956f96fd76cff7af5bf7207f2e6deb24e5f8bf17/Cargo.lock;
      outputHashes = {
  ...
  hyprland = {
    pname = "hyprland";
    version = "5d09bb647bb698d3a6cb25aeb01abb1f0522f5c6";
    src = fetchFromGitHub ({
      owner = "hyprwm";
      repo = "hyprland";
      rev = "5d09bb647bb698d3a6cb25aeb01abb1f0522f5c6";
      fetchSubmodules = false;
      sha256 = "sha256-NF+GuBNQqjDGJ7G4+gqXK74oeav20MQ96/MZlHRNYb0=";
    });
  };
  ibus = {
    pname = "ibus";
  ...
  microsoft-edge-beta = {
    ...
    version = "105.0.1343.23";
    src = fetchurl {
      url = "https://packages.microsoft.com/repos/edge/pool/main/m/microsoft-edge-beta/microsoft-edge-beta_105.0.1343.23-1_amd64.deb";
      sha256 = "sha256-68ZcWAunoBO7vG530fb8B+N0QpcoRRv13ocu/odnZZU=";
    };
  };
  microsoft-edge-dev = {
  ...
  microsoft-edge-stable = {
    ...
    src = fetchurl {
      url = "https://packages.microsoft.com/repos/edge/pool/main/m/microsoft-edge-stable/microsoft-edge-stable_105.0.1343.25-1_amd64.deb";
      sha256 = "sha256-pEr34TXpWuZpoY6A5IISJFlGFzZOe20bSXYam2/9WF0=";
    };
  };
  minecraft-wayland = {
  ...
  retroarch = {
    pname = "retroarch";
    version = "8f14143859b7e09f2aee5f63d73f0ce6713d7f30";
    src = fetchFromGitHub ({
      owner = "libretro";
      repo = "retroarch";
      rev = "8f14143859b7e09f2aee5f63d73f0ce6713d7f30";
      fetchSubmodules = false;
      sha256 = "sha256-xAqJAfgrbyEno8180nWgestainHpvul4k20dIoLqFXI=";
    });
  };
  revanced-cli = {
    pname = "revanced-cli";
  ...
  tailscale = {
    pname = "tailscale";
    version = "a0bae4dac8c195a7c81fe59fde04d6ff4b8ef9f0";
    src = fetchFromGitHub ({
      owner = "tailscale";
      repo = "tailscale";
      rev = "a0bae4dac8c195a7c81fe59fde04d6ff4b8ef9f0";
      fetchSubmodules = false;
      sha256 = "sha256-nJDovMoZMW1Y5Mv+M4tjwXqR6A6kk6AzfpTEC6XUSBM=";
    });
  };
  tailscale-systray = {
