...
{ fetchgit, fetchurl, fetchFromGitHub }:
{
  ...
  adl = {
    pname = "adl";
    version = "f3ccf0e1d81ef1c76005f9cd4c87ae0e254d89ed";
    src = fetchFromGitHub ({
      owner = "RaitaroH";
      repo = "adl";
      rev = "f3ccf0e1d81ef1c76005f9cd4c87ae0e254d89ed";
      fetchSubmodules = false;
      sha256 = "sha256-n9Cv2uF7iZmyUkSvMdDKtIIMQxGosu1Zkr1feAbKFi0=";
    });
  };
  age-plugin-yubikey = {
  ...
  conduit = {
    pname = "conduit";
    version = "f4dd051a1db65498bdf93601f66ab591d8362626";
    src = fetchgit {
      url = "https://gitlab.com/famedly/conduit";
      rev = "f4dd051a1db65498bdf93601f66ab591d8362626";
      fetchSubmodules = false;
      deepClone = false;
      leaveDotGit = false;
      sha256 = "sha256-O5m863BNAw9t6QKaogYKPGhISwaI0bepm5Zt/HrElfI=";
    };
    cargoLock."Cargo.lock" = {
      lockFile = ./conduit-f4dd051a1db65498bdf93601f66ab591d8362626/Cargo.lock;
      outputHashes = {
  ...
  jitsi-meet = {
    ...
    version = "1.0.6838";
    src = fetchurl {
      url = "https://download.jitsi.org/jitsi-meet/src/jitsi-meet-1.0.6838.tar.bz2";
      sha256 = "sha256-QFgiuuMdRLeZw3bUI6wnKgZxjtxg72JmG1LEMDmt5c0=";
    };
  };
  jitsi-meet-prosody = {
    ...
    version = "1.0.6838";
    src = fetchurl {
      url = "https://download.jitsi.org/unstable/jitsi-meet-prosody_1.0.6838-1_all.deb";
      sha256 = "sha256-MFmdw4+z85A4cmKwITf/Fy7aArXseKEccyoCDhtWiC8=";
    };
  };
  jitsi-videobridge2 = {
  ...
  retroarch = {
    pname = "retroarch";
    version = "c75af6194b67d17258109d7c75de189349841206";
    src = fetchFromGitHub ({
      owner = "libretro";
      repo = "retroarch";
      rev = "c75af6194b67d17258109d7c75de189349841206";
      fetchSubmodules = false;
      sha256 = "sha256-Uz3R0cje/JytKNWq9vXu2ddCaGqMrKniHWapPBK5DqY=";
    });
  };
  revanced-cli = {
    pname = "revanced-cli";
  ...
  revanced-patches-jar = {
    ...
    version = "2.130.0";
    src = fetchurl {
      url = "https://github.com/revanced/revanced-patches/releases/download/v2.130.0/revanced-patches-2.130.0.jar";
      sha256 = "sha256-+YX/MX1V6eaj0HR9+OBRtoUaaWwArvFHokxQFpaDwLQ=";
    };
  };
  rofi-wayland = {
    pname = "rofi-wayland";
  ...
  rustdesk = {
    pname = "rustdesk";
    version = "e13e0ab18fc8d15922073e9f990ef513ee588630";
    src = fetchFromGitHub ({
      owner = "rustdesk";
      repo = "rustdesk";
      rev = "e13e0ab18fc8d15922073e9f990ef513ee588630";
      fetchSubmodules = false;
      sha256 = "sha256-cmpZWT2Su2cEOucA6QGBgeTkSQh/JMVIP34hJJo2ogo=";
    });
    cargoLock."Cargo.lock" = {
      lockFile = ./rustdesk-e13e0ab18fc8d15922073e9f990ef513ee588630/Cargo.lock;
      outputHashes = {
  ...
  tailscale = {
    pname = "tailscale";
    version = "256ba62e0051d97e7d9837b8da4279e01c693b72";
    src = fetchFromGitHub ({
      owner = "tailscale";
      repo = "tailscale";
      rev = "256ba62e0051d97e7d9837b8da4279e01c693b72";
      fetchSubmodules = false;
      sha256 = "sha256-h4Q3cHcUo+Nxjj62W6ad2W+JmpMGeokuNQik8lAez64=";
    });
  };
  tailscale-systray = {
