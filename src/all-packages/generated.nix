...
{ fetchgit, fetchurl, fetchFromGitHub }:
{
  ...
  hyprland = {
    pname = "hyprland";
    version = "39a4f82460effec877d14a8efac7952f543323be";
    src = fetchFromGitHub ({
      owner = "hyprwm";
      repo = "hyprland";
      rev = "39a4f82460effec877d14a8efac7952f543323be";
      fetchSubmodules = false;
      sha256 = "sha256-fSndLtXyHvzP0xG1t+wVNLMnuQaZKmEogXx0CHdf81E=";
    });
  };
  ibus = {
    pname = "ibus";
  ...
  rustdesk = {
    pname = "rustdesk";
    version = "60d0b9209b3daf31c14cf6ffb6a9437699f6b04c";
    src = fetchFromGitHub ({
      owner = "rustdesk";
      repo = "rustdesk";
      rev = "60d0b9209b3daf31c14cf6ffb6a9437699f6b04c";
      fetchSubmodules = false;
      sha256 = "sha256-AbkS88smztjhhQUH3gh+smjyO9snpMAZcYte+21DxWQ=";
    });
    cargoLock."Cargo.lock" = {
      lockFile = ./rustdesk-60d0b9209b3daf31c14cf6ffb6a9437699f6b04c/Cargo.lock;
      outputHashes = {
  ...
  tailscale = {
    pname = "tailscale";
    version = "a5a3188b7e73a16abbc6667099c32abc301283a7";
    src = fetchFromGitHub ({
      owner = "tailscale";
      repo = "tailscale";
      rev = "a5a3188b7e73a16abbc6667099c32abc301283a7";
      fetchSubmodules = false;
      sha256 = "sha256-fYYMumr4wU/a+Wb7dEPQs7VGCCzx+A5m8sn72BTb3Po=";
    });
  };
  tailscale-systray = {
