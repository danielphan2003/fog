...
{ fetchgit, fetchurl, fetchFromGitHub }:
{
  ...
  bottles = {
    pname = "bottles";
    version = "22fa3573a13f4e9b9c429e4cdfe4ca29787a2832";
    src = fetchFromGitHub ({
      owner = "bottlesdevs";
      repo = "Bottles";
      rev = "22fa3573a13f4e9b9c429e4cdfe4ca29787a2832";
      fetchSubmodules = false;
      sha256 = "sha256-A0A5H+TmW+0CCuSaSLa+sZ0q6xSrvhvqQbBba/+M4kc=";
    });
  };
  caddy = {
    pname = "caddy";
  ...
  flameshot = {
    pname = "flameshot";
    version = "13c034c1e485769d743e791bd9ed68486d43f147";
    src = fetchFromGitHub ({
      owner = "flameshot-org";
      repo = "flameshot";
      rev = "13c034c1e485769d743e791bd9ed68486d43f147";
      fetchSubmodules = false;
      sha256 = "sha256-RJosFD1aVg7aN4NdPVPzIB6JDq9gwevQW5kJPpEwiEk=";
    });
  };
  fluffychat = {
    pname = "fluffychat";
  ...
  tailscale = {
    pname = "tailscale";
    version = "3b1f99ded1d1162b07122ba3ae04201f0493cfe8";
    src = fetchFromGitHub ({
      owner = "tailscale";
      repo = "tailscale";
      rev = "3b1f99ded1d1162b07122ba3ae04201f0493cfe8";
      fetchSubmodules = false;
      sha256 = "sha256-DJzXDLUFnDkrMMcMHVqmyCDSxhnfqAUa69OCuQBUKmY=";
    });
  };
  tailscale-systray = {
