...
{ fetchgit, fetchurl, fetchFromGitHub }:
{
  ...
  bottles = {
    pname = "bottles";
    version = "33830d29e7134c8e2e03dda53510854b13c3aeef";
    src = fetchFromGitHub ({
      owner = "bottlesdevs";
      repo = "Bottles";
      rev = "33830d29e7134c8e2e03dda53510854b13c3aeef";
      fetchSubmodules = false;
      sha256 = "sha256-aoa0e1pvTFQL/02RFPtjp9AiiIQpWFQ/vLYVrOLHa3o=";
    });
  };
  caddy = {
    pname = "caddy";
  ...
  cinny = {
    pname = "cinny";
    version = "02f7d7c74d932da716c0900795eb5f8d18978220";
    src = fetchFromGitHub ({
      owner = "cinnyapp";
      repo = "cinny";
      rev = "02f7d7c74d932da716c0900795eb5f8d18978220";
      fetchSubmodules = false;
      sha256 = "sha256-colpa5LZqivetiDCAqiULg4uXbZ9EJNyG5ZjK19F3V4=";
    });
  };
  cinny-bin = {
    pname = "cinny-bin";
  ...
  conduit = {
    pname = "conduit";
    version = "2a52f666dc329c296e74f1f987e230d4f4cede7d";
    src = fetchgit {
      url = "https://gitlab.com/famedly/conduit";
      rev = "2a52f666dc329c296e74f1f987e230d4f4cede7d";
      fetchSubmodules = false;
      deepClone = false;
      leaveDotGit = false;
      sha256 = "sha256-MVpVfXaiYkKYWV+Jfn4MIhmjR1JUnMQ1y2Ea0vq7qis=";
    };
    cargoLock."Cargo.lock" = {
      lockFile = ./conduit-2a52f666dc329c296e74f1f987e230d4f4cede7d/Cargo.lock;
      outputHashes = {
  ...
  fluffychat = {
    pname = "fluffychat";
    version = "ad113bc230034678a18a4ada69851758f4e5b2c4";
    src = fetchgit {
      url = "https://gitlab.com/famedly/fluffychat";
      rev = "ad113bc230034678a18a4ada69851758f4e5b2c4";
      fetchSubmodules = false;
      deepClone = false;
      leaveDotGit = false;
      sha256 = "sha256-SBIMVvQNQ4w7+0BGhg72BrjopTYIUVsXEjallXWOQPQ=";
    };
  };
  flyingfox = {
    pname = "flyingfox";
  ...
  hyprland = {
    pname = "hyprland";
    version = "989deafd5e2b7962e9eb27bb3ec0cd7ee9dd107b";
    src = fetchFromGitHub ({
      owner = "hyprwm";
      repo = "hyprland";
      rev = "989deafd5e2b7962e9eb27bb3ec0cd7ee9dd107b";
      fetchSubmodules = false;
      sha256 = "sha256-TeiufpN2Y3JwcwA0XtjR55Ni1M6oj3fpJEqCPRhmG7Y=";
    });
  };
  ibus = {
    pname = "ibus";
  ...
  jitsi-meet = {
    ...
    version = "1.0.6750";
    src = fetchurl {
      url = "https://download.jitsi.org/jitsi-meet/src/jitsi-meet-1.0.6750.tar.bz2";
      sha256 = "sha256-ww2AMZX0YIBroV/6AoCyXZDtLrF+lZwjVv+Vd9THbJs=";
    };
  };
  jitsi-meet-prosody = {
    ...
    version = "1.0.6750";
    src = fetchurl {
      url = "https://download.jitsi.org/unstable/jitsi-meet-prosody_1.0.6750-1_all.deb";
      sha256 = "sha256-gEqJ5jxnH/tbtE8GGOseLz4VGr/XekwaMRMVjcG5Phs=";
    };
  };
  jitsi-videobridge2 = {
  ...
  netdata-go-d-plugin = {
    ...
    version = "0.41.2";
    src = fetchurl {
      url = "https://github.com/netdata/go.d.plugin/archive/refs/tags/v0.41.2.tar.gz";
      sha256 = "sha256-OQZJ0e06vD+YoThKQAEUuL4RYtd6p5p/bySLLXBEV4I=";
    };
  };
  nix-zsh-completions = {
  ...
  retroarch = {
    pname = "retroarch";
    version = "9e84c8923303303972d50fc974190ba7a53b9c53";
    src = fetchFromGitHub ({
      owner = "libretro";
      repo = "retroarch";
      rev = "9e84c8923303303972d50fc974190ba7a53b9c53";
      fetchSubmodules = false;
      sha256 = "sha256-typmXz90XYbahv0+yxzkSWYVGrXi6grNXjIr6vwAQBQ=";
    });
  };
  revanced-cli = {
    pname = "revanced-cli";
  ...
  revanced-integrations = {
    ...
    version = "0.64.0";
    src = fetchurl {
      url = "https://github.com/revanced/revanced-integrations/releases/download/v0.64.0/app-release-unsigned.apk";
      sha256 = "sha256-7Fr0dzc8KU67Lf0YVevM09muw6gYsXuPGP7VItkwLEA=";
    };
  };
  revanced-patches-jar = {
    ...
    version = "2.100.0";
    src = fetchurl {
      url = "https://github.com/revanced/revanced-patches/releases/download/v2.100.0/revanced-patches-2.100.0.jar";
      sha256 = "sha256-/d/svPCyQZ1P2hSOme+GqvZvOrZeuIA3hjkT+GGi2QE=";
    };
  };
  rofi-wayland = {
    pname = "rofi-wayland";
  ...
  rustdesk = {
    pname = "rustdesk";
    version = "0db60865c44c4f304efa9572a3426c535c8293be";
    src = fetchFromGitHub ({
      owner = "rustdesk";
      repo = "rustdesk";
      rev = "0db60865c44c4f304efa9572a3426c535c8293be";
      fetchSubmodules = false;
      sha256 = "sha256-ZAAeXFLCMNMQfiuNso2uPAyZ1ZiF+4a1wbTXeAcd0Eo=";
    });
    cargoLock."Cargo.lock" = {
      lockFile = ./rustdesk-0db60865c44c4f304efa9572a3426c535c8293be/Cargo.lock;
      outputHashes = {
  ...
  spicetify-marketplace = {
    ...
    version = "1967fa38d47843292be092455b2baafe1b782a1b";
    src = fetchFromGitHub ({
      owner = "spicetify";
      repo = "spicetify-marketplace";
      rev = "1967fa38d47843292be092455b2baafe1b782a1b";
      fetchSubmodules = false;
      sha256 = "sha256-vcFvuER47LR0kdqfy1iz5BdSStZvHsJWtOXlW0QvJAg=";
    });
  };
  spicetify-themes = {
  ...
  tailscale = {
    pname = "tailscale";
    version = "ea24895e084e09bbb9a8d84626d2c305668e02f5";
    src = fetchFromGitHub ({
      owner = "tailscale";
      repo = "tailscale";
      rev = "ea24895e084e09bbb9a8d84626d2c305668e02f5";
      fetchSubmodules = false;
      sha256 = "sha256-5j/Uy7Y4onbfTCOYy9SiDcPNonIcwKlSjhUd0YUwFd8=";
    });
  };
  tailscale-systray = {
  ...
  waydroid = {
    pname = "waydroid";
    version = "f5543df68651277042b156f19f5b3804c297f2a7";
    src = fetchFromGitHub ({
      owner = "waydroid";
      repo = "waydroid";
      rev = "f5543df68651277042b156f19f5b3804c297f2a7";
      fetchSubmodules = false;
      sha256 = "sha256-soIvD98tbtZV8z1Go81yRtrGlW1WpMtvFreyvGaRhRk=";
    });
  };
  wgcf = {
    pname = "wgcf";
