...
{ fetchgit, fetchurl, fetchFromGitHub }:
{
  ...
  bottles = {
    pname = "bottles";
    version = "998174de63e8be8e1b19db0e85f38c529232d3d6";
    src = fetchFromGitHub ({
      owner = "bottlesdevs";
      repo = "Bottles";
      rev = "998174de63e8be8e1b19db0e85f38c529232d3d6";
      fetchSubmodules = false;
      sha256 = "sha256-zcAlwmLRa0KDHgFKbc1Fe72itSsimc9KrPTZQ4WAC5M=";
    });
  };
  caddy = {
    pname = "caddy";
  ...
  caddy-git = {
    pname = "caddy-git";
    version = "660c59b6f3c138ce1a143ea864225ba177005e8e";
    src = fetchFromGitHub ({
      owner = "caddyserver";
      repo = "caddy";
      rev = "660c59b6f3c138ce1a143ea864225ba177005e8e";
      fetchSubmodules = false;
      sha256 = "sha256-OcUxL1B/v3kiDWLBi7rpZbWAfRRFnuwHxgmdrtIB0cc=";
    });
  };
  cinny = {
    pname = "cinny";
  ...
  flameshot = {
    pname = "flameshot";
    version = "f6355949ca63e8d631501dbb644e078b5a5f5985";
    src = fetchFromGitHub ({
      owner = "flameshot-org";
      repo = "flameshot";
      rev = "f6355949ca63e8d631501dbb644e078b5a5f5985";
      fetchSubmodules = false;
      sha256 = "sha256-cDqRWnDzo3W4dQGh8H0+4+xMdhG2A+xIurb497K66I8=";
    });
  };
  fluffychat = {
    pname = "fluffychat";
  ...
  jitsi-meet = {
    ...
    version = "1.0.6310";
    src = fetchurl {
      url = "https://download.jitsi.org/jitsi-meet/src/jitsi-meet-1.0.6310.tar.bz2";
      sha256 = "sha256-F8G7QCn+0eAdw4RKh+ijrctow6rktDaBhpnLMQufV5Y=";
    };
  };
  jitsi-meet-prosody = {
    ...
    version = "1.0.6310";
    src = fetchurl {
      url = "https://download.jitsi.org/unstable/jitsi-meet-prosody_1.0.6310-1_all.deb";
      sha256 = "sha256-467IAIUKWo8in6lMEOPZS76VdKKnkCwKb6QZqL8/hNQ=";
    };
  };
  jitsi-videobridge2 = {
    pname = "jitsi-videobridge2";
    version = "2.2-11-g20f6f30d";
    src = fetchurl {
      url = "https://download.jitsi.org/unstable/jitsi-videobridge2_2.2-11-g20f6f30d-1_all.deb";
      sha256 = "sha256-xAC7H5SceNEYS6F8H+A02qyXIv6zz7EFRhpk3IsaeTo=";
    };
  };
  layout-machi = {
    pname = "layout-machi";
  ...
  microsoft-edge-beta = {
    ...
    src = fetchurl {
      url = "https://packages.microsoft.com/repos/edge/pool/main/m/microsoft-edge-beta/microsoft-edge-beta_103.0.1264.45-1_amd64.deb";
      sha256 = "sha256-U7PzIXOF7m4xa5kWQasT5SM2alUQPxoeohU76zwqOY0=";
    };
  };
  microsoft-edge-dev = {
    ...
    src = fetchurl {
      url = "https://packages.microsoft.com/repos/edge/pool/main/m/microsoft-edge-dev/microsoft-edge-dev_104.0.1293.5-1_amd64.deb";
      sha256 = "sha256-gbb1Wn4h26d+HZw7CkI63gHm3idZx00PiZOr8W+TRog=";
    };
  };
  minecraft-wayland = {
  ...
  retroarch = {
    pname = "retroarch";
    version = "9dd1fb895b43b251e7a1488cb2cef5f433f864d9";
    src = fetchFromGitHub ({
      owner = "libretro";
      repo = "retroarch";
      rev = "9dd1fb895b43b251e7a1488cb2cef5f433f864d9";
      fetchSubmodules = false;
      sha256 = "sha256-l3PnjDSaiQLTtk/GQlnaahZAhS6wtzs0hzGbSu4S/fg=";
    });
  };
  revanced-cli = {
    pname = "revanced-cli";
  ...
  revanced-patches-dex = {
    ...
    version = "2.7.0";
    src = fetchurl {
      url = "https://github.com/revanced/revanced-patches/releases/download/v2.7.0/revanced-patches-2.7.0.dex";
      sha256 = "sha256-nJk90zE7idRyVhA6klVZJvqy8E2b5BCQczmyj1xv3rk=";
    };
  };
  revanced-patches-jar = {
    ...
    version = "2.7.0";
    src = fetchurl {
      url = "https://github.com/revanced/revanced-patches/releases/download/v2.7.0/revanced-patches-2.7.0.jar";
      sha256 = "sha256-V3p48sJyMPZMBXvmnyaCmcojw72TVLqoDifEk2jmMcY=";
    };
  };
  rofi-wayland = {
    pname = "rofi-wayland";
  ...
  snui = {
    pname = "snui";
    version = "04f64a1b8abbba7e5f0e5a6c03590344d2e49eab";
    src = fetchgit {
      url = "https://gitlab.com/snakedye/snui";
      rev = "04f64a1b8abbba7e5f0e5a6c03590344d2e49eab";
      fetchSubmodules = false;
      deepClone = false;
      leaveDotGit = false;
      sha256 = "sha256-n9ZN9akXtcJXjBVqVP6wrbT4Oi7pZedRQZy7EIYxQus=";
    };
  };
  spicetify-cli = {
    pname = "spicetify-cli";
    version = "6b992807504844e91d68d54e76561ee2cff3e66f";
    src = fetchFromGitHub ({
      owner = "khanhas";
      repo = "spicetify-cli";
      rev = "6b992807504844e91d68d54e76561ee2cff3e66f";
      fetchSubmodules = false;
      sha256 = "sha256-s1heA16xyqoq/WzbysuQYqbHqasShOEEZ+DvkMVa2lo=";
    });
  };
  spicetify-marketplace = {
    pname = "spicetify-marketplace";
    version = "a73b49d64362ac7ac6235b9cca8331e6d5c46c28";
    src = fetchFromGitHub ({
      owner = "spicetify";
      repo = "spicetify-marketplace";
      rev = "a73b49d64362ac7ac6235b9cca8331e6d5c46c28";
      fetchSubmodules = false;
      sha256 = "sha256-VVH9Sz3TBzQfay7dXBAWC1631oKB2+BZneTg4q1swps=";
    });
  };
  spicetify-themes = {
    pname = "spicetify-themes";
    version = "8410f0a997efd800481e59ac7da4cf2e6abecec9";
    src = fetchFromGitHub ({
      owner = "morpheusthewhite";
      repo = "spicetify-themes";
      rev = "8410f0a997efd800481e59ac7da4cf2e6abecec9";
      fetchSubmodules = false;
      sha256 = "sha256-wmnDzNOH56kunMFEDFtwjbX+2Boaw6V78wz94GzuW10=";
    });
  };
  spotify = {
    pname = "spotify";
  ...
  tailscale = {
    pname = "tailscale";
    version = "c93fd0d22bb464433f2dfd12386b24219d82e066";
    src = fetchFromGitHub ({
      owner = "tailscale";
      repo = "tailscale";
      rev = "c93fd0d22bb464433f2dfd12386b24219d82e066";
      fetchSubmodules = false;
      sha256 = "sha256-X32G2Ym34jFCnePYUHxd434PsTCWikbnnFEbvt2tmbU=";
    });
  };
  tailscale-systray = {
  ...
  whitesur-gtk-theme = {
    ...
    version = "c7cd8a8e54dacdc6bbb602c61c9c2ea45b52b4a0";
    src = fetchFromGitHub ({
      owner = "vinceliuice";
      repo = "whitesur-gtk-theme";
      rev = "c7cd8a8e54dacdc6bbb602c61c9c2ea45b52b4a0";
      fetchSubmodules = false;
      sha256 = "sha256-tMAATdyo+Qr2KK36nTjFcN6WUZJuercQu8jwBmFafwo=";
    });
  };
  whitesur-icon-theme = {
