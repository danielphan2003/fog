...
{ fetchgit, fetchurl, fetchFromGitHub }:
{
  ...
  asusctl = {
    pname = "asusctl";
    version = "067738b94f4547b1015e1327e9e35b12177df78d";
    src = fetchgit {
      url = "https://gitlab.com/asus-linux/asusctl";
      rev = "067738b94f4547b1015e1327e9e35b12177df78d";
      fetchSubmodules = false;
      deepClone = false;
      leaveDotGit = false;
    ...
    cargoLock."Cargo.lock" = {
      lockFile = ./asusctl-067738b94f4547b1015e1327e9e35b12177df78d/Cargo.lock;
      outputHashes = {
  ...
  fluffychat = {
    pname = "fluffychat";
    version = "17f8eda6e4ddf54b8856b94c85c2d00bd9e397ae";
    src = fetchgit {
      url = "https://gitlab.com/famedly/fluffychat";
      rev = "17f8eda6e4ddf54b8856b94c85c2d00bd9e397ae";
      fetchSubmodules = false;
      deepClone = false;
      leaveDotGit = false;
  ...
  retroarch = {
    pname = "retroarch";
    version = "2cbb7953d4e71e59fec89b00411b2826fa5b6f03";
    src = fetchFromGitHub ({
      owner = "libretro";
      repo = "retroarch";
      rev = "2cbb7953d4e71e59fec89b00411b2826fa5b6f03";
      fetchSubmodules = false;
      sha256 = "sha256-CRAuXc/gZXhgh+KlRsZ6CXGwKB4TnwcSgLEvv7j9wGM=";
    });
  };
  rofi-wayland = {
    pname = "rofi-wayland";
  ...
  rustdesk = {
    pname = "rustdesk";
    version = "90dda7b287d728a09af0bf0821be9ec48ea03c4c";
    src = fetchFromGitHub ({
      owner = "rustdesk";
      repo = "rustdesk";
      rev = "90dda7b287d728a09af0bf0821be9ec48ea03c4c";
      fetchSubmodules = false;
      sha256 = "sha256-NTrnayQboZ+MJb64xLzE6WsRM5Euh+YopBeBzza08D4=";
    });
    cargoLock."Cargo.lock" = {
      lockFile = ./rustdesk-90dda7b287d728a09af0bf0821be9ec48ea03c4c/Cargo.lock;
      outputHashes = {
        ...
        "rdev-0.5.0-2" = "sha256-W0Nwu8AhRNNVY4Dv221bqJ1+AxPHJMKxtA5gwK+d5mY=";
  ...
  spicetify-cli = {
    pname = "spicetify-cli";
    version = "b6776b7bc9dfdebc9363208c64422e517ab353e8";
    src = fetchFromGitHub ({
      owner = "spicetify";
      repo = "spicetify-cli";
      rev = "b6776b7bc9dfdebc9363208c64422e517ab353e8";
      fetchSubmodules = false;
      sha256 = "sha256-2BbIijM0fKyfUpzAU3tjz4N757dnPB0eGN7lvWKxO10=";
    });
  };
  ...
  ulauncher = {
    pname = "ulauncher";
    version = "d81879ea53bf856f472fce18c3e5c66c8d4d2e4b";
    src = fetchFromGitHub ({
      owner = "Ulauncher";
      repo = "Ulauncher";
      rev = "d81879ea53bf856f472fce18c3e5c66c8d4d2e4b";
      fetchSubmodules = false;
      sha256 = "sha256-NN40MYYh/ECECrGDNdakvmspuaj7iO876iSMkmcELCc=";
    });
  };
  uniemoji = {
    pname = "uniemoji";
