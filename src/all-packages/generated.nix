...
{ fetchgit, fetchurl, fetchFromGitHub }:
{
  ...
  hyprland = {
    pname = "hyprland";
    version = "d7ef19e2e745c2184fcf5c2ce6ac4208d6a81594";
    src = fetchFromGitHub ({
      owner = "hyprwm";
      repo = "hyprland";
      rev = "d7ef19e2e745c2184fcf5c2ce6ac4208d6a81594";
      fetchSubmodules = false;
      sha256 = "sha256-/ubu4NLIxQmKoD4al6L8qFE74FbFWmIrtjwwnyOYv0A=";
    });
  };
  ibus = {
    pname = "ibus";
  ...
  swhkd = {
    pname = "swhkd";
    version = "36281fed8fa866a2220d65be5a3c31734e62501f";
    src = fetchFromGitHub ({
      owner = "waycrate";
      repo = "swhkd";
      rev = "36281fed8fa866a2220d65be5a3c31734e62501f";
      fetchSubmodules = false;
      sha256 = "sha256-wQSwbJI3dKMe6uiz87qzATfWZQ3g3hWtraigmAkuZSM=";
    });
    cargoLock."Cargo.lock" = {
      lockFile = ./swhkd-36281fed8fa866a2220d65be5a3c31734e62501f/Cargo.lock;
      outputHashes = {
