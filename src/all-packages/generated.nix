...
{ fetchgit, fetchurl, fetchFromGitHub }:
{
  ...
  jitsi-meet = {
    ...
    version = "1.0.6727";
    src = fetchurl {
      url = "https://download.jitsi.org/jitsi-meet/src/jitsi-meet-1.0.6727.tar.bz2";
      sha256 = "sha256-/1Ezh+HM5LWYS3OTLLea0ZlISMGCcUSl9GdG2kaStlc=";
    };
  };
  jitsi-meet-prosody = {
    ...
    version = "1.0.6727";
    src = fetchurl {
      url = "https://download.jitsi.org/unstable/jitsi-meet-prosody_1.0.6727-1_all.deb";
      sha256 = "sha256-43f62FYlzHAZCLkZDh/xCPPrnhppU9NDhk+29dFPc1U=";
    };
  };
  jitsi-videobridge2 = {
  ...
  netdata-go-d-plugin = {
    ...
    version = "0.41.0";
    src = fetchurl {
      url = "https://github.com/netdata/go.d.plugin/archive/refs/tags/v0.41.0.tar.gz";
      sha256 = "sha256-ecMgGejLJxBBTpivHPJ8T13rlbv8t1L6rhgQNhEpygw=";
    };
  };
  nix-zsh-completions = {
  ...
  revanced-patches-jar = {
    ...
    version = "2.85.1";
    src = fetchurl {
      url = "https://github.com/revanced/revanced-patches/releases/download/v2.85.1/revanced-patches-2.85.1.jar";
      sha256 = "sha256-EOU4BSLsn95aDTx5Mo+t7fFR1o9FpTYKO7vhGS2Xck4=";
    };
  };
  rofi-wayland = {
    pname = "rofi-wayland";
  ...
  rustdesk = {
    pname = "rustdesk";
    version = "3a3f1a6bf60790cdc0d6d0a98db5b7fb1174f8d5";
    src = fetchFromGitHub ({
      owner = "rustdesk";
      repo = "rustdesk";
      rev = "3a3f1a6bf60790cdc0d6d0a98db5b7fb1174f8d5";
      fetchSubmodules = false;
      sha256 = "sha256-f1HeKXZasO9d01qSPIGvzGuz27bMD4fbxp8TEbg2ZWM=";
    });
    cargoLock."Cargo.lock" = {
      lockFile = ./rustdesk-3a3f1a6bf60790cdc0d6d0a98db5b7fb1174f8d5/Cargo.lock;
      outputHashes = {
  ...
  tailscale = {
    pname = "tailscale";
    version = "bd47e28638112f7368fe255dfa941bd185171ebe";
    src = fetchFromGitHub ({
      owner = "tailscale";
      repo = "tailscale";
      rev = "bd47e28638112f7368fe255dfa941bd185171ebe";
      fetchSubmodules = false;
      sha256 = "sha256-n9y0HqJu8FVvz7f/R6uMKYMPJrwTtAJFXjslCTB26ko=";
    });
  };
  tailscale-systray = {
