...
{ fetchgit, fetchurl, fetchFromGitHub }:
{
  ...
  asusctl = {
    pname = "asusctl";
    version = "ee0600d50d495ff3c6ba6ee5940931eec8750493";
    src = fetchgit {
      url = "https://gitlab.com/asus-linux/asusctl";
      rev = "ee0600d50d495ff3c6ba6ee5940931eec8750493";
      fetchSubmodules = false;
      deepClone = false;
      leaveDotGit = false;
      sha256 = "sha256-BnvDznZkZ00cz/frmTy6Wyl6zA1gtg2aI+T0MzxIu/o=";
    };
    cargoLock."Cargo.lock" = {
      lockFile = ./asusctl-ee0600d50d495ff3c6ba6ee5940931eec8750493/Cargo.lock;
      outputHashes = {
  ...
  bottles = {
    pname = "bottles";
    version = "061cd04e366bd507c380144b944e53493dffd80e";
    src = fetchFromGitHub ({
      owner = "bottlesdevs";
      repo = "Bottles";
      rev = "061cd04e366bd507c380144b944e53493dffd80e";
      fetchSubmodules = false;
      sha256 = "sha256-muNJERtDQ1foYsjSvrtquOSSeKeTyTdSG903y35RUEs=";
    });
  };
  caddy = {
    pname = "caddy";
  ...
  fluffychat = {
    pname = "fluffychat";
    version = "63abbf403a2da6d0648c4dc7899d2a37dbec900f";
    src = fetchgit {
      url = "https://gitlab.com/famedly/fluffychat";
      rev = "63abbf403a2da6d0648c4dc7899d2a37dbec900f";
      fetchSubmodules = false;
      deepClone = false;
      leaveDotGit = false;
      sha256 = "sha256-9sdicX8zii+WwDKpZBqoWAa2+dStCpt19AboUy23rM8=";
    };
  };
  flyingfox = {
    pname = "flyingfox";
  ...
  hyprland = {
    pname = "hyprland";
    version = "a33ecec61ef4c5749a17f52b15f0e0d0722b1f3d";
    src = fetchFromGitHub ({
      owner = "hyprwm";
      repo = "hyprland";
      rev = "a33ecec61ef4c5749a17f52b15f0e0d0722b1f3d";
      fetchSubmodules = false;
      sha256 = "sha256-b2496poVvWBylP8gUqeUDljs1zV+w8eslvhH0ic/P/0=";
    });
  };
  ibus = {
    pname = "ibus";
  ...
  retroarch = {
    pname = "retroarch";
    version = "43bee969b70a64ee583e9258748f1b833f8e00ea";
    src = fetchFromGitHub ({
      owner = "libretro";
      repo = "retroarch";
      rev = "43bee969b70a64ee583e9258748f1b833f8e00ea";
      fetchSubmodules = false;
      sha256 = "sha256-JuRIJqG4YzwvZhocv7M5oucMUJ2BqIDzopgEv+axQ+w=";
    });
  };
  rofi-wayland = {
    pname = "rofi-wayland";
  ...
  rustdesk = {
    pname = "rustdesk";
    version = "7359161e21a7f73cabdc2cd28168b5e6fc26a86c";
    src = fetchFromGitHub ({
      owner = "rustdesk";
      repo = "rustdesk";
      rev = "7359161e21a7f73cabdc2cd28168b5e6fc26a86c";
      fetchSubmodules = false;
      sha256 = "sha256-bYSilrgNlVSs/IxCvwLGIc3HQdErYyUzPld/8KBej0U=";
    });
    cargoLock."Cargo.lock" = {
      lockFile = ./rustdesk-7359161e21a7f73cabdc2cd28168b5e6fc26a86c/Cargo.lock;
      outputHashes = {
  ...
  waydroid = {
    pname = "waydroid";
    version = "54dbd9258fbd735f06758df4a08ef38d15b4d87d";
    src = fetchFromGitHub ({
      owner = "waydroid";
      repo = "waydroid";
      rev = "54dbd9258fbd735f06758df4a08ef38d15b4d87d";
      fetchSubmodules = false;
      sha256 = "sha256-/MenO7nHjHxs46ZuVFAGwUsVLbZstX0rEBoFT/Ox7sk=";
    });
  };
  wgcf = {
    pname = "wgcf";
