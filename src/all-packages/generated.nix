...
{ fetchgit, fetchurl, fetchFromGitHub }:
{
  ...
  asusctl = {
    pname = "asusctl";
    version = "aad31610f2e8ba82ce789648cb3f23a4a825d0d5";
    src = fetchgit {
      url = "https://gitlab.com/asus-linux/asusctl";
      rev = "aad31610f2e8ba82ce789648cb3f23a4a825d0d5";
      fetchSubmodules = false;
      deepClone = false;
      leaveDotGit = false;
      sha256 = "sha256-ms6xRxBQSaL6ni/LKvibOApxNAufwoVmYnofrQgzIBs=";
    };
    cargoLock."Cargo.lock" = {
      lockFile = ./asusctl-aad31610f2e8ba82ce789648cb3f23a4a825d0d5/Cargo.lock;
      outputHashes = {
  ...
  cinny = {
    pname = "cinny";
    version = "856e616247f8a84f978afa761a0f490c9ef22685";
    src = fetchFromGitHub ({
      owner = "cinnyapp";
      repo = "cinny";
      rev = "856e616247f8a84f978afa761a0f490c9ef22685";
      fetchSubmodules = false;
      sha256 = "sha256-UzCCWx3lsjKwE3uZBcPB+KYNYjIqTko/9rvy4J0mb0M=";
    });
  };
  cinny-bin = {
    pname = "cinny-bin";
  ...
  hyprland = {
    pname = "hyprland";
    version = "c545ab4993f3cb06d68a6637d0088efaf2d00a01";
    src = fetchFromGitHub ({
      owner = "hyprwm";
      repo = "hyprland";
      rev = "c545ab4993f3cb06d68a6637d0088efaf2d00a01";
      fetchSubmodules = false;
      sha256 = "sha256-zwWGa0sD3MUbVVz7acm0r/jQ18p1XevRBYVsj7+QcCY=";
    });
  };
  ibus = {
    pname = "ibus";
  ...
  jitsi-meet = {
    ...
    version = "1.0.6776";
    src = fetchurl {
      url = "https://download.jitsi.org/jitsi-meet/src/jitsi-meet-1.0.6776.tar.bz2";
      sha256 = "sha256-WOruaF+9d9EkKCMRwS/Hb5FQG8by6wCHagtjANEVI1o=";
    };
  };
  jitsi-meet-prosody = {
    ...
    version = "1.0.6776";
    src = fetchurl {
      url = "https://download.jitsi.org/unstable/jitsi-meet-prosody_1.0.6776-1_all.deb";
      sha256 = "sha256-rnU8MHGH6Wwd0td3kYzsUebOBab2BhynPN9mM0P/KQg=";
    };
  };
  jitsi-videobridge2 = {
  ...
  retroarch = {
    pname = "retroarch";
    version = "68401205f273e2e271dade59d2041d27208f825c";
    src = fetchFromGitHub ({
      owner = "libretro";
      repo = "retroarch";
      rev = "68401205f273e2e271dade59d2041d27208f825c";
      fetchSubmodules = false;
      sha256 = "sha256-Frbv8qte0/y5cNRCpHMqsWapHvyjuoZJF27gH4iJgPY=";
    });
  };
  revanced-cli = {
    pname = "revanced-cli";
  ...
  revanced-integrations = {
    ...
    version = "0.67.1";
    src = fetchurl {
      url = "https://github.com/revanced/revanced-integrations/releases/download/v0.67.1/app-release-unsigned.apk";
      sha256 = "sha256-44G2RqKNe6u9X/r2dkf/3NBIePWHcJbkRtKs/H07aQE=";
    };
  };
  revanced-patches-jar = {
    ...
    version = "2.104.1";
    src = fetchurl {
      url = "https://github.com/revanced/revanced-patches/releases/download/v2.104.1/revanced-patches-2.104.1.jar";
      sha256 = "sha256-iE4XXcsO/upxII2xzxBO3VVf2KXkNi4jA2ouDvu/938=";
    };
  };
  rofi-wayland = {
    pname = "rofi-wayland";
  ...
  rustdesk = {
    pname = "rustdesk";
    version = "a78e928f4ac0ba476378c4998c37de3f7fe2a041";
    src = fetchFromGitHub ({
      owner = "rustdesk";
      repo = "rustdesk";
      rev = "a78e928f4ac0ba476378c4998c37de3f7fe2a041";
      fetchSubmodules = false;
      sha256 = "sha256-AWIUQxUv3SfFayH1fx54Afrm6MYgKpCCbyYgVRDyObs=";
    });
    cargoLock."Cargo.lock" = {
      lockFile = ./rustdesk-a78e928f4ac0ba476378c4998c37de3f7fe2a041/Cargo.lock;
      outputHashes = {
  ...
  tailscale = {
    pname = "tailscale";
    version = "6d8320a6e903f8db41beb5e2c7c180855f7361e6";
    src = fetchFromGitHub ({
      owner = "tailscale";
      repo = "tailscale";
      rev = "6d8320a6e903f8db41beb5e2c7c180855f7361e6";
      fetchSubmodules = false;
      sha256 = "sha256-QM1dAI10C1/0Hk4ilALJJcGItJXaT8VDyMxZo9138jk=";
    });
  };
  tailscale-systray = {
