...
{ fetchgit, fetchurl, fetchFromGitHub, dockerTools }:
{
  ...
  hyprland = {
    pname = "hyprland";
    version = "8440aa3e9b2682261cf9608e553761ec4cf21654";
    src = fetchFromGitHub ({
      owner = "hyprwm";
      repo = "hyprland";
      rev = "8440aa3e9b2682261cf9608e553761ec4cf21654";
      fetchSubmodules = false;
      sha256 = "sha256-/0PzbIcX4QZVFinjIhaxKGzXyP4sO+7fyAgmCjI1Ipg=";
    });
    date = "2023-01-12";
  };
  ibus = {
  ...
  jitsi-meet = {
    ...
    version = "1.0.6911";
    src = fetchurl {
      url = "https://download.jitsi.org/jitsi-meet/src/jitsi-meet-1.0.6911.tar.bz2";
      sha256 = "sha256-mign2vfsU8Du/3Pkn8jeaKMJxAvT28cOy+qHxyaTjfg=";
    };
  };
  jitsi-meet-prosody = {
    ...
    version = "1.0.6911";
    src = fetchurl {
      url = "https://download.jitsi.org/unstable/jitsi-meet-prosody_1.0.6911-1_all.deb";
      sha256 = "sha256-srwVmivRBt4i6qOsPmu1S9zwQL3yx39jumPeMw5qHZk=";
    };
  };
  jitsi-videobridge2 = {
  ...
  picom = {
    pname = "picom";
    version = "e20a02e67a6f3bd0b994a5236ab318caecc7df92";
    src = fetchFromGitHub ({
      owner = "yshui";
      repo = "picom";
      rev = "e20a02e67a6f3bd0b994a5236ab318caecc7df92";
      fetchSubmodules = false;
      sha256 = "sha256-7VaoVb9T833zmXJQqvo8QoD7TKNmvOAy8RXH2bd1Rk0=";
    });
    date = "2023-01-12";
  };
  playit-agent = {
  ...
  rustdesk = {
    pname = "rustdesk";
    version = "570f1f482ca476bbd0edb33ddf998a1c046dd1b1";
    src = fetchFromGitHub ({
      owner = "rustdesk";
      repo = "rustdesk";
      rev = "570f1f482ca476bbd0edb33ddf998a1c046dd1b1";
      fetchSubmodules = false;
      sha256 = "sha256-JZsBRSWhxAsOLu48nvTdPSxpl32xk2ug5uvUGIhCRtM=";
    });
    cargoLock."Cargo.lock" = {
      lockFile = ./rustdesk-570f1f482ca476bbd0edb33ddf998a1c046dd1b1/Cargo.lock;
      outputHashes = {
  ...
  tailscale = {
    pname = "tailscale";
    version = "2ac5474be197e83cdfb5e3162b70b9ced861ed7f";
    src = fetchFromGitHub ({
      owner = "tailscale";
      repo = "tailscale";
      rev = "2ac5474be197e83cdfb5e3162b70b9ced861ed7f";
      fetchSubmodules = false;
      sha256 = "sha256-UJV3HDLG+0hL//DEFBBi+ptI3eKZZc+Qk8jhk4VXm5Q=";
    });
    date = "2023-01-11";
  };
  tailscale-systray = {
