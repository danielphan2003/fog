...
{ fetchgit, fetchurl, fetchFromGitHub }:
{
  ...
  hyprland = {
    pname = "hyprland";
    version = "5a96142cf844939c560b554be914aa4fd40822a0";
    src = fetchFromGitHub ({
      owner = "hyprwm";
      repo = "hyprland";
      rev = "5a96142cf844939c560b554be914aa4fd40822a0";
      fetchSubmodules = false;
      sha256 = "sha256-I5xv0T76Xpmch6NkrJVgXFQ7wAqC2BTrCuVik6JNfT4=";
    });
  };
  ibus = {
    pname = "ibus";
  ...
  retroarch = {
    pname = "retroarch";
    version = "c240340c91f5af9fdabfd9b0da9e1f1e499426bc";
    src = fetchFromGitHub ({
      owner = "libretro";
      repo = "retroarch";
      rev = "c240340c91f5af9fdabfd9b0da9e1f1e499426bc";
      fetchSubmodules = false;
      sha256 = "sha256-VJPHS5kkbEcCoGUV/Y7dxrID/pORazs7gO8nSoIV9vc=";
    });
  };
  revanced-cli = {
    pname = "revanced-cli";
    version = "2.8.3";
    src = fetchurl {
      url = "https://github.com/revanced/revanced-cli/releases/download/v2.8.3/revanced-cli-2.8.3-all.jar";
      sha256 = "sha256-H0sC5CX8SeafFfgku9js0eA6JbbZl/eMfVIIpeI4T70=";
    };
  };
  ...
  tailscale = {
    pname = "tailscale";
    version = "adc5ffea99200efac02541c57ac70bff010c8029";
    src = fetchFromGitHub ({
      owner = "tailscale";
      repo = "tailscale";
      rev = "adc5ffea99200efac02541c57ac70bff010c8029";
      fetchSubmodules = false;
      sha256 = "sha256-SMSkkRzGJ4XlyQVsIVLVBR3uvsTESgSoIFiFPhSR6pM=";
    });
  };
  tailscale-systray = {
