...
{ fetchgit, fetchurl, fetchFromGitHub }:
{
  ...
  asusctl = {
    pname = "asusctl";
    version = "5c0ad3e59021ef07e21bc821ac6ff3e28af37b11";
    src = fetchgit {
      url = "https://gitlab.com/asus-linux/asusctl";
      rev = "5c0ad3e59021ef07e21bc821ac6ff3e28af37b11";
      fetchSubmodules = false;
      deepClone = false;
      leaveDotGit = false;
      sha256 = "sha256-Yc6f7asu7yXrHIqrwsHJkKd6Mqkc71bXDdyjblapK7U=";
    };
    cargoLock."Cargo.lock" = {
      lockFile = ./asusctl-5c0ad3e59021ef07e21bc821ac6ff3e28af37b11/Cargo.lock;
      outputHashes = {
  ...
  hyprland = {
    pname = "hyprland";
    version = "84a0fa0f34ccc82c1bbb961bac0dbe81c82e999c";
    src = fetchFromGitHub ({
      owner = "vaxerski";
      repo = "hyprland";
      rev = "84a0fa0f34ccc82c1bbb961bac0dbe81c82e999c";
      fetchSubmodules = false;
      sha256 = "sha256-hWmeHWR7RJanGJYgz2rJk0O3cArQVUGFetDxQOQIJNU=";
    });
  };
  ibus = {
    pname = "ibus";
  ...
  jitsi-meet-prosody = {
    ...
    version = "1.0.6219";
    src = fetchurl {
      url = "https://download.jitsi.org/unstable/jitsi-meet-prosody_1.0.6219-1_all.deb";
      sha256 = "sha256-2db11dWmK8Up0FdiHxx8SbE7ie/Ca1ZmDwyecpfDAH4=";
    };
  };
  jitsi-videobridge2 = {
  ...
  rustdesk = {
    pname = "rustdesk";
    version = "897d5c8cc910fcb9252f372a52618dabc8aa5588";
    src = fetchFromGitHub ({
      owner = "rustdesk";
      repo = "rustdesk";
      rev = "897d5c8cc910fcb9252f372a52618dabc8aa5588";
      fetchSubmodules = false;
      sha256 = "sha256-lcUuLlg8TkSOQybiNVhHdHvjKrIBRw+tMASfD9Fs5Sg=";
    });
    cargoLock."Cargo.lock" = {
      lockFile = ./rustdesk-897d5c8cc910fcb9252f372a52618dabc8aa5588/Cargo.lock;
      outputHashes = {
  ...
  tailscale = {
    pname = "tailscale";
    version = "0df3b76c251c8f1c963f1c414b1eedbefe49018d";
    src = fetchFromGitHub ({
      owner = "tailscale";
      repo = "tailscale";
      rev = "0df3b76c251c8f1c963f1c414b1eedbefe49018d";
      fetchSubmodules = false;
      sha256 = "sha256-9Xj5qTKojArBiIDubYaA8FozUpTNYU3YMn4wruSNxZU=";
    });
  };
  tailscale-systray = {
