...
{ fetchgit, fetchurl, fetchFromGitHub, dockerTools }:
{
  ...
  hyprland = {
    pname = "hyprland";
    version = "b5b436e01ddb5d5200f55be3deed8f4fade0574c";
    src = fetchFromGitHub ({
      owner = "hyprwm";
      repo = "hyprland";
      rev = "b5b436e01ddb5d5200f55be3deed8f4fade0574c";
      fetchSubmodules = false;
      sha256 = "sha256-mgJd3fKzUcO96IcaNpM9WJY60N+2oATp5AqgWFwm3c8=";
    });
    date = "2023-01-14";
  };
  ibus = {
  ...
  tailscale = {
    pname = "tailscale";
    version = "358262869176bfddf369517994ac0337712f75e0";
    src = fetchFromGitHub ({
      owner = "tailscale";
      repo = "tailscale";
      rev = "358262869176bfddf369517994ac0337712f75e0";
      fetchSubmodules = false;
      sha256 = "sha256-HnB+UouRkSJ66UZ48dIA7qxNdT5yPFR9fyCObrng3XY=";
    });
    date = "2023-01-14";
  };
  tailscale-systray = {
