...
{ fetchgit, fetchurl, fetchFromGitHub }:
{
  ...
  fx_cast = {
    pname = "fx_cast";
    version = "314a1d2031ac517c90aabcff9cb02f30bb51e314";
    src = fetchFromGitHub ({
      owner = "hensm";
      repo = "fx_cast";
      rev = "314a1d2031ac517c90aabcff9cb02f30bb51e314";
      fetchSubmodules = false;
      sha256 = "sha256-rLld+FC2ZCmRorIsYd9OiSGZn6wmjzYlpWVAotaiDu8=";
    });
  };
  godu = {
    pname = "godu";
  ...
  hyprland = {
    pname = "hyprland";
    version = "8581e7178961ebe3a6c25f49583d13f9ee6ee22a";
    src = fetchFromGitHub ({
      owner = "hyprwm";
      repo = "hyprland";
      rev = "8581e7178961ebe3a6c25f49583d13f9ee6ee22a";
      fetchSubmodules = false;
      sha256 = "sha256-uKYBa8+xcYtPV+XFs9dltQP1sP1QFIJKQcD/io3h5Pc=";
    });
  };
  ibus = {
    pname = "ibus";
  ...
  jitsi-meet = {
    ...
    version = "1.0.6521";
    src = fetchurl {
      url = "https://download.jitsi.org/jitsi-meet/src/jitsi-meet-1.0.6521.tar.bz2";
      sha256 = "sha256-kuqSIQC8kxJkunuG3XdgfKlPnJzZ84hOIWw5D+7Plzc=";
    };
  };
  jitsi-meet-prosody = {
    ...
    version = "1.0.6521";
    src = fetchurl {
      url = "https://download.jitsi.org/unstable/jitsi-meet-prosody_1.0.6521-1_all.deb";
      sha256 = "sha256-pq6v9Ulfnn2qPzEZdVrWiY4cGr2HE/FD3RlwnHmOnV4=";
    };
  };
  jitsi-videobridge2 = {
  ...
  retroarch = {
    pname = "retroarch";
    version = "60030e373e955e9a4cc86ad0186e35a14477a6f8";
    src = fetchFromGitHub ({
      owner = "libretro";
      repo = "retroarch";
      rev = "60030e373e955e9a4cc86ad0186e35a14477a6f8";
      fetchSubmodules = false;
      sha256 = "sha256-KY8bw1VATI7BmXX0+q46dxZMLYjkGvZ6olFdEx/INb8=";
    });
  };
  revanced-cli = {
    pname = "revanced-cli";
  ...
  tailscale = {
    ...
    src = fetchFromGitHub ({
      owner = "tailscale";
      repo = "tailscale";
      rev = "cfbbcf6d071dd13addbc1b38ef993a08d557ba22";
      fetchSubmodules = false;
