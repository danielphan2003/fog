...
{ fetchgit, fetchurl, fetchFromGitHub }:
{
  ...
  caddy-git = {
    pname = "caddy-git";
    version = "5e52bbb1369b7444700427539e4dd532ed13ac6d";
    src = fetchFromGitHub ({
      owner = "caddyserver";
      repo = "caddy";
      rev = "5e52bbb1369b7444700427539e4dd532ed13ac6d";
      fetchSubmodules = false;
      sha256 = "sha256-yLwkugRZ1LuxpUa5yHuFqdZS06a7OU/Z183LzOQUk80=";
    });
  };
  cinny = {
    pname = "cinny";
  ...
  hyprland = {
    pname = "hyprland";
    version = "2d73da1a79fc32bca62da6e9b79b8525ec42fa9c";
    src = fetchFromGitHub ({
      owner = "hyprwm";
      repo = "hyprland";
      rev = "2d73da1a79fc32bca62da6e9b79b8525ec42fa9c";
      fetchSubmodules = false;
      sha256 = "sha256-yaEcXMzpn5oL5Tq0fE2KT0XwbsejroYMK48YBhsJ6vA=";
    });
  };
  ibus = {
    pname = "ibus";
  ...
  jitsi-meet = {
    ...
    version = "1.0.6629";
    src = fetchurl {
      url = "https://download.jitsi.org/jitsi-meet/src/jitsi-meet-1.0.6629.tar.bz2";
      sha256 = "sha256-K8aDZNnrCNX3xSuATr5j83/Pu0KXjqiqq5oXd1haPFQ=";
    };
  };
  jitsi-meet-prosody = {
    ...
    version = "1.0.6629";
    src = fetchurl {
      url = "https://download.jitsi.org/unstable/jitsi-meet-prosody_1.0.6629-1_all.deb";
      sha256 = "sha256-UEe+ys00qMJmxjbydU/A6dMpbSsTwtzRR82pXZs2BeA=";
    };
  };
  jitsi-videobridge2 = {
  ...
  retroarch = {
    pname = "retroarch";
    version = "9586d679a8b143fbe1880dff7454fd0809262b55";
    src = fetchFromGitHub ({
      owner = "libretro";
      repo = "retroarch";
      rev = "9586d679a8b143fbe1880dff7454fd0809262b55";
      fetchSubmodules = false;
  ...
  snui = {
    pname = "snui";
    version = "fe2d4ea097074350e5d58dabc76d6088bf7ed1d5";
    src = fetchgit {
      url = "https://gitlab.com/snakedye/snui";
      rev = "fe2d4ea097074350e5d58dabc76d6088bf7ed1d5";
      fetchSubmodules = false;
      deepClone = false;
      leaveDotGit = false;
      sha256 = "sha256-X22xq0kGj72IjFpyDFC7TWQxDFlQQ/TGRucUaMt3yak=";
    };
  };
  spicetify-cli = {
    pname = "spicetify-cli";
  ...
  spicetify-marketplace = {
    ...
    version = "4b85409df40a07ca9f1e27784c6615161f7bdc91";
    src = fetchFromGitHub ({
      owner = "spicetify";
      repo = "spicetify-marketplace";
      rev = "4b85409df40a07ca9f1e27784c6615161f7bdc91";
      fetchSubmodules = false;
      sha256 = "sha256-rQr6tYhGmFpZW0gwB4S6GV971Kh/jGEIIzDTxhOX/FQ=";
    });
  };
  spicetify-themes = {
  ...
  tailscale = {
    pname = "tailscale";
    version = "d4811f11a0fd504abcaf984458825eb13958ed4c";
    src = fetchFromGitHub ({
      owner = "tailscale";
      repo = "tailscale";
      rev = "d4811f11a0fd504abcaf984458825eb13958ed4c";
      fetchSubmodules = false;
      sha256 = "sha256-sCVMuQGduCeW+8MrdH50A4G2aMOw8axwTyOIFmr7EAM=";
    });
  };
  tailscale-systray = {
