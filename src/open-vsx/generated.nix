...
{ fetchgit, fetchurl, fetchFromGitHub }:
{
  ...
  Slint-slint-nightly = {
    ...
    version = "2022.9.1720";
    src = fetchurl {
      url = "https://open-vsx.org/api/Slint/slint-nightly/2022.9.1720/file/Slint.slint-nightly-2022.9.1720.vsix";
      sha256 = "sha256-ek+CDfqXMuN557K6zo7w68H02SETtgrkhYwCUrY+3PM=";
    };
    license = "GPL-3.0";
    name = "slint-nightly";
