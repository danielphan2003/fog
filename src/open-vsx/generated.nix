...
{ fetchgit, fetchurl, fetchFromGitHub }:
{
  ...
  Prisma-prisma-insider = {
    ...
    version = "31.0.1027";
    src = fetchurl {
      url = "https://open-vsx.org/api/Prisma/prisma-insider/31.0.1027/file/Prisma.prisma-insider-31.0.1027.vsix";
      sha256 = "sha256-s36WSE48/5M72npYZ56ZT6r3RdXhvZDLkgXuLd12G2s=";
    };
    license = "Apache-2.0";
    name = "prisma-insider";
