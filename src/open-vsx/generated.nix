...
{ fetchgit, fetchurl, fetchFromGitHub }:
{
  ...
  GitLab-gitlab-workflow = {
    ...
    version = "3.45.0";
    src = fetchurl {
      url = "https://open-vsx.org/api/GitLab/gitlab-workflow/3.45.0/file/GitLab.gitlab-workflow-3.45.0.vsix";
      sha256 = "sha256-NCQu/gXY7/ZAczWNYPSp2ucpH8iJBD7Xyt01zLcRzM8=";
    };
    license = "MIT";
