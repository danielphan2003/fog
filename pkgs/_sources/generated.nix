...
{ fetchgit, fetchurl, fetchFromGitHub }:
{
  ...
  dnscrypt-proxy2 = {
    ...
    version = "27e93a53cf5aa6ddfbd9b01f825d3127dd34499a";
    src = fetchFromGitHub ({
      owner = "DNSCrypt";
      repo = "dnscrypt-proxy";
      rev = "27e93a53cf5aa6ddfbd9b01f825d3127dd34499a";
      fetchSubmodules = false;
      sha256 = "sha256-GXpyc+DVLZq/CEx/Jn2Bsc2bDMGXPLi1VZn3sTF+iz4=";
    });
  };
  doggo = {
    pname = "doggo";
  ...
  jitsi-meet = {
    ...
    version = "1.0.5677";
    src = fetchurl {
      url = "https://download.jitsi.org/jitsi-meet/src/jitsi-meet-1.0.5677.tar.bz2";
      sha256 = "sha256-Ga/O5QcXEfh1Irsa2uKpIrhM3rcWXDX7UHb75gMzGWE=";
    };
  };
  jitsi-meet-prosody = {
    ...
    version = "1.0.5677";
    src = fetchurl {
      url = "https://download.jitsi.org/unstable/jitsi-meet-prosody_1.0.5677-1_all.deb";
      sha256 = "sha256-jOyLxL1fW2ruc4U29GXRYuvQoPNfh/Url4s8vm7HksQ=";
    };
  };
  jitsi-videobridge2 = {
  ...
  retroarch = {
    pname = "retroarch";
    version = "62528a483ffd2a588909c4aabe50f207335f8b7f";
    src = fetchFromGitHub ({
      owner = "libretro";
      repo = "retroarch";
      rev = "62528a483ffd2a588909c4aabe50f207335f8b7f";
      fetchSubmodules = false;
      sha256 = "sha256-csuIQ4lz+/yqxpieWbf+JcgWtt+CPYqPpgffwU2Q0Yg=";
    });
  };
  rofi-wayland = {
    pname = "rofi-wayland";
    version = "a2a1c89df846eabeb8e2e7ad7c7beb6d23e11d86";
    src = fetchFromGitHub ({
      owner = "lbonn";
      repo = "rofi";
  ...
  spicetify-cli = {
    pname = "spicetify-cli";
    version = "81294fdf6cd89a4b9fb6bd82c3ff22b0168bf5d9";
    src = fetchFromGitHub ({
      owner = "khanhas";
      repo = "spicetify-cli";
      rev = "81294fdf6cd89a4b9fb6bd82c3ff22b0168bf5d9";
      fetchSubmodules = false;
      sha256 = "sha256-CQSDwzWP11UXjC0AN0gnMZSFcaTGd0y/8DLTS5xbmb0=";
    });
  };
  spicetify-themes = {
  ...
  tailscale = {
    pname = "tailscale";
    version = "cced414c7dd5ac4f9df1d5851feb2d4c74764c31";
    src = fetchFromGitHub ({
      owner = "tailscale";
      repo = "tailscale";
      rev = "cced414c7dd5ac4f9df1d5851feb2d4c74764c31";
      fetchSubmodules = false;
      sha256 = "sha256-wWIMbvuqTeh9vb7D+3b8pitOypcvi24uLiykRD9mz4g=";
    });
  };
  tailscale-systray = {
  ...
  vscode-extensions-Material-theme = {
    ...
    version = "3.13.6";
    src = fetchurl {
      url = "https://open-vsx.org/api/zhuangtongfa/material-theme/3.13.6/file/zhuangtongfa.material-theme-3.13.6.vsix";
      sha256 = "sha256-pygDSBfG6NmejEmnaiz+NyaMAVIJ/lq0TGZ6SXU8g80=";
    };
