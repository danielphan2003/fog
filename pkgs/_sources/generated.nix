...
{ fetchgit, fetchurl, fetchFromGitHub }:
{
  ...
  ouch = {
    pname = "ouch";
    version = "272b3069ea2578f6a66056c7f5e733bdeb4f1146";
    src = fetchFromGitHub ({
      owner = "ouch-org";
      repo = "ouch";
      rev = "272b3069ea2578f6a66056c7f5e733bdeb4f1146";
      fetchSubmodules = false;
      sha256 = "sha256-DjZEPbJaR7PrzRfVlvrAl/EOyKwEZ78HqCgtsOsgqFw=";
    });
    cargoLock = {
      lockFile = ./ouch-272b3069ea2578f6a66056c7f5e733bdeb4f1146/Cargo.lock;
      outputHashes = { };
    };
  };
  paper = {
  ...
  papermc = {
    ...
    version = "357";
    src = fetchurl {
      url = "https://papermc.io/api/v2/projects/paper/versions/1.17.1/builds/357/downloads/paper-1.17.1-357.jar";
      sha256 = "sha256-hqZoHdxhn9K+iTL1maXIm989/4PBrrT0VHsoCPImegg=";
    };
  };
  picom = {
    pname = "picom";
