...
{ fetchgit, fetchurl, fetchFromGitHub }:
{
  ...
  awesome = {
    pname = "awesome";
    version = "f353499230b1d3efffe0c190902ce2cf43fa1bd0";
    src = fetchFromGitHub ({
      owner = "awesomeWM";
      repo = "awesome";
      rev = "f353499230b1d3efffe0c190902ce2cf43fa1bd0";
      fetchSubmodules = false;
      sha256 = "sha256-KBWbdbuj6TNB7eob55GBcytoGAf9Shqcy3JuZe417n8=";
    });
  };
  awestore = {
    pname = "awestore";
  ...
  papermc-1_18_1 = {
    ...
    version = "85";
    src = fetchurl {
      url = "https://papermc.io/api/v2/projects/paper/versions/1.18.1/builds/85/downloads/paper-1.18.1-85.jar";
      sha256 = "sha256-yeDpXlEF1wQ8FnvENwG/1B2FxnHOHRxYRDQg/CxRn/U=";
    };
    mcVer = "1.18.1";
  };
  papermc-1_8_8 = {
  ...
  retroarch = {
    pname = "retroarch";
    version = "9da43ad34ecbf5bae1111fac76fc56c0117ee8fa";
    src = fetchFromGitHub ({
      owner = "libretro";
      repo = "retroarch";
      rev = "9da43ad34ecbf5bae1111fac76fc56c0117ee8fa";
      fetchSubmodules = false;
      sha256 = "sha256-HnBgZdjAZPDIEA37IhrFiJdztwAtlIps1jX9UpAdbQ0=";
    });
  };
  rofi-wayland = {
    pname = "rofi-wayland";
