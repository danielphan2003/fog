...
{ fetchgit, fetchurl, fetchFromGitHub }:
{
  ...
  arkenfox-userjs = {
    ...
    version = "6027aaa45ddaf3072d7675364a58bea9bb08440a";
    src = fetchFromGitHub ({
      owner = "arkenfox";
      repo = "user.js";
      rev = "6027aaa45ddaf3072d7675364a58bea9bb08440a";
      fetchSubmodules = false;
      sha256 = "sha256-pMGIfSY7GBew3hM1HYYq1t1/OBHEuqHU+2mZ3OBVL4Y=";
    });
  };
  avizo = {
    pname = "avizo";
  ...
  jitsi-meet = {
    ...
    version = "1.0.5585";
    src = fetchurl {
      url = "https://download.jitsi.org/jitsi-meet/src/jitsi-meet-1.0.5585.tar.bz2";
      sha256 = "sha256-MH7L6ELzduRdyHhm0Ssb60b9l02WpUg+RylG5+N4YPY=";
    };
  };
  jitsi-meet-prosody = {
    ...
    version = "1.0.5585";
    src = fetchurl {
      url = "https://download.jitsi.org/unstable/jitsi-meet-prosody_1.0.5585-1_all.deb";
      sha256 = "sha256-CMV4STrctrRNWcSgIzcmEkyuyzKPSjjuSw1eETz4GhU=";
    };
  };
  jitsi-videobridge2 = {
