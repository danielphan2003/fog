...
{ fetchgit, fetchurl }:
{
  ...
  papermc = {
    ...
    version = "280";
    src = fetchurl {
      url = "https://papermc.io/api/v2/projects/paper/versions/1.17.1/builds/280/downloads/paper-1.17.1-280.jar";
      sha256 = "1z3q5i3l595nxnjvy6qj4jcppiz039x80nbkla6i8d0k13kykysz";
    };
  };
  picom = {
    pname = "picom";
