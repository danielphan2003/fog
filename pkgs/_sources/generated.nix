...
{ fetchgit, fetchurl, fetchFromGitHub }:
{
  ...
  arkenfox-userjs = {
    ...
    src = fetchFromGitHub ({
      ...
      fetchSubmodules = false;
      sha256 = "sha256-/ITf8nv/IWR1sKBchPtdkPjZO5OFH9p6FgVbDfBrJc8=";
    });
  };
  avizo = {
    pname = "avizo";
  ...
  bottles = {
    ...
    src = fetchFromGitHub ({
      ...
      fetchSubmodules = false;
      sha256 = "sha256-EEnH4AezqWzPbI0ywrYhzsaJ9rSC9sCcL4IdYOWIuCY=";
    });
  };
  caddy = {
    pname = "caddy";
  ...
  dribbblish-dynamic-theme = {
    ...
    version = "2f825e5eb9caf58623ba5c525994f8718e3da223";
    src = fetchFromGitHub ({
      owner = "JulienMaille";
      repo = "dribbblish-dynamic-theme";
      rev = "2f825e5eb9caf58623ba5c525994f8718e3da223";
      fetchSubmodules = false;
      sha256 = "sha256-S9dThpCdszLkUzDUf+dMGZsa/vp7/PF21j2ATWzaerI=";
    });
  };
  droidcam = {
    pname = "droidcam";
  ...
  eww = {
    pname = "eww";
    version = "08eef05ae8534d47845c50ae5e1c237c3fe18bf1";
    src = fetchFromGitHub ({
      owner = "elkowar";
      repo = "eww";
      rev = "08eef05ae8534d47845c50ae5e1c237c3fe18bf1";
      fetchSubmodules = false;
      sha256 = "sha256-SmX7tJqSfRl6Dp4moPPKu1WaTr6fr9ITt9xS6vayO+0=";
    });
    cargoLock = {
      lockFile = ./eww-08eef05ae8534d47845c50ae5e1c237c3fe18bf1/Cargo.lock;
      outputHashes = { };
    };
  };
  ...
  papermc = {
    ...
    version = "351";
    src = fetchurl {
      url = "https://papermc.io/api/v2/projects/paper/versions/1.17.1/builds/351/downloads/paper-1.17.1-351.jar";
      sha256 = "sha256-vyJ1+71y2ru1UxLZ2DgRm2RDE2iw/ZSNY04lCQmUQ2o=";
    };
  };
  picom = {
    pname = "picom";
    ...
    src = fetchFromGitHub ({
      ...
      fetchSubmodules = false;
      sha256 = "sha256-eiejNH8HP/QkRkMq9NCgAWZBjHUCYEDre1iJ53/QQRs=";
    });
  };
  plymouth-themes = {
  ...
  spicetify-cli = {
    pname = "spicetify-cli";
    version = "27301dc9b983f466f28d90d711f15d8fe2a8ad71";
    src = fetchFromGitHub ({
      owner = "khanhas";
      repo = "spicetify-cli";
      rev = "27301dc9b983f466f28d90d711f15d8fe2a8ad71";
      fetchSubmodules = false;
      sha256 = "sha256-a3/borQt5Bzw2kuER27VdlLUNi33AzRb2d6iTfkg8xk=";
    });
  };
  spicetify-themes = {
    ...
    src = fetchFromGitHub ({
      ...
      fetchSubmodules = false;
      sha256 = "sha256-Oy98Fh03jqGITNCPA7z60+oy4M6HT7jBYySWqI6G7Ps=";
    });
  };
  spotify = {
    pname = "spotify";
