...
{ fetchgit, fetchurl, fetchFromGitHub }:
{
  ...
  bottles = {
    pname = "bottles";
    version = "fcdbdaf4a747a08822c2eaad0fe0748135ec97bf";
    src = fetchFromGitHub ({
      owner = "bottlesdevs";
      repo = "Bottles";
      rev = "fcdbdaf4a747a08822c2eaad0fe0748135ec97bf";
      fetchSubmodules = false;
      sha256 = "sha256-cMVm9KSoJ9kTlq1XYT0Q1TadPil+3aNsXHDgigI03g4=";
    });
  };
  caddy = {
    pname = "caddy";
  ...
  tailscale = {
    pname = "tailscale";
    version = "e4d2ef2b67310608cbd8f7335f0a2b24f85c735a";
    src = fetchFromGitHub ({
      owner = "tailscale";
      repo = "tailscale";
      rev = "e4d2ef2b67310608cbd8f7335f0a2b24f85c735a";
      fetchSubmodules = false;
      sha256 = "sha256-OYw7Z9i12IABn/tZqy/Tq+ZWL/KYmDWCyVFHtXqgCXk=";
    });
  };
  teams = {
    pname = "teams";
