...
{ fetchgit, fetchurl }:
{
  ...
  dribbblish-dynamic-theme = {
    ...
    version = "db1ad17ffaa47c33acb2be3bc3577b57207b918e";
    src = fetchgit {
      url = "https://github.com/JulienMaille/dribbblish-dynamic-theme";
      rev = "db1ad17ffaa47c33acb2be3bc3577b57207b918e";
      fetchSubmodules = false;
      deepClone = false;
      leaveDotGit = false;
      sha256 = "1pv8c2r588bb14hxg9q8qg5qkl2vpj9ykdlwcp724ajb83q6vsz5";
    };
  };
  droidcam = {
    pname = "droidcam";
  ...
  ouch = {
    pname = "ouch";
    version = "a8beaaae84e2f3093111ffec7c4c0acf289ce15c";
    src = fetchgit {
      url = "https://github.com/ouch-org/ouch";
      rev = "a8beaaae84e2f3093111ffec7c4c0acf289ce15c";
      fetchSubmodules = false;
      deepClone = false;
      leaveDotGit = false;
      sha256 = "02qa1f6i84msv48lc0k71angdvk7yc04ar7z05z731fjzsp832lj";
    };
    cargoLock = {
      lockFile = ./ouch-a8beaaae84e2f3093111ffec7c4c0acf289ce15c/Cargo.lock;
      outputHashes = { };
    };
  };
  paper = {
  ...
  papermc = {
    ...
    version = "308";
    src = fetchurl {
      url = "https://papermc.io/api/v2/projects/paper/versions/1.17.1/builds/308/downloads/paper-1.17.1-308.jar";
      sha256 = "0rvl994p1gq3niqb5jdnlb0sbq2b6nzn47m7dyx3nmdmn5cral4j";
    };
  };
  picom = {
    pname = "picom";
  ...
  retroarch = {
    pname = "retroarch";
    version = "55bf2b0083fd6795c9774761356c8f1374b49928";
    src = fetchgit {
      url = "https://github.com/libretro/retroarch";
      rev = "55bf2b0083fd6795c9774761356c8f1374b49928";
      fetchSubmodules = false;
      deepClone = false;
      leaveDotGit = false;
      sha256 = "0ix0s2mj36fs72pg81y6nxpx0m05va4r0zlbxzjqyk7c3g70hzml";
    };
  };
  rofi-wayland = {
    pname = "rofi-wayland";
  ...
  tailscale = {
    pname = "tailscale";
    version = "0410f1a35a32dc3f09d8bc7d67a6845291a0d8b5";
    src = fetchgit {
      url = "https://github.com/tailscale/tailscale";
      rev = "0410f1a35a32dc3f09d8bc7d67a6845291a0d8b5";
      fetchSubmodules = false;
      deepClone = false;
      leaveDotGit = false;
      sha256 = "12nx9l91klq4hc5ij76fc09gvk4hmcfdzdmnrha1h8lfb5lbawhn";
    };
  };
  teams = {
    pname = "teams";
