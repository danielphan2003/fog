...
{ fetchgit, fetchurl, fetchFromGitHub }:
{
  ...
  caddy = {
    pname = "caddy";
    version = "f55b123d63132e290789bcd07077375c76b6e1dd";
    src = fetchFromGitHub ({
      owner = "caddyserver";
      repo = "caddy";
      rev = "f55b123d63132e290789bcd07077375c76b6e1dd";
      fetchSubmodules = false;
      sha256 = "sha256-7f0L8/dlX5ujDpualJJpRgr7XxeXr6sSD+1ayFLwQmo=";
    });
  };
  cups-pdf = {
    pname = "cups-pdf";
  ...
  tailscale = {
    pname = "tailscale";
    version = "f8cef1ba082ee461f5622cf614e73f32f2223914";
    src = fetchFromGitHub ({
      owner = "tailscale";
      repo = "tailscale";
      rev = "f8cef1ba082ee461f5622cf614e73f32f2223914";
      fetchSubmodules = false;
      sha256 = "sha256-GY8iYM5raY+SPDqw+3nRvdBnDdf8UlfRUcsP53d7Bew=";
    });
  };
  tailscale-systray = {
