...
{ fetchgit, fetchurl, fetchFromGitHub }:
{
  ...
  arkenfox-userjs = {
    ...
    version = "cbfb8abf1544c3e87f412f64a9747bd1dea4a705";
    src = fetchFromGitHub ({
      owner = "arkenfox";
      repo = "user.js";
      rev = "cbfb8abf1544c3e87f412f64a9747bd1dea4a705";
      fetchSubmodules = false;
      sha256 = "sha256-RvG+GRh8Md1yrTzFniu1G2UpTnOb7KCGDfQmFvdtl58=";
    });
  };
  avizo = {
    pname = "avizo";
  ...
  caddy = {
    pname = "caddy";
    version = "bcac2beee7e419f8cdab2ed16f388d1af282a46b";
    src = fetchFromGitHub ({
      owner = "caddyserver";
      repo = "caddy";
      rev = "bcac2beee7e419f8cdab2ed16f388d1af282a46b";
      fetchSubmodules = false;
      sha256 = "sha256-FyFnxRLQa2+OvsAwtGIMBvME6kdJedsNI+4qwgaef2k=";
    });
  };
  cups-pdf = {
    pname = "cups-pdf";
  ...
  dribbblish-dynamic-theme = {
    ...
    version = "328cf2a59a2cc3424a246274fcd67b8b8f90b746";
    src = fetchFromGitHub ({
      owner = "JulienMaille";
      repo = "dribbblish-dynamic-theme";
      rev = "328cf2a59a2cc3424a246274fcd67b8b8f90b746";
      fetchSubmodules = false;
      sha256 = "sha256-KfG/w4boxamTFH8ae+jF4Q6iOHAlnA1omiIbt64LyQo=";
    });
  };
  droidcam = {
    pname = "droidcam";
