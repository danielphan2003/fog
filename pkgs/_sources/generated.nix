...
{ fetchgit, fetchurl, fetchFromGitHub }:
{
  ...
  bottles = {
    pname = "bottles";
    version = "d3299a096446607a75f7b5de960b6c4ab1f653fe";
    src = fetchFromGitHub ({
      owner = "bottlesdevs";
      repo = "Bottles";
      rev = "d3299a096446607a75f7b5de960b6c4ab1f653fe";
      fetchSubmodules = false;
      sha256 = "sha256-QywNNwC7/yX5hQP/2Liz8djMoFYYR1Zcn96/lCcKO0I=";
    });
  };
  caddy = {
    pname = "caddy";
  ...
  guiscrcpy = {
    pname = "guiscrcpy";
    version = "7087cddf032e0b77ca5b61133b34b3a18fa1a701";
    src = fetchFromGitHub ({
      owner = "srevinsaju";
      repo = "guiscrcpy";
      rev = "7087cddf032e0b77ca5b61133b34b3a18fa1a701";
      fetchSubmodules = false;
      sha256 = "sha256-Iv8+5UsAlzRchbDOFjZkUGlWfoLmg2DE7DBSVM0BiFg=";
    });
  };
  ibus = {
    pname = "ibus";
  ...
  jitsi-meet = {
    ...
    version = "1.0.5707";
    src = fetchurl {
      url = "https://download.jitsi.org/jitsi-meet/src/jitsi-meet-1.0.5707.tar.bz2";
      sha256 = "sha256-azM6q1+Y+apaHaqiHZ4kLV3V5/GO4cBDPi0BsZfArso=";
    };
  };
  jitsi-meet-prosody = {
    ...
    version = "1.0.5707";
    src = fetchurl {
      url = "https://download.jitsi.org/unstable/jitsi-meet-prosody_1.0.5707-1_all.deb";
      sha256 = "sha256-Kj30pCJPYLJ8e6j8Rw867y6rKidyr1ntsJM2dVMP99A=";
    };
  };
  jitsi-videobridge2 = {
  ...
  rustdesk = {
    pname = "rustdesk";
    version = "07ea52d6204fb47586c65411d55b688caa3bc929";
    src = fetchFromGitHub ({
      owner = "rustdesk";
      repo = "rustdesk";
      rev = "07ea52d6204fb47586c65411d55b688caa3bc929";
      fetchSubmodules = false;
      sha256 = "sha256-+m47LAg0wADA0giyyyvdeCs2xm5ULVsPQYZLXhX+lYM=";
    });
    cargoLock = {
      lockFile = ./rustdesk-07ea52d6204fb47586c65411d55b688caa3bc929/Cargo.lock;
      outputHashes = {
