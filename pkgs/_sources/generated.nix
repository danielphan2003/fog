...
{ fetchgit, fetchurl, fetchFromGitHub }:
{
  ...
  awesome = {
    pname = "awesome";
    version = "ebc9b99ae2817ddd95b5b9b2238881fcd5c777e0";
    src = fetchFromGitHub ({
      owner = "awesomeWM";
      repo = "awesome";
      rev = "ebc9b99ae2817ddd95b5b9b2238881fcd5c777e0";
      fetchSubmodules = false;
      sha256 = "sha256-Uqqf1KL9EsdM2zqJDpZacUElOypJ8B3zapuWQM9SJ3M=";
    });
  };
  awestore = {
    pname = "awestore";
  ...
  bottles = {
    pname = "bottles";
    version = "fc7e25e8b62238f341c6cb6007572bbfa5d2ed7e";
    src = fetchFromGitHub ({
      owner = "bottlesdevs";
      repo = "Bottles";
      rev = "fc7e25e8b62238f341c6cb6007572bbfa5d2ed7e";
      fetchSubmodules = false;
      sha256 = "sha256-WQzy7aGS5xecq2c2v42G23oc5MYZ3FthzKMrlfpgAwU=";
    });
  };
  caddy = {
    pname = "caddy";
  ...
  dribbblish-dynamic-theme = {
    ...
    version = "611907a2d60ef34a2a516bbbd383945ebb8b6b25";
    src = fetchFromGitHub ({
      owner = "JulienMaille";
      repo = "dribbblish-dynamic-theme";
      rev = "611907a2d60ef34a2a516bbbd383945ebb8b6b25";
      fetchSubmodules = false;
      sha256 = "sha256-QCacMyjNST3kf730dxXlhFo/1s8OleZKFm6EpZHA3IU=";
    });
  };
  droidcam = {
    pname = "droidcam";
  ...
  tailscale = {
    pname = "tailscale";
    version = "cf8fcc1254a4736570bf2d9db8e0e81df8f53c9a";
    src = fetchFromGitHub ({
      owner = "tailscale";
      repo = "tailscale";
      rev = "cf8fcc1254a4736570bf2d9db8e0e81df8f53c9a";
      fetchSubmodules = false;
      sha256 = "sha256-eD3LdZ0h2hpO7yhHvZFJDiz88SdLM6viiu7oISxUH90=";
    });
  };
  teams = {
    pname = "teams";
