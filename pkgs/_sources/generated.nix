...
{ fetchgit, fetchurl, fetchFromGitHub }:
{
  ...
  arkenfox-userjs = {
    ...
    version = "15158974496806e8ee9564d0b36fe0cbbb0f869f";
    src = fetchFromGitHub ({
      owner = "arkenfox";
      repo = "user.js";
      rev = "15158974496806e8ee9564d0b36fe0cbbb0f869f";
      fetchSubmodules = false;
      sha256 = "sha256-zeYJrFenEmFZVFBx+4yLSasmdnGptPxExHQHygXFMpI=";
    });
  };
  avizo = {
    pname = "avizo";
  ...
  dribbblish-dynamic-theme = {
    ...
    version = "23b83c2fdfb07a3b6cbcd9d4eb4251890b799b8f";
    src = fetchFromGitHub ({
      owner = "JulienMaille";
      repo = "dribbblish-dynamic-theme";
      rev = "23b83c2fdfb07a3b6cbcd9d4eb4251890b799b8f";
      fetchSubmodules = false;
      sha256 = "sha256-hmf/Lb1N6zYbmhvKvtVW2baiD8CTX1sW6zhF1jNSDgE=";
    });
  };
  droidcam = {
    pname = "droidcam";
  ...
  microsoft-edge-beta = {
    ...
    src = fetchurl {
      ...
      sha256 = "sha256-OSg+elf7TB09JaHpkbVSLk+HpuEg3QmYKKlNf+cREV8=";
    };
  };
  microsoft-edge-dev = {
  ...
  ouch = {
    pname = "ouch";
    version = "a1c4f0373f77c19f5f8c3c98d5e9dd04b13ec23b";
    src = fetchFromGitHub ({
      owner = "ouch-org";
      repo = "ouch";
      rev = "a1c4f0373f77c19f5f8c3c98d5e9dd04b13ec23b";
      fetchSubmodules = false;
      sha256 = "sha256-+U6wabNamIrtiU0Ul6dq9ux6WM1Mzo3H8CPRxNpmPbM=";
    });
    cargoLock = {
      lockFile = ./ouch-a1c4f0373f77c19f5f8c3c98d5e9dd04b13ec23b/Cargo.lock;
      outputHashes = { };
    };
  };
  paper = {
  ...
  tailscale = {
    pname = "tailscale";
    version = "c467ed0b628baec6b7cfdb166d2bee724745cc54";
    src = fetchFromGitHub ({
      owner = "tailscale";
      repo = "tailscale";
      rev = "c467ed0b628baec6b7cfdb166d2bee724745cc54";
      fetchSubmodules = false;
      sha256 = "sha256-E6WvMJZx9zvrJkm+B5WKH4JA6YZOJbzWQofctW8O6Hs=";
    });
  };
  tailscale-systray = {
  ...
  whitesur-gtk-theme = {
    ...
    version = "ce402c0b1b8c2cad876037c06b8553d2c6b5af6d";
    src = fetchFromGitHub ({
      owner = "vinceliuice";
      repo = "whitesur-gtk-theme";
      rev = "ce402c0b1b8c2cad876037c06b8553d2c6b5af6d";
      fetchSubmodules = false;
      sha256 = "sha256-DoZKPXEVDOxbZJqgXbgsEvJkV55qIYUIyK1cx3q/fKg=";
    });
  };
  whitesur-icon-theme = {
    pname = "whitesur-icon-theme";
    version = "c629b76575dc6d670e732a71caacef7cd95bb967";
    src = fetchFromGitHub ({
      owner = "vinceliuice";
      repo = "whitesur-icon-theme";
      rev = "c629b76575dc6d670e732a71caacef7cd95bb967";
      fetchSubmodules = false;
      sha256 = "sha256-uQJGe5b/vzDhUSBE1vWAGCVsszrCWCV5Nf6REALEOJM=";
    });
  };
  widevine-cdm = {
    pname = "widevine-cdm";
