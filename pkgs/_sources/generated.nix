...
{ fetchgit, fetchurl, fetchFromGitHub }:
{
  ...
  arkenfox-userjs = {
    ...
    version = "460951df9e54a24540181a74379a12aaffa7798e";
    src = fetchFromGitHub ({
      owner = "arkenfox";
      repo = "user.js";
      rev = "460951df9e54a24540181a74379a12aaffa7798e";
      fetchSubmodules = false;
      sha256 = "sha256-PzKr03VnctIWbRjFnpZdYS3709eMttnv6DY5Dw1Az+Q=";
    });
  };
  avizo = {
    pname = "avizo";
  ...
  bottles = {
    pname = "bottles";
    version = "ca16e4b096dc5be35211a5601028615c5d5738b9";
    src = fetchFromGitHub ({
      owner = "bottlesdevs";
      repo = "Bottles";
      rev = "ca16e4b096dc5be35211a5601028615c5d5738b9";
      fetchSubmodules = false;
      sha256 = "sha256-pUrt4760dHSMAtmBa0eunToVyVLO3a4yeLVixJjD2mg=";
    });
  };
  caddy = {
    pname = "caddy";
