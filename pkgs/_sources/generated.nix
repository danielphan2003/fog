...
{ fetchgit, fetchurl }:
{
  ...
  papermc = {
    ...
    version = "346";
    src = fetchurl {
      url = "https://papermc.io/api/v2/projects/paper/versions/1.17.1/builds/346/downloads/paper-1.17.1-346.jar";
      sha256 = "1jmjsn1924ds8h1sq5i22cy8f3jn95rz3qysr5kx42rynpwgr01n";
    };
  };
  picom = {
    pname = "picom";
