...
{ fetchgit, fetchurl }:
{
  ...
  flameshot = {
    pname = "flameshot";
    version = "0b777c4558dfc4fa01004f4423c6462a453dc010";
    src = fetchgit {
      url = "https://github.com/flameshot-org/flameshot";
      rev = "0b777c4558dfc4fa01004f4423c6462a453dc010";
      fetchSubmodules = false;
      deepClone = false;
      leaveDotGit = false;
      sha256 = "0z8rdaw48c1m8i70l1jdz9fzmgjff76zskzclycrylxwhn8glbxs";
    };
  };
  flyingfox = {
    pname = "flyingfox";
  ...
  ouch = {
    pname = "ouch";
    version = "b804e820f2a61d6934b2f6e93662eedbebf4f002";
    src = fetchgit {
      url = "https://github.com/ouch-org/ouch";
      rev = "b804e820f2a61d6934b2f6e93662eedbebf4f002";
      fetchSubmodules = false;
      deepClone = false;
      leaveDotGit = false;
      sha256 = "1p4nm0r1aj07rhzxg5dpxwyx5yax364ki3vm06ny75793mqp37fi";
    };
    cargoLock = {
      lockFile = ./ouch-b804e820f2a61d6934b2f6e93662eedbebf4f002/Cargo.lock;
      outputHashes = { };
    };
  };
  paper = {
  ...
  tailscale = {
    pname = "tailscale";
    version = "2d11503cffcc025f3474dbd622aebe307fe7b258";
    src = fetchgit {
      url = "https://github.com/tailscale/tailscale";
      rev = "2d11503cffcc025f3474dbd622aebe307fe7b258";
      fetchSubmodules = false;
      deepClone = false;
      leaveDotGit = false;
      sha256 = "1w06l1s4d38ik6j9a5zbccvnxzqb2g1w45f7j00as93d9rxvcvkl";
    };
  };
  teams = {
    pname = "teams";
