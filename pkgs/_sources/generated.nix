...
{ fetchgit, fetchurl }:
{
  ...
  papermc = {
    ...
    version = "268";
    src = fetchurl {
      url = "https://papermc.io/api/v2/projects/paper/versions/1.17.1/builds/268/downloads/paper-1.17.1-268.jar";
      sha256 = "0q0030nkhsda4nssqg768qbi58wd3bszz1anfx2r45b0arrcbikk";
    };
  };
  picom = {
    pname = "picom";
  ...
  tailscale = {
    pname = "tailscale";
    version = "478775de6ab6ffb3a511d3630d40cff1f96dd072";
    src = fetchgit {
      url = "https://github.com/tailscale/tailscale";
      rev = "478775de6ab6ffb3a511d3630d40cff1f96dd072";
      fetchSubmodules = false;
      deepClone = false;
      leaveDotGit = false;
      sha256 = "1v7csx98rvyhc1x963akr7jl98l9ma0z3s5rxn2p4wqppsfqzi7g";
    };
  };
  teams = {
    pname = "teams";
