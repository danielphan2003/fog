...
{ fetchgit, fetchurl, fetchFromGitHub }:
{
  ...
  papermc-1_18_1 = {
    ...
    version = "108";
    src = fetchurl {
      url = "https://papermc.io/api/v2/projects/paper/versions/1.18.1/builds/108/downloads/paper-1.18.1-108.jar";
      sha256 = "sha256-aFvHYpPG9bw1Lj9auL+tkbN0SwoBMcxpoV+cePlpRTI=";
    };
    mcVer = "1.18.1";
  };
  papermc-1_8_8 = {
  ...
  rustdesk = {
    pname = "rustdesk";
    version = "8be7331cb62ddc75b405ddf4d5610a20db972434";
    src = fetchFromGitHub ({
      owner = "rustdesk";
      repo = "rustdesk";
      rev = "8be7331cb62ddc75b405ddf4d5610a20db972434";
      fetchSubmodules = false;
      sha256 = "sha256-BZLOejEjM3a3j4PxjBCdKgGJHuhzABuqWBN25aZqd6c=";
    });
    cargoLock = {
      lockFile = ./rustdesk-8be7331cb62ddc75b405ddf4d5610a20db972434/Cargo.lock;
      outputHashes = {
  ...
  tailscale = {
    pname = "tailscale";
    version = "63d9c7b9b3a838e4e88cc3c3a8ec59169e4badd5";
    src = fetchFromGitHub ({
      owner = "tailscale";
      repo = "tailscale";
      rev = "63d9c7b9b3a838e4e88cc3c3a8ec59169e4badd5";
      fetchSubmodules = false;
      sha256 = "sha256-LRI5GqTnfwGsrB9McQuDDlUDk/ddK3QZLpT3qj4EOqQ=";
    });
  };
  tailscale-systray = {
