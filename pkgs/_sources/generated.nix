...
{ fetchgit, fetchurl, fetchFromGitHub }:
{
  ...
  bottles = {
    pname = "bottles";
    version = "0ee81309669eecba4cc710aa88a3eef927695d87";
    src = fetchFromGitHub ({
      owner = "bottlesdevs";
      repo = "Bottles";
      rev = "0ee81309669eecba4cc710aa88a3eef927695d87";
      fetchSubmodules = false;
      sha256 = "sha256-MiQmXE3Ul9avBja4BN45OKYjBRqppMdUtrtq8vDaaHc=";
    });
  };
  caddy = {
    pname = "caddy";
  ...
  jitsi-meet = {
    ...
    version = "1.0.5638";
    src = fetchurl {
      url = "https://download.jitsi.org/jitsi-meet/src/jitsi-meet-1.0.5638.tar.bz2";
      sha256 = "sha256-hs/B96dKkPhvhTbuleXuvL7wDr4VV/8LIQAQFImSUNk=";
    };
  };
  jitsi-meet-prosody = {
    ...
    version = "1.0.5638";
    src = fetchurl {
      url = "https://download.jitsi.org/unstable/jitsi-meet-prosody_1.0.5638-1_all.deb";
      sha256 = "sha256-59viR49pMlVd4lnRtaL8qxserc5Bh6ljCx5vNhiJlMQ=";
    };
  };
  jitsi-videobridge2 = {
  ...
  papermc = {
    ...
    src = fetchurl {
      ...
      sha256 = "sha256-RIjCofwXtldZ1rAYCOAg31NMK6drTE2q2SqQ3XJCJng=";
    };
  };
  picom = {
    pname = "picom";
  ...
  retroarch = {
    pname = "retroarch";
    version = "9b7270cb6af3971de0a2f9e69f632f598dc46b2f";
    src = fetchFromGitHub ({
      owner = "libretro";
      repo = "retroarch";
      rev = "9b7270cb6af3971de0a2f9e69f632f598dc46b2f";
      fetchSubmodules = false;
      sha256 = "sha256-IINeAgjNqzHYRvQbIwN6HsOG7j5eg06FgIa3E5Q9cSk=";
    });
  };
  rofi-wayland = {
    pname = "rofi-wayland";
  ...
  snui = {
    pname = "snui";
    version = "ec0866d95e37d7d4685d247251582014108d21b8";
    src = fetchgit {
      url = "https://gitlab.com/snakedye/snui";
      rev = "ec0866d95e37d7d4685d247251582014108d21b8";
      fetchSubmodules = false;
      deepClone = false;
      leaveDotGit = false;
      sha256 = "sha256-5G6o+4UXpQDIkKju77NG35z+19dhRq6cDtM2+yP7Rkc=";
    };
  };
  spicetify-cli = {
    pname = "spicetify-cli";
  ...
  tailscale = {
    pname = "tailscale";
    version = "0a9932f3b2ac8000e0b82939becdbde9ad3631a9";
    src = fetchFromGitHub ({
      owner = "tailscale";
      repo = "tailscale";
      rev = "0a9932f3b2ac8000e0b82939becdbde9ad3631a9";
      fetchSubmodules = false;
      sha256 = "sha256-awvB+CwOgL7SAyuWzc/tnOoNRAq5u/QVZJJNpMlmI/s=";
    });
  };
  tailscale-systray = {
  ...
  ulauncher = {
    pname = "ulauncher";
    version = "41948e133c701939d7c71b6468b2c052a9da461c";
    src = fetchFromGitHub ({
      owner = "Ulauncher";
      repo = "Ulauncher";
      rev = "41948e133c701939d7c71b6468b2c052a9da461c";
      fetchSubmodules = false;
      sha256 = "sha256-LOtWVmqLtMexZwOSJWFoaTDIvt/tk/oVoxvKatsElnE=";
    });
  };
  ultimmc = {
    pname = "ultimmc";
  ...
  whitesur-gtk-theme = {
    ...
    version = "d4ebdbbf2f67feecfc6775b00965e2a4f798563f";
    src = fetchFromGitHub ({
      owner = "vinceliuice";
      repo = "whitesur-gtk-theme";
      rev = "d4ebdbbf2f67feecfc6775b00965e2a4f798563f";
      fetchSubmodules = false;
      sha256 = "sha256-Kq1Px95ABCUytAg4CJe81c2+2GkYoXzYXvnOtKVg5eg=";
    });
  };
  whitesur-icon-theme = {
  ...
  xdg-desktop-portal = {
    ...
    version = "580a62fb595be380b501f19f66be17f5bcbb48cc";
    src = fetchFromGitHub ({
      owner = "flatpak";
      repo = "xdg-desktop-portal";
      rev = "580a62fb595be380b501f19f66be17f5bcbb48cc";
      fetchSubmodules = false;
      sha256 = "sha256-hf66hQrhGsfliAkEt5zn+xZmKrPXIwZ59hiT+skguKk=";
    });
  };
  ...
  xwayland = {
    pname = "xwayland";
    version = "04c93b98e9e4593aa2e6701bb08f5e27c3544d8a";
    src = fetchgit {
      url = "git://anongit.freedesktop.org/xorg/xserver";
      rev = "04c93b98e9e4593aa2e6701bb08f5e27c3544d8a";
      fetchSubmodules = false;
      deepClone = false;
      leaveDotGit = false;
      sha256 = "sha256-euzy2NTXVpDJizvC641QcVMMxa9dyTSvPgq06oGCD04=";
    };
  };
  ydotool = {
    pname = "ydotool";
