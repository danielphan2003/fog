...
{ fetchgit, fetchurl, fetchFromGitHub }:
{
  ...
  dribbblish-dynamic-theme = {
    ...
    version = "5e0236dff562d5dd47443ea256bda1129b23ff06";
    src = fetchFromGitHub ({
      owner = "JulienMaille";
      repo = "dribbblish-dynamic-theme";
      rev = "5e0236dff562d5dd47443ea256bda1129b23ff06";
      fetchSubmodules = false;
      sha256 = "sha256-YUiAyEsikA2vfwl5JfyHfCiUC9SntA41dQ/98IQyIPM=";
    });
  };
  droidcam = {
    pname = "droidcam";
  ...
  pmbootstrap-test = {
    ...
    version = "f30b1cc3f28a2bf538f8d045c8163060d120c2c1";
    src = fetchgit {
      url = "https://gitlab.com/postmarketOS/pmbootstrap";
      rev = "f30b1cc3f28a2bf538f8d045c8163060d120c2c1";
      fetchSubmodules = false;
      deepClone = false;
      leaveDotGit = false;
      sha256 = "sha256-T5xHZjn6SPRjhJJq0u8Xm3lI+/A88yNh4gtBVvo0kuw=";
    };
  };
  pure = {
    pname = "pure";
  ...
  retroarch = {
    pname = "retroarch";
    version = "019466e92887f589b6c1f66540b2285739e333c2";
    src = fetchFromGitHub ({
      owner = "libretro";
      repo = "retroarch";
      rev = "019466e92887f589b6c1f66540b2285739e333c2";
      fetchSubmodules = false;
      sha256 = "sha256-ol8AZ+o0ljHQs5Zs+QFkpT7+Iy28C0AcxW6jACqAm0A=";
    });
  };
  rofi-wayland = {
    pname = "rofi-wayland";
