...
{ fetchgit, fetchurl, fetchFromGitHub }:
{
  ...
  jitsi-meet = {
    ...
    version = "1.0.5634";
    src = fetchurl {
      url = "https://download.jitsi.org/jitsi-meet/src/jitsi-meet-1.0.5634.tar.bz2";
      sha256 = "sha256-221pehg5Dwm753PTeIMpDDTOsIuiQ/6CUor+UOd8HJ8=";
    };
  };
  jitsi-meet-prosody = {
    ...
    version = "1.0.5634";
    src = fetchurl {
      url = "https://download.jitsi.org/unstable/jitsi-meet-prosody_1.0.5634-1_all.deb";
      sha256 = "sha256-qECHxZhfLBwWJKIVSDE9k8zAv40wP+gha8UaR1HzFwg=";
    };
  };
  jitsi-videobridge2 = {
  ...
  snui = {
    pname = "snui";
    version = "1b18791cf4d0a5d037f0e68459a11a94c12805c2";
    src = fetchgit {
      url = "https://gitlab.com/snakedye/snui";
      rev = "1b18791cf4d0a5d037f0e68459a11a94c12805c2";
      fetchSubmodules = false;
      deepClone = false;
      leaveDotGit = false;
      sha256 = "sha256-SdA1WsbksaAJYFRUqcodKvEqUDkBP9k4NMYFJ0fn8H0=";
    };
  };
  spicetify-cli = {
    pname = "spicetify-cli";
  ...
  tailscale = {
    pname = "tailscale";
    version = "03a323de4e4c37790c0988bc73266646b54c109f";
    src = fetchFromGitHub ({
      owner = "tailscale";
      repo = "tailscale";
      rev = "03a323de4e4c37790c0988bc73266646b54c109f";
      fetchSubmodules = false;
      sha256 = "sha256-xbAssSC9nsFAV9xE1RomPqStwU6tD14WwEu7Enm1skc=";
    });
  };
  tailscale-systray = {
