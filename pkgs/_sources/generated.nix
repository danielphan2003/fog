...
{ fetchgit, fetchurl }:
{
  ...
  bottles = {
    pname = "bottles";
    version = "f6151a5d15d6df23a2fa7d2efc0468cd6addabd1";
    src = fetchgit {
      url = "https://github.com/bottlesdevs/Bottles";
      rev = "f6151a5d15d6df23a2fa7d2efc0468cd6addabd1";
      fetchSubmodules = false;
      deepClone = false;
      leaveDotGit = false;
      sha256 = "0hvwc0znrkdrf809ayx0rslm5kkmsld8ggws109wiq8h3rbciy6j";
    };
  };
  caddy = {
    pname = "caddy";
  ...
  dribbblish-dynamic-theme = {
    ...
    version = "cf2327d2717a272e6a747921fba695a6dcb0a7e4";
    src = fetchgit {
      url = "https://github.com/JulienMaille/dribbblish-dynamic-theme";
      rev = "cf2327d2717a272e6a747921fba695a6dcb0a7e4";
      fetchSubmodules = false;
      deepClone = false;
      leaveDotGit = false;
      sha256 = "0pndxsv4adjl6rsfnjcbkpkcsvkq39nxr70nd3qimp9b0f0n84ar";
    };
  };
  droidcam = {
    pname = "droidcam";
  ...
  papermc = {
    ...
    version = "321";
    src = fetchurl {
      url = "https://papermc.io/api/v2/projects/paper/versions/1.17.1/builds/321/downloads/paper-1.17.1-321.jar";
      sha256 = "0ayzipb1rk08qjqjf3dg34lby4w9whdqzmqddry0125xd3zayr64";
    };
  };
  picom = {
    pname = "picom";
  ...
  tailscale = {
    pname = "tailscale";
    version = "e5dddb2b9928a83f7bd6e400c1d35cdf281b7b03";
    src = fetchgit {
      url = "https://github.com/tailscale/tailscale";
      rev = "e5dddb2b9928a83f7bd6e400c1d35cdf281b7b03";
      fetchSubmodules = false;
      deepClone = false;
      leaveDotGit = false;
      sha256 = "1hncdh1lkkx1a5dgs32mfxgawhyyixkxhcf91dq0l8rdl2nnzw7m";
    };
  };
  teams = {
    pname = "teams";
