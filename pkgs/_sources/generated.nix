...
{ fetchgit, fetchurl }:
{
  ...
  dribbblish-dynamic-theme = {
    ...
    version = "5957564db16ea6b6bbdfdf72d7410b8f6252f594";
    src = fetchgit {
      url = "https://github.com/JulienMaille/dribbblish-dynamic-theme";
      rev = "5957564db16ea6b6bbdfdf72d7410b8f6252f594";
      fetchSubmodules = false;
      deepClone = false;
      leaveDotGit = false;
      sha256 = "04z06pnnfhpjn08ik1icl8l930b1wmy4hcbvm6m432zqjmrla5gv";
    };
  };
  droidcam = {
    pname = "droidcam";
  ...
  papermc = {
    ...
    version = "324";
    src = fetchurl {
      url = "https://papermc.io/api/v2/projects/paper/versions/1.17.1/builds/324/downloads/paper-1.17.1-324.jar";
      sha256 = "0masnd1svhi61qpwszjx1zg1qlyk6szs6cfx8sp8kfn01iy0m89p";
    };
  };
  picom = {
    pname = "picom";
  ...
  spicetify-themes = {
    ...
    version = "e4ba9389e40e1533dcbdea662d8da80b41246cdc";
    src = fetchgit {
      url = "https://github.com/morpheusthewhite/spicetify-themes";
      rev = "e4ba9389e40e1533dcbdea662d8da80b41246cdc";
      fetchSubmodules = false;
      deepClone = false;
      leaveDotGit = false;
      sha256 = "0skwf64slcjcvdmps1aja9z378ywn391k1qzzj69af87m5dvxa9z";
    };
  };
  spotify = {
    pname = "spotify";
  ...
  tailscale = {
    pname = "tailscale";
    version = "d883747d8b701d1ca3db60f05d22e153caa17714";
    src = fetchgit {
      url = "https://github.com/tailscale/tailscale";
      rev = "d883747d8b701d1ca3db60f05d22e153caa17714";
      fetchSubmodules = false;
      deepClone = false;
      leaveDotGit = false;
      sha256 = "1qkki7iw34fc8gx8jgikwlpb7yv8djzfvi357q5dwd2ipf810n86";
    };
  };
  teams = {
    pname = "teams";
