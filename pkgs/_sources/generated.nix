...
{ fetchgit, fetchurl, fetchFromGitHub }:
{
  ...
  bottles = {
    pname = "bottles";
    version = "44e9107d283c624ae19f9d368b1b7a38a77b962b";
    src = fetchFromGitHub ({
      owner = "bottlesdevs";
      repo = "Bottles";
      rev = "44e9107d283c624ae19f9d368b1b7a38a77b962b";
      fetchSubmodules = false;
      sha256 = "sha256-8LR6YKIgpyJXCVeJS3mt6bWycRww91LEg73bl7+mHyI=";
    });
  };
  caddy = {
    pname = "caddy";
  ...
  dnscrypt-proxy2 = {
    ...
    version = "4e9f0382eef4340c14829caa16835f0a85494713";
    src = fetchFromGitHub ({
      owner = "DNSCrypt";
      repo = "dnscrypt-proxy";
      rev = "4e9f0382eef4340c14829caa16835f0a85494713";
      fetchSubmodules = false;
      sha256 = "sha256-Nc0UzsJxLFfXCk+rXlncxtUTl9KwvB7K/qEXns4lYDY=";
    });
  };
  doggo = {
    pname = "doggo";
  ...
  jitsi-meet = {
    ...
    version = "1.0.5723";
    src = fetchurl {
      url = "https://download.jitsi.org/jitsi-meet/src/jitsi-meet-1.0.5723.tar.bz2";
      sha256 = "sha256-U4cRlSkgnbh2Wr1cYsplZB4lIb9cC62cQ3Hxa7Sj0G0=";
    };
  };
  jitsi-meet-prosody = {
    ...
    version = "1.0.5723";
    src = fetchurl {
      url = "https://download.jitsi.org/unstable/jitsi-meet-prosody_1.0.5723-1_all.deb";
      sha256 = "sha256-y/8GPdKhreluTn4NDhzf7IzDQwmTv/sPv836iHSIGj8=";
    };
  };
  jitsi-videobridge2 = {
  ...
  retroarch = {
    pname = "retroarch";
    version = "a74603090112f2b07ffec031f6d6aba52736874f";
    src = fetchFromGitHub ({
      owner = "libretro";
      repo = "retroarch";
      rev = "a74603090112f2b07ffec031f6d6aba52736874f";
      fetchSubmodules = false;
      sha256 = "sha256-zKwshfAHdotDD7dLwTlc2eEuk11Krao/1JZM0QXWR44=";
    });
  };
  rofi-wayland = {
    pname = "rofi-wayland";
  ...
  rustdesk = {
    pname = "rustdesk";
    version = "da629ec42ccc1344aacd8df9cb904987ce67c94a";
    src = fetchFromGitHub ({
      owner = "rustdesk";
      repo = "rustdesk";
      rev = "da629ec42ccc1344aacd8df9cb904987ce67c94a";
      fetchSubmodules = false;
      sha256 = "sha256-ATLwIv28i64/K4RdQO0wMbrP0wIsFKSC/nI4XeoedV0=";
    });
    cargoLock = {
      lockFile = ./rustdesk-da629ec42ccc1344aacd8df9cb904987ce67c94a/Cargo.lock;
      outputHashes = {
  ...
  snui = {
    pname = "snui";
    version = "e02c010ab0a6748d4f7d7db020ef0f47e85b1e83";
    src = fetchgit {
      url = "https://gitlab.com/snakedye/snui";
      rev = "e02c010ab0a6748d4f7d7db020ef0f47e85b1e83";
      fetchSubmodules = false;
      deepClone = false;
      leaveDotGit = false;
      sha256 = "sha256-AAROhovXYuKdOGL/LOz2M1cxJR6DA1eQdw7uFisqPtk=";
    };
  };
  spicetify-cli = {
    pname = "spicetify-cli";
  ...
  whitesur-gtk-theme = {
    ...
    version = "b597208fe5b92de62f1a4e482ffcf380546c3a84";
    src = fetchFromGitHub ({
      owner = "vinceliuice";
      repo = "whitesur-gtk-theme";
      rev = "b597208fe5b92de62f1a4e482ffcf380546c3a84";
      fetchSubmodules = false;
      sha256 = "sha256-Y8H3S0q8ptbZS3qEfsOTwtOYvD9kIuL3ENJb6cwXbVo=";
    });
  };
  whitesur-icon-theme = {
