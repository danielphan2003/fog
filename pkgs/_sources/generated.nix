...
{ fetchgit, fetchurl }:
{
  ...
  bottles = {
    pname = "bottles";
    version = "dd3d21ff65e459b24f35489b14e4d69580c0317d";
    src = fetchgit {
      url = "https://github.com/bottlesdevs/Bottles";
      rev = "dd3d21ff65e459b24f35489b14e4d69580c0317d";
      fetchSubmodules = false;
      deepClone = false;
      leaveDotGit = false;
      sha256 = "1yk1ar64kwyp6blcsy70v663hf1xynqxq92fh86djxn1idakx58c";
    };
  };
  caddy = {
    pname = "caddy";
    version = "0ffb2229b00c3e6b484fb7fac6d5ff8d652c2cc8";
    src = fetchgit {
      url = "https://github.com/caddyserver/caddy";
      rev = "0ffb2229b00c3e6b484fb7fac6d5ff8d652c2cc8";
      fetchSubmodules = false;
      deepClone = false;
      leaveDotGit = false;
      sha256 = "17gyj97749qds7lin8675gn8yd8m5dqcd8alr6ysnaa92q5aq359";
    };
  };
  cups-pdf = {
    pname = "cups-pdf";
  ...
  papermc = {
    ...
    version = "348";
    src = fetchurl {
      url = "https://papermc.io/api/v2/projects/paper/versions/1.17.1/builds/348/downloads/paper-1.17.1-348.jar";
      sha256 = "08n8n2ha5m4fy3ybxw9clcwccsygk7f0bb49v0gbdcxiyjdg04r7";
    };
  };
  picom = {
    pname = "picom";
  ...
  tailscale = {
    pname = "tailscale";
    version = "c60806b55771e061f90a809ae9b964f50c88e687";
    src = fetchgit {
      url = "https://github.com/tailscale/tailscale";
      rev = "c60806b55771e061f90a809ae9b964f50c88e687";
      fetchSubmodules = false;
      deepClone = false;
      leaveDotGit = false;
      sha256 = "19vi3kqid1b9g5fmw57fa8fji4pgcm1bj7mycr8fvw28frz2cnar";
    };
  };
  teams = {
    pname = "teams";
  ...
  whitesur-gtk-theme = {
    ...
    version = "08874d9aec8ad281c85ec634a9b3c2ccd42f3304";
    src = fetchgit {
      url = "https://github.com/vinceliuice/whitesur-gtk-theme";
      rev = "08874d9aec8ad281c85ec634a9b3c2ccd42f3304";
      fetchSubmodules = false;
      deepClone = false;
      leaveDotGit = false;
