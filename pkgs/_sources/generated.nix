...
{ fetchgit, fetchurl, fetchFromGitHub }:
{
  adguardhome-darwin-amd64 = {
    ...
    version = "0.107.1";
    src = fetchurl {
      url = "https://github.com/AdguardTeam/AdGuardHome/releases/download/v0.107.1/AdGuardHome_darwin_amd64.zip";
      sha256 = "sha256-O8/sWvVw0gP+prUUuLYtOoWc/pR3UV1ndKa6HTrcDwQ=";
    };
  };
  adguardhome-linux-386 = {
    ...
    version = "0.107.1";
    src = fetchurl {
      url = "https://github.com/AdguardTeam/AdGuardHome/releases/download/v0.107.1/AdGuardHome_linux_386.tar.gz";
      sha256 = "sha256-ADt3UaS6xsDWZmDsKW1tpok1ltxizzMpO/eJZQjCXAs=";
    };
  };
  adguardhome-linux-amd64 = {
    ...
    version = "0.107.1";
    src = fetchurl {
      url = "https://github.com/AdguardTeam/AdGuardHome/releases/download/v0.107.1/AdGuardHome_linux_amd64.tar.gz";
      sha256 = "sha256-ieHvIPN+cH7V0COru8cfkM9u59r6fO1HfZ7ZcQT97+M=";
    };
  };
  adguardhome-linux-arm64 = {
    ...
    version = "0.107.1";
    src = fetchurl {
      url = "https://github.com/AdguardTeam/AdGuardHome/releases/download/v0.107.1/AdGuardHome_linux_arm64.tar.gz";
      sha256 = "sha256-3P8HNoBH9fvm/TNlIdHkSM77IbFrbfclw0hp8u3WfDQ=";
    };
  };
  adl = {
    pname = "adl";
  ...
  bottles = {
    pname = "bottles";
    version = "439702d88c7ab960cf2adcc307865ed5eb91770d";
    src = fetchFromGitHub ({
      owner = "bottlesdevs";
      repo = "Bottles";
      rev = "439702d88c7ab960cf2adcc307865ed5eb91770d";
      fetchSubmodules = false;
      sha256 = "sha256-MWT28I6L0G99yw9SAz8NRf1/QwY03itqk63eVqKsxo0=";
    });
  };
  caddy = {
    pname = "caddy";
  ...
  papermc-1_17_1 = {
    ...
    version = "404";
    src = fetchurl {
      url = "https://papermc.io/api/v2/projects/paper/versions/1.17.1/builds/404/downloads/paper-1.17.1-404.jar";
      sha256 = "sha256-J8yrVtiptdeVXtljH2EYtU3+2vXVdfUgZzWi1H5J0nQ=";
    };
    mcVer = "1.17.1";
  };
  papermc-1_18 = {
  ...
  papermc-1_18_1 = {
    ...
    version = "110";
    src = fetchurl {
      url = "https://papermc.io/api/v2/projects/paper/versions/1.18.1/builds/110/downloads/paper-1.18.1-110.jar";
      sha256 = "sha256-AsiGqvNExvVnNUaWI92xT9FoRGoggMFo4lqCha6vPAE=";
    };
    mcVer = "1.18.1";
  };
  papermc-1_8_8 = {
  ...
  retroarch = {
    pname = "retroarch";
    version = "ee1d9f5d1b118360bff1080d22116b21aa688ea2";
    src = fetchFromGitHub ({
      owner = "libretro";
      repo = "retroarch";
      rev = "ee1d9f5d1b118360bff1080d22116b21aa688ea2";
      fetchSubmodules = false;
      sha256 = "sha256-mT3VmoOw7FbhzSgfI5QL4rK/1MZfUhF5Ji+Hf77kB4U=";
    });
  };
  rofi-wayland = {
    pname = "rofi-wayland";
  ...
  rustdesk = {
    pname = "rustdesk";
    version = "66af938858d43f64db1aca33a90de2b85c17e6bf";
    src = fetchFromGitHub ({
      owner = "rustdesk";
      repo = "rustdesk";
      rev = "66af938858d43f64db1aca33a90de2b85c17e6bf";
      fetchSubmodules = false;
      sha256 = "sha256-wWLc25mbgQNchlPHRcoXn1gsOtcpRmvO7cnBg0byWrE=";
    });
    cargoLock = {
      lockFile = ./rustdesk-66af938858d43f64db1aca33a90de2b85c17e6bf/Cargo.lock;
      outputHashes = {
  ...
  tailscale = {
    pname = "tailscale";
    version = "96cab21383b321d29d6523ea56711e8381faeaac";
    src = fetchFromGitHub ({
      owner = "tailscale";
      repo = "tailscale";
      rev = "96cab21383b321d29d6523ea56711e8381faeaac";
      fetchSubmodules = false;
      sha256 = "sha256-knnK/I8LYlzfw7UYO5yT+eibbXD2kzpA+D3DwGvfIsY=";
    });
  };
  tailscale-systray = {
