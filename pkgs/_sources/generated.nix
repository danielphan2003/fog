...
{ fetchgit, fetchurl }:
{
  ...
  papermc = {
    ...
    version = "347";
    src = fetchurl {
      url = "https://papermc.io/api/v2/projects/paper/versions/1.17.1/builds/347/downloads/paper-1.17.1-347.jar";
      sha256 = "05znwdd9wq6raynwqajafh5mlid1z6nc9dn577d1yb9j81r4fanp";
    };
  };
  picom = {
    pname = "picom";
