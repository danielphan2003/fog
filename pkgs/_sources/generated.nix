...
{ fetchgit, fetchurl, fetchFromGitHub }:
{
  ...
  whitesur-gtk-theme = {
    ...
    version = "1588c1140be8313c67b6397614579d27a7d6c9aa";
    src = fetchFromGitHub ({
      owner = "vinceliuice";
      repo = "whitesur-gtk-theme";
      rev = "1588c1140be8313c67b6397614579d27a7d6c9aa";
      fetchSubmodules = false;
      sha256 = "sha256-lujlQxXuSdkeWUCbv1MR1BXvbN/DyPhLbNpurkw3Els=";
    });
  };
  whitesur-icon-theme = {
  ...
  xwayland = {
    pname = "xwayland";
    version = "0099412ea4347b02e61ea21946f309f2535cc07b";
    src = fetchgit {
      url = "git://anongit.freedesktop.org/xorg/xserver";
      rev = "0099412ea4347b02e61ea21946f309f2535cc07b";
      fetchSubmodules = false;
      deepClone = false;
      leaveDotGit = false;
      sha256 = "sha256-d+UmTS85+OlgKReYrfwx5ESc3fBGu3o0NO5/GBZz1sk=";
    };
  };
  ydotool = {
    pname = "ydotool";
