...
{ fetchgit, fetchurl, fetchFromGitHub }:
{
  ...
  jitsi-meet = {
    ...
    version = "1.0.5672";
    src = fetchurl {
      url = "https://download.jitsi.org/jitsi-meet/src/jitsi-meet-1.0.5672.tar.bz2";
      sha256 = "sha256-pxyzSX35hq3vXUdazid4FLpHUBTeEgdtEWpHzp6ecEs=";
    };
  };
  jitsi-meet-prosody = {
    ...
    version = "1.0.5672";
    src = fetchurl {
      url = "https://download.jitsi.org/unstable/jitsi-meet-prosody_1.0.5672-1_all.deb";
      sha256 = "sha256-fFzjiE0eaImFWALtIL1l5A6gA70IIGNI/pveqfe9wKA=";
    };
  };
  jitsi-videobridge2 = {
  ...
  xdg-desktop-portal = {
    ...
    version = "9090df5c3f74a108f17a3da7e1d2e7bc7f4b183f";
    src = fetchFromGitHub ({
      owner = "flatpak";
      repo = "xdg-desktop-portal";
      rev = "9090df5c3f74a108f17a3da7e1d2e7bc7f4b183f";
      fetchSubmodules = false;
      sha256 = "sha256-V0XwaLwI+1p+9KfQS43n0FZrmfHnhshzsmk+AhVeuRY=";
    });
  };
