...
{ fetchgit, fetchurl }:
{
  ...
  awesome = {
    pname = "awesome";
    version = "eddabebac46d94b5afd2916460f22b2057628b2b";
    src = fetchgit {
  ...
  flameshot = {
    pname = "flameshot";
    version = "2ff0f4af346d29feb3ed0b11f3ffd0a7a3b3b414";
    src = fetchgit {
      url = "https://github.com/flameshot-org/flameshot";
      rev = "2ff0f4af346d29feb3ed0b11f3ffd0a7a3b3b414";
      fetchSubmodules = false;
      deepClone = false;
      leaveDotGit = false;
      sha256 = "08ivyfzzb6zkw2xns11ha8bqyj4dnfm6jna9fn8rz14q7akrhrsv";
    };
  };
  flyingfox = {
    pname = "flyingfox";
  ...
  ntfs2btrfs = {
    pname = "ntfs2btrfs";
    version = "a8f27e850f4a6b2d7735dad31c6ab6e6cb38b5b6";
    src = fetchgit {
      url = "https://github.com/maharmstone/ntfs2btrfs";
      rev = "a8f27e850f4a6b2d7735dad31c6ab6e6cb38b5b6";
      fetchSubmodules = false;
      deepClone = false;
      leaveDotGit = false;
      sha256 = "142zqjq4bipa265ba9snyh3i2ihmfsf473ifs5zpx9qn5xr62gn7";
    };
  };
  nwg-drawer = {
    pname = "nwg-drawer";
  ...
  ouch = {
    pname = "ouch";
    version = "9265198f58ec3514746aae17d4239c68678f5e25";
    src = fetchgit {
      url = "https://github.com/ouch-org/ouch";
      rev = "9265198f58ec3514746aae17d4239c68678f5e25";
      fetchSubmodules = false;
      deepClone = false;
      leaveDotGit = false;
      sha256 = "1f1850lzm5mb5xk8sh1rwxdp10gpk7d2vkx731xlp39b11i7zkjh";
    };
    cargoLock = {
      lockFile = ./ouch-9265198f58ec3514746aae17d4239c68678f5e25/Cargo.lock;
      outputHashes = { };
    };
  };
  paper = {
  ...
  papermc = {
    ...
    version = "279";
    src = fetchurl {
      url = "https://papermc.io/api/v2/projects/paper/versions/1.17.1/builds/279/downloads/paper-1.17.1-279.jar";
      sha256 = "1r6agvlwaycwrap57lmkl9kn2p7kjsqn9yhqrjqa6hi7y8wrn5cx";
    };
  };
  picom = {
    pname = "picom";
  ...
  retroarch = {
    pname = "retroarch";
    version = "3dee62ce62ec194863d9d213ff11908ae5e2a1b9";
    src = fetchgit {
      url = "https://github.com/libretro/retroarch";
      rev = "3dee62ce62ec194863d9d213ff11908ae5e2a1b9";
      fetchSubmodules = false;
      deepClone = false;
      leaveDotGit = false;
      sha256 = "1pgpp6bcfmm04cshwifpdn664mw37db1sq9p9cflcvzcilpyzba5";
    };
  };
  rofi-wayland = {
    pname = "rofi-wayland";
  ...
  spicetify-themes = {
    ...
    version = "347d83467e0c5f66d2f57734a9a6bd5a8b6e45f5";
    src = fetchgit {
      url = "https://github.com/morpheusthewhite/spicetify-themes";
      rev = "347d83467e0c5f66d2f57734a9a6bd5a8b6e45f5";
      fetchSubmodules = false;
      deepClone = false;
      leaveDotGit = false;
      sha256 = "0hnykzawcmgfwcka5hmi49zk3pkp7sk34a1jn1hrm2c8y7y97160";
    };
  };
  spotify = {
    pname = "spotify";
  ...
  tailscale = {
    pname = "tailscale";
    version = "3b3994f0db979674c2850872bf7acfaeafb9b69e";
    src = fetchgit {
      url = "https://github.com/tailscale/tailscale";
      rev = "3b3994f0db979674c2850872bf7acfaeafb9b69e";
      fetchSubmodules = false;
      deepClone = false;
      leaveDotGit = false;
      sha256 = "0xp1mn6jplya6l62j3rbqy9400b3d8vl2hmvagaqbv9gajzg31n8";
    };
  };
  teams = {
    pname = "teams";
  ...
  vscode-extensions-Material-theme = {
    ...
    version = "3.12.1";
    src = fetchurl {
      url = "https://open-vsx.org/api/zhuangtongfa/material-theme/3.12.1/file/zhuangtongfa.material-theme-3.12.1.vsix";
      sha256 = "018kbllrzl5lg61xfafsyvs51f83ar35m23kmjqchk0bz9bv2qvx";
    };
  ...
  whitesur-icon-theme = {
    ...
    version = "18ae3563615fa769da4ee2ee005ef81bca161fc5";
    src = fetchgit {
      url = "https://github.com/vinceliuice/whitesur-icon-theme";
      rev = "18ae3563615fa769da4ee2ee005ef81bca161fc5";
      fetchSubmodules = false;
      deepClone = false;
      leaveDotGit = false;
      sha256 = "07v3q0g579c3azn39d642ygq1l4z7rcbfpg4kad7rapz6n0kzcfi";
    };
  };
  widevine-cdm = {
    pname = "widevine-cdm";
