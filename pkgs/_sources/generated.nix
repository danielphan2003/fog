...
{ fetchgit, fetchurl, fetchFromGitHub }:
{
  ...
  jitsi-meet = {
    ...
    version = "1.0.5625";
    src = fetchurl {
      url = "https://download.jitsi.org/jitsi-meet/src/jitsi-meet-1.0.5625.tar.bz2";
      sha256 = "sha256-XtEg1g4ekoKR0kGqzQazO7TTQv0UBQ4VPMdrVTS19Ik=";
    };
  };
  jitsi-meet-prosody = {
    ...
    version = "1.0.5625";
    src = fetchurl {
      url = "https://download.jitsi.org/unstable/jitsi-meet-prosody_1.0.5625-1_all.deb";
      sha256 = "sha256-Lw9VXuOZVIk3r1veVm9Bbri1wR3W+GUIYfujJy0DpdE=";
    };
  };
  jitsi-videobridge2 = {
  ...
  snui = {
    pname = "snui";
    version = "018aaaf65e21ed1993ac711bfa982f305d14d3b4";
    src = fetchgit {
      url = "https://gitlab.com/snakedye/snui";
      rev = "018aaaf65e21ed1993ac711bfa982f305d14d3b4";
      fetchSubmodules = false;
      deepClone = false;
      leaveDotGit = false;
      sha256 = "sha256-eXYix8g/i4I+IQ9xb2E+wMxeaN1b8w/unEvOvPU54q4=";
    };
  };
  spicetify-cli = {
    pname = "spicetify-cli";
