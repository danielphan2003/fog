...
{ fetchgit, fetchurl, fetchFromGitHub }:
{
  ...
  bottles = {
    pname = "bottles";
    version = "fda2c38167281b43491f8e4dd31645b173dfb137";
    src = fetchFromGitHub ({
      owner = "bottlesdevs";
      repo = "Bottles";
      rev = "fda2c38167281b43491f8e4dd31645b173dfb137";
      fetchSubmodules = false;
      sha256 = "sha256-rCedt1dC6z98Ut4Ja+zur/jtm1IHGuOn8ny4VtW1ZsM=";
    });
  };
  caddy = {
    pname = "caddy";
    version = "997e41deae139dbf2cb3e95ed250070b40d6f3cb";
    src = fetchFromGitHub ({
      owner = "caddyserver";
      repo = "caddy";
      rev = "997e41deae139dbf2cb3e95ed250070b40d6f3cb";
      fetchSubmodules = false;
      sha256 = "sha256-JhQmWYr6bKtZmd6ANsoVMTjUzc6PwhMOGmAbWC3MsXw=";
    });
  };
  cups-pdf = {
    pname = "cups-pdf";
  ...
  microsoft-edge-dev = {
    ...
    src = fetchurl {
      ...
      sha256 = "sha256-2exF1Y5EuTcbvWuJ91ipKfSveJX6U89VfKz2mjpszJQ=";
    };
  };
  ...
  ouch = {
    ...
    src = fetchFromGitHub ({
      ...
      fetchSubmodules = false;
      sha256 = "sha256-e/+Q4eflYOoITA38fIKLTiPZHBcJhEFrADX83BNtH5Q=";
    });
    cargoLock = {
  ...
  retroarch = {
    pname = "retroarch";
    version = "6b7f28761a5429ed26e1e7339caf61d680eabc92";
    src = fetchFromGitHub ({
      owner = "libretro";
      repo = "retroarch";
      rev = "6b7f28761a5429ed26e1e7339caf61d680eabc92";
      fetchSubmodules = false;
      sha256 = "sha256-ja5b2zG5GgdS/YYq7Xx6y1dUkY0HYJwZSCpXp01MPoo=";
    });
  };
  rofi-wayland = {
    pname = "rofi-wayland";
  ...
  sddm = {
    pname = "sddm";
    version = "e83ced075be03e39f7a45916e0960de13864a6e0";
    src = fetchFromGitHub ({
      owner = "sddm";
      repo = "sddm";
      rev = "e83ced075be03e39f7a45916e0960de13864a6e0";
      fetchSubmodules = false;
      sha256 = "sha256-w9wb3PZU9wjJPWLjeJM+SfSZflSNtqaEnRbBW/WnaDk=";
    });
  };
  sddm-chili = {
    pname = "sddm-chili";
  ...
  spicetify-cli = {
    pname = "spicetify-cli";
    version = "855aa0fab3f1461d21a0322009f7b2d96cba84af";
    src = fetchFromGitHub ({
      owner = "khanhas";
      repo = "spicetify-cli";
      rev = "855aa0fab3f1461d21a0322009f7b2d96cba84af";
      fetchSubmodules = false;
      sha256 = "sha256-TpT4NclXFqEfSKH6Jbiq5kLCJEytXB9FgtvtRyhRDE0=";
    });
  };
  spicetify-themes = {
  ...
  tailscale = {
    pname = "tailscale";
    version = "85fa1b0d616b27fd294316d66178730feae33680";
    src = fetchFromGitHub ({
      owner = "tailscale";
      repo = "tailscale";
      rev = "85fa1b0d616b27fd294316d66178730feae33680";
      fetchSubmodules = false;
      sha256 = "sha256-yEDL0vIOSbdDPOaE3Qrjacl6szyKwGhR+7GimrJk17I=";
    });
  };
  teams = {
    pname = "teams";
  ...
  vscode-extensions-astro = {
    ...
    src = fetchurl {
      ...
      sha256 = "sha256-WrNqNK4GneZJXI/FwnNacwsutWtUxDF/EpfCBW3AcJU=";
    };
    license = "mit";
  };
