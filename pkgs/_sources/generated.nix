...
{ fetchgit, fetchurl, fetchFromGitHub }:
{
  ...
  dribbblish-dynamic-theme = {
    ...
    version = "c2d7f851b1fff62377394ae2b6e9586964be9d68";
    src = fetchFromGitHub ({
      owner = "JulienMaille";
      repo = "dribbblish-dynamic-theme";
      rev = "c2d7f851b1fff62377394ae2b6e9586964be9d68";
      fetchSubmodules = false;
      sha256 = "sha256-TNlkktBOr9hjGLwXZGajlmR4wP//qJftzEW6JPsSlEk=";
    });
  };
  droidcam = {
    pname = "droidcam";
  ...
  jitsi-meet = {
    ...
    version = "1.0.5570";
    src = fetchurl {
      url = "https://download.jitsi.org/jitsi-meet/src/jitsi-meet-1.0.5570.tar.bz2";
      sha256 = "sha256-2w1X9UmjwreV9UVQoId4iwVJgtmO9GU8NXgzhXmMnvU=";
    };
  };
  jitsi-meet-prosody = {
    ...
    version = "1.0.5570";
    src = fetchurl {
      url = "https://download.jitsi.org/unstable/jitsi-meet-prosody_1.0.5570-1_all.deb";
      sha256 = "sha256-boisD3I4MPIX7zdKSeD2+eEmFlor/quorFRugee+PzI=";
    };
  };
  jitsi-videobridge2 = {
