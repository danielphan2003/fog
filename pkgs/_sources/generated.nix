...
{ fetchgit, fetchurl, fetchFromGitHub }:
{
  ...
  retroarch = {
    pname = "retroarch";
    version = "49e99266f8c7fe363c6b33aa85a41b6516eb8a72";
    src = fetchFromGitHub ({
      owner = "libretro";
      repo = "retroarch";
      rev = "49e99266f8c7fe363c6b33aa85a41b6516eb8a72";
      fetchSubmodules = false;
      sha256 = "sha256-NfU476hC14YcKDkzaMkF0p5+cGs5yxz/3sKaxL4dQgA=";
    });
  };
  rofi-wayland = {
    pname = "rofi-wayland";
  ...
  rustdesk = {
    pname = "rustdesk";
    version = "247ea5fed307ffa07140b721668946cb966d7a24";
    src = fetchFromGitHub ({
      owner = "rustdesk";
      repo = "rustdesk";
      rev = "247ea5fed307ffa07140b721668946cb966d7a24";
      fetchSubmodules = false;
      sha256 = "sha256-fOPucjs9PxuuxvvvjaR22nJGeyDyAeUFgLUO32/Etf0=";
    });
    cargoLock = {
      lockFile = ./rustdesk-247ea5fed307ffa07140b721668946cb966d7a24/Cargo.lock;
      outputHashes = {
