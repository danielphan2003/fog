...
{ fetchgit, fetchurl, fetchFromGitHub }:
{
  ...
  jitsi-meet = {
    ...
    version = "1.0.5607";
    src = fetchurl {
      url = "https://download.jitsi.org/jitsi-meet/src/jitsi-meet-1.0.5607.tar.bz2";
      sha256 = "sha256-WUJOZm9+ktsi4f7iBEKWCtHKF3AYFmEc3qUw8zovLo8=";
    };
  };
  jitsi-meet-prosody = {
    ...
    version = "1.0.5607";
    src = fetchurl {
      url = "https://download.jitsi.org/unstable/jitsi-meet-prosody_1.0.5607-1_all.deb";
      sha256 = "sha256-nHiERZeIID6ZQ27xqvGdxw9HNnc66B5HVucC5kvMMAo=";
    };
  };
  jitsi-videobridge2 = {
  ...
  spicetify-cli = {
    pname = "spicetify-cli";
    version = "bf109f8c43edaf1f73ec63a3b3eef61022610dce";
    src = fetchFromGitHub ({
      owner = "khanhas";
      repo = "spicetify-cli";
      rev = "bf109f8c43edaf1f73ec63a3b3eef61022610dce";
      fetchSubmodules = false;
      sha256 = "sha256-lSHVBR+/ImYVSuFILy64VF0tV7YczWPhYKisd3c8+Bg=";
    });
  };
  spicetify-themes = {
