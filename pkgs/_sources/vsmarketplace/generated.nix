...
{ fetchgit, fetchurl, fetchFromGitHub }:
{
  ...
  astro-build-astro-vscode = {
    ...
    version = "0.9.1";
    src = fetchurl {
      url = "https://astro-build.gallery.vsassets.io/_apis/public/gallery/publisher/astro-build/extension/astro-vscode/0.9.1/assetbyname/Microsoft.VisualStudio.Services.VSIXPackage";
      name = "astro-vscode-0.9.1.zip";
      sha256 = "sha256-DPfKB5/N6CIvsv4BFgC9g5owvi+vX9HXm4ISdgZNll4=";
    };
    name = "astro-vscode";
    license = "MIT";
  ...
  ms-vscode-cpptools = {
    ...
    version = "1.9.2";
    src = fetchurl {
      url = "https://ms-vscode.gallery.vsassets.io/_apis/public/gallery/publisher/ms-vscode/extension/cpptools/1.9.2/assetbyname/Microsoft.VisualStudio.Services.VSIXPackage";
      name = "cpptools-1.9.2.zip";
      sha256 = "sha256-rHNYpEK+Uxxc+sfoGN3gZRSPKfL2lywuI4AUlDAy9UM=";
    };
    name = "cpptools";
    license = "MIT";
    publisher = "ms-vscode";
