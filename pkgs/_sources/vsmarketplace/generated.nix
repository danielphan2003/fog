...
{ fetchgit, fetchurl, fetchFromGitHub }:
{
  ...
  astro-build-astro-vscode = {
    ...
    version = "0.13.1";
    src = fetchurl {
      url = "https://astro-build.gallery.vsassets.io/_apis/public/gallery/publisher/astro-build/extension/astro-vscode/0.13.1/assetbyname/Microsoft.VisualStudio.Services.VSIXPackage";
      name = "astro-vscode-0.13.1.zip";
      sha256 = "sha256-2UEzPJMWkOnvrNvx7FjVQ6V92vtZZ0zkEzeusUiywDQ=";
    };
    name = "astro-vscode";
    license = "MIT";
  ...
  ms-vscode-cpptools = {
    ...
    version = "1.9.6";
    src = fetchurl {
      url = "https://ms-vscode.gallery.vsassets.io/_apis/public/gallery/publisher/ms-vscode/extension/cpptools/1.9.6/assetbyname/Microsoft.VisualStudio.Services.VSIXPackage";
      name = "cpptools-1.9.6.zip";
      sha256 = "sha256-n5MsurwjfbTmOqUv9pmMLVOHwfDsIA9qepkpZgqNEJ4=";
    };
    name = "cpptools";
    license = "MIT";
    publisher = "ms-vscode";
