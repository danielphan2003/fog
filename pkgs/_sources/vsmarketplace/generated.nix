...
{ fetchgit, fetchurl, fetchFromGitHub }:
{
  ...
  astro-build-astro-vscode = {
    ...
    version = "0.18.0";
    src = fetchurl {
      url = "https://astro-build.gallery.vsassets.io/_apis/public/gallery/publisher/astro-build/extension/astro-vscode/0.18.0/assetbyname/Microsoft.VisualStudio.Services.VSIXPackage";
      name = "astro-vscode-0.18.0.zip";
      sha256 = "sha256-8PmNdof1D4kbXw72HdPsp8VVx8Q/hzPDrxvR5Ya+Se4=";
    };
    name = "astro-vscode";
    license = "MIT";
  ...
  ms-vscode-cpptools = {
    ...
    version = "1.10.2";
    src = fetchurl {
      url = "https://ms-vscode.gallery.vsassets.io/_apis/public/gallery/publisher/ms-vscode/extension/cpptools/1.10.2/assetbyname/Microsoft.VisualStudio.Services.VSIXPackage";
      name = "cpptools-1.10.2.zip";
      sha256 = "sha256-cNjxAKCfiYm6nQyYRHAvYvVxENs/M4nyA3qdvyKZUAo=";
    };
    name = "cpptools";
    license = "MIT";
    publisher = "ms-vscode";
