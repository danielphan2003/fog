...
{ fetchgit, fetchurl, fetchFromGitHub }:
{
  ...
  astro-build-astro-vscode = {
    ...
    version = "0.19.0";
    src = fetchurl {
      url = "https://astro-build.gallery.vsassets.io/_apis/public/gallery/publisher/astro-build/extension/astro-vscode/0.19.0/assetbyname/Microsoft.VisualStudio.Services.VSIXPackage";
      name = "astro-vscode-0.19.0.zip";
      sha256 = "sha256-dfH1ve2UwRXtPO3R1U1vgQe14Tukb+K1umh9uaYksLc=";
    };
    name = "astro-vscode";
    license = "MIT";
  ...
  ms-vscode-cpptools = {
    ...
    version = "1.10.3";
    src = fetchurl {
      url = "https://ms-vscode.gallery.vsassets.io/_apis/public/gallery/publisher/ms-vscode/extension/cpptools/1.10.3/assetbyname/Microsoft.VisualStudio.Services.VSIXPackage";
      name = "cpptools-1.10.3.zip";
      sha256 = "sha256-CNnsz98Tas5/2+3gXD23wFMIEtUoFSFXKNkybUN63gc=";
    };
    name = "cpptools";
    license = "MIT";
    publisher = "ms-vscode";
