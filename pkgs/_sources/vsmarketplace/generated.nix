...
{ fetchgit, fetchurl, fetchFromGitHub }:
{
  ...
  astro-build-astro-vscode = {
    ...
    version = "0.12.0";
    src = fetchurl {
      url = "https://astro-build.gallery.vsassets.io/_apis/public/gallery/publisher/astro-build/extension/astro-vscode/0.12.0/assetbyname/Microsoft.VisualStudio.Services.VSIXPackage";
      name = "astro-vscode-0.12.0.zip";
      sha256 = "sha256-1ZXr9Y/GazQu/LBgnYHbKe8AYWpu0GioB18p1+aAnLM=";
    };
    name = "astro-vscode";
    license = "MIT";
  ...
  ms-vscode-cpptools = {
    ...
    version = "1.9.4";
    src = fetchurl {
      url = "https://ms-vscode.gallery.vsassets.io/_apis/public/gallery/publisher/ms-vscode/extension/cpptools/1.9.4/assetbyname/Microsoft.VisualStudio.Services.VSIXPackage";
      name = "cpptools-1.9.4.zip";
      sha256 = "sha256-Ix7borukBqK60FEbnbLW1KxemsdVTEP0YwKtcUlklPw=";
    };
    name = "cpptools";
    license = "MIT";
    publisher = "ms-vscode";
