...
{ fetchgit, fetchurl, fetchFromGitHub }:
{
  ...
  bottles = {
    pname = "bottles";
    version = "fed51f0b2d482029a33531b2d92724514a949201";
    src = fetchFromGitHub ({
      owner = "bottlesdevs";
      repo = "Bottles";
      rev = "fed51f0b2d482029a33531b2d92724514a949201";
      fetchSubmodules = false;
      sha256 = "sha256-VXBOF9DydCODc3j58AKFoI7GpOKkEOgbzya9iFvHzXQ=";
    });
  };
  caddy = {
    pname = "caddy";
  ...
  jitsi-meet = {
    ...
    version = "1.0.5929";
    src = fetchurl {
      url = "https://download.jitsi.org/jitsi-meet/src/jitsi-meet-1.0.5929.tar.bz2";
      sha256 = "sha256-FfWA0NMZYl6hvFipLayvMvFEZF9+YbfrM0bqQWGuz6g=";
    };
  };
  jitsi-meet-prosody = {
    ...
    version = "1.0.5929";
    src = fetchurl {
      url = "https://download.jitsi.org/unstable/jitsi-meet-prosody_1.0.5929-1_all.deb";
      sha256 = "sha256-DnmfwkALj+NlSsrOsCrWKLdJH/3RCYFKKaAeHYoq+og=";
    };
  };
  jitsi-videobridge2 = {
  ...
  retroarch = {
    pname = "retroarch";
    version = "b094c58081e762584f59dad587746b3867eaea9f";
    src = fetchFromGitHub ({
      owner = "libretro";
      repo = "retroarch";
      rev = "b094c58081e762584f59dad587746b3867eaea9f";
      fetchSubmodules = false;
      sha256 = "sha256-efyLsfgMWXjGtfx1Bbu20vIjZ+QQs+x+cpVwqYdhsuQ=";
    });
  };
  rofi-wayland = {
    pname = "rofi-wayland";
  ...
  rustdesk = {
    pname = "rustdesk";
    version = "362aa9a8ffed5727ca33cbc3e8a111e864b8977f";
    src = fetchFromGitHub ({
      owner = "rustdesk";
      repo = "rustdesk";
      rev = "362aa9a8ffed5727ca33cbc3e8a111e864b8977f";
      fetchSubmodules = false;
      sha256 = "sha256-DM/OrVlADHL1IG9F1pQummUtlw7CB7UiiDQqVQHQo4M=";
    });
    cargoLock = {
      lockFile = ./rustdesk-362aa9a8ffed5727ca33cbc3e8a111e864b8977f/Cargo.lock;
      outputHashes = {
  ...
  spotifyd = {
    pname = "spotifyd";
    version = "f8fce08b4f81397d5628f40d9379e93ff7bbe073";
    src = fetchFromGitHub ({
      owner = "Spotifyd";
      repo = "spotifyd";
      rev = "f8fce08b4f81397d5628f40d9379e93ff7bbe073";
      fetchSubmodules = false;
      sha256 = "sha256-7AkQIcDL4tERJNerVxe8HY6qJzrd+uUrja2eWHaGLUs=";
    });
    cargoLock = {
      lockFile = ./spotifyd-f8fce08b4f81397d5628f40d9379e93ff7bbe073/Cargo.lock;
      outputHashes = { };
    };
  };
  steamcompmgr = {
  ...
  tailscale = {
    pname = "tailscale";
    version = "efc48b0578739538cd808ebcb458b1e94731f04c";
    src = fetchFromGitHub ({
      owner = "tailscale";
      repo = "tailscale";
      rev = "efc48b0578739538cd808ebcb458b1e94731f04c";
      fetchSubmodules = false;
      sha256 = "sha256-R9xuCMqOg5c17CSA+DgBqXrUQ66y2YXqBTGUaRUN3tM=";
    });
  };
  tailscale-systray = {
  ...
  xdg-desktop-portal = {
    ...
    version = "9b0c9d46085418cbfc0689dcbf352e360ca1c5ab";
    src = fetchFromGitHub ({
      owner = "flatpak";
      repo = "xdg-desktop-portal";
      rev = "9b0c9d46085418cbfc0689dcbf352e360ca1c5ab";
      fetchSubmodules = false;
      sha256 = "sha256-mXMrQqiicXgY1Q5rLzaTBw26BuRA7FZotpEpamP+enk=";
    });
  };
