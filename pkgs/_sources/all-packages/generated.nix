...
{ fetchgit, fetchurl, fetchFromGitHub }:
{
  ...
  hyprland = {
    pname = "hyprland";
    version = "726ba657850ef1680c82d3815c91421d9c588844";
    src = fetchFromGitHub ({
      owner = "vaxerski";
      repo = "hyprland";
      rev = "726ba657850ef1680c82d3815c91421d9c588844";
      fetchSubmodules = false;
      sha256 = "sha256-WdQxgat5jI3SCY0/JtWplCdUZtv1O5EROlkAKKza15c=";
    });
  };
  ibus = {
    pname = "ibus";
  ...
  jitsi-meet = {
    ...
    version = "1.0.6125";
    src = fetchurl {
      url = "https://download.jitsi.org/jitsi-meet/src/jitsi-meet-1.0.6125.tar.bz2";
      sha256 = "sha256-1raKPrc4GDLlfEx5ZgmaI38+aZq4WnKVt0+jqp1muHA=";
    };
  };
  jitsi-meet-prosody = {
    ...
    version = "1.0.6125";
    src = fetchurl {
      url = "https://download.jitsi.org/unstable/jitsi-meet-prosody_1.0.6125-1_all.deb";
      sha256 = "sha256-qgTYGvx+PZDQTrnDdf8el4dhGrvF1Hpi/jKmhsOV6a4=";
    };
  };
  jitsi-videobridge2 = {
  ...
  rustdesk = {
    pname = "rustdesk";
    version = "8df1e4297700cd0d16da05ac5cb488fafe6fff8a";
    src = fetchFromGitHub ({
      owner = "rustdesk";
      repo = "rustdesk";
      rev = "8df1e4297700cd0d16da05ac5cb488fafe6fff8a";
      fetchSubmodules = false;
      sha256 = "sha256-LaRhwWl+ip0jPwI7oFgYIMw2wc9nRqQdxDI7rFtdCbQ=";
    });
    cargoLock = {
      lockFile = ./rustdesk-8df1e4297700cd0d16da05ac5cb488fafe6fff8a/Cargo.lock;
      outputHashes = {
  ...
  spicetify-cli = {
    pname = "spicetify-cli";
    version = "249cf69bc987be642a00e583f5a235c79ed540af";
    src = fetchFromGitHub ({
      owner = "khanhas";
      repo = "spicetify-cli";
      rev = "249cf69bc987be642a00e583f5a235c79ed540af";
      fetchSubmodules = false;
      sha256 = "sha256-IWR+jVYjgf2DxYbwfm17stNlML2tPn0WvJk2mX5stKU=";
    });
  };
  spicetify-themes = {
  ...
  tailscale = {
    pname = "tailscale";
    version = "cfe68d0a8678261989eb7202e7b3681e82fb1481";
    src = fetchFromGitHub ({
      owner = "tailscale";
      repo = "tailscale";
      rev = "cfe68d0a8678261989eb7202e7b3681e82fb1481";
      fetchSubmodules = false;
      sha256 = "sha256-nBNqt8z3Jw8P3nkTmcgqR2HQ/ZzNLSNLWNtTL7lOBSU=";
    });
  };
  tailscale-systray = {
