...
{ fetchgit, fetchurl, fetchFromGitHub }:
{
  ...
  jicofo = {
    ...
    version = "1.0-881";
    src = fetchurl {
      url = "https://download.jitsi.org/unstable/jicofo_1.0-881-1_all.deb";
      sha256 = "sha256-VVk06wLiq5mQzRjRjktfLcUT18RUACZAb+GIqslVQiE=";
    };
  };
  jitsi-meet = {
    pname = "jitsi-meet";
  ...
  retroarch = {
    pname = "retroarch";
    version = "14ab2db692fbf5c5feed75dec81f0d308d1ef388";
    src = fetchFromGitHub ({
      owner = "libretro";
      repo = "retroarch";
      rev = "14ab2db692fbf5c5feed75dec81f0d308d1ef388";
      fetchSubmodules = false;
      sha256 = "sha256-bU4fiNB5t32h6TLK6H7w3PkkBMfwP60bFZtwUhxPMxI=";
    });
  };
  rofi-wayland = {
    pname = "rofi-wayland";
  ...
  tailscale = {
    pname = "tailscale";
    version = "7cfc6130e5e88d00db2afcfbadfb90979cc21af1";
    src = fetchFromGitHub ({
      owner = "tailscale";
      repo = "tailscale";
      rev = "7cfc6130e5e88d00db2afcfbadfb90979cc21af1";
      fetchSubmodules = false;
      sha256 = "sha256-Yc7wV2Km1syM3pXu05yfmvNRlgX9c7Q/8FEKAIgq8yI=";
    });
  };
  tailscale-systray = {
