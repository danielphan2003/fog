...
{ fetchgit, fetchurl, fetchFromGitHub }:
{
  ...
  bottles = {
    pname = "bottles";
    version = "510ea5be8932316adf323621a90c7b5c8bdb1f68";
    src = fetchFromGitHub ({
      owner = "bottlesdevs";
      repo = "Bottles";
      rev = "510ea5be8932316adf323621a90c7b5c8bdb1f68";
      fetchSubmodules = false;
      sha256 = "sha256-dp6MwetlFTxtfblzQjueQeaBk2y7DtVdGi/Yie05cRE=";
    });
  };
  caddy = {
    pname = "caddy";
  ...
  eww = {
    pname = "eww";
    version = "bf7f49848d63f4fdf8994668ec346d9d3ced77ed";
    src = fetchFromGitHub ({
      owner = "elkowar";
      repo = "eww";
      rev = "bf7f49848d63f4fdf8994668ec346d9d3ced77ed";
      fetchSubmodules = false;
      sha256 = "sha256-j5PLiQi9yNQ/qGb3ATAtdXFbdmiP/4EB2DY04I3h3Mo=";
    });
    cargoLock = {
      lockFile = ./eww-bf7f49848d63f4fdf8994668ec346d9d3ced77ed/Cargo.lock;
      outputHashes = { };
    };
  };
  ...
  ibus = {
    pname = "ibus";
    version = "0f1485bfa687386f26ef5909c123e0ae2e3e11b9";
    src = fetchFromGitHub ({
      owner = "ibus";
      repo = "ibus";
      rev = "0f1485bfa687386f26ef5909c123e0ae2e3e11b9";
      fetchSubmodules = false;
      sha256 = "sha256-V/uo1L6XCzMV610Le8nghLFthuAGF9wclVGZTjCic60=";
    });
  };
  ibus-bamboo = {
    pname = "ibus-bamboo";
  ...
  jitsi-meet = {
    ...
    version = "1.0.5829";
    src = fetchurl {
      url = "https://download.jitsi.org/jitsi-meet/src/jitsi-meet-1.0.5829.tar.bz2";
      sha256 = "sha256-v5REIXKBbQqLvS7ephZE/t6yCAbv/p+RKewuPizPQDE=";
    };
  };
  jitsi-meet-prosody = {
    ...
    version = "1.0.5829";
    src = fetchurl {
      url = "https://download.jitsi.org/unstable/jitsi-meet-prosody_1.0.5829-1_all.deb";
      sha256 = "sha256-QTfL2Am5WrMvt0aQnqFx8e3z9a8589TDZz7gzw937fM=";
    };
  };
  jitsi-videobridge2 = {
  ...
  tailscale = {
    pname = "tailscale";
    version = "0626cf41834604940cb83f84ec5613da460c2bd4";
    src = fetchFromGitHub ({
      owner = "tailscale";
      repo = "tailscale";
      rev = "0626cf41834604940cb83f84ec5613da460c2bd4";
      fetchSubmodules = false;
      sha256 = "sha256-zysY6VZO2cyYbYn6QAZuBzlFuJ4+IVl6z+dsORIFyvU=";
    });
  };
  tailscale-systray = {
