...
{ fetchgit, fetchurl, fetchFromGitHub }:
{
  ...
  bottles = {
    pname = "bottles";
    version = "2cc475aa17eadd118c8bc17dd2a1dae408469af4";
    src = fetchFromGitHub ({
      owner = "bottlesdevs";
      repo = "Bottles";
      rev = "2cc475aa17eadd118c8bc17dd2a1dae408469af4";
      fetchSubmodules = false;
      sha256 = "sha256-3IE3n8vb1/PFamCYN7QOZOQDbPd5x/JOaDq4YzmwflQ=";
    });
  };
  caddy = {
    pname = "caddy";
  ...
  dnscrypt-proxy2 = {
    ...
    version = "62092726ecbbd7c1698f8f615dc07d6c593f2545";
    src = fetchFromGitHub ({
      owner = "DNSCrypt";
      repo = "dnscrypt-proxy";
      rev = "62092726ecbbd7c1698f8f615dc07d6c593f2545";
      fetchSubmodules = false;
      sha256 = "sha256-mLcip9UMnQUMvj4U4IzSXwiYXBEgqVPdHAanOG+jF80=";
    });
  };
  doggo = {
    pname = "doggo";
  ...
  jitsi-meet = {
    ...
    version = "1.0.5853";
    src = fetchurl {
      url = "https://download.jitsi.org/jitsi-meet/src/jitsi-meet-1.0.5853.tar.bz2";
      sha256 = "sha256-x49rifoU3ljSRbsJgDHOYgwSxjZLu2Udik7wUYI3G4c=";
    };
  };
  jitsi-meet-prosody = {
    ...
    version = "1.0.5853";
    src = fetchurl {
      url = "https://download.jitsi.org/unstable/jitsi-meet-prosody_1.0.5853-1_all.deb";
      sha256 = "sha256-n6BPekUZJPXaSGGJRnJ7H41Cl6Z5p6lHHgQzKI6/dAU=";
    };
  };
  jitsi-videobridge2 = {
    pname = "jitsi-videobridge2";
    version = "2.1-620-g93f4d88c";
    src = fetchurl {
      url = "https://download.jitsi.org/unstable/jitsi-videobridge2_2.1-620-g93f4d88c-1_all.deb";
      sha256 = "sha256-580EEsoXdl6zKe3TV3Fz1HZ1+oaECxkLA39W6eGhZwU=";
    };
  };
  layout-machi = {
    pname = "layout-machi";
  ...
  retroarch = {
    pname = "retroarch";
    version = "a576ee49dba7c800e357da90122db4cc7a60d1d2";
    src = fetchFromGitHub ({
      owner = "libretro";
      repo = "retroarch";
      rev = "a576ee49dba7c800e357da90122db4cc7a60d1d2";
      fetchSubmodules = false;
      sha256 = "sha256-0yEu9FxceZgmCBCJLp3Ya7zfa/sGmM78FAoIL3PsRCQ=";
    });
  };
  rofi-wayland = {
    pname = "rofi-wayland";
  ...
  rustdesk = {
    pname = "rustdesk";
    version = "3c29b8a58a8a3987ad37d973dec9137d59c9bc4e";
    src = fetchFromGitHub ({
      owner = "rustdesk";
      repo = "rustdesk";
      rev = "3c29b8a58a8a3987ad37d973dec9137d59c9bc4e";
      fetchSubmodules = false;
      sha256 = "sha256-BFEslMGBqXwrCTCYu0C0yhixTDksbFng9ERsAITiwEw=";
    });
    cargoLock = {
      lockFile = ./rustdesk-3c29b8a58a8a3987ad37d973dec9137d59c9bc4e/Cargo.lock;
      outputHashes = {
  ...
  tailscale = {
    pname = "tailscale";
    version = "3a74f2d2d74bf9bd989252612c82df9eed2b8a5a";
    src = fetchFromGitHub ({
      owner = "tailscale";
      repo = "tailscale";
      rev = "3a74f2d2d74bf9bd989252612c82df9eed2b8a5a";
      fetchSubmodules = false;
      sha256 = "sha256-GSISgSFf2UwM41/l5ZydEexMV1RqFtYlWScJWujNBDk=";
    });
  };
  tailscale-systray = {
