...
{ fetchgit, fetchurl, fetchFromGitHub }:
{
  ...
  retroarch = {
    pname = "retroarch";
    version = "31342ea18f757d437250e1738e9f5eedb53a3c12";
    src = fetchFromGitHub ({
      owner = "libretro";
      repo = "retroarch";
      rev = "31342ea18f757d437250e1738e9f5eedb53a3c12";
      fetchSubmodules = false;
      sha256 = "sha256-M/palR8iDLJCjILq2bP2eYSBk7TlP9MAIvV2DM5xM9Q=";
    });
  };
  rofi-wayland = {
    pname = "rofi-wayland";
  ...
  rustdesk = {
    pname = "rustdesk";
    version = "ee088a8ddfdd933a490754ab86ee4b1f7e6af2b6";
    src = fetchFromGitHub ({
      owner = "rustdesk";
      repo = "rustdesk";
      rev = "ee088a8ddfdd933a490754ab86ee4b1f7e6af2b6";
      fetchSubmodules = false;
      sha256 = "sha256-WMUa9sR2tVGRa3y2Sk3yCRymsR94eQup6g9umo85lPI=";
    });
    cargoLock = {
      lockFile = ./rustdesk-ee088a8ddfdd933a490754ab86ee4b1f7e6af2b6/Cargo.lock;
      outputHashes = {
