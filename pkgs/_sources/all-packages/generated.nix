...
{ fetchgit, fetchurl, fetchFromGitHub }:
{
  ...
  hyprland = {
    pname = "hyprland";
    version = "0de058beb148713a5b3a6fefaf38a5684163ac37";
    src = fetchFromGitHub ({
      owner = "vaxerski";
      repo = "hyprland";
      rev = "0de058beb148713a5b3a6fefaf38a5684163ac37";
      fetchSubmodules = false;
      sha256 = "sha256-P8dDyiIUt/kpN/I08P/5qz+0OZ8PycqB9HYxOhTHZSc=";
    });
  };
  ibus = {
    pname = "ibus";
  ...
  retroarch = {
    pname = "retroarch";
    version = "1b8c1faa8a7ab1c14c0abc5dd106023bcce34a64";
    src = fetchFromGitHub ({
      owner = "libretro";
      repo = "retroarch";
      rev = "1b8c1faa8a7ab1c14c0abc5dd106023bcce34a64";
      fetchSubmodules = false;
      sha256 = "sha256-vS8280wh9xPYegeGrX6ge4UNj6IU9K1qPRREGOYWtcY=";
    });
  };
  rofi-wayland = {
    pname = "rofi-wayland";
  ...
  rustdesk = {
    pname = "rustdesk";
    version = "21ad4cb8d8804862d903a90f2aa3a3ddbf85001b";
    src = fetchFromGitHub ({
      owner = "rustdesk";
      repo = "rustdesk";
      rev = "21ad4cb8d8804862d903a90f2aa3a3ddbf85001b";
      fetchSubmodules = false;
      sha256 = "sha256-vpKmAb1OQU2OjzSt1np/EMc9XP1iuJL9wvQ7XKuH0uY=";
    });
    cargoLock = {
      lockFile = ./rustdesk-21ad4cb8d8804862d903a90f2aa3a3ddbf85001b/Cargo.lock;
      outputHashes = {
