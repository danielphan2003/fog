...
{ fetchgit, fetchurl, fetchFromGitHub }:
{
  ...
  hyprland = {
    pname = "hyprland";
    version = "f9c8a72e4689869a4373ce25b2458820027881e0";
    src = fetchFromGitHub ({
      owner = "vaxerski";
      repo = "hyprland";
      rev = "f9c8a72e4689869a4373ce25b2458820027881e0";
      fetchSubmodules = false;
      sha256 = "sha256-o8zH79yNz6HA14q16CUOx1MpqiLE37o+UpUiXljBVJU=";
    });
  };
  ibus = {
    pname = "ibus";
  ...
  rustdesk = {
    pname = "rustdesk";
    version = "cb781fe08c29f41d5b0fb916ab3b401778e1c3dc";
    src = fetchFromGitHub ({
      owner = "rustdesk";
      repo = "rustdesk";
      rev = "cb781fe08c29f41d5b0fb916ab3b401778e1c3dc";
      fetchSubmodules = false;
      sha256 = "sha256-JO11aeqopa7htbGQDVigZ4EwMKwetmtQVEmwgPx3flM=";
    });
    cargoLock = {
      lockFile = ./rustdesk-cb781fe08c29f41d5b0fb916ab3b401778e1c3dc/Cargo.lock;
      outputHashes = {
  ...
  tailscale = {
    pname = "tailscale";
    version = "a9f32656f53e4dbe7248852a616af75072f89000";
    src = fetchFromGitHub ({
      owner = "tailscale";
      repo = "tailscale";
      rev = "a9f32656f53e4dbe7248852a616af75072f89000";
      fetchSubmodules = false;
      sha256 = "sha256-O/QWedKCPQN6yDCoAwr0zSDzzrxSuEG3u1Ncis9G/qE=";
    });
  };
  tailscale-systray = {
