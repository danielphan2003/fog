...
{ fetchgit, fetchurl, fetchFromGitHub }:
{
  ...
  rustdesk = {
    pname = "rustdesk";
    version = "885d3a6651c9d85c0feb528ebbc88a47b411c503";
    src = fetchFromGitHub ({
      owner = "rustdesk";
      repo = "rustdesk";
      rev = "885d3a6651c9d85c0feb528ebbc88a47b411c503";
      fetchSubmodules = false;
      sha256 = "sha256-9oO4EFha9xgMVbSMW5g+4YULb/pEOX7HfNrQlcT4pwc=";
    });
    cargoLock = {
      lockFile = ./rustdesk-885d3a6651c9d85c0feb528ebbc88a47b411c503/Cargo.lock;
      outputHashes = {
  ...
  tailscale = {
    pname = "tailscale";
    version = "91a187bf87e264618c0708953ecaa3cdd0236b70";
    src = fetchFromGitHub ({
      owner = "tailscale";
      repo = "tailscale";
      rev = "91a187bf87e264618c0708953ecaa3cdd0236b70";
      fetchSubmodules = false;
      sha256 = "sha256-qSAbwbeQc1bsWwqGBLUB/HQcWEa744BDUpeOGnSVzfg=";
    });
  };
  tailscale-systray = {
