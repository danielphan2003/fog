...
{ fetchgit, fetchurl, fetchFromGitHub }:
{
  ...
  bottles = {
    pname = "bottles";
    version = "dc599f60c9c77e3deba4edaaba1e5978f40c46d9";
    src = fetchFromGitHub ({
      owner = "bottlesdevs";
      repo = "Bottles";
      rev = "dc599f60c9c77e3deba4edaaba1e5978f40c46d9";
      fetchSubmodules = false;
      sha256 = "sha256-jkFDv5ZTce5odkNm5VMbF0t1yWUaMHHdtidp69DRDxc=";
    });
  };
  caddy = {
    pname = "caddy";
  ...
  conduit = {
    pname = "conduit";
    version = "1ce03059a0194740abe35483b359878479e0c611";
    src = fetchgit {
      url = "https://gitlab.com/famedly/conduit";
      rev = "1ce03059a0194740abe35483b359878479e0c611";
      fetchSubmodules = false;
      deepClone = false;
      leaveDotGit = false;
      sha256 = "sha256-ifFwrkj5CJFqMr/+evszFRlBaWzNwum+vKvLf2+OpuI=";
    };
    cargoLock = {
      lockFile = ./conduit-1ce03059a0194740abe35483b359878479e0c611/Cargo.lock;
      outputHashes = {
  ...
  dnscrypt-proxy2 = {
    ...
    version = "77dc3b1e853950d354f505719df45b066fbea866";
    src = fetchFromGitHub ({
      owner = "DNSCrypt";
      repo = "dnscrypt-proxy";
      rev = "77dc3b1e853950d354f505719df45b066fbea866";
      fetchSubmodules = false;
      sha256 = "sha256-R0pPf6FIBuLO7mZBsSyceyNcTa2wuAn8dOaVIvvnqhk=";
    });
  };
  doggo = {
    pname = "doggo";
  ...
  flameshot = {
    pname = "flameshot";
    version = "a4807861f05fba0f3b1bc29a63a5b7b99a6cd7e2";
    src = fetchFromGitHub ({
      owner = "flameshot-org";
      repo = "flameshot";
      rev = "a4807861f05fba0f3b1bc29a63a5b7b99a6cd7e2";
      fetchSubmodules = false;
      sha256 = "sha256-dVNaQfiiLiRYsIvO8xI6us/DdjwZo95lNglUFlVmjtI=";
    });
  };
  flyingfox = {
    pname = "flyingfox";
  ...
  jibri = {
    pname = "jibri";
    version = "8.0-125-g3997aaa";
    src = fetchurl {
      url = "https://download.jitsi.org/unstable/jibri_8.0-125-g3997aaa-1_all.deb";
      sha256 = "sha256-LINFByOqLyGhKlQ7JKhZxtacoecQ9Vsq6FLU7rTU1RE=";
    };
  };
  jicofo = {
    pname = "jicofo";
  ...
  jitsi-meet = {
    ...
    version = "1.0.6042";
    src = fetchurl {
      url = "https://download.jitsi.org/jitsi-meet/src/jitsi-meet-1.0.6042.tar.bz2";
      sha256 = "sha256-tl4eKus12OX2enQDUZIYvcUqI6O32pMnsTEaODu2lpg=";
    };
  };
  jitsi-meet-prosody = {
    ...
    version = "1.0.6042";
    src = fetchurl {
      url = "https://download.jitsi.org/unstable/jitsi-meet-prosody_1.0.6042-1_all.deb";
      sha256 = "sha256-aDsu0urQupfoyHUjE4PBLpyBl668GyY2+q5VUldowdk=";
    };
  };
  jitsi-videobridge2 = {
    pname = "jitsi-videobridge2";
    version = "2.1-654-gb016ab13";
    src = fetchurl {
      url = "https://download.jitsi.org/unstable/jitsi-videobridge2_2.1-654-gb016ab13-1_all.deb";
      sha256 = "sha256-mJ7Y4iYc8Dd5j4QkPEyLS+jSPjByKlS/V4CqIvEVFJg=";
    };
  };
  layout-machi = {
    pname = "layout-machi";
  ...
  microsoft-edge-beta = {
    ...
    src = fetchurl {
      ...
      sha256 = "sha256-FaMcKruY/KmtrTessRc4kAhbFhz/4IP1pqCGq//eqgM=";
    };
  };
  microsoft-edge-dev = {
  ...
  retroarch = {
    pname = "retroarch";
    version = "77b5e312033e477e7fa959618cdd4398ce5bca8d";
    src = fetchFromGitHub ({
      owner = "libretro";
      repo = "retroarch";
      rev = "77b5e312033e477e7fa959618cdd4398ce5bca8d";
      fetchSubmodules = false;
      sha256 = "sha256-Q0MDUtGgpFaqDa3rgkw5PlOKDIQyEzmpXG1L11A5Lzc=";
    });
  };
  rofi-wayland = {
    pname = "rofi-wayland";
  ...
  rustdesk = {
    pname = "rustdesk";
    version = "6d122d8aef810a197274ae4e8dc430124e66eb9f";
    src = fetchFromGitHub ({
      owner = "rustdesk";
      repo = "rustdesk";
      rev = "6d122d8aef810a197274ae4e8dc430124e66eb9f";
      fetchSubmodules = false;
      sha256 = "sha256-r3H+KiEXsvFAGvogbDc4uMXHfYrgtNJB9FKBqg7vh7Y=";
    });
    cargoLock = {
      lockFile = ./rustdesk-6d122d8aef810a197274ae4e8dc430124e66eb9f/Cargo.lock;
      outputHashes = {
