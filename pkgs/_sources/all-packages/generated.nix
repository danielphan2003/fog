...
{ fetchgit, fetchurl, fetchFromGitHub }:
{
  ...
  arkenfox-userjs = {
    ...
    version = "eb98f06d69610644db94860f3927e97b24b2d1ca";
    src = fetchFromGitHub ({
      owner = "arkenfox";
      repo = "user.js";
      rev = "eb98f06d69610644db94860f3927e97b24b2d1ca";
      fetchSubmodules = false;
      sha256 = "sha256-d+IsfxBn9iZJljoH/2ca+pqzxtyvJ6oKS2W2d3dNafE=";
    });
  };
  asusctl = {
    pname = "asusctl";
  ...
  dribbblish-dynamic-theme = {
    ...
    version = "6d23932d0ba8f8fd0da9b2d53638da3487983a63";
    src = fetchFromGitHub ({
      owner = "JulienMaille";
      repo = "dribbblish-dynamic-theme";
      rev = "6d23932d0ba8f8fd0da9b2d53638da3487983a63";
      fetchSubmodules = false;
      sha256 = "sha256-T3oUtyI/rceD8qacogdq0CgZTL4krlIE+c99IWtsWIE=";
    });
  };
  droidcam = {
    pname = "droidcam";
  ...
  jitsi-meet = {
    ...
    version = "1.0.6071";
    src = fetchurl {
      url = "https://download.jitsi.org/jitsi-meet/src/jitsi-meet-1.0.6071.tar.bz2";
      sha256 = "sha256-OcYrd6Z+8+wdKLeEPzWBqy79IuwWSAhNekJl5k/1A+k=";
    };
  };
  jitsi-meet-prosody = {
    ...
    version = "1.0.6071";
    src = fetchurl {
      url = "https://download.jitsi.org/unstable/jitsi-meet-prosody_1.0.6071-1_all.deb";
      sha256 = "sha256-OBljEq5PpidJucXbDhxJ+VrIFxlyDSkP7DvsnEuCi9A=";
    };
  };
  jitsi-videobridge2 = {
  ...
  retroarch = {
    pname = "retroarch";
    version = "044e1ec655eea7461542371668134d13a58cc5dd";
    src = fetchFromGitHub ({
      owner = "libretro";
      repo = "retroarch";
      rev = "044e1ec655eea7461542371668134d13a58cc5dd";
      fetchSubmodules = false;
      sha256 = "sha256-O6TU1LP2Il5l+yOwv/o4npNvcrMsyWjYBOv2qkWncdM=";
    });
  };
  rofi-wayland = {
    pname = "rofi-wayland";
  ...
  rustdesk = {
    pname = "rustdesk";
    version = "8d1f1a9ab487bc3ab36ee202b5261e932a7b7360";
    src = fetchFromGitHub ({
      owner = "rustdesk";
      repo = "rustdesk";
      rev = "8d1f1a9ab487bc3ab36ee202b5261e932a7b7360";
      fetchSubmodules = false;
      sha256 = "sha256-Pfe7IQKl8yoFcsW7JYqo/q5wujuMwQdFd7YSdlX6Kpw=";
    });
    cargoLock = {
      lockFile = ./rustdesk-8d1f1a9ab487bc3ab36ee202b5261e932a7b7360/Cargo.lock;
      outputHashes = {
  ...
  xwayland = {
    pname = "xwayland";
    version = "4422177d2659adef2cdf239e243fb7e1e262a9fd";
    src = fetchgit {
      url = "git://anongit.freedesktop.org/xorg/xserver";
      rev = "4422177d2659adef2cdf239e243fb7e1e262a9fd";
      fetchSubmodules = false;
      deepClone = false;
      leaveDotGit = false;
      sha256 = "sha256-Kf8VFZ5h7LXMX/AJ6+Cqev3/dvzTfc4/vF0EuG4P6/E=";
    };
  };
  ydotool = {
    pname = "ydotool";
