...
{ fetchgit, fetchurl, fetchFromGitHub }:
{
  ...
  bottles = {
    pname = "bottles";
    version = "328a860ebc8614f4153bc895efd6794003391db4";
    src = fetchFromGitHub ({
      owner = "bottlesdevs";
      repo = "Bottles";
      rev = "328a860ebc8614f4153bc895efd6794003391db4";
      fetchSubmodules = false;
      sha256 = "sha256-wjR6kqs82th7irrD+RoakQNZ5PqqC7Vp0cXQ7Qor7k4=";
    });
  };
  caddy = {
    pname = "caddy";
  ...
  ibus = {
    pname = "ibus";
    version = "787b564982d17017cb35ab87b71b6a16d7440387";
    src = fetchFromGitHub ({
      owner = "ibus";
      repo = "ibus";
      rev = "787b564982d17017cb35ab87b71b6a16d7440387";
      fetchSubmodules = false;
      sha256 = "sha256-tI0BfuGwOEO2/GeCs2DUMoKi/n9QrwFJE6zSScmny3Q=";
    });
  };
  ibus-bamboo = {
    pname = "ibus-bamboo";
