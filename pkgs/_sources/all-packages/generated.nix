...
{ fetchgit, fetchurl, fetchFromGitHub }:
{
  ...
  bottles = {
    pname = "bottles";
    version = "94c8f1f7efcc1087dacb389c65a8edd55979252d";
    src = fetchFromGitHub ({
      owner = "bottlesdevs";
      repo = "Bottles";
      rev = "94c8f1f7efcc1087dacb389c65a8edd55979252d";
      fetchSubmodules = false;
      sha256 = "sha256-3sTkjv6qNVH+SLijxksh7PnPiCChlY7WTTm9Y2o0wR8=";
    });
  };
  caddy = {
    pname = "caddy";
  ...
  cinny = {
    pname = "cinny";
    version = "a59aa2c30fddd64f1c03584141bb57b6465af2db";
    src = fetchFromGitHub ({
      owner = "ajbura";
      repo = "cinny";
      rev = "a59aa2c30fddd64f1c03584141bb57b6465af2db";
      fetchSubmodules = false;
      sha256 = "sha256-0K9DjCBIoc4HtNpoyGC21BZOpgk8f+FXVRCaxHhqBTs=";
    });
  };
  conduit = {
    pname = "conduit";
  ...
  ibus = {
    pname = "ibus";
    version = "dfd3fbf26fa4b5ff20512b166a8dd321afc10344";
    src = fetchFromGitHub ({
      owner = "ibus";
      repo = "ibus";
      rev = "dfd3fbf26fa4b5ff20512b166a8dd321afc10344";
      fetchSubmodules = false;
      sha256 = "sha256-XmjxixTw/gzBimJTsGG+H2fLlcJaPUvL9OhYBLxerVw=";
    });
  };
  ibus-bamboo = {
    pname = "ibus-bamboo";
  ...
  jitsi-meet = {
    ...
    version = "1.0.5833";
    src = fetchurl {
      url = "https://download.jitsi.org/jitsi-meet/src/jitsi-meet-1.0.5833.tar.bz2";
      sha256 = "sha256-0ONrOV35Qb2O0kgRT11p/qePnS3ThkfljFnrzz3VciU=";
    };
  };
  jitsi-meet-prosody = {
    ...
    version = "1.0.5833";
    src = fetchurl {
      url = "https://download.jitsi.org/unstable/jitsi-meet-prosody_1.0.5833-1_all.deb";
      sha256 = "sha256-4lYDYdL/9484UjLCT99ifoNVTy55Zyj/gyeNrpjfGS4=";
    };
  };
  jitsi-videobridge2 = {
  ...
  pmbootstrap-test = {
    ...
    version = "47410eafb9e7ad5583a3ffd9528bf54b9cebfad5";
    src = fetchgit {
      url = "https://gitlab.com/postmarketOS/pmbootstrap";
      rev = "47410eafb9e7ad5583a3ffd9528bf54b9cebfad5";
      fetchSubmodules = false;
      deepClone = false;
      leaveDotGit = false;
      sha256 = "sha256-OzkRLhUzsLdpGsCo/WSBprt+PI7pr8IWolb0EjseV/w=";
    };
  };
  pure = {
    pname = "pure";
  ...
  rustdesk = {
    pname = "rustdesk";
    version = "eb49af843c782a8e693e001020a79d6e00c08137";
    src = fetchFromGitHub ({
      owner = "rustdesk";
      repo = "rustdesk";
      rev = "eb49af843c782a8e693e001020a79d6e00c08137";
      fetchSubmodules = false;
      sha256 = "sha256-6da8z0Y2dTcMyoDijAYtr+Tr55rbozrla/ovuIxfp4E=";
    });
    cargoLock = {
      lockFile = ./rustdesk-eb49af843c782a8e693e001020a79d6e00c08137/Cargo.lock;
      outputHashes = {
  ...
  spicetify-cli = {
    pname = "spicetify-cli";
    version = "1543c417a3f60d13051463291db584c7e8e50086";
    src = fetchFromGitHub ({
      owner = "khanhas";
      repo = "spicetify-cli";
      rev = "1543c417a3f60d13051463291db584c7e8e50086";
      fetchSubmodules = false;
      sha256 = "sha256-NfMUNYXjzoJa1qud548eNJKEQ+UmVEmzXPdVEeOyxgE=";
    });
  };
  spicetify-themes = {
