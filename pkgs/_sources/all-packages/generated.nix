...
{ fetchgit, fetchurl, fetchFromGitHub }:
{
  ...
  awesome = {
    ...
    src = fetchFromGitHub ({
      ...
      fetchSubmodules = false;
      sha256 = "sha256-lE3qAh1VzoLkmjnFm172BaJTxwwyOhRezkVqvQqdqZc=";
    });
  };
  awestore = {
    pname = "awestore";
  ...
  bottles = {
    pname = "bottles";
    version = "15c07ee89447c1a426c40d1e4b663cbc21f113c0";
    src = fetchFromGitHub ({
      owner = "bottlesdevs";
      repo = "Bottles";
      rev = "15c07ee89447c1a426c40d1e4b663cbc21f113c0";
      fetchSubmodules = false;
      sha256 = "sha256-5pJb2B6P8rP58uQjanM0Ddgzp5QcowBBeXSvEUkmCDY=";
    });
  };
  caddy = {
    pname = "caddy";
  ...
  jitsi-meet = {
    ...
    version = "1.0.5972";
    src = fetchurl {
      url = "https://download.jitsi.org/jitsi-meet/src/jitsi-meet-1.0.5972.tar.bz2";
      sha256 = "sha256-nLoEqg0xSRbTJF+mIlzsqmfea8ZCE1NYtoI2k2EtJSA=";
    };
  };
  jitsi-meet-prosody = {
    ...
    version = "1.0.5972";
    src = fetchurl {
      url = "https://download.jitsi.org/unstable/jitsi-meet-prosody_1.0.5972-1_all.deb";
      sha256 = "sha256-ycl5W4LCID5aPXvaL0VLXbRSXNlwtJH2Cl2FypjEX+Y=";
    };
  };
  jitsi-videobridge2 = {
  ...
  retroarch = {
    pname = "retroarch";
    version = "1e31a8d5fdab7127150d7abd9085c37ab29b5e25";
    src = fetchFromGitHub ({
      owner = "libretro";
      repo = "retroarch";
      rev = "1e31a8d5fdab7127150d7abd9085c37ab29b5e25";
      fetchSubmodules = false;
      sha256 = "sha256-xy3qVax+sG3prjzlZ2H4rj9UlCpaTfERAE4lNuYcBjo=";
    });
  };
  rofi-wayland = {
    pname = "rofi-wayland";
  ...
  rustdesk = {
    pname = "rustdesk";
    version = "9136b3e3f8e7793f2020be84175a75cf96a55142";
    src = fetchFromGitHub ({
      owner = "rustdesk";
      repo = "rustdesk";
      rev = "9136b3e3f8e7793f2020be84175a75cf96a55142";
      fetchSubmodules = false;
      sha256 = "sha256-QTU97RGYafp0j75QsbbwLvwMajuu8NolAenmj/hBbxc=";
    });
    cargoLock = {
      lockFile = ./rustdesk-9136b3e3f8e7793f2020be84175a75cf96a55142/Cargo.lock;
      outputHashes = {
  ...
  tailscale = {
    pname = "tailscale";
    version = "21445b56a5a411ac4f58d76466fc84140b2ff96c";
    src = fetchFromGitHub ({
      owner = "tailscale";
      repo = "tailscale";
      rev = "21445b56a5a411ac4f58d76466fc84140b2ff96c";
      fetchSubmodules = false;
      sha256 = "sha256-wDg/7NqE1O9vDgQHfzvdg106+9rxLn1b8BV4HObN7GQ=";
    });
  };
  tailscale-systray = {
