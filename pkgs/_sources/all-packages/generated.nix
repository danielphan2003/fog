...
{ fetchgit, fetchurl, fetchFromGitHub }:
{
  ...
  bottles = {
    pname = "bottles";
    version = "fa8699598f2079fd84a04384916617116859dc2e";
    src = fetchFromGitHub ({
      owner = "bottlesdevs";
      repo = "Bottles";
      rev = "fa8699598f2079fd84a04384916617116859dc2e";
      fetchSubmodules = false;
      sha256 = "sha256-FqGsYF9kcKwLSHZO1oLJqQA06l5U4PrfFBmwJoT5vbE=";
    });
  };
  caddy = {
    pname = "caddy";
  ...
  conduit = {
    pname = "conduit";
    version = "0066f20bddb510308bdea9afbf3c19802e92a553";
    src = fetchgit {
      url = "https://gitlab.com/famedly/conduit";
      rev = "0066f20bddb510308bdea9afbf3c19802e92a553";
      fetchSubmodules = false;
      deepClone = false;
      leaveDotGit = false;
      sha256 = "sha256-+o833IjmFesmo0B+4xZB1gRNd6DPWnrCoDB2pvj0tUI=";
    };
    cargoLock = {
      lockFile = ./conduit-0066f20bddb510308bdea9afbf3c19802e92a553/Cargo.lock;
      outputHashes = {
  ...
  dnscrypt-proxy2 = {
    ...
    version = "f67e9cab32b40fb321ab56322eec7082890f9a4b";
    src = fetchFromGitHub ({
      owner = "DNSCrypt";
      repo = "dnscrypt-proxy";
      rev = "f67e9cab32b40fb321ab56322eec7082890f9a4b";
      fetchSubmodules = false;
      sha256 = "sha256-iuh/hSI35WL1F4ITbJ06rqIxbSWwDQROIRAi4EQsLNA=";
    });
  };
  doggo = {
    pname = "doggo";
  ...
  jitsi-meet = {
    ...
    version = "1.0.6036";
    src = fetchurl {
      url = "https://download.jitsi.org/jitsi-meet/src/jitsi-meet-1.0.6036.tar.bz2";
      sha256 = "sha256-BTLOnUNOPzkaywhdi5uJDawIm1750HGivOFqMi5ULD4=";
    };
  };
  jitsi-meet-prosody = {
    ...
    version = "1.0.6036";
    src = fetchurl {
      url = "https://download.jitsi.org/unstable/jitsi-meet-prosody_1.0.6036-1_all.deb";
      sha256 = "sha256-7DuZ+3kXfhRAS/8JU5DKlBS14vok4JJ5/Bz4YIHe6Gw=";
    };
  };
  jitsi-videobridge2 = {
  ...
  retroarch = {
    pname = "retroarch";
    version = "f353898a9d189c5b36c5a6c8dcb6812c8f8b68dc";
    src = fetchFromGitHub ({
      owner = "libretro";
      repo = "retroarch";
      rev = "f353898a9d189c5b36c5a6c8dcb6812c8f8b68dc";
      fetchSubmodules = false;
      sha256 = "sha256-ccG6mwiKQYvw+g/gJkCfi0KVKWl2UnjCaqNrgNKMamk=";
    });
  };
  rofi-wayland = {
    pname = "rofi-wayland";
  ...
  snui = {
    pname = "snui";
    version = "342032284fdeff78b74b1047f24a08b4161311c1";
    src = fetchgit {
      url = "https://gitlab.com/snakedye/snui";
      rev = "342032284fdeff78b74b1047f24a08b4161311c1";
      fetchSubmodules = false;
      deepClone = false;
      leaveDotGit = false;
      sha256 = "sha256-M/uGueKnNjZ1w4Cvx5hA2Vj8FrVnKJLIS4oGvNZ7qZs=";
    };
  };
  spicetify-cli = {
    pname = "spicetify-cli";
