...
{ fetchgit, fetchurl, fetchFromGitHub }:
{
  ...
  bottles = {
    pname = "bottles";
    version = "f7ac55c6c7045d93c3e09572f2c599557bffbeaa";
    src = fetchFromGitHub ({
      owner = "bottlesdevs";
      repo = "Bottles";
      rev = "f7ac55c6c7045d93c3e09572f2c599557bffbeaa";
      fetchSubmodules = false;
      sha256 = "sha256-P77sh6Z27K+vPN0LkWkIaTcBZFB+dK+ASF6b+3uI5M8=";
    });
  };
  caddy = {
    pname = "caddy";
  ...
  conduit = {
    pname = "conduit";
    version = "5a99460a4cf62d34f3a721bd7c77cf2ad3af59cb";
    src = fetchgit {
      url = "https://gitlab.com/famedly/conduit";
      rev = "5a99460a4cf62d34f3a721bd7c77cf2ad3af59cb";
      fetchSubmodules = false;
      deepClone = false;
      leaveDotGit = false;
      sha256 = "sha256-Otd3MLS7FAt2OrgN/VrIPZSbqfenbS7ReE47d1gw0CA=";
    };
    cargoLock = {
      lockFile = ./conduit-5a99460a4cf62d34f3a721bd7c77cf2ad3af59cb/Cargo.lock;
      outputHashes = {
  ...
  flameshot = {
    pname = "flameshot";
    version = "424b7fba3798efa4e85294403c182bfa5a203619";
    src = fetchFromGitHub ({
      owner = "flameshot-org";
      repo = "flameshot";
      rev = "424b7fba3798efa4e85294403c182bfa5a203619";
      fetchSubmodules = false;
      sha256 = "sha256-Ah2Mhx1xqHK2NFkvBTAnEUKZaKeA9FeTG3wMp7IvLMY=";
    });
  };
  flyingfox = {
    pname = "flyingfox";
