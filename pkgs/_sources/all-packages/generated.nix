...
{ fetchgit, fetchurl, fetchFromGitHub }:
{
  ...
  jitsi-meet = {
    ...
    version = "1.0.5934";
    src = fetchurl {
      url = "https://download.jitsi.org/jitsi-meet/src/jitsi-meet-1.0.5934.tar.bz2";
      sha256 = "sha256-JjqCz41rFCC+UIPIoOmoeOT9puDj7lKzECONZDIecQo=";
    };
  };
  jitsi-meet-prosody = {
    ...
    version = "1.0.5934";
    src = fetchurl {
      url = "https://download.jitsi.org/unstable/jitsi-meet-prosody_1.0.5934-1_all.deb";
      sha256 = "sha256-oM16A5oqmG7vk51uRJWFik3EGLI3Nf0RK85wwpaAcjk=";
    };
  };
  jitsi-videobridge2 = {
  ...
  rustdesk = {
    pname = "rustdesk";
    version = "565e81d32963792386a009c6c108a47faaeb6852";
    src = fetchFromGitHub ({
      owner = "rustdesk";
      repo = "rustdesk";
      rev = "565e81d32963792386a009c6c108a47faaeb6852";
      fetchSubmodules = false;
      sha256 = "sha256-+4jbYP0SsKXoCTDR5Jkv5/gSScxf0GP3E1BqTj5YXLw=";
    });
    cargoLock = {
      lockFile = ./rustdesk-565e81d32963792386a009c6c108a47faaeb6852/Cargo.lock;
      outputHashes = {
