...
{ fetchgit, fetchurl, fetchFromGitHub }:
{
  ...
  bottles = {
    pname = "bottles";
    version = "0a1c4a45a70d9ff33879085bbf92578898072bcc";
    src = fetchFromGitHub ({
      owner = "bottlesdevs";
      repo = "Bottles";
      rev = "0a1c4a45a70d9ff33879085bbf92578898072bcc";
      fetchSubmodules = false;
      sha256 = "sha256-uAgjlyJ8FuonFLruRguIDAS+XeFmv/bPRozQDQgUt7s=";
    });
  };
  caddy = {
    pname = "caddy";
  ...
  dribbblish-dynamic-theme = {
    ...
    version = "bb4462afdee60b5cb90f6bdda3601c9ffd33fc33";
    src = fetchFromGitHub ({
      owner = "JulienMaille";
      repo = "dribbblish-dynamic-theme";
      rev = "bb4462afdee60b5cb90f6bdda3601c9ffd33fc33";
      fetchSubmodules = false;
      sha256 = "sha256-xVHp1ym4R21J3WwpdMvO/ctLuOR73UNWEN9zWkdG5OM=";
    });
  };
  droidcam = {
    pname = "droidcam";
  ...
  eww = {
    pname = "eww";
    version = "6b7fa5d55ccd560a3c95b93caa2e945662953db8";
    src = fetchFromGitHub ({
      owner = "elkowar";
      repo = "eww";
    ...
    cargoLock = {
      lockFile = ./eww-6b7fa5d55ccd560a3c95b93caa2e945662953db8/Cargo.lock;
      outputHashes = { };
    };
  };
  ...
  hyprland = {
    pname = "hyprland";
    version = "fc14157d765ce44e634525b2c437808e20ec93d6";
    src = fetchFromGitHub ({
      owner = "vaxerski";
      repo = "hyprland";
      rev = "fc14157d765ce44e634525b2c437808e20ec93d6";
      fetchSubmodules = false;
      sha256 = "sha256-ZGauVf0Us6jP1Y1e5z2wAppu79Z5MlH03M26Is+nXHQ=";
    });
  };
  ibus = {
    pname = "ibus";
  ...
  jitsi-meet = {
    ...
    version = "1.0.6103";
    src = fetchurl {
      url = "https://download.jitsi.org/jitsi-meet/src/jitsi-meet-1.0.6103.tar.bz2";
      sha256 = "sha256-S4Kf7eG7MIsh9PS+MLx6zG0lVb0css/jcYhW2aLjZzk=";
    };
  };
  jitsi-meet-prosody = {
    ...
    version = "1.0.6103";
    src = fetchurl {
      url = "https://download.jitsi.org/unstable/jitsi-meet-prosody_1.0.6103-1_all.deb";
      sha256 = "sha256-+P5LS+VzUfUMe+ZLcvjYE22rs4YSF2tcXI9FICyGunM=";
    };
  };
  jitsi-videobridge2 = {
  ...
  retroarch = {
    pname = "retroarch";
    version = "1613ebdfb4b6e4f48af8d3d9ee9f9acba924dcc0";
    src = fetchFromGitHub ({
      owner = "libretro";
      repo = "retroarch";
      rev = "1613ebdfb4b6e4f48af8d3d9ee9f9acba924dcc0";
      fetchSubmodules = false;
      sha256 = "sha256-JVPUBfHJa8peF9HMI3lZMPKFv3Fbu5uAvT9JEbhHpng=";
    });
  };
  rofi-wayland = {
    pname = "rofi-wayland";
  ...
  rustdesk = {
    pname = "rustdesk";
    version = "7854ad5ee1740a7d78896c85ee8ef95cf8cd17dc";
    src = fetchFromGitHub ({
      owner = "rustdesk";
      repo = "rustdesk";
      rev = "7854ad5ee1740a7d78896c85ee8ef95cf8cd17dc";
      fetchSubmodules = false;
      sha256 = "sha256-GkG8G8hv8KPUdnebhzJRzcuhwVwH9J+P+1yYJkgA8WI=";
    });
    cargoLock = {
      lockFile = ./rustdesk-7854ad5ee1740a7d78896c85ee8ef95cf8cd17dc/Cargo.lock;
      outputHashes = {
  ...
  snui = {
    pname = "snui";
    version = "832271db18aa0a7d57d182c2a61b3a66c60f4477";
    src = fetchgit {
      url = "https://gitlab.com/snakedye/snui";
      rev = "832271db18aa0a7d57d182c2a61b3a66c60f4477";
      fetchSubmodules = false;
      deepClone = false;
      leaveDotGit = false;
      sha256 = "sha256-xz4YiExHPpMaH/VAjnKVKpOnTXkU37FgQBmntKI4qqU=";
    };
  };
  spicetify-cli = {
    pname = "spicetify-cli";
    version = "524e9855be42edd076ce42ebc46a8f87a9243b08";
    src = fetchFromGitHub ({
      owner = "khanhas";
      repo = "spicetify-cli";
      rev = "524e9855be42edd076ce42ebc46a8f87a9243b08";
      fetchSubmodules = false;
      sha256 = "sha256-g8EOpBjwZa1Qus3048zsJ1Yb6b+HsDHX3SLD23Vn6oc=";
    });
  };
  spicetify-themes = {
    pname = "spicetify-themes";
    version = "5630da75b981bf7f6e27f1cdfe28fc72d676afa1";
    src = fetchFromGitHub ({
      owner = "morpheusthewhite";
      repo = "spicetify-themes";
      rev = "5630da75b981bf7f6e27f1cdfe28fc72d676afa1";
      fetchSubmodules = false;
      sha256 = "sha256-ZLsIWfBrm6tD2bfIjoKRKl9c5QTll1esYFoAACk0OEw=";
    });
  };
  spotify = {
    pname = "spotify";
  ...
  tailscale = {
    pname = "tailscale";
    version = "e97209c6bf45f34f238a5cf58303d9f467e0d8fd";
    src = fetchFromGitHub ({
      owner = "tailscale";
      repo = "tailscale";
      rev = "e97209c6bf45f34f238a5cf58303d9f467e0d8fd";
      fetchSubmodules = false;
      sha256 = "sha256-u0Kr9pPvlqqgiOm9cncS/sPIHNl1lcKA87ZljO7M2Co=";
    });
  };
  tailscale-systray = {
  ...
  ulauncher = {
    pname = "ulauncher";
    version = "c0b9b88d75b1388864538b83924946881ca7f440";
    src = fetchFromGitHub ({
      owner = "Ulauncher";
      repo = "Ulauncher";
      rev = "c0b9b88d75b1388864538b83924946881ca7f440";
      fetchSubmodules = false;
      sha256 = "sha256-HBcercfPNJ+mAm5gS8JOa3EebIDVNFdt+gNudfyTusM=";
    });
  };
  ultimmc = {
    pname = "ultimmc";
  ...
  zoom-us = {
    ...
    version = "5.10.3.2778";
    src = fetchurl {
      url = "https://cdn.zoom.us/prod/5.10.3.2778/zoom_x86_64.pkg.tar.xz";
      sha256 = "sha256-R/AJuu4VsaKqhve5hs6hz+Xg0feaZejMgcf6sms5Buk=";
    };
  };
}
