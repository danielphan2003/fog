...
{ fetchgit, fetchurl, fetchFromGitHub }:
{
  ...
  bottles = {
    pname = "bottles";
    version = "f4672ecbcd42dad3698e2d64b1e855c2011b0c4b";
    src = fetchFromGitHub ({
      owner = "bottlesdevs";
      repo = "Bottles";
      rev = "f4672ecbcd42dad3698e2d64b1e855c2011b0c4b";
      fetchSubmodules = false;
      sha256 = "sha256-CCDLXyA0OJCF22GfbkbbrfdNxR6aoiUOZEszgRJltdo=";
    });
  };
  caddy = {
    pname = "caddy";
    version = "2e46c2ac1d860230a80de5fd7bc85c8c9429d3f4";
    src = fetchFromGitHub ({
      owner = "caddyserver";
      repo = "caddy";
      rev = "2e46c2ac1d860230a80de5fd7bc85c8c9429d3f4";
      fetchSubmodules = false;
      sha256 = "sha256-8Kc6vW2Xz0CX8buhoJM76VwWJ+qMuPkeRs6o6LGxFVM=";
    });
  };
  cups-pdf = {
    pname = "cups-pdf";
