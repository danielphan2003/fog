...
{ fetchgit, fetchurl, fetchFromGitHub }:
{
  ...
  bottles = {
    pname = "bottles";
    version = "5fdfb78482c482e3e12b1f1181bc204e09707c81";
    src = fetchFromGitHub ({
      owner = "bottlesdevs";
      repo = "Bottles";
      rev = "5fdfb78482c482e3e12b1f1181bc204e09707c81";
      fetchSubmodules = false;
      sha256 = "sha256-ISANdL+b33UIKulcpwJfVmGUECKsdZT6qWiKbb3pe5U=";
    });
  };
  caddy = {
    pname = "caddy";
    version = "4b9849c7922c3a0a7b1bd487f5d890fcff32aaba";
    src = fetchFromGitHub ({
      owner = "caddyserver";
      repo = "caddy";
      rev = "4b9849c7922c3a0a7b1bd487f5d890fcff32aaba";
      fetchSubmodules = false;
      sha256 = "sha256-9LqcH8XMZ95l4qnf+dXciLOnrTIvXL7sVHZm+I8Eek8=";
    });
  };
  conduit = {
    pname = "conduit";
  ...
  jitsi-meet = {
    ...
    version = "1.0.5740";
    src = fetchurl {
      url = "https://download.jitsi.org/jitsi-meet/src/jitsi-meet-1.0.5740.tar.bz2";
      sha256 = "sha256-iiFr3H21S11O4JwYf4MwUlAQQ75u+MVmIqXRck9wGuI=";
    };
  };
  jitsi-meet-prosody = {
    ...
    version = "1.0.5740";
    src = fetchurl {
      url = "https://download.jitsi.org/unstable/jitsi-meet-prosody_1.0.5740-1_all.deb";
      sha256 = "sha256-/lT0eEjPeNRce3Kh5D9qoQrkqg/+tfUORl6zQpoVrD8=";
    };
  };
  jitsi-videobridge2 = {
  ...
  retroarch = {
    pname = "retroarch";
    version = "7ca3c314f8fb63afca0b4091a1ba76113193ad13";
    src = fetchFromGitHub ({
      owner = "libretro";
      repo = "retroarch";
      rev = "7ca3c314f8fb63afca0b4091a1ba76113193ad13";
      fetchSubmodules = false;
      sha256 = "sha256-E1XaqD9RrR1yKdccJvz8ejSHhhULq1Dhlu++SMa29E4=";
    });
  };
  rofi-wayland = {
    pname = "rofi-wayland";
  ...
  rustdesk = {
    pname = "rustdesk";
    version = "089acaa6e7f15cc849f6b40357739d38942f1ddb";
    src = fetchFromGitHub ({
      owner = "rustdesk";
      repo = "rustdesk";
      rev = "089acaa6e7f15cc849f6b40357739d38942f1ddb";
      fetchSubmodules = false;
      sha256 = "sha256-o8Yc7tK8bYwY2n+Qbv5AxQuGKUqk/i4eEyzcSFQfrQs=";
    });
    cargoLock = {
      lockFile = ./rustdesk-089acaa6e7f15cc849f6b40357739d38942f1ddb/Cargo.lock;
      outputHashes = {
  ...
  tailscale = {
    pname = "tailscale";
    version = "138662e248cbe1170812c0d23ecf7cd3a7080c92";
    src = fetchFromGitHub ({
      owner = "tailscale";
      repo = "tailscale";
      rev = "138662e248cbe1170812c0d23ecf7cd3a7080c92";
      fetchSubmodules = false;
      sha256 = "sha256-UEG1wiu6E8rS+WYkWIwAD2vmvd1et8Hya9hOa+N4Tb8=";
    });
  };
  tailscale-systray = {
