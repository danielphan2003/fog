...
{ fetchgit, fetchurl, fetchFromGitHub }:
{
  ...
  bottles = {
    pname = "bottles";
    version = "ec6001b9270cc78d2250b114e1e0f8b0174b6bdd";
    src = fetchFromGitHub ({
      owner = "bottlesdevs";
      repo = "Bottles";
      rev = "ec6001b9270cc78d2250b114e1e0f8b0174b6bdd";
      fetchSubmodules = false;
      sha256 = "sha256-hyXRFt2CD5TnUDob81GQnUwI2CRtrkxTjTH62Bxx7vg=";
    });
  };
  caddy = {
    pname = "caddy";
  ...
  tailscale = {
    pname = "tailscale";
    version = "f2041c90882204d7499bbabe56284a0c2a7057b7";
    src = fetchFromGitHub ({
      owner = "tailscale";
      repo = "tailscale";
      rev = "f2041c90882204d7499bbabe56284a0c2a7057b7";
      fetchSubmodules = false;
      sha256 = "sha256-f0ldbCGWDapDMQF1voGltc1TsslreE2fs3tPhu12t6Y=";
    });
  };
  tailscale-systray = {
