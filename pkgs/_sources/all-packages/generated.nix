...
{ fetchgit, fetchurl, fetchFromGitHub }:
{
  ...
  bottles = {
    pname = "bottles";
    version = "7e1fd6478a274f094cc522de89eca6f3b30b0b23";
    src = fetchFromGitHub ({
      owner = "bottlesdevs";
      repo = "Bottles";
      rev = "7e1fd6478a274f094cc522de89eca6f3b30b0b23";
      fetchSubmodules = false;
      sha256 = "sha256-Ncy6FGn8ZLJ0XqPa3KL6kV6WpYVm/0YlVoDn9sbch4U=";
    });
  };
  caddy = {
    pname = "caddy";
  ...
  dnscrypt-proxy2 = {
    ...
    version = "e931b234b7f4ee9c8cdada0cda864579ac4321b2";
    src = fetchFromGitHub ({
      owner = "DNSCrypt";
      repo = "dnscrypt-proxy";
      rev = "e931b234b7f4ee9c8cdada0cda864579ac4321b2";
      fetchSubmodules = false;
      sha256 = "sha256-Z8DFLEM5StJzwsAB4nmoyIAOZSCFx6n2Z5rLVfciY10=";
    });
  };
  doggo = {
    pname = "doggo";
  ...
  jitsi-meet = {
    ...
    version = "1.0.6035";
    src = fetchurl {
      url = "https://download.jitsi.org/jitsi-meet/src/jitsi-meet-1.0.6035.tar.bz2";
      sha256 = "sha256-2Y3fpbsMonaAecp+Zz5BwPMtqV7AKKSSFNxVGVUK3ic=";
    };
  };
  jitsi-meet-prosody = {
    ...
    version = "1.0.6035";
    src = fetchurl {
      url = "https://download.jitsi.org/unstable/jitsi-meet-prosody_1.0.6035-1_all.deb";
      sha256 = "sha256-0fzA2Zk+OUGEvfBvUMoklAa/mhS6Fj5tGY8635vmNVw=";
    };
  };
  jitsi-videobridge2 = {
    pname = "jitsi-videobridge2";
    version = "2.1-653-g82b1ba3f";
    src = fetchurl {
      url = "https://download.jitsi.org/unstable/jitsi-videobridge2_2.1-653-g82b1ba3f-1_all.deb";
      sha256 = "sha256-djixnMryJe236dC/BJ2EUC4OgBbCBKoTssJF9CSuX1A=";
    };
  };
  layout-machi = {
    pname = "layout-machi";
  ...
  retroarch = {
    pname = "retroarch";
    version = "81946293145dfd3d0c6518ad493ad3586407f727";
    src = fetchFromGitHub ({
      owner = "libretro";
      repo = "retroarch";
      rev = "81946293145dfd3d0c6518ad493ad3586407f727";
      fetchSubmodules = false;
      sha256 = "sha256-T7n+0cktULGW7ELn/8EcoV5obXXVxUHmhOYvf3cvaH0=";
    });
  };
  rofi-wayland = {
    pname = "rofi-wayland";
