...
{ fetchgit, fetchurl, fetchFromGitHub }:
{
  ...
  rustdesk = {
    pname = "rustdesk";
    version = "6a11981675a5147eefb34d9161aeb852e3f6cec7";
    src = fetchFromGitHub ({
      owner = "rustdesk";
      repo = "rustdesk";
      rev = "6a11981675a5147eefb34d9161aeb852e3f6cec7";
      fetchSubmodules = false;
      sha256 = "sha256-nfEuzxWpCcO2Ts7TrKRRD2C+4vOMKnHVpK2+K4rJhek=";
    });
    cargoLock = {
      lockFile = ./rustdesk-6a11981675a5147eefb34d9161aeb852e3f6cec7/Cargo.lock;
      outputHashes = {
  ...
  ulauncher = {
    pname = "ulauncher";
    version = "54d3a1e1133aa55763ca0d952872643914de3491";
    src = fetchFromGitHub ({
      owner = "Ulauncher";
      repo = "Ulauncher";
      rev = "54d3a1e1133aa55763ca0d952872643914de3491";
      fetchSubmodules = false;
      sha256 = "sha256-RImWjNKQ2vxEQH39YT6rxB+LI0k0dss/5TRk9fxPrTs=";
    });
  };
  ultimmc = {
    pname = "ultimmc";
