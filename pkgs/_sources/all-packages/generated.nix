...
{ fetchgit, fetchurl, fetchFromGitHub }:
{
  ...
  hyprland = {
    pname = "hyprland";
    version = "8f0aa6c941733ac5b540de27909b9b279be61aae";
    src = fetchFromGitHub ({
      owner = "vaxerski";
      repo = "hyprland";
      rev = "8f0aa6c941733ac5b540de27909b9b279be61aae";
      fetchSubmodules = false;
      sha256 = "sha256-g/R2RsRKGYK/4pIEm5+M2REZrPt5JhUS7f3C9TZNpBg=";
    });
  };
  ibus = {
    pname = "ibus";
  ...
  rustdesk = {
    pname = "rustdesk";
    version = "bc4d727ffd835fe2dbaa113225f23dc9f10639ed";
    src = fetchFromGitHub ({
      owner = "rustdesk";
      repo = "rustdesk";
      rev = "bc4d727ffd835fe2dbaa113225f23dc9f10639ed";
      fetchSubmodules = false;
      sha256 = "sha256-DTepgkuaQAdDsauzie6PA2nll0cTZ1tdIQhfG+8GqA0=";
    });
    cargoLock = {
      lockFile = ./rustdesk-bc4d727ffd835fe2dbaa113225f23dc9f10639ed/Cargo.lock;
      outputHashes = {
