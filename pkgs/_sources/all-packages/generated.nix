...
{ fetchgit, fetchurl, fetchFromGitHub }:
{
  ...
  bottles = {
    pname = "bottles";
    version = "812a4f5a0cdb93f92992175048040fcbd3adb3e7";
    src = fetchFromGitHub ({
      owner = "bottlesdevs";
      repo = "Bottles";
      rev = "812a4f5a0cdb93f92992175048040fcbd3adb3e7";
      fetchSubmodules = false;
      sha256 = "sha256-Jf4sbhH7tQZlTMhB6mJPUWc3gEYbKsIKzjgcEkP3vAg=";
    });
  };
  caddy = {
    pname = "caddy";
  ...
  tailscale = {
    pname = "tailscale";
    version = "8c3c5e80b7d40aeb1e1ed54a26a700bd59f1b8cb";
    src = fetchFromGitHub ({
      owner = "tailscale";
      repo = "tailscale";
      rev = "8c3c5e80b7d40aeb1e1ed54a26a700bd59f1b8cb";
      fetchSubmodules = false;
      sha256 = "sha256-uh0UxGFP0Og0l4f/EgywmMEu7e2ujmeSaTwo+yr2HB0=";
    });
  };
  tailscale-systray = {
