...
{ fetchgit, fetchurl, fetchFromGitHub }:
{
  ...
  rustdesk = {
    pname = "rustdesk";
    version = "8ea5d80f01bf191d215f141fbfa4f67eee5d1dee";
    src = fetchFromGitHub ({
      owner = "rustdesk";
      repo = "rustdesk";
      rev = "8ea5d80f01bf191d215f141fbfa4f67eee5d1dee";
      fetchSubmodules = false;
      sha256 = "sha256-9MfRUV4h1IiW+V2sH5e0b0JhaXD/t26W9/2kCsJ3srU=";
    });
    cargoLock = {
      lockFile = ./rustdesk-8ea5d80f01bf191d215f141fbfa4f67eee5d1dee/Cargo.lock;
      outputHashes = {
  ...
  tailscale = {
    pname = "tailscale";
    version = "e6626366a2b80d215c0a94bfd97f18d9efa5e4ab";
    src = fetchFromGitHub ({
      owner = "tailscale";
      repo = "tailscale";
      rev = "e6626366a2b80d215c0a94bfd97f18d9efa5e4ab";
      fetchSubmodules = false;
      sha256 = "sha256-6vMu90tca7AyzsnilZJ6wtdDbdm07/l7OcKd4I3uAys=";
    });
  };
  tailscale-systray = {
