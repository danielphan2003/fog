...
{ fetchgit, fetchurl, fetchFromGitHub }:
{
  ...
  bottles = {
    pname = "bottles";
    version = "516bc34ac97ca9049cb8dace8f669528842aadd4";
    src = fetchFromGitHub ({
      owner = "bottlesdevs";
      repo = "Bottles";
      rev = "516bc34ac97ca9049cb8dace8f669528842aadd4";
      fetchSubmodules = false;
      sha256 = "sha256-PDT8eLWg7PcF/swXhtwoKxXddlQHOvdbSH8mkYVd/IY=";
    });
  };
  caddy = {
    pname = "caddy";
  ...
  rustdesk = {
    pname = "rustdesk";
    version = "2ec5f8fe7ed94019b59c0500d6f47cd12f5d5f04";
    src = fetchFromGitHub ({
      owner = "rustdesk";
      repo = "rustdesk";
      rev = "2ec5f8fe7ed94019b59c0500d6f47cd12f5d5f04";
      fetchSubmodules = false;
      sha256 = "sha256-HBOeSqqLc+CDef03uvHFTKI48wgeXMPMWgKaoa7DnZA=";
    });
    cargoLock = {
      lockFile = ./rustdesk-2ec5f8fe7ed94019b59c0500d6f47cd12f5d5f04/Cargo.lock;
      outputHashes = {
