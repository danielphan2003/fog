...
{ fetchgit, fetchurl, fetchFromGitHub }:
{
  ...
  retroarch = {
    pname = "retroarch";
    version = "7b95f3e2eab74ce129387bdb14cfe9f1e2eb3011";
    src = fetchFromGitHub ({
      owner = "libretro";
      repo = "retroarch";
      rev = "7b95f3e2eab74ce129387bdb14cfe9f1e2eb3011";
      fetchSubmodules = false;
      sha256 = "sha256-0UOhGpahwLvBLxpfa/xXF8MeR91LJsYjUM157Y1uZp4=";
    });
  };
  rofi-wayland = {
    pname = "rofi-wayland";
  ...
  rustdesk = {
    pname = "rustdesk";
    version = "222245a60c36f885fd7077374077cfaf01077a4a";
    src = fetchFromGitHub ({
      owner = "rustdesk";
      repo = "rustdesk";
      rev = "222245a60c36f885fd7077374077cfaf01077a4a";
      fetchSubmodules = false;
      sha256 = "sha256-LWDfiGC2VWtvZzZa0FS75F18ZURnpCOtbagTApYQvCs=";
    });
    cargoLock = {
      lockFile = ./rustdesk-222245a60c36f885fd7077374077cfaf01077a4a/Cargo.lock;
      outputHashes = {
  ...
  ulauncher = {
    pname = "ulauncher";
    version = "4d4f6071f30d0ae3e93e0f35d4f1392d7e96298d";
    src = fetchFromGitHub ({
      owner = "Ulauncher";
      repo = "Ulauncher";
      rev = "4d4f6071f30d0ae3e93e0f35d4f1392d7e96298d";
      fetchSubmodules = false;
      sha256 = "sha256-pASsN3F3KO9hBPGAmV1JGgcIW8fCftFQDBO5KVSnuxY=";
    });
  };
  ultimmc = {
    pname = "ultimmc";
