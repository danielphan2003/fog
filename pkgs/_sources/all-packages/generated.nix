...
{ fetchgit, fetchurl, fetchFromGitHub }:
{
  ...
  bottles = {
    pname = "bottles";
    version = "184e920053adfb8736309818d08edf515ba64b92";
    src = fetchFromGitHub ({
      owner = "bottlesdevs";
      repo = "Bottles";
      rev = "184e920053adfb8736309818d08edf515ba64b92";
      fetchSubmodules = false;
      sha256 = "sha256-oHdfvO93bG5KAhNh2Ofq6wICp8+Gf3hUH3tFq/4LwLg=";
    });
  };
  caddy = {
    pname = "caddy";
  ...
  flameshot = {
    pname = "flameshot";
    version = "883e55c52db375a77b1343311f0f39a6a78cc600";
    src = fetchFromGitHub ({
      owner = "flameshot-org";
      repo = "flameshot";
      rev = "883e55c52db375a77b1343311f0f39a6a78cc600";
      fetchSubmodules = false;
      sha256 = "sha256-jd+u8S0JUkxLH2aXFhuP630EPL7ugTmGpQ9jM+DeR/8=";
    });
  };
  flyingfox = {
    pname = "flyingfox";
  ...
  jitsi-meet = {
    ...
    version = "1.0.5728";
    src = fetchurl {
      url = "https://download.jitsi.org/jitsi-meet/src/jitsi-meet-1.0.5728.tar.bz2";
      sha256 = "sha256-uEbU/E67WUm2wfUxh4Z3CU4hXbPpF4XMwTOSFhw2j2M=";
    };
  };
  jitsi-meet-prosody = {
    ...
    version = "1.0.5728";
    src = fetchurl {
      url = "https://download.jitsi.org/unstable/jitsi-meet-prosody_1.0.5728-1_all.deb";
      sha256 = "sha256-tCW0SOVRAdOdPPlRTHtdOZPymPpRe/ySZ97e33PlIzs=";
    };
  };
  jitsi-videobridge2 = {
  ...
  rustdesk = {
    pname = "rustdesk";
    version = "1b61b77fbeb2b3ce056a6617856cb5d9d73dca53";
    src = fetchFromGitHub ({
      owner = "rustdesk";
      repo = "rustdesk";
      rev = "1b61b77fbeb2b3ce056a6617856cb5d9d73dca53";
      fetchSubmodules = false;
      sha256 = "sha256-GNC7WoyzfRzjddrKdOhxk12Q/ArzaU26rre8C/yL3m4=";
    });
    cargoLock = {
      lockFile = ./rustdesk-1b61b77fbeb2b3ce056a6617856cb5d9d73dca53/Cargo.lock;
      outputHashes = {
