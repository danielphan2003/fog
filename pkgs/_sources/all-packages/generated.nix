...
{ fetchgit, fetchurl, fetchFromGitHub }:
{
  ...
  awesome = {
    pname = "awesome";
    version = "e26069682635b734d61c251e261d8fcadcd7522c";
    src = fetchFromGitHub ({
      owner = "awesomeWM";
      repo = "awesome";
  ...
  jitsi-meet = {
    ...
    version = "1.0.5863";
    src = fetchurl {
      url = "https://download.jitsi.org/jitsi-meet/src/jitsi-meet-1.0.5863.tar.bz2";
      sha256 = "sha256-krb07JazCZAcyBF/MEUplgvrpULKdLzlaCxK5o8zt88=";
    };
  };
  jitsi-meet-prosody = {
    ...
    version = "1.0.5863";
    src = fetchurl {
      url = "https://download.jitsi.org/unstable/jitsi-meet-prosody_1.0.5863-1_all.deb";
      sha256 = "sha256-pc7nKOKCbojwdNkdAjQRSpn16pTikE48zY1Inn4sH28=";
    };
  };
  jitsi-videobridge2 = {
  ...
  retroarch = {
    pname = "retroarch";
    version = "0e22b1ec739e97918de257eb8d3014310d050b4f";
    src = fetchFromGitHub ({
      owner = "libretro";
      repo = "retroarch";
      rev = "0e22b1ec739e97918de257eb8d3014310d050b4f";
      fetchSubmodules = false;
      sha256 = "sha256-vuFfSeRuZjEEdodPXbZP/60A5+lyWd64EIQLzBnX7vk=";
    });
  };
  rofi-wayland = {
    pname = "rofi-wayland";
  ...
  tailscale = {
    pname = "tailscale";
    version = "1dc4151f8b96817d6e30b7b00469ebddf15ae2a5";
    src = fetchFromGitHub ({
      owner = "tailscale";
      repo = "tailscale";
      rev = "1dc4151f8b96817d6e30b7b00469ebddf15ae2a5";
      fetchSubmodules = false;
      sha256 = "sha256-qFy6NHzdouLUnK1AWKmrw20zG7caRfjEFuvJmL1AWh0=";
    });
  };
  tailscale-systray = {
