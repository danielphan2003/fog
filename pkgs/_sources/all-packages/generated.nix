...
{ fetchgit, fetchurl, fetchFromGitHub }:
{
  ...
  rustdesk = {
    pname = "rustdesk";
    version = "4df09f4aec2fe02925acfa47b6b8b2595a18f33f";
    src = fetchFromGitHub ({
      owner = "rustdesk";
      repo = "rustdesk";
      rev = "4df09f4aec2fe02925acfa47b6b8b2595a18f33f";
      fetchSubmodules = false;
      sha256 = "sha256-Uusl2t83x5W9MHuQ2Kt2qGnaVwcHa5WRvmy9OlAQwOs=";
    });
    cargoLock = {
      lockFile = ./rustdesk-4df09f4aec2fe02925acfa47b6b8b2595a18f33f/Cargo.lock;
      outputHashes = {
  ...
  waydroid = {
    pname = "waydroid";
    version = "9bee074239199570d70630281ff0053253675044";
    src = fetchFromGitHub ({
      owner = "waydroid";
      repo = "waydroid";
      rev = "9bee074239199570d70630281ff0053253675044";
      fetchSubmodules = false;
      sha256 = "sha256-r2kCMLHemosG0taMCqk7S+2wisWg06PA6Yz9Vgmzl8o=";
    });
  };
  wgcf = {
    pname = "wgcf";
