...
{ fetchgit, fetchurl, fetchFromGitHub }:
{
  ...
  bottles = {
    pname = "bottles";
    version = "a76d873367803949f51c0fc4896c5ce1006f3b95";
    src = fetchFromGitHub ({
      owner = "bottlesdevs";
      repo = "Bottles";
      rev = "a76d873367803949f51c0fc4896c5ce1006f3b95";
      fetchSubmodules = false;
      sha256 = "sha256-cWda63pWyyPHiMVb7aFq0m285Ni5ta3ujs27mDSCyaM=";
    });
  };
  caddy = {
    pname = "caddy";
  ...
  ibus = {
    pname = "ibus";
    version = "ad95015dc411f84dd9b8869e596e4707cd2ccd2b";
    src = fetchFromGitHub ({
      owner = "ibus";
      repo = "ibus";
      rev = "ad95015dc411f84dd9b8869e596e4707cd2ccd2b";
      fetchSubmodules = false;
      sha256 = "sha256-XndRnXZ/y2sNtKQJh8RajopNlaH3dgyl8oT9vXsEeGc=";
    });
  };
  ibus-bamboo = {
    pname = "ibus-bamboo";
  ...
  retroarch = {
    pname = "retroarch";
    version = "42e03cae8340713040d23a92d3104a70af6cf585";
    src = fetchFromGitHub ({
      owner = "libretro";
      repo = "retroarch";
      rev = "42e03cae8340713040d23a92d3104a70af6cf585";
      fetchSubmodules = false;
      sha256 = "sha256-iNsGL/JXxrGQ5cd1TZT8rTol5Im9bRCYBThrBEyq7w4=";
    });
  };
  rofi-wayland = {
    pname = "rofi-wayland";
