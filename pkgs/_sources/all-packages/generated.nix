...
{ fetchgit, fetchurl, fetchFromGitHub }:
{
  ...
  bottles = {
    pname = "bottles";
    version = "c25a17301f1bad1cbaba645b8e5ef975b656eb4b";
    src = fetchFromGitHub ({
      owner = "bottlesdevs";
      repo = "Bottles";
      rev = "c25a17301f1bad1cbaba645b8e5ef975b656eb4b";
      fetchSubmodules = false;
      sha256 = "sha256-kYgemCUs5N5HvRxHDX9bAjDN4V6HmfMLjTJ+35UnUMI=";
    });
  };
  caddy = {
    pname = "caddy";
  ...
  tailscale = {
    pname = "tailscale";
    version = "575aacb1e2a907f9eed9bc2f9eac14460176b47d";
    src = fetchFromGitHub ({
      owner = "tailscale";
      repo = "tailscale";
      rev = "575aacb1e2a907f9eed9bc2f9eac14460176b47d";
      fetchSubmodules = false;
      sha256 = "sha256-J2xIl9jtZZTVpeP1iHGRnswigfiNSR9SMgzg6xV8EbA=";
    });
  };
  tailscale-systray = {
