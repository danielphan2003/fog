...
{ fetchgit, fetchurl, fetchFromGitHub }:
{
  ...
  hyprland = {
    pname = "hyprland";
    version = "8a8877e7390fbc1f387fe931848598b5ecb5609b";
    src = fetchFromGitHub ({
      owner = "vaxerski";
      repo = "hyprland";
      rev = "8a8877e7390fbc1f387fe931848598b5ecb5609b";
      fetchSubmodules = false;
      sha256 = "sha256-2OFXxSJ/hdo5Sq2g9GhmvafrYttJ/71u5viZ+hXJUBA=";
    });
  };
  ibus = {
    pname = "ibus";
  ...
  tailscale = {
    pname = "tailscale";
    version = "3ffd88a84acdfc585767cced9b703ed544789590";
    src = fetchFromGitHub ({
      owner = "tailscale";
      repo = "tailscale";
      rev = "3ffd88a84acdfc585767cced9b703ed544789590";
      fetchSubmodules = false;
      sha256 = "sha256-ntGQ7s+Oj4SmyyOnbwfs2BgGWAmOpJ5JN8Ubew+Z2mI=";
    });
  };
  tailscale-systray = {
