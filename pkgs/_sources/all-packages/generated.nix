...
{ fetchgit, fetchurl, fetchFromGitHub }:
{
  ...
  bottles = {
    pname = "bottles";
    version = "d6853058b2fc2e96096fae0b9468bc3b4ea1221b";
    src = fetchFromGitHub ({
      owner = "bottlesdevs";
      repo = "Bottles";
      rev = "d6853058b2fc2e96096fae0b9468bc3b4ea1221b";
      fetchSubmodules = false;
      sha256 = "sha256-OQU9QoZO3R9bPtn8EtxYE5qnm1jzkQyeAHqX+y+ltIQ=";
    });
  };
  caddy = {
    pname = "caddy";
  ...
  dribbblish-dynamic-theme = {
    ...
    version = "167e253a8614515cfc60e7c8a005acd5a2e2d3c7";
    src = fetchFromGitHub ({
      owner = "JulienMaille";
      repo = "dribbblish-dynamic-theme";
      rev = "167e253a8614515cfc60e7c8a005acd5a2e2d3c7";
      fetchSubmodules = false;
      sha256 = "sha256-ia1DMRbWff3I+1pYUfc5Vd6lqFu94JobG+/auzRzGsQ=";
    });
  };
  droidcam = {
    pname = "droidcam";
  ...
  duf = {
    pname = "duf";
    version = "9504b9862ce85ddfb3c2edf014420396eeab3006";
    src = fetchFromGitHub ({
      owner = "muesli";
      repo = "duf";
      rev = "9504b9862ce85ddfb3c2edf014420396eeab3006";
      fetchSubmodules = false;
      sha256 = "sha256-UtjkdFiqnGk+wlSkVn+79xqdMazUq2BAVMVHVJXvgMo=";
    });
  };
  eww = {
    pname = "eww";
  ...
  guiscrcpy = {
    pname = "guiscrcpy";
    version = "2f055ab8317761295fafd076fda5bf2aaaea0f42";
    src = fetchFromGitHub ({
      owner = "srevinsaju";
      repo = "guiscrcpy";
      rev = "2f055ab8317761295fafd076fda5bf2aaaea0f42";
      fetchSubmodules = false;
      sha256 = "sha256-VXZOQr10LHEyD8EECNWYWpkMLilsQIsXMHqtELmLjIo=";
    });
  };
  ibus = {
    pname = "ibus";
  ...
  microsoft-edge-beta = {
    ...
    src = fetchurl {
      url = "https://packages.microsoft.com/repos/edge/pool/main/m/microsoft-edge-beta/microsoft-edge-beta_99.0.1150.25-1_amd64.deb";
      sha256 = "sha256-Dgn0ePxP0IjYZNMmnL6GrwO3KK4TLCeIb8chRdM5K9M=";
    };
  };
  microsoft-edge-dev = {
  ...
  spicetify-cli = {
    pname = "spicetify-cli";
    version = "0824e1656dcfcf783c3fccfb19bf0418b7c06933";
    src = fetchFromGitHub ({
      owner = "khanhas";
      repo = "spicetify-cli";
      rev = "0824e1656dcfcf783c3fccfb19bf0418b7c06933";
      fetchSubmodules = false;
      sha256 = "sha256-As/lvHLAoFi7Ncw3IPWHW3HI6y9uuLcVmvQlE/2CL4M=";
    });
  };
  spicetify-themes = {
  ...
  tailscale = {
    pname = "tailscale";
    version = "5d085a6f4196c4213a37be4a9f405d2478bec3f7";
    src = fetchFromGitHub ({
      owner = "tailscale";
      repo = "tailscale";
      rev = "5d085a6f4196c4213a37be4a9f405d2478bec3f7";
      fetchSubmodules = false;
      sha256 = "sha256-d96Ovim7hFVmYv5W5w6OAGR3SNO4lZeby9eNJfxcz90=";
    });
  };
  tailscale-systray = {
