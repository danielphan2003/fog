...
{ fetchgit, fetchurl, fetchFromGitHub }:
{
  ...
  duf = {
    pname = "duf";
    version = "eb5190d0b26f7ba0ac642fb8d5d9910cbe9869ab";
    src = fetchFromGitHub ({
      owner = "muesli";
      repo = "duf";
      rev = "eb5190d0b26f7ba0ac642fb8d5d9910cbe9869ab";
      fetchSubmodules = false;
      sha256 = "sha256-YbuE2/NImVif/girlI/dfDqWsfK4V89tAYqrCAIvP78=";
    });
  };
  eww = {
    pname = "eww";
  ...
  retroarch = {
    pname = "retroarch";
    version = "3f6d8508a4610cfc7616638ebbb38ee777ded63a";
    src = fetchFromGitHub ({
      owner = "libretro";
      repo = "retroarch";
      rev = "3f6d8508a4610cfc7616638ebbb38ee777ded63a";
      fetchSubmodules = false;
      sha256 = "sha256-QCgeIFUSJzgPa4kNYqxoHGQHmGi4kFVmsK0b/p0I1Iw=";
    });
  };
  rofi-wayland = {
    pname = "rofi-wayland";
  ...
  rustdesk = {
    pname = "rustdesk";
    version = "1c447fe4388801e1503f64587aab2fd16a3161b7";
    src = fetchFromGitHub ({
      owner = "rustdesk";
      repo = "rustdesk";
      rev = "1c447fe4388801e1503f64587aab2fd16a3161b7";
      fetchSubmodules = false;
      sha256 = "sha256-srQwc/etUvmTeveUj+UN2W3wdd5YFGOoVSzb4+DKbqQ=";
    });
    cargoLock = {
      lockFile = ./rustdesk-1c447fe4388801e1503f64587aab2fd16a3161b7/Cargo.lock;
      outputHashes = {
  ...
  snui = {
    pname = "snui";
    version = "ac0cef6b18ba408672c4acaf2d93c7dc813cdc25";
    src = fetchgit {
      url = "https://gitlab.com/snakedye/snui";
      rev = "ac0cef6b18ba408672c4acaf2d93c7dc813cdc25";
      fetchSubmodules = false;
      deepClone = false;
      leaveDotGit = false;
      sha256 = "sha256-sa7r2lZUM3zIBpMEB1B1qE9yTFjBS8964ASqclLo6T0=";
    };
  };
  spicetify-cli = {
    pname = "spicetify-cli";
  ...
  ulauncher = {
    pname = "ulauncher";
    version = "ae35dc9eb54faa52a514de2d675cd74ab4399b29";
    src = fetchFromGitHub ({
      owner = "Ulauncher";
      repo = "Ulauncher";
      rev = "ae35dc9eb54faa52a514de2d675cd74ab4399b29";
      fetchSubmodules = false;
      sha256 = "sha256-WMl/BSJnGQis2z8tYYJp8j1CZ5QeKDibZpWbkQ0F7Ic=";
    });
  };
  ultimmc = {
    pname = "ultimmc";
