...
{ fetchgit, fetchurl, fetchFromGitHub }:
{
  ...
  arkenfox-userjs = {
    ...
    version = "ab7380c93b244992234e33c424f4bd7579f8e53e";
    src = fetchFromGitHub ({
      owner = "arkenfox";
      repo = "user.js";
      rev = "ab7380c93b244992234e33c424f4bd7579f8e53e";
      fetchSubmodules = false;
      sha256 = "sha256-SG+NlAzcly0qTm1P0Z2MtEfqehEQTy1GVlfWIDpdWwM=";
    });
  };
  avizo = {
    pname = "avizo";
  ...
  bottles = {
    pname = "bottles";
    version = "d96c02595b9017ecec71dd9a527042a53c68380e";
    src = fetchFromGitHub ({
      owner = "bottlesdevs";
      repo = "Bottles";
      rev = "d96c02595b9017ecec71dd9a527042a53c68380e";
      fetchSubmodules = false;
      sha256 = "sha256-n18WlwRk/DNpf3DNkZ/i/KCZNfgqqCXdLX/oirQ/8a4=";
    });
  };
  caddy = {
    pname = "caddy";
  ...
  cinny = {
    pname = "cinny";
    version = "a279995982c2d2954b196113bdeea03c1ff2a43a";
    src = fetchFromGitHub ({
      owner = "ajbura";
      repo = "cinny";
      rev = "a279995982c2d2954b196113bdeea03c1ff2a43a";
      fetchSubmodules = false;
      sha256 = "sha256-cMqayL2llS91b+JY7y2aD77sR+0rXcpMzO3KbryjsAE=";
    });
  };
  conduit = {
    pname = "conduit";
  ...
  jitsi-meet = {
    ...
    version = "1.0.5752";
    src = fetchurl {
      url = "https://download.jitsi.org/jitsi-meet/src/jitsi-meet-1.0.5752.tar.bz2";
      sha256 = "sha256-A4SJ3db8yjlgNvDmWoSXx3DXwcjFkHWSFpH7/4OKY94=";
    };
  };
  jitsi-meet-prosody = {
    ...
    version = "1.0.5752";
    src = fetchurl {
      url = "https://download.jitsi.org/unstable/jitsi-meet-prosody_1.0.5752-1_all.deb";
      sha256 = "sha256-IwcCD2qU1Y1PbRw4xPMamr51RRVgGK8xQW7hSiF6OHA=";
    };
  };
  jitsi-videobridge2 = {
  ...
  rustdesk = {
    pname = "rustdesk";
    version = "4071f803f7b94794ed869485b86fcf66fd9b3225";
    src = fetchFromGitHub ({
      owner = "rustdesk";
      repo = "rustdesk";
      rev = "4071f803f7b94794ed869485b86fcf66fd9b3225";
      fetchSubmodules = false;
      sha256 = "sha256-ArXVb/4Er3+YuVwRsKWASn25spn3Ekmiytb3Iqyhz1c=";
    });
    cargoLock = {
      lockFile = ./rustdesk-4071f803f7b94794ed869485b86fcf66fd9b3225/Cargo.lock;
      outputHashes = {
  ...
  tailscale = {
    pname = "tailscale";
    version = "8df3fa4638734ad6547e7a18b2a41301f9da6939";
    src = fetchFromGitHub ({
      owner = "tailscale";
      repo = "tailscale";
      rev = "8df3fa4638734ad6547e7a18b2a41301f9da6939";
      fetchSubmodules = false;
      sha256 = "sha256-yz6qfrSIGBlJeamhRdslAevLzWp6e4aZcpyOVwW2FZQ=";
    });
  };
  tailscale-systray = {
