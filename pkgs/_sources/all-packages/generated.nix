...
{ fetchgit, fetchurl, fetchFromGitHub }:
{
  ...
  bottles = {
    pname = "bottles";
    version = "d3445fd47bdbf05a4621099ce147854fb1b8564b";
    src = fetchFromGitHub ({
      owner = "bottlesdevs";
      repo = "Bottles";
      rev = "d3445fd47bdbf05a4621099ce147854fb1b8564b";
      fetchSubmodules = false;
      sha256 = "sha256-shfMHPp0O/69uDrGknPVSQ++0YeW5GVxjJZqrL2LhTU=";
    });
  };
  caddy = {
    pname = "caddy";
  ...
  jitsi-meet = {
    ...
    version = "1.0.5993";
    src = fetchurl {
      url = "https://download.jitsi.org/jitsi-meet/src/jitsi-meet-1.0.5993.tar.bz2";
      sha256 = "sha256-Uu78T6JvOUWPu8h+NCa73Czc4HwFS928kyoAZtfbMqI=";
    };
  };
  jitsi-meet-prosody = {
    ...
    version = "1.0.5993";
    src = fetchurl {
      url = "https://download.jitsi.org/unstable/jitsi-meet-prosody_1.0.5993-1_all.deb";
      sha256 = "sha256-Cur07TsN6z64TOtio+6YNH1BeQc9YqlUwv4qZ1YTKTw=";
    };
  };
  jitsi-videobridge2 = {
  ...
  retroarch = {
    pname = "retroarch";
    version = "d89ab49d32a5a5e737806d720e32820fc8e25ef8";
    src = fetchFromGitHub ({
      owner = "libretro";
      repo = "retroarch";
      rev = "d89ab49d32a5a5e737806d720e32820fc8e25ef8";
      fetchSubmodules = false;
      sha256 = "sha256-KXyB5xU0znYS+LbVAE/pdoSGE0bwkk0KDtYkLtrC6Is=";
    });
  };
  rofi-wayland = {
    pname = "rofi-wayland";
  ...
  rustdesk = {
    pname = "rustdesk";
    version = "1c84fc3786cb6841b215a7dd37456f31b547d32c";
    src = fetchFromGitHub ({
      owner = "rustdesk";
      repo = "rustdesk";
      rev = "1c84fc3786cb6841b215a7dd37456f31b547d32c";
      fetchSubmodules = false;
      sha256 = "sha256-WjJL1tOiXDTWRMjZepmq7jgqcQ3H+3KKnXWLwrhcToI=";
    });
    cargoLock = {
      lockFile = ./rustdesk-1c84fc3786cb6841b215a7dd37456f31b547d32c/Cargo.lock;
      outputHashes = {
  ...
  spicetify-themes = {
    ...
    version = "1a9d4e3e0817147fdbb3123183bf58416a4b78c2";
    src = fetchFromGitHub ({
      owner = "morpheusthewhite";
      repo = "spicetify-themes";
      rev = "1a9d4e3e0817147fdbb3123183bf58416a4b78c2";
      fetchSubmodules = false;
      sha256 = "sha256-BQgZel9t8wHxeUYsEgVJM5uEd3UJ9SV1DUEOpDe5XoI=";
    });
  };
  spotify = {
    pname = "spotify";
  ...
  tailscale = {
    pname = "tailscale";
    version = "b2f269d5b7bb04c226cf509c3794481ef4395519";
    src = fetchFromGitHub ({
      owner = "tailscale";
      repo = "tailscale";
      rev = "b2f269d5b7bb04c226cf509c3794481ef4395519";
      fetchSubmodules = false;
      sha256 = "sha256-V9BPCW12fsqdAqSO7VVwJZO9GRvhuqNB+DKq2cLO1ek=";
    });
  };
  tailscale-systray = {
