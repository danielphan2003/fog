...
{ fetchgit, fetchurl, fetchFromGitHub }:
{
  ...
  rustdesk = {
    pname = "rustdesk";
    version = "4d5d0a4c6201942ac9c832c4f31615e2b663be62";
    src = fetchFromGitHub ({
      owner = "rustdesk";
      repo = "rustdesk";
      rev = "4d5d0a4c6201942ac9c832c4f31615e2b663be62";
      fetchSubmodules = false;
      sha256 = "sha256-yPIYxr6zNSShD/WL7JAyP/mxmC75p+/iv+ChJCZnmoQ=";
    });
    cargoLock = {
      lockFile = ./rustdesk-4d5d0a4c6201942ac9c832c4f31615e2b663be62/Cargo.lock;
      outputHashes = {
  ...
  tailscale = {
    pname = "tailscale";
    version = "bbca2c78cbd07704b2921e0a8598f87619dbc3af";
    src = fetchFromGitHub ({
      owner = "tailscale";
      repo = "tailscale";
      rev = "bbca2c78cbd07704b2921e0a8598f87619dbc3af";
      fetchSubmodules = false;
      sha256 = "sha256-FG9MhDCluMXsukCmdEsNfat8jp7Uu7QrGPrfoG/M7SM=";
    });
  };
  tailscale-systray = {
