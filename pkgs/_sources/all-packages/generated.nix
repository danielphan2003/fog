...
{ fetchgit, fetchurl, fetchFromGitHub }:
{
  ...
  bottles = {
    pname = "bottles";
    version = "44a631b7cc3af66abea45886c6d1c42d2325e932";
    src = fetchFromGitHub ({
      owner = "bottlesdevs";
      repo = "Bottles";
      rev = "44a631b7cc3af66abea45886c6d1c42d2325e932";
      fetchSubmodules = false;
      sha256 = "sha256-esEIlGTTAavUu9hovtPXzNj3/QLg+0zd6n7jBiKESPM=";
    });
  };
  caddy = {
    pname = "caddy";
  ...
  jitsi-videobridge2 = {
    ...
    version = "2.1-664-g341f15af";
    src = fetchurl {
      url = "https://download.jitsi.org/unstable/jitsi-videobridge2_2.1-664-g341f15af-1_all.deb";
      sha256 = "sha256-WlLAeURooTT23u8qAFmgS3EdIWLUy+1lLL+rezIw2Pw=";
    };
  };
  layout-machi = {
    pname = "layout-machi";
  ...
  tailscale = {
    pname = "tailscale";
    version = "df9ce972c79023e0b0535bffee6afb3d88e61dc3";
    src = fetchFromGitHub ({
      owner = "tailscale";
      repo = "tailscale";
      rev = "df9ce972c79023e0b0535bffee6afb3d88e61dc3";
      fetchSubmodules = false;
      sha256 = "sha256-QRcIbB5Mr1Gp3yS2F1X+FLjRNyqmRmKLkVvT6mNaxBo=";
    });
  };
  tailscale-systray = {
