...
{ fetchgit, fetchurl, fetchFromGitHub }:
{
  ...
  bottles = {
    pname = "bottles";
    version = "dfa5bfc5952ac8a06ea9413847e890cb7c644f8b";
    src = fetchFromGitHub ({
      owner = "bottlesdevs";
      repo = "Bottles";
      rev = "dfa5bfc5952ac8a06ea9413847e890cb7c644f8b";
      fetchSubmodules = false;
      sha256 = "sha256-sXAfSSKVN6xVjfIHVppqe8ZOmhQs2pVffAxv1i1KO1o=";
    });
  };
  caddy = {
    pname = "caddy";
  ...
  eww = {
    pname = "eww";
    version = "4fb9bd4054b8f2776f1d770c1d582dce70b7fb9f";
    src = fetchFromGitHub ({
      owner = "elkowar";
      repo = "eww";
      rev = "4fb9bd4054b8f2776f1d770c1d582dce70b7fb9f";
      fetchSubmodules = false;
      sha256 = "sha256-l/EM1Lg5/LaOZVZWAYjPRhADfTBveev0UAdZRNJKP68=";
    });
    cargoLock = {
      lockFile = ./eww-4fb9bd4054b8f2776f1d770c1d582dce70b7fb9f/Cargo.lock;
      outputHashes = { };
    };
  };
  ...
  retroarch = {
    pname = "retroarch";
    version = "802b3ecd05992daf3b6afd518b9b93ebcc6c53be";
    src = fetchFromGitHub ({
      owner = "libretro";
      repo = "retroarch";
      rev = "802b3ecd05992daf3b6afd518b9b93ebcc6c53be";
      fetchSubmodules = false;
      sha256 = "sha256-xT+g/QIO4JgSwtHpBR7WRtnSqybfpNc6lo3m2IUHwhE=";
    });
  };
  rofi-wayland = {
    pname = "rofi-wayland";
  ...
  rustdesk = {
    pname = "rustdesk";
    version = "8e2aaf578fbb1e4f01a6bb8bee8f029a4aa3dce9";
    src = fetchFromGitHub ({
      owner = "rustdesk";
      repo = "rustdesk";
      rev = "8e2aaf578fbb1e4f01a6bb8bee8f029a4aa3dce9";
      fetchSubmodules = false;
      sha256 = "sha256-gHNMmDxi8sH0H6U6JPQJs2vwaf36EitxIISy0DWhSYw=";
    });
    cargoLock = {
      lockFile = ./rustdesk-8e2aaf578fbb1e4f01a6bb8bee8f029a4aa3dce9/Cargo.lock;
      outputHashes = {
  ...
  spicetify-cli = {
    pname = "spicetify-cli";
    version = "0f958de1d5587dbe9d766ae718f56633a7eb4929";
    src = fetchFromGitHub ({
      owner = "khanhas";
      repo = "spicetify-cli";
      rev = "0f958de1d5587dbe9d766ae718f56633a7eb4929";
      fetchSubmodules = false;
  ...
  spicetify-themes = {
    ...
    version = "f39b627ad95e4cc318bd333ac177cfad59114fe2";
    src = fetchFromGitHub ({
      owner = "morpheusthewhite";
      repo = "spicetify-themes";
      rev = "f39b627ad95e4cc318bd333ac177cfad59114fe2";
      fetchSubmodules = false;
      sha256 = "sha256-Ux6dnudflADrDkxHYDW4XVrZ2uuGq7Jzlag5JGbr1hU=";
    });
  };
  spotify = {
    pname = "spotify";
  ...
  ulauncher = {
    pname = "ulauncher";
    version = "0097d8d561e043ec719aa3f22a1dbafc3b5ada71";
    src = fetchFromGitHub ({
      owner = "Ulauncher";
      repo = "Ulauncher";
      rev = "0097d8d561e043ec719aa3f22a1dbafc3b5ada71";
      fetchSubmodules = false;
      sha256 = "sha256-7R3KgiJLrIznnz4oiQj0Fk+9C1WiTuqk+Iz9xnuu2cg=";
    });
  };
  ultimmc = {
    pname = "ultimmc";
