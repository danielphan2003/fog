...
{ fetchgit, fetchurl, fetchFromGitHub }:
{
  ...
  bottles = {
    pname = "bottles";
    version = "f406f5e992b31240e1550d4744fb3e8c9d046a76";
    src = fetchFromGitHub ({
      owner = "bottlesdevs";
      repo = "Bottles";
      rev = "f406f5e992b31240e1550d4744fb3e8c9d046a76";
      fetchSubmodules = false;
      sha256 = "sha256-NU76cFUmjZA7A1C6I5SA7aJ77OoJfo3zrrPjeky9BzM=";
    });
  };
  caddy = {
    pname = "caddy";
  ...
  conduit = {
    pname = "conduit";
    version = "0cec4219302876e2308afa1bfa9d73b0da6c7bcc";
    src = fetchgit {
      url = "https://gitlab.com/famedly/conduit";
      rev = "0cec4219302876e2308afa1bfa9d73b0da6c7bcc";
      fetchSubmodules = false;
      deepClone = false;
      leaveDotGit = false;
    ...
    cargoLock = {
      lockFile = ./conduit-0cec4219302876e2308afa1bfa9d73b0da6c7bcc/Cargo.lock;
      outputHashes = {
  ...
  dnscrypt-proxy2 = {
    ...
    version = "ef1c70e87da17576cf5ddef66957173884f5b48d";
    src = fetchFromGitHub ({
      owner = "DNSCrypt";
      repo = "dnscrypt-proxy";
      rev = "ef1c70e87da17576cf5ddef66957173884f5b48d";
      fetchSubmodules = false;
      sha256 = "sha256-lKW8Xk0Pvs7vxb/uSlwQbh6F+UW0IDyZW3/C/xuZh6E=";
    });
  };
  doggo = {
    pname = "doggo";
  ...
  duf = {
    pname = "duf";
    version = "eda58962936ab40818ebe961f1d2a1826b3ba7aa";
    src = fetchFromGitHub ({
      owner = "muesli";
      repo = "duf";
      rev = "eda58962936ab40818ebe961f1d2a1826b3ba7aa";
      fetchSubmodules = false;
      sha256 = "sha256-DYJEPSALe5hX5gm/Za8C2bOF331MJqTd3K1KSUeT9m4=";
    });
  };
  eww = {
    pname = "eww";
    version = "ee07598a039e191239a143407bf934b3781ee675";
    src = fetchFromGitHub ({
      owner = "elkowar";
      repo = "eww";
      rev = "ee07598a039e191239a143407bf934b3781ee675";
      fetchSubmodules = false;
      sha256 = "sha256-e6Ql2ob9qKw6XtZ3ISWWohyp6wM0dIi0amg1omSAxVU=";
    });
    cargoLock = {
      lockFile = ./eww-ee07598a039e191239a143407bf934b3781ee675/Cargo.lock;
      outputHashes = { };
    };
  };
  ...
  flameshot = {
    pname = "flameshot";
    version = "bcb4041e0e433e6ac0d65e87bd50c194459f5684";
    src = fetchFromGitHub ({
      owner = "flameshot-org";
      repo = "flameshot";
      rev = "bcb4041e0e433e6ac0d65e87bd50c194459f5684";
      fetchSubmodules = false;
      sha256 = "sha256-3Wk2oOIuj2kHfpiczkSipGa5oNgqsRg+q4UL8miU/b8=";
    });
  };
  flyingfox = {
    pname = "flyingfox";
  ...
  ibus = {
    pname = "ibus";
    version = "c69b61aa66239e1b13c9764b2d3bf6f02d086785";
    src = fetchFromGitHub ({
      owner = "ibus";
      repo = "ibus";
      rev = "c69b61aa66239e1b13c9764b2d3bf6f02d086785";
      fetchSubmodules = false;
      sha256 = "sha256-3KRU8r3cRbzCEFSV4GW/NlIM4BfbrktIfcN5lyEBz9M=";
    });
  };
  ibus-bamboo = {
    pname = "ibus-bamboo";
  ...
  jicofo = {
    ...
    version = "1.0-853";
    src = fetchurl {
      url = "https://download.jitsi.org/unstable/jicofo_1.0-853-1_all.deb";
      sha256 = "sha256-iYQVa3KY+svN3EQbAVe1m0MmyvQ6i1e9ToaHmEPhFK4=";
    };
  };
  jitsi-meet = {
    pname = "jitsi-meet";
    version = "1.0.5845";
    src = fetchurl {
      url = "https://download.jitsi.org/jitsi-meet/src/jitsi-meet-1.0.5845.tar.bz2";
      sha256 = "sha256-OFVWlvNXwMB7bdCoFj4X2V9wNSgSmg8yzXxcGJa842I=";
    };
  };
  jitsi-meet-prosody = {
    ...
    version = "1.0.5845";
    src = fetchurl {
      url = "https://download.jitsi.org/unstable/jitsi-meet-prosody_1.0.5845-1_all.deb";
      sha256 = "sha256-CaOWqwoaAVYXqwjNyLou4SFbPMy3zakI9pJHMT4UJAE=";
    };
  };
  jitsi-videobridge2 = {
    pname = "jitsi-videobridge2";
    version = "2.1-619-ge4ae71b9";
    src = fetchurl {
      url = "https://download.jitsi.org/unstable/jitsi-videobridge2_2.1-619-ge4ae71b9-1_all.deb";
      sha256 = "sha256-VgdWD/AunFUMPheFxlwOXcyo7twaaxxKATKJV30vja0=";
    };
  };
  layout-machi = {
    pname = "layout-machi";
  ...
  picom = {
    pname = "picom";
    version = "126750f0991caea852b500ea7d20491ce2c168c7";
    src = fetchFromGitHub ({
      owner = "yshui";
      repo = "picom";
      rev = "126750f0991caea852b500ea7d20491ce2c168c7";
      fetchSubmodules = false;
      sha256 = "sha256-hW0mBBdMujWV70jBh4dA1Ek8Ymf80ukr1HxjCNaI0E8=";
    });
  };
  plymouth-themes = {
  ...
  retroarch = {
    pname = "retroarch";
    version = "e71e895ad69000cff958d89153866e951b92741c";
    src = fetchFromGitHub ({
      owner = "libretro";
      repo = "retroarch";
      rev = "e71e895ad69000cff958d89153866e951b92741c";
      fetchSubmodules = false;
      sha256 = "sha256-YWSj+Zqr8lMmyiPYO9NI48PnBr1PFw8ZQG3M/bdEzkU=";
    });
  };
  rofi-wayland = {
    pname = "rofi-wayland";
  ...
  rustdesk = {
    pname = "rustdesk";
    version = "6143a3c649d24bd257258ab6122ac22f01c28fa9";
    src = fetchFromGitHub ({
      owner = "rustdesk";
      repo = "rustdesk";
      rev = "6143a3c649d24bd257258ab6122ac22f01c28fa9";
      fetchSubmodules = false;
      sha256 = "sha256-qaBVLymdsMXHmGDUzwLPjDImxxK4AGlCdykjZGT/IUo=";
    });
    cargoLock = {
      lockFile = ./rustdesk-6143a3c649d24bd257258ab6122ac22f01c28fa9/Cargo.lock;
      outputHashes = {
  ...
  steamcompmgr = {
    pname = "steamcompmgr";
    version = "6e46ed604ad4c98e027a1d28ad2b2b4e81c0a275";
    src = fetchFromGitHub ({
      owner = "ChimeraOS";
      repo = "steamos-compositor-plus";
      rev = "6e46ed604ad4c98e027a1d28ad2b2b4e81c0a275";
      fetchSubmodules = false;
      sha256 = "sha256-no9yb6gAOJu6SL7+DHEsMKBbhJ0hHw2cClZp2NnaZJg=";
    });
  };
  sway-borders = {
    pname = "sway-borders";
  ...
  tailscale = {
    pname = "tailscale";
    version = "b3d268c5a199da28d6cc1e2057e1486375e754ab";
    src = fetchFromGitHub ({
      owner = "tailscale";
      repo = "tailscale";
      rev = "b3d268c5a199da28d6cc1e2057e1486375e754ab";
      fetchSubmodules = false;
      sha256 = "sha256-GPlFjQnN8Y5S8LKwfy7wfd9LtG9fnKbwtRP3uo0kA20=";
    });
  };
  tailscale-systray = {
  ...
  whitesur-gtk-theme = {
    ...
    version = "a1ccc136f3c18be9cc76088665667cef345f2edb";
    src = fetchFromGitHub ({
      owner = "vinceliuice";
      repo = "whitesur-gtk-theme";
      rev = "a1ccc136f3c18be9cc76088665667cef345f2edb";
      fetchSubmodules = false;
      sha256 = "sha256-VcI8hUZGCC4u2wsrE00+6C3hngolrw1IrW+l7bzW4iI=";
    });
  };
  whitesur-icon-theme = {
