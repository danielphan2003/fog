...
{ fetchgit, fetchurl, fetchFromGitHub }:
{
  ...
  bottles = {
    pname = "bottles";
    version = "6808ec959f4757d7110935c6c6858afae78e796e";
    src = fetchFromGitHub ({
      owner = "bottlesdevs";
      repo = "Bottles";
      rev = "6808ec959f4757d7110935c6c6858afae78e796e";
      fetchSubmodules = false;
      sha256 = "sha256-nr3rcO1EY6S5iLnvsXptHKtCyJNai58rOfsUofgGw7c=";
    });
  };
  caddy = {
    pname = "caddy";
  ...
  pmbootstrap-test = {
    ...
    version = "8ca71ed3a0e4a8614b19ee16645bbbe490ea0eab";
    src = fetchgit {
      url = "https://gitlab.com/postmarketOS/pmbootstrap";
      rev = "8ca71ed3a0e4a8614b19ee16645bbbe490ea0eab";
      fetchSubmodules = false;
      deepClone = false;
      leaveDotGit = false;
      sha256 = "sha256-a3ZseMO5co+a8Nj3IFa5hyU5TnwR2isRAHPFXd5whbY=";
    };
  };
  pure = {
    pname = "pure";
  ...
  retroarch = {
    pname = "retroarch";
    version = "3c388b62d418502b685d22f24f630fcf6c1fa13a";
    src = fetchFromGitHub ({
      owner = "libretro";
      repo = "retroarch";
      rev = "3c388b62d418502b685d22f24f630fcf6c1fa13a";
      fetchSubmodules = false;
      sha256 = "sha256-y3zWncxcHXrOf+R5h5R+g9SIjAEV1+gYyOI2uggzBsc=";
    });
  };
  rofi-wayland = {
    pname = "rofi-wayland";
  ...
  rustdesk = {
    pname = "rustdesk";
    version = "64f181e4a15a928f138f98b536c04443fe011cc9";
    src = fetchFromGitHub ({
      owner = "rustdesk";
      repo = "rustdesk";
      rev = "64f181e4a15a928f138f98b536c04443fe011cc9";
      fetchSubmodules = false;
      sha256 = "sha256-wlhkvXfj9+Wb89SBgFuKQ1PuXI9cW/RqwJcHq+v6d6Q=";
    });
    cargoLock = {
      lockFile = ./rustdesk-64f181e4a15a928f138f98b536c04443fe011cc9/Cargo.lock;
      outputHashes = {
