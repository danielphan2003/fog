...
{ fetchgit, fetchurl, fetchFromGitHub }:
{
  ...
  bottles = {
    pname = "bottles";
    version = "2a8289bb253d4ec7cf2efc4efce1997f0dfd513c";
    src = fetchFromGitHub ({
      owner = "bottlesdevs";
      repo = "Bottles";
      rev = "2a8289bb253d4ec7cf2efc4efce1997f0dfd513c";
      fetchSubmodules = false;
      sha256 = "sha256-js/s+j+Rzuyn+ecNZCQermSLMNGlYud8mlfAEzTsmws=";
    });
  };
  caddy = {
    pname = "caddy";
  ...
  rustdesk = {
    pname = "rustdesk";
    version = "1d8cdb5e932fe52a21417514fa3ccda4602f5594";
    src = fetchFromGitHub ({
      owner = "rustdesk";
      repo = "rustdesk";
      rev = "1d8cdb5e932fe52a21417514fa3ccda4602f5594";
      fetchSubmodules = false;
      sha256 = "sha256-et1XpxBaoBK6Yx9Vg91vOtqzAZZvh6T9AlRwKE2UE8I=";
    });
    cargoLock = {
      lockFile = ./rustdesk-1d8cdb5e932fe52a21417514fa3ccda4602f5594/Cargo.lock;
      outputHashes = {
        ...
        "tokio-socks-0.5.1" = "sha256-iURrvVYJr0W+9DHJQnrblE4v0crff3GjZbBokdW65d8=";
