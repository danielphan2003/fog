...
{ fetchgit, fetchurl, fetchFromGitHub }:
{
  ...
  avizo = {
    pname = "avizo";
    version = "976db521c15f5b141c6ca733c80ab35c22a72731";
    src = fetchFromGitHub ({
      owner = "misterdanb";
      repo = "avizo";
      rev = "976db521c15f5b141c6ca733c80ab35c22a72731";
      fetchSubmodules = false;
      sha256 = "sha256-3sC6dk1dhA7NKvr5m+kOHPcBLDd0du8FYotWOJBjK14=";
    });
  };
  awesome = {
    pname = "awesome";
  ...
  bottles = {
    pname = "bottles";
    version = "2658e2bed2b2f6f47ef32302a49762f89592dc65";
    src = fetchFromGitHub ({
      owner = "bottlesdevs";
      repo = "Bottles";
      rev = "2658e2bed2b2f6f47ef32302a49762f89592dc65";
      fetchSubmodules = false;
      sha256 = "sha256-SMBuCMEq2JNLhUSgnWeesoNj15BV3/3MDhiFJc3512o=";
    });
  };
  caddy = {
    pname = "caddy";
  ...
  retroarch = {
    pname = "retroarch";
    version = "ddaf3bc6cf4b865700839ce61f39f4ca8a08e587";
    src = fetchFromGitHub ({
      owner = "libretro";
      repo = "retroarch";
      rev = "ddaf3bc6cf4b865700839ce61f39f4ca8a08e587";
      fetchSubmodules = false;
      sha256 = "sha256-Ra6yElCoVXB6O/Z4Fct9b7kksprdtb+HqvjoBGkO45s=";
    });
  };
  rofi-wayland = {
    pname = "rofi-wayland";
