...
{ fetchgit, fetchurl, fetchFromGitHub }:
{
  ...
  conduit = {
    pname = "conduit";
    version = "9e29dc808ff231eb06baef012f681e51da8411cf";
    src = fetchgit {
      url = "https://gitlab.com/famedly/conduit";
      rev = "9e29dc808ff231eb06baef012f681e51da8411cf";
      fetchSubmodules = false;
      deepClone = false;
      leaveDotGit = false;
      sha256 = "sha256-5sulycUmI4JGAbnFcD6bXyhLUSBc6WYDhDjLH9/aCTI=";
    };
    cargoLock = {
      lockFile = ./conduit-9e29dc808ff231eb06baef012f681e51da8411cf/Cargo.lock;
      outputHashes = {
  ...
  rustdesk = {
    pname = "rustdesk";
    version = "fa2407d857648cefaeecb9a62d2e0bf390db0f87";
    src = fetchFromGitHub ({
      owner = "rustdesk";
      repo = "rustdesk";
      rev = "fa2407d857648cefaeecb9a62d2e0bf390db0f87";
      fetchSubmodules = false;
      sha256 = "sha256-uCy5e5WSd9cuajA+tDnIzbHaS5Hh7eQTwJO/a2Srx5c=";
    });
    cargoLock = {
      lockFile = ./rustdesk-fa2407d857648cefaeecb9a62d2e0bf390db0f87/Cargo.lock;
      outputHashes = {
