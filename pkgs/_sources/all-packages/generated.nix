...
{ fetchgit, fetchurl, fetchFromGitHub }:
{
  ...
  bottles = {
    pname = "bottles";
    version = "4e6125e5047905d96d83aaf945378cbb38098933";
    src = fetchFromGitHub ({
      owner = "bottlesdevs";
      repo = "Bottles";
      rev = "4e6125e5047905d96d83aaf945378cbb38098933";
      fetchSubmodules = false;
      sha256 = "sha256-2PoYb5g4dH2a7WJSPnIJzT2F9H4Yv4/hdbM5IzRSKxQ=";
    });
  };
  caddy = {
    pname = "caddy";
  ...
  eww = {
    pname = "eww";
    version = "ee4d1d908a1ff767dd8abf692e620ea4a332b120";
    src = fetchFromGitHub ({
      owner = "elkowar";
      repo = "eww";
      rev = "ee4d1d908a1ff767dd8abf692e620ea4a332b120";
      fetchSubmodules = false;
      sha256 = "sha256-l6L8iXAmqg/fPLUevqkNQcKce2I/O/BGAE9K0OzY6+w=";
    });
    cargoLock = {
      lockFile = ./eww-ee4d1d908a1ff767dd8abf692e620ea4a332b120/Cargo.lock;
      outputHashes = { };
    };
  };
  ...
  pmbootstrap-test = {
    ...
    version = "dee8e342989933cba35dcf0324659b0fc303956f";
    src = fetchgit {
      url = "https://gitlab.com/postmarketOS/pmbootstrap";
      rev = "dee8e342989933cba35dcf0324659b0fc303956f";
      fetchSubmodules = false;
      deepClone = false;
      leaveDotGit = false;
      sha256 = "sha256-uYqqQn0UwMvTfu7nX4LniqA2WMazhwMn5UdJpjJvWN4=";
    };
  };
  pure = {
    pname = "pure";
  ...
  retroarch = {
    pname = "retroarch";
    version = "dcc67278754452071c0c6c073d239f7e90b7b2a2";
    src = fetchFromGitHub ({
      owner = "libretro";
      repo = "retroarch";
      rev = "dcc67278754452071c0c6c073d239f7e90b7b2a2";
      fetchSubmodules = false;
      sha256 = "sha256-K3VxUOx3C/yD+Ao88BQAsmUTi0RJXQxWBF0yogPMm8Y=";
    });
  };
  rofi-wayland = {
    pname = "rofi-wayland";
  ...
  tailscale = {
    pname = "tailscale";
    version = "dec68166e416d661e1482e2ed4d2ac162cd94488";
    src = fetchFromGitHub ({
      owner = "tailscale";
      repo = "tailscale";
      rev = "dec68166e416d661e1482e2ed4d2ac162cd94488";
      fetchSubmodules = false;
      sha256 = "sha256-uo6Q3RNASFm9UO4BT7LYgAmE2lJe59h3mwxJxTdKPN8=";
    });
  };
  tailscale-systray = {
