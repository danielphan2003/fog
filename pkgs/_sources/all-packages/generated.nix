...
{ fetchgit, fetchurl, fetchFromGitHub }:
{
  ...
  bottles = {
    pname = "bottles";
    version = "e7cc4f474c52722cef8ac8ce481981453355b77b";
    src = fetchFromGitHub ({
      owner = "bottlesdevs";
      repo = "Bottles";
      rev = "e7cc4f474c52722cef8ac8ce481981453355b77b";
      fetchSubmodules = false;
      sha256 = "sha256-kNRio4UbdxAMGm6T5ytUI+VC7NuBg/Ag2ShkyAFsG10=";
    });
  };
  caddy = {
    pname = "caddy";
  ...
  eww = {
    pname = "eww";
    version = "b79f7b8fb71ff42285444cbdde93ee02ee464250";
    src = fetchFromGitHub ({
      owner = "elkowar";
      repo = "eww";
      rev = "b79f7b8fb71ff42285444cbdde93ee02ee464250";
      fetchSubmodules = false;
      sha256 = "sha256-zN3I7O3CNnz+E5cfxK9wtW1AFqMJGcCR/ermqoQje5M=";
    });
    cargoLock = {
      lockFile = ./eww-b79f7b8fb71ff42285444cbdde93ee02ee464250/Cargo.lock;
      outputHashes = { };
    };
  };
  ...
  hyprland = {
    pname = "hyprland";
    version = "c7d02a38d9527b4a1190102786e3d2cc75d4c84c";
    src = fetchFromGitHub ({
      owner = "vaxerski";
      repo = "hyprland";
      rev = "c7d02a38d9527b4a1190102786e3d2cc75d4c84c";
      fetchSubmodules = false;
      sha256 = "sha256-UZ+yinhCjVd2WPPd0Rb4c31JQyW+ovSOqpHEofO5vig=";
    });
  };
  ibus = {
    pname = "ibus";
  ...
  jitsi-meet = {
    ...
    version = "1.0.6094";
    src = fetchurl {
      url = "https://download.jitsi.org/jitsi-meet/src/jitsi-meet-1.0.6094.tar.bz2";
      sha256 = "sha256-oH4t2uKSKShKLsinR864kaYNoJvXo4zR7sI0cdvvlQk=";
    };
  };
  jitsi-meet-prosody = {
    ...
    version = "1.0.6094";
    src = fetchurl {
      url = "https://download.jitsi.org/unstable/jitsi-meet-prosody_1.0.6094-1_all.deb";
      sha256 = "sha256-b334TBeEkya66Fs0h9rWVRAQ55iTq7EEdgGj3ptRAM4=";
    };
  };
  jitsi-videobridge2 = {
  ...
  retroarch = {
    pname = "retroarch";
    version = "da5d135a9ffb242618e60718345babe94a13ceb9";
    src = fetchFromGitHub ({
      owner = "libretro";
      repo = "retroarch";
      rev = "da5d135a9ffb242618e60718345babe94a13ceb9";
      fetchSubmodules = false;
      sha256 = "sha256-FAd/AdwlMHgNo5y+Dwle61Tq1YH8orNTxMDIiEESNrI=";
    });
  };
  rofi-wayland = {
    pname = "rofi-wayland";
  ...
  rustdesk = {
    pname = "rustdesk";
    version = "f95f9e408a2d3d0079f3f279f5777675fd543922";
    src = fetchFromGitHub ({
      owner = "rustdesk";
      repo = "rustdesk";
      rev = "f95f9e408a2d3d0079f3f279f5777675fd543922";
      fetchSubmodules = false;
      sha256 = "sha256-YHFfwgntByRTxXFUgdtQnC3eCsXPy/EDO46CIA8cCVA=";
    });
    cargoLock = {
      lockFile = ./rustdesk-f95f9e408a2d3d0079f3f279f5777675fd543922/Cargo.lock;
      outputHashes = {
  ...
  snui = {
    pname = "snui";
    version = "17d5834643445e16e94f0077803993c96c9f9342";
    src = fetchgit {
      url = "https://gitlab.com/snakedye/snui";
      rev = "17d5834643445e16e94f0077803993c96c9f9342";
      fetchSubmodules = false;
      deepClone = false;
      leaveDotGit = false;
      sha256 = "sha256-idl2XworLWLfw/XuSyx42uspfueaFymtOBgEkuHXJNQ=";
    };
  };
  spicetify-cli = {
    pname = "spicetify-cli";
  ...
  spicetify-themes = {
    ...
    version = "7887bbf8768062aa5b719a32d81f0851bf48056c";
    src = fetchFromGitHub ({
      owner = "morpheusthewhite";
      repo = "spicetify-themes";
      rev = "7887bbf8768062aa5b719a32d81f0851bf48056c";
      fetchSubmodules = false;
      sha256 = "sha256-13xRgUKvf9g6SuCx2ru98Tzs3lQJUt9r6y69ORz+xBM=";
    });
  };
  spotify = {
    pname = "spotify";
  ...
  tailscale = {
    pname = "tailscale";
    version = "d201d217df313fca8e7cf5fff91879db080bb593";
    src = fetchFromGitHub ({
      owner = "tailscale";
      repo = "tailscale";
      rev = "d201d217df313fca8e7cf5fff91879db080bb593";
      fetchSubmodules = false;
      sha256 = "sha256-ARlAG6WgS7/jMvaPcX8NAsdH3x6sHRHBYSnGqnW0A+g=";
    });
  };
  tailscale-systray = {
