...
{ fetchgit, fetchurl, fetchFromGitHub }:
{
  ...
  bottles = {
    pname = "bottles";
    version = "2f8e4a64facbc34dc3cfb3ed2864dd5774b88489";
    src = fetchFromGitHub ({
      owner = "bottlesdevs";
      repo = "Bottles";
      rev = "2f8e4a64facbc34dc3cfb3ed2864dd5774b88489";
      fetchSubmodules = false;
      sha256 = "sha256-uMRAsAKG9PO3PcncY1rqVhtaGXtzihw3l3am+ORxqaI=";
    });
  };
  caddy = {
    pname = "caddy";
  ...
  flameshot = {
    pname = "flameshot";
    version = "1bccad6a0abc0a1a10fd9c87896d0d7045974fef";
    src = fetchFromGitHub ({
      owner = "flameshot-org";
      repo = "flameshot";
      rev = "1bccad6a0abc0a1a10fd9c87896d0d7045974fef";
      fetchSubmodules = false;
      sha256 = "sha256-6IDvZbTMJmeFxl6+BN4MOBUAsQMdF+6JVVc/EfVal6M=";
    });
  };
  flyingfox = {
    pname = "flyingfox";
  ...
  jitsi-meet = {
    ...
    version = "1.0.5734";
    src = fetchurl {
      url = "https://download.jitsi.org/jitsi-meet/src/jitsi-meet-1.0.5734.tar.bz2";
      sha256 = "sha256-xKHnXdWjFaxfU4YZAoypnXQxkLRPqf2WswjCTo2rz0M=";
    };
  };
  jitsi-meet-prosody = {
    ...
    version = "1.0.5734";
    src = fetchurl {
      url = "https://download.jitsi.org/unstable/jitsi-meet-prosody_1.0.5734-1_all.deb";
      sha256 = "sha256-id0cLNeT6o5wAOILjkNFQH6EnWwoAkXLogUX1uFua44=";
    };
  };
  jitsi-videobridge2 = {
  ...
  rainfox = {
    pname = "rainfox";
    version = "e65cb4af4646548568abb5e3ca4ce7bc8fdf3a31";
    src = fetchFromGitHub ({
      owner = "1280px";
      repo = "rainfox";
      rev = "e65cb4af4646548568abb5e3ca4ce7bc8fdf3a31";
      fetchSubmodules = false;
      sha256 = "sha256-schVVhuF7E73L/KrMWl3u1iTzz2WQEYj0zXfrx3uUKk=";
    });
  };
  redshift = {
    pname = "redshift";
  ...
  retroarch = {
    pname = "retroarch";
    version = "19d05db9ae7f727c6174401a94bb8fe0560d92b9";
    src = fetchFromGitHub ({
      owner = "libretro";
      repo = "retroarch";
      rev = "19d05db9ae7f727c6174401a94bb8fe0560d92b9";
      fetchSubmodules = false;
      sha256 = "sha256-d/h322IWHfvd1x5flphG61ve176rz8/goyLdirdOh1A=";
    });
  };
  rofi-wayland = {
    pname = "rofi-wayland";
  ...
  rustdesk = {
    pname = "rustdesk";
    version = "1931cb8c7c57c8093ec742978e134c0cd898a6d2";
    src = fetchFromGitHub ({
      owner = "rustdesk";
      repo = "rustdesk";
      rev = "1931cb8c7c57c8093ec742978e134c0cd898a6d2";
      fetchSubmodules = false;
      sha256 = "sha256-QXFT+sjGQQ3o8MR7jQdDOq4UT39yMpUOkutyi6w7tnw=";
    });
    cargoLock = {
      lockFile = ./rustdesk-1931cb8c7c57c8093ec742978e134c0cd898a6d2/Cargo.lock;
      outputHashes = {
  ...
  tailscale = {
    pname = "tailscale";
    version = "3690bfecb09deb5f069f26d9ff44be94cdbf79ed";
    src = fetchFromGitHub ({
      owner = "tailscale";
      repo = "tailscale";
      rev = "3690bfecb09deb5f069f26d9ff44be94cdbf79ed";
      fetchSubmodules = false;
      sha256 = "sha256-SwXbSkhONzLL1vAVBn7mhq5lCW4AByTaN3HT6H8MrNg=";
    });
  };
  tailscale-systray = {
