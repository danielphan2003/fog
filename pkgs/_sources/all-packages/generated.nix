...
{ fetchgit, fetchurl, fetchFromGitHub }:
{
  ...
  retroarch = {
    pname = "retroarch";
    version = "ee4486068dddf268808d492cd2bfce11535d4d07";
    src = fetchFromGitHub ({
      owner = "libretro";
      repo = "retroarch";
      rev = "ee4486068dddf268808d492cd2bfce11535d4d07";
      fetchSubmodules = false;
      sha256 = "sha256-RCKtDB8n3iWS3SdKzFTY3u+lco8DqKVYLIl+nd/Wn4g=";
    });
  };
  rofi-wayland = {
    pname = "rofi-wayland";
  ...
  tailscale = {
    pname = "tailscale";
    version = "7d897229d9951211b2718fc3e997f630eb41b76c";
    src = fetchFromGitHub ({
      owner = "tailscale";
      repo = "tailscale";
      rev = "7d897229d9951211b2718fc3e997f630eb41b76c";
      fetchSubmodules = false;
      sha256 = "sha256-JWqkTqTZvCD7sf49RxRFlJHoubEuUVf1ksXFr7G+qLA=";
    });
  };
  tailscale-systray = {
