...
{ fetchgit, fetchurl, fetchFromGitHub }:
{
  ...
  bottles = {
    pname = "bottles";
    version = "33351405b9a60cad7ef09f1de89d9f42add4b8e4";
    src = fetchFromGitHub ({
      owner = "bottlesdevs";
      repo = "Bottles";
      rev = "33351405b9a60cad7ef09f1de89d9f42add4b8e4";
      fetchSubmodules = false;
      sha256 = "sha256-e6kbwwsO0wTZC7de1vNcM6LWpjcNSER6RdfFgsnkVJw=";
    });
  };
  caddy = {
    pname = "caddy";
  ...
  flameshot = {
    pname = "flameshot";
    version = "0c9a58fad02ac24395f0952643d40d73459509a1";
    src = fetchFromGitHub ({
      owner = "flameshot-org";
      repo = "flameshot";
      rev = "0c9a58fad02ac24395f0952643d40d73459509a1";
      fetchSubmodules = false;
      sha256 = "sha256-IIA4nrWsxcF+f1ry3+rxK4I0IPFZ2VBCHh5jzkudKkU=";
    });
  };
  flyingfox = {
    pname = "flyingfox";
  ...
  jitsi-meet = {
    ...
    version = "1.0.6082";
    src = fetchurl {
      url = "https://download.jitsi.org/jitsi-meet/src/jitsi-meet-1.0.6082.tar.bz2";
      sha256 = "sha256-BfXXCRgqKSqedSNg238EypwMoqZg2wjodAHVAMCtoC0=";
    };
  };
  jitsi-meet-prosody = {
    ...
    version = "1.0.6082";
    src = fetchurl {
      url = "https://download.jitsi.org/unstable/jitsi-meet-prosody_1.0.6082-1_all.deb";
      sha256 = "sha256-FRIXq+qurWzbBZmN0wwcZTsTDDqle3gUgzajd/THHmU=";
    };
  };
  jitsi-videobridge2 = {
  ...
  microsoft-edge-beta = {
    ...
    src = fetchurl {
      url = "https://packages.microsoft.com/repos/edge/pool/main/m/microsoft-edge-beta/microsoft-edge-beta_101.0.1210.10-1_amd64.deb";
      sha256 = "sha256-vYpaAnL/xfV7IinJ9x9ZpZSwYU+5Vif8ZBhED8bHIgs=";
    };
  };
  microsoft-edge-dev = {
    ...
    src = fetchurl {
      url = "https://packages.microsoft.com/repos/edge/pool/main/m/microsoft-edge-dev/microsoft-edge-dev_102.0.1217.0-1_amd64.deb";
      sha256 = "sha256-kgwhy2L5qQRiundgQBc2ORWPVYngQluXKX+1lT0ioZY=";
    };
  };
  minecraft-wayland = {
  ...
  picom = {
    pname = "picom";
    version = "61faf42b9e59127e698baaa4aacd78d4ac4cc490";
    src = fetchFromGitHub ({
      owner = "yshui";
      repo = "picom";
      rev = "61faf42b9e59127e698baaa4aacd78d4ac4cc490";
      fetchSubmodules = false;
      sha256 = "sha256-KbxPf3HS10fOO4wpcTFnHBdeUK/YDYKhGFFfOOwld5c=";
    });
  };
  plymouth-themes = {
  ...
  pmbootstrap-test = {
    ...
    version = "ff569ece145efb1633799307a87d5cf5acee87ec";
    src = fetchgit {
      url = "https://gitlab.com/postmarketOS/pmbootstrap";
      rev = "ff569ece145efb1633799307a87d5cf5acee87ec";
      fetchSubmodules = false;
      deepClone = false;
      leaveDotGit = false;
      sha256 = "sha256-X0DJ9FhJgrRkTKKl8Ot/rB+HmDV+5KtUK2ZrGwHhKRU=";
    };
  };
  pure = {
    pname = "pure";
  ...
  retroarch = {
    pname = "retroarch";
    version = "f9d0a49d424381a767ada5bfd2fa2587df6f8cb8";
    src = fetchFromGitHub ({
      owner = "libretro";
      repo = "retroarch";
      rev = "f9d0a49d424381a767ada5bfd2fa2587df6f8cb8";
      fetchSubmodules = false;
      sha256 = "sha256-Y6dSGEu2wj8tI5HE71psxAksvC49zf+6nZEFEHcpklc=";
    });
  };
  rofi-wayland = {
    pname = "rofi-wayland";
  ...
  rustdesk = {
    pname = "rustdesk";
    version = "aeb2846d1566e4858afc1caa0c8b6b010b1d3af0";
    src = fetchFromGitHub ({
      owner = "rustdesk";
      repo = "rustdesk";
      rev = "aeb2846d1566e4858afc1caa0c8b6b010b1d3af0";
      fetchSubmodules = false;
      sha256 = "sha256-DUqOpZVusXNe6Nd9FDAD8kmAAzHqs9NYleq0kEqUtdM=";
    });
    cargoLock = {
      lockFile = ./rustdesk-aeb2846d1566e4858afc1caa0c8b6b010b1d3af0/Cargo.lock;
      outputHashes = {
  ...
  snui = {
    pname = "snui";
    version = "d0a419d7eb5632d51fee24f18469a273fe753fca";
    src = fetchgit {
      url = "https://gitlab.com/snakedye/snui";
      rev = "d0a419d7eb5632d51fee24f18469a273fe753fca";
      fetchSubmodules = false;
      deepClone = false;
      leaveDotGit = false;
      sha256 = "sha256-l9nEaAelyDJ3Idt4k2YVKytGD/6Bi4xADIcE7GendoU=";
    };
  };
  spicetify-cli = {
    pname = "spicetify-cli";
    version = "91f95e4f38f1ac7d546eb6a96572da6ffecaa7c2";
    src = fetchFromGitHub ({
      owner = "khanhas";
      repo = "spicetify-cli";
      rev = "91f95e4f38f1ac7d546eb6a96572da6ffecaa7c2";
      fetchSubmodules = false;
      sha256 = "sha256-5xDkFcOnP645IjR+0YBKsCpqOWGj2jzv02epnYPpdTs=";
    });
  };
  spicetify-themes = {
  ...
  tailscale = {
    pname = "tailscale";
    version = "3ae701f0ebe053a1f7b6a3fa345a56b3132c818f";
    src = fetchFromGitHub ({
      owner = "tailscale";
      repo = "tailscale";
      rev = "3ae701f0ebe053a1f7b6a3fa345a56b3132c818f";
      fetchSubmodules = false;
      sha256 = "sha256-Ldqm4bcWyBdShcNYr95PUCFdhpAmV/Gt0M4GRBjEib8=";
    });
  };
  tailscale-systray = {
