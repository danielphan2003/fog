...
{ fetchgit, fetchurl, fetchFromGitHub }:
{
  ...
  jicofo = {
    ...
    version = "1.0-869";
    src = fetchurl {
      url = "https://download.jitsi.org/unstable/jicofo_1.0-869-1_all.deb";
      sha256 = "sha256-S3uwmbqndgqpz+ni5HTTXUNBPRcI5dcw2VA5calQ8og=";
    };
  };
  jitsi-meet = {
    pname = "jitsi-meet";
  ...
  retroarch = {
    pname = "retroarch";
    version = "8fc14354e9a32a1a11c388774bd28d62bfc0abca";
    src = fetchFromGitHub ({
      owner = "libretro";
      repo = "retroarch";
      rev = "8fc14354e9a32a1a11c388774bd28d62bfc0abca";
      fetchSubmodules = false;
      sha256 = "sha256-xNH4H6MssoFmlpAgXjLWv8Gd9I6YfoJ7d7aC+mBpqXU=";
    });
  };
  rofi-wayland = {
    pname = "rofi-wayland";
