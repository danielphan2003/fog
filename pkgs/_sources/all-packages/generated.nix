...
{ fetchgit, fetchurl, fetchFromGitHub }:
{
  ...
  bottles = {
    pname = "bottles";
    version = "80f924cd36dfb9a574935a4907f9a87deebf404b";
    src = fetchFromGitHub ({
      owner = "bottlesdevs";
      repo = "Bottles";
      rev = "80f924cd36dfb9a574935a4907f9a87deebf404b";
      fetchSubmodules = false;
      sha256 = "sha256-WmhsWvkw4i8uhpC2rkZ9L0UFYxUJK+DxHvhLf/dFcNE=";
    });
  };
  caddy = {
    pname = "caddy";
  ...
  retroarch = {
    pname = "retroarch";
    version = "065fb5acee12d0149a567258f835900dd1047a4e";
    src = fetchFromGitHub ({
      owner = "libretro";
      repo = "retroarch";
      rev = "065fb5acee12d0149a567258f835900dd1047a4e";
      fetchSubmodules = false;
      sha256 = "sha256-vc4/pPUjhX6rInzMYPkQ3coTAJiAwg7Vv45wlkKMJDg=";
    });
  };
  rofi-wayland = {
    pname = "rofi-wayland";
  ...
  rustdesk = {
    pname = "rustdesk";
    version = "7c5d2607384de56f9f4760b249b5b92900517532";
    src = fetchFromGitHub ({
      owner = "rustdesk";
      repo = "rustdesk";
      rev = "7c5d2607384de56f9f4760b249b5b92900517532";
      fetchSubmodules = false;
      sha256 = "sha256-2ThXsEsYB8UvxZQtUWI7tGcgqZA2dzdMYVcgiuZOjgM=";
    });
    cargoLock = {
      lockFile = ./rustdesk-7c5d2607384de56f9f4760b249b5b92900517532/Cargo.lock;
      outputHashes = {
  ...
  tailscale = {
    pname = "tailscale";
    version = "1db46919ab02676faa65535c18da9c45988e3a30";
    src = fetchFromGitHub ({
      owner = "tailscale";
      repo = "tailscale";
      rev = "1db46919ab02676faa65535c18da9c45988e3a30";
      fetchSubmodules = false;
      sha256 = "sha256-KBOEb5D0rxInWO9D/o9FA98k7Hdx+smVdOCN2E0hVnI=";
    });
  };
  tailscale-systray = {
  ...
  whitesur-icon-theme = {
    ...
    version = "0c0918659f549bd0c6fefe0f5feed5f80475eaaa";
    src = fetchFromGitHub ({
      owner = "vinceliuice";
      repo = "whitesur-icon-theme";
      rev = "0c0918659f549bd0c6fefe0f5feed5f80475eaaa";
      fetchSubmodules = false;
      sha256 = "sha256-iHLxZqcDLUo62J67MwZ72CSvsHHiI9/Jk31KwkgIPr4=";
    });
  };
  widevine-cdm = {
    pname = "widevine-cdm";
  ...
  xdg-desktop-portal = {
    ...
    version = "380bd87f6be0702f1acc4c2f2a3541e08ef7d1a4";
    src = fetchFromGitHub ({
      owner = "flatpak";
      repo = "xdg-desktop-portal";
      rev = "380bd87f6be0702f1acc4c2f2a3541e08ef7d1a4";
      fetchSubmodules = false;
      sha256 = "sha256-joiJG9O2MuExMTP9SEAY/ewPjzMTA/a8aUrY0mIEVEI=";
    });
  };
