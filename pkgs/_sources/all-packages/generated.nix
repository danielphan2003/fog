...
{ fetchgit, fetchurl, fetchFromGitHub }:
{
  ...
  bottles = {
    pname = "bottles";
    version = "22d75b1f6b40211e4bed71ec1396280a213a60cb";
    src = fetchFromGitHub ({
      owner = "bottlesdevs";
      repo = "Bottles";
      rev = "22d75b1f6b40211e4bed71ec1396280a213a60cb";
      fetchSubmodules = false;
      sha256 = "sha256-p9QbS1Tcusk4ss9uj+R5cVTOOoUrDsLpYedtcRHogLA=";
    });
  };
  caddy = {
    pname = "caddy";
  ...
  rustdesk = {
    pname = "rustdesk";
    version = "71fb27fe4b4a1ae966869996b49b3500daebc592";
    src = fetchFromGitHub ({
      owner = "rustdesk";
      repo = "rustdesk";
      rev = "71fb27fe4b4a1ae966869996b49b3500daebc592";
      fetchSubmodules = false;
      sha256 = "sha256-SkjSmCQgg7yioGk/wI1fDEp5sjVar6vsU3i01SU7mI0=";
    });
    cargoLock = {
      lockFile = ./rustdesk-71fb27fe4b4a1ae966869996b49b3500daebc592/Cargo.lock;
      outputHashes = {
