...
{ fetchgit, fetchurl, fetchFromGitHub }:
{
  ...
  retroarch = {
    pname = "retroarch";
    version = "80a9c16b3f7213ca6565bdeda510dbff397aef26";
    src = fetchFromGitHub ({
      owner = "libretro";
      repo = "retroarch";
      rev = "80a9c16b3f7213ca6565bdeda510dbff397aef26";
      fetchSubmodules = false;
      sha256 = "sha256-3nK+ZdaSKMhuIaPkqiZc4FCDvRMHHRsPm8lDEPrbd+g=";
    });
  };
  rofi-wayland = {
    pname = "rofi-wayland";
  ...
  rustdesk = {
    pname = "rustdesk";
    version = "2724bd40000f81b5e316ea867fee66bf9761abc0";
    src = fetchFromGitHub ({
      owner = "rustdesk";
      repo = "rustdesk";
      rev = "2724bd40000f81b5e316ea867fee66bf9761abc0";
      fetchSubmodules = false;
      sha256 = "sha256-7/MBb1zzSM9BjihH8GLlLfPDgWNlnPx3ah3WJ5z/fe8=";
    });
    cargoLock = {
      lockFile = ./rustdesk-2724bd40000f81b5e316ea867fee66bf9761abc0/Cargo.lock;
      outputHashes = {
