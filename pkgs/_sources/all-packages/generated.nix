...
{ fetchgit, fetchurl, fetchFromGitHub }:
{
  ...
  bling = {
    pname = "bling";
    version = "c20aa6daea6b9887d2430ac9e62cb70514d23cbe";
    src = fetchFromGitHub ({
      owner = "BlingCorp";
      repo = "bling";
      rev = "c20aa6daea6b9887d2430ac9e62cb70514d23cbe";
      fetchSubmodules = false;
      sha256 = "sha256-rAV9jmFy06S7dND1vzmb3ybFYkPl1FYLcywB2SuAdsQ=";
    });
  };
  bottles = {
    pname = "bottles";
    version = "fabc99d1f26787266c030d5e8b5da034cac6741c";
    src = fetchFromGitHub ({
      owner = "bottlesdevs";
      repo = "Bottles";
      rev = "fabc99d1f26787266c030d5e8b5da034cac6741c";
      fetchSubmodules = false;
      sha256 = "sha256-8ZsPI2ETA2PSdndRmaOUxOscwGAyayOK8i78KXZc8kg=";
    });
  };
  caddy = {
    pname = "caddy";
  ...
  tailscale = {
    pname = "tailscale";
    version = "6dae9e47f92a77e40b932e2961b1dd99cd47d2f6";
    src = fetchFromGitHub ({
      owner = "tailscale";
      repo = "tailscale";
      rev = "6dae9e47f92a77e40b932e2961b1dd99cd47d2f6";
      fetchSubmodules = false;
      sha256 = "sha256-4pzdx4qP5vichkcfNooDFirzKm4QqDTQofgH7p+sCZ0=";
    });
  };
  tailscale-systray = {
