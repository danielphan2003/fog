...
{ fetchgit, fetchurl, fetchFromGitHub }:
{
  ...
  bottles = {
    pname = "bottles";
    version = "ab44240e9345a76ae65288ea7229b5a36f299de0";
    src = fetchFromGitHub ({
      owner = "bottlesdevs";
      repo = "Bottles";
      rev = "ab44240e9345a76ae65288ea7229b5a36f299de0";
      fetchSubmodules = false;
      sha256 = "sha256-7DUN+noBCG2f1fqLPsy31NN+LYtjghg/T448e0HqEUY=";
    });
  };
  caddy = {
    pname = "caddy";
  ...
  eww = {
    pname = "eww";
    version = "fe4097c73eeeffd4fdae13477eabe7fd2b4bea52";
    src = fetchFromGitHub ({
      owner = "elkowar";
      repo = "eww";
      rev = "fe4097c73eeeffd4fdae13477eabe7fd2b4bea52";
      fetchSubmodules = false;
      sha256 = "sha256-K1DWMsViviUBcm0ghxOGCIQqwIpYt1hTRmWFvz//4OA=";
    });
    cargoLock = {
      lockFile = ./eww-fe4097c73eeeffd4fdae13477eabe7fd2b4bea52/Cargo.lock;
      outputHashes = { };
    };
  };
  ...
  hyprland = {
    pname = "hyprland";
    version = "1eec8c374151bdb74559749bb76fa732e41cb0ba";
    src = fetchFromGitHub ({
      owner = "vaxerski";
      repo = "hyprland";
      rev = "1eec8c374151bdb74559749bb76fa732e41cb0ba";
      fetchSubmodules = false;
      sha256 = "sha256-7L9yVp/SgYJ/Zi7cY39VzB7x027JgmEe8tmc/OoeeXc=";
    });
  };
  ibus = {
    pname = "ibus";
  ...
  jitsi-meet = {
    ...
    version = "1.0.6098";
    src = fetchurl {
      url = "https://download.jitsi.org/jitsi-meet/src/jitsi-meet-1.0.6098.tar.bz2";
      sha256 = "sha256-D8lXNbhBcsH1jouT5eWboGoiz4LFaLnCAOqaRjiptQg=";
    };
  };
  jitsi-meet-prosody = {
    ...
    version = "1.0.6098";
    src = fetchurl {
      url = "https://download.jitsi.org/unstable/jitsi-meet-prosody_1.0.6098-1_all.deb";
      sha256 = "sha256-4qAppty/36SmFrSTE/sm3lij1Re4UKAWUKa0x6Fz2bQ=";
    };
  };
  jitsi-videobridge2 = {
  ...
  retroarch = {
    pname = "retroarch";
    version = "6195711bb33bfcdc6571b876204bc31a0d59be8f";
    src = fetchFromGitHub ({
      owner = "libretro";
      repo = "retroarch";
      rev = "6195711bb33bfcdc6571b876204bc31a0d59be8f";
      fetchSubmodules = false;
      sha256 = "sha256-XFU4CCj/m9dRW6DjPI3rMX7qOAlB3WlH+pRpFWM5yCw=";
    });
  };
  rofi-wayland = {
    pname = "rofi-wayland";
  ...
  snui = {
    pname = "snui";
    version = "38bdad6847741b78fac46654492c7b456f9e6cf4";
    src = fetchgit {
      url = "https://gitlab.com/snakedye/snui";
      rev = "38bdad6847741b78fac46654492c7b456f9e6cf4";
      fetchSubmodules = false;
      deepClone = false;
      leaveDotGit = false;
      sha256 = "sha256-F070GOxk9jbxUUJ+Dzlic/b4avjs/XGNhpr9pIqSN0Y=";
    };
  };
  spicetify-cli = {
    pname = "spicetify-cli";
  ...
  spicetify-themes = {
    ...
    version = "178a76ae14c6dd4125a14c0f0d7a6a572d0b5e66";
    src = fetchFromGitHub ({
      owner = "morpheusthewhite";
      repo = "spicetify-themes";
      rev = "178a76ae14c6dd4125a14c0f0d7a6a572d0b5e66";
      fetchSubmodules = false;
      sha256 = "sha256-hKs3/TcOtAgbLIXDHYeNg0T0u+AEP+TrEfhC73T+XGw=";
    });
  };
  spotify = {
    pname = "spotify";
