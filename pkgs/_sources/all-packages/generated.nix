...
{ fetchgit, fetchurl, fetchFromGitHub }:
{
  ...
  bottles = {
    pname = "bottles";
    version = "6732b731f95793fb49747dcd254d32a16d86583e";
    src = fetchFromGitHub ({
      owner = "bottlesdevs";
      repo = "Bottles";
      rev = "6732b731f95793fb49747dcd254d32a16d86583e";
      fetchSubmodules = false;
      sha256 = "sha256-lquINWsYtdMVAOcoxGT9kviofVTNOYSBwW9ogmTlZOI=";
    });
  };
  caddy = {
    pname = "caddy";
  ...
  retroarch = {
    pname = "retroarch";
    version = "460f5e745dbe205b5018a48d3c9575d421b02146";
    src = fetchFromGitHub ({
      owner = "libretro";
      repo = "retroarch";
      rev = "460f5e745dbe205b5018a48d3c9575d421b02146";
      fetchSubmodules = false;
      sha256 = "sha256-rk1xFDATnbdk2ZSOGuksZcgKtDdo6yAsaDGW6ZPaVJI=";
    });
  };
  rofi-wayland = {
    pname = "rofi-wayland";
  ...
  rustdesk = {
    pname = "rustdesk";
    version = "bcda7d31932d0c3ff8fe76ab7f761665025b0df6";
    src = fetchFromGitHub ({
      owner = "rustdesk";
      repo = "rustdesk";
      rev = "bcda7d31932d0c3ff8fe76ab7f761665025b0df6";
      fetchSubmodules = false;
      sha256 = "sha256-7228rFgqt8KjVEJtWSo6XjlE9mi6iwK8nQybCxtCofA=";
    });
    cargoLock = {
      lockFile = ./rustdesk-bcda7d31932d0c3ff8fe76ab7f761665025b0df6/Cargo.lock;
      outputHashes = {
        ...
        "rdev-0.5.0" = "sha256-01o33kUYtkp/7izQcL/hppzdKv6OF1giQRrxHozKZCk=";
  ...
  tailscale = {
    pname = "tailscale";
    version = "c85694fac48b17f3d657ad407257a40a65ee310b";
    src = fetchFromGitHub ({
      owner = "tailscale";
      repo = "tailscale";
      rev = "c85694fac48b17f3d657ad407257a40a65ee310b";
      fetchSubmodules = false;
      sha256 = "sha256-VmTXB3luDRsJOIBvBH79VcwuYVYrRBqYyfrCPSdQ+ew=";
    });
  };
  tailscale-systray = {
  ...
  trackma = {
    pname = "trackma";
    version = "d7e352374cdc5e84c3aeb363d4e08184ae90af43";
    src = fetchurl {
      url = "https://github.com/z411/trackma/archive/master.tar.gz";
      sha256 = "sha256-KIjC87SiP0q2kmRKY0SiuBVkJ+v6yN3tsZrpGSEvfjA=";
    };
  };
  ulauncher = {
    pname = "ulauncher";
