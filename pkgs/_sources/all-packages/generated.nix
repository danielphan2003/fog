...
{ fetchgit, fetchurl, fetchFromGitHub }:
{
  ...
  jitsi-videobridge2 = {
    ...
    version = "2.1-676-g8c5035d3";
    src = fetchurl {
      url = "https://download.jitsi.org/unstable/jitsi-videobridge2_2.1-676-g8c5035d3-1_all.deb";
      sha256 = "sha256-clMTWxvY2WlW8VehHXdkyaeVvI0no9xTr1ZuoV5SZDY=";
    };
  };
  layout-machi = {
    pname = "layout-machi";
  ...
  tailscale = {
    pname = "tailscale";
    version = "5a1ef1bbb9b67f11d625c543f16005c8c4ac41ba";
    src = fetchFromGitHub ({
      owner = "tailscale";
      repo = "tailscale";
      rev = "5a1ef1bbb9b67f11d625c543f16005c8c4ac41ba";
      fetchSubmodules = false;
      sha256 = "sha256-0qVmHneiht0yPe7VxKSxLwyM2CvYaxvS8azf7G5cYmQ=";
    });
  };
  tailscale-systray = {
