...
{ fetchgit, fetchurl, fetchFromGitHub }:
{
  ...
  jitsi-meet = {
    ...
    version = "1.0.5973";
    src = fetchurl {
      url = "https://download.jitsi.org/jitsi-meet/src/jitsi-meet-1.0.5973.tar.bz2";
      sha256 = "sha256-F5x0wcFv43T2xLJrmNb65Z3K9fK6pGcdP7XWJXqCGyI=";
    };
  };
  jitsi-meet-prosody = {
    ...
    version = "1.0.5973";
    src = fetchurl {
      url = "https://download.jitsi.org/unstable/jitsi-meet-prosody_1.0.5973-1_all.deb";
      sha256 = "sha256-EKAD+mb2QpEEzgzINzqDH5oX4lU/pywXAx+f3+LOkKc=";
    };
  };
  jitsi-videobridge2 = {
  ...
  tailscale = {
    pname = "tailscale";
    version = "f6642e0ece20e59e29a076d500d0edf03122d2d1";
    src = fetchFromGitHub ({
      owner = "tailscale";
      repo = "tailscale";
      rev = "f6642e0ece20e59e29a076d500d0edf03122d2d1";
      fetchSubmodules = false;
      sha256 = "sha256-3X36oSj0VRHyWPKc6OR3m1p5O81z1RUKso+EEGoBL+c=";
    });
  };
  tailscale-systray = {
