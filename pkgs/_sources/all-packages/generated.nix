...
{ fetchgit, fetchurl, fetchFromGitHub }:
{
  ...
  bottles = {
    pname = "bottles";
    version = "6da2b55c394919473fedbab02501f5caf29d0092";
    src = fetchFromGitHub ({
      owner = "bottlesdevs";
      repo = "Bottles";
      rev = "6da2b55c394919473fedbab02501f5caf29d0092";
      fetchSubmodules = false;
      sha256 = "sha256-DCb7PWdbQXg/cGpIBfZD8HAL6Bb7bTxSzhu0tFA3Oww=";
    });
  };
  caddy = {
    pname = "caddy";
  ...
  tailscale = {
    pname = "tailscale";
    version = "1dd5cf62a551aff209afbf7c91ebad24b852be91";
    src = fetchFromGitHub ({
      owner = "tailscale";
      repo = "tailscale";
      rev = "1dd5cf62a551aff209afbf7c91ebad24b852be91";
      fetchSubmodules = false;
      sha256 = "sha256-2dGpSiATnDyDmjANlAx9YTi4+obvL+ZS3g7auJf/JQ0=";
    });
  };
  tailscale-systray = {
