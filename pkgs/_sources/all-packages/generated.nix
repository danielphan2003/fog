...
{ fetchgit, fetchurl, fetchFromGitHub }:
{
  ...
  rustdesk = {
    pname = "rustdesk";
    version = "f21788b9672d2944eb9bd33926475a06eba38db1";
    src = fetchFromGitHub ({
      owner = "rustdesk";
      repo = "rustdesk";
      rev = "f21788b9672d2944eb9bd33926475a06eba38db1";
      fetchSubmodules = false;
      sha256 = "sha256-sYmj85mhDCXE7vPGlKrTNKygXRNGaD7FzSLQpsct6tw=";
    });
    cargoLock = {
      lockFile = ./rustdesk-f21788b9672d2944eb9bd33926475a06eba38db1/Cargo.lock;
      outputHashes = {
  ...
  tailscale = {
    pname = "tailscale";
    version = "e3619b890c201de66dadacc538b5442586151541";
    src = fetchFromGitHub ({
      owner = "tailscale";
      repo = "tailscale";
      rev = "e3619b890c201de66dadacc538b5442586151541";
      fetchSubmodules = false;
      sha256 = "sha256-Qcmue7oVz7Dm1Isb+r8/JDjcFI/UtufxbIA2b8zPCwM=";
    });
  };
  tailscale-systray = {
