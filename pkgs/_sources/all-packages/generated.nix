...
{ fetchgit, fetchurl, fetchFromGitHub }:
{
  ...
  arkenfox-userjs = {
    ...
    version = "ba052105de3c4be2e34cf103f08b2f28c6d5b496";
    src = fetchFromGitHub ({
      owner = "arkenfox";
      repo = "user.js";
      rev = "ba052105de3c4be2e34cf103f08b2f28c6d5b496";
      fetchSubmodules = false;
  ...
  bottles = {
    pname = "bottles";
    version = "97bd234bf8ed6e1b4add73d9821412dc3eb19455";
    src = fetchFromGitHub ({
      owner = "bottlesdevs";
      repo = "Bottles";
      rev = "97bd234bf8ed6e1b4add73d9821412dc3eb19455";
      fetchSubmodules = false;
      sha256 = "sha256-PdwbrRuYBpZDxXsXIGjiJjbr39f7hXkQ/acwioKeBl4=";
    });
  };
  caddy = {
    pname = "caddy";
  ...
  pmbootstrap-test = {
    ...
    version = "0d5ff8f5201c466695b0b7fdfb8cccf40c7df5ae";
    src = fetchgit {
      url = "https://gitlab.com/postmarketOS/pmbootstrap";
      rev = "0d5ff8f5201c466695b0b7fdfb8cccf40c7df5ae";
      fetchSubmodules = false;
      deepClone = false;
      leaveDotGit = false;
      sha256 = "sha256-K+9E25ulNGdP8cFoO8MwBq1DEJGWMFW7i9FKke/aE7Y=";
    };
  };
  pure = {
    pname = "pure";
  ...
  retroarch = {
    pname = "retroarch";
    version = "b8242601ecfdbad93d57493b66727b73025c8860";
    src = fetchFromGitHub ({
      owner = "libretro";
      repo = "retroarch";
      rev = "b8242601ecfdbad93d57493b66727b73025c8860";
      fetchSubmodules = false;
      sha256 = "sha256-dhXpILPuk75gi5yE1DDpqT63ePXOVM9lVZpkGAkSZ4I=";
    });
  };
  rofi-wayland = {
    pname = "rofi-wayland";
  ...
  rustdesk = {
    pname = "rustdesk";
    version = "8bb41830987e238315ba884281779d55b0a2b93a";
    src = fetchFromGitHub ({
      owner = "rustdesk";
      repo = "rustdesk";
      rev = "8bb41830987e238315ba884281779d55b0a2b93a";
      fetchSubmodules = false;
      sha256 = "sha256-Dtrkb8O3HHW+s9pdQeAGomPyTeCYXVHWF4n608PT3i4=";
    });
    cargoLock = {
      lockFile = ./rustdesk-8bb41830987e238315ba884281779d55b0a2b93a/Cargo.lock;
      outputHashes = {
  ...
  tailscale = {
    pname = "tailscale";
    version = "8fe503057da26a2e29db6ca27d2ef4573ae62395";
    src = fetchFromGitHub ({
      owner = "tailscale";
      repo = "tailscale";
      rev = "8fe503057da26a2e29db6ca27d2ef4573ae62395";
      fetchSubmodules = false;
      sha256 = "sha256-IZPsxYggp87g6kC3c7L4VswfSzKTuxmslqqVx3GSb1o=";
    });
  };
  tailscale-systray = {
  ...
  whitesur-icon-theme = {
    ...
    version = "bc20300c4b659de2c02f130d3465bd996f964ac8";
    src = fetchFromGitHub ({
      owner = "vinceliuice";
      repo = "whitesur-icon-theme";
      rev = "bc20300c4b659de2c02f130d3465bd996f964ac8";
      fetchSubmodules = false;
      sha256 = "sha256-ZSxxzr/5pXkQztTxGBs9yWtVdvJC6C6FXncvcde0954=";
    });
  };
  widevine-cdm = {
    pname = "widevine-cdm";
