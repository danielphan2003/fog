...
{ fetchgit, fetchurl, fetchFromGitHub }:
{
  ...
  caddy = {
    pname = "caddy";
    version = "6cadb60fa2308f24a20a32c3f8d5e3a521c277ff";
    src = fetchFromGitHub ({
      owner = "caddyserver";
      repo = "caddy";
      rev = "6cadb60fa2308f24a20a32c3f8d5e3a521c277ff";
      fetchSubmodules = false;
      sha256 = "sha256-MT7VcdmtFs80UZux5A1szzDcTcsBnNE68Wl+iBWYSw4=";
    });
  };
  cups-pdf = {
    pname = "cups-pdf";
  ...
  tailscale = {
    pname = "tailscale";
    version = "c8b63a409e031baba04d37a16f8d99a5e3b9f6b5";
    src = fetchFromGitHub ({
      owner = "tailscale";
      repo = "tailscale";
      rev = "c8b63a409e031baba04d37a16f8d99a5e3b9f6b5";
      fetchSubmodules = false;
      sha256 = "sha256-c6aRsmHLf3guBovuQ0Sg5933RYoqLfvnoYoT8pcSPcM=";
    });
  };
  tailscale-systray = {
