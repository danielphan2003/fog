...
{ fetchgit, fetchurl, fetchFromGitHub }:
{
  ...
  bottles = {
    pname = "bottles";
    version = "41c957265b29972c408e8da3d936d7c751008aaf";
    src = fetchFromGitHub ({
      owner = "bottlesdevs";
      repo = "Bottles";
      rev = "41c957265b29972c408e8da3d936d7c751008aaf";
      fetchSubmodules = false;
      sha256 = "sha256-01cCuSRDTsLxqkjTyKKAaZNQPCwSlKxFaIHiwh1RGC0=";
    });
  };
  caddy = {
    pname = "caddy";
  ...
  dribbblish-dynamic-theme = {
    ...
    version = "69f283c7a99ee7b344309c2da6d18b02d8929305";
    src = fetchFromGitHub ({
      owner = "JulienMaille";
      repo = "dribbblish-dynamic-theme";
      rev = "69f283c7a99ee7b344309c2da6d18b02d8929305";
      fetchSubmodules = false;
      sha256 = "sha256-ghuuLM7AIb2UCVk9S77352POqXaz8xYet9wllJfimJ0=";
    });
  };
  droidcam = {
    pname = "droidcam";
  ...
  hyprland = {
    pname = "hyprland";
    version = "c35517d44e983524760109ea7864c2ace91e5f9e";
    src = fetchFromGitHub ({
      owner = "vaxerski";
      repo = "hyprland";
      rev = "c35517d44e983524760109ea7864c2ace91e5f9e";
      fetchSubmodules = false;
      sha256 = "sha256-dPMNLr9QmMRBCfKqrCpG0l3yRMcz3kzihFI0Wh72NKA=";
    });
  };
  ibus = {
    pname = "ibus";
  ...
  rustdesk = {
    pname = "rustdesk";
    version = "f1d187739c0b2a0edf2466201785ec909571a813";
    src = fetchFromGitHub ({
      owner = "rustdesk";
      repo = "rustdesk";
      rev = "f1d187739c0b2a0edf2466201785ec909571a813";
      fetchSubmodules = false;
      sha256 = "sha256-pCTOqtx0gy96uxJPpQad1jXkyukr+SdhRySQD08voH0=";
    });
    cargoLock = {
      lockFile = ./rustdesk-f1d187739c0b2a0edf2466201785ec909571a813/Cargo.lock;
      outputHashes = {
  ...
  spicetify-cli = {
    pname = "spicetify-cli";
    version = "427e9c6d9dcc658554ade2d8930eccd3ea37d58a";
    src = fetchFromGitHub ({
      owner = "khanhas";
      repo = "spicetify-cli";
      rev = "427e9c6d9dcc658554ade2d8930eccd3ea37d58a";
      fetchSubmodules = false;
      sha256 = "sha256-9zea9Ht/ninWuN+Fa7jIlIZ6rSBp8vmN41mY7+yxAYA=";
    });
  };
  spicetify-themes = {
    ...
    src = fetchFromGitHub ({
      ...
      fetchSubmodules = false;
      sha256 = "sha256-rRwwpl3F5bxq/YZFY9bQ+/5CSXigz/ZN5/aCC4LcoTM=";
    });
  };
  spotify = {
    pname = "spotify";
