...
{ fetchgit, fetchurl, fetchFromGitHub }:
{
  ...
  retroarch = {
    pname = "retroarch";
    version = "f0d9add1b266c4e34e03171f213991715ffbd08e";
    src = fetchFromGitHub ({
      owner = "libretro";
      repo = "retroarch";
      rev = "f0d9add1b266c4e34e03171f213991715ffbd08e";
      fetchSubmodules = false;
      sha256 = "sha256-ALTUVPmv7Nui3/rANkQqtv4f+36fXyxQ+paVuTRwVS4=";
    });
  };
  rofi-wayland = {
    pname = "rofi-wayland";
  ...
  rustdesk = {
    pname = "rustdesk";
    version = "944fde15a4ec80a37cd3c5021242750d3a95e235";
    src = fetchFromGitHub ({
      owner = "rustdesk";
      repo = "rustdesk";
      rev = "944fde15a4ec80a37cd3c5021242750d3a95e235";
      fetchSubmodules = false;
      sha256 = "sha256-AFgA5BTgRWf0ooDoYfaAiBdMoKPr8YiX/ltU0467jqM=";
    });
    cargoLock = {
      lockFile = ./rustdesk-944fde15a4ec80a37cd3c5021242750d3a95e235/Cargo.lock;
      outputHashes = {
