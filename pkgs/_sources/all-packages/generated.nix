...
{ fetchgit, fetchurl, fetchFromGitHub }:
{
  ...
  retroarch = {
    pname = "retroarch";
    version = "be567da82b8104566d27bb32f6078851d2cca126";
    src = fetchFromGitHub ({
      owner = "libretro";
      repo = "retroarch";
      rev = "be567da82b8104566d27bb32f6078851d2cca126";
      fetchSubmodules = false;
      sha256 = "sha256-ua5nHaHDVO6jO2fUhTI077TzXW8vuqkm7n4XEBHXWzk=";
    });
  };
  rofi-wayland = {
    pname = "rofi-wayland";
  ...
  rustdesk = {
    pname = "rustdesk";
    version = "85a2a7cd4452502d16c10edf1ba81573f215ec7c";
    src = fetchFromGitHub ({
      owner = "rustdesk";
      repo = "rustdesk";
      rev = "85a2a7cd4452502d16c10edf1ba81573f215ec7c";
      fetchSubmodules = false;
      sha256 = "sha256-DtD33JAfKEBAXh+d1kzJLTZHS4NUPPQDb7jrgLjd02E=";
    });
    cargoLock = {
      lockFile = ./rustdesk-85a2a7cd4452502d16c10edf1ba81573f215ec7c/Cargo.lock;
      outputHashes = {
