...
{ fetchgit, fetchurl, fetchFromGitHub }:
{
  ...
  hyprland = {
    pname = "hyprland";
    version = "0132e52b1351a93fd7017e9653caa4aab419ca87";
    src = fetchFromGitHub ({
      owner = "vaxerski";
      repo = "hyprland";
      rev = "0132e52b1351a93fd7017e9653caa4aab419ca87";
      fetchSubmodules = false;
      sha256 = "sha256-Y/BhaLeGuVaZQCSUIYZ9gEHvG8Jwmp5jvivlkKy1LnA=";
    });
  };
  ibus = {
    pname = "ibus";
  ...
  tailscale = {
    pname = "tailscale";
    version = "6bed78125933a4fe1cad38c98b4a9dbd0b4f9df4";
    src = fetchFromGitHub ({
      owner = "tailscale";
      repo = "tailscale";
      rev = "6bed78125933a4fe1cad38c98b4a9dbd0b4f9df4";
      fetchSubmodules = false;
      sha256 = "sha256-AaAKxL6R98X41x3t0GLaKGDk3tzF5ovM+6jvB3ZFZPo=";
    });
  };
  tailscale-systray = {
