...
{ fetchgit, fetchurl, fetchFromGitHub }:
{
  ...
  bottles = {
    pname = "bottles";
    version = "b9a6c17d1af060fa894d1b194057419d8c5ab070";
    src = fetchFromGitHub ({
      owner = "bottlesdevs";
      repo = "Bottles";
      rev = "b9a6c17d1af060fa894d1b194057419d8c5ab070";
      fetchSubmodules = false;
      sha256 = "sha256-OWZY4SsX/HJvU/FC7Cvm75AQddYSt2RmBNQ6SXzlDk8=";
    });
  };
  caddy = {
    pname = "caddy";
  ...
  eww = {
    pname = "eww";
    version = "7168ceafe3438082900214c760bec777dcb9421f";
    src = fetchFromGitHub ({
      owner = "elkowar";
      repo = "eww";
      rev = "7168ceafe3438082900214c760bec777dcb9421f";
      fetchSubmodules = false;
      sha256 = "sha256-8ow9/qQk8YAESmdLAKm0pSQCXqZdftZsOIhG48TyULI=";
    });
    cargoLock = {
      lockFile = ./eww-7168ceafe3438082900214c760bec777dcb9421f/Cargo.lock;
      outputHashes = { };
    };
  };
  ...
  hyprland = {
    pname = "hyprland";
    version = "aa5b0d2cda4aa3a06bb80b69dbcbb18ffddb8c8f";
    src = fetchFromGitHub ({
      owner = "vaxerski";
      repo = "hyprland";
      rev = "aa5b0d2cda4aa3a06bb80b69dbcbb18ffddb8c8f";
      fetchSubmodules = false;
      sha256 = "sha256-wLta456FPh8lqz+JjCtqbeEaOSZw4xIFyt/+h/8E1wQ=";
    });
  };
  ibus = {
    pname = "ibus";
  ...
  jibri = {
    pname = "jibri";
    version = "8.0-130-g6a74835";
    src = fetchurl {
      url = "https://download.jitsi.org/unstable/jibri_8.0-130-g6a74835-1_all.deb";
      sha256 = "sha256-vRpt1hk2Yz8edR9/Ja9Y8X3InznsvuGa2SO9yJx7cVc=";
    };
  };
  jicofo = {
    pname = "jicofo";
  ...
  jitsi-meet = {
    ...
    version = "1.0.6165";
    src = fetchurl {
      url = "https://download.jitsi.org/jitsi-meet/src/jitsi-meet-1.0.6165.tar.bz2";
      sha256 = "sha256-9Q0GYUksGxAZXeEtK+0lgoxB6Z6DUd/hc7ShznDQ1CI=";
    };
  };
  jitsi-meet-prosody = {
    ...
    version = "1.0.6165";
    src = fetchurl {
      url = "https://download.jitsi.org/unstable/jitsi-meet-prosody_1.0.6165-1_all.deb";
      sha256 = "sha256-CyJENy3qhZJeCryFtX/cw8H0thoeAPrEErSP9W/jryE=";
    };
  };
  jitsi-videobridge2 = {
    ...
    src = fetchurl {
      url = "https://download.jitsi.org/unstable/jitsi-videobridge2_2.1-681-g3544ed05-1_all.deb";
  ...
  microsoft-edge-beta = {
    ...
    src = fetchurl {
      url = "https://packages.microsoft.com/repos/edge/pool/main/m/microsoft-edge-beta/microsoft-edge-beta_101.0.1210.39-1_amd64.deb";
      sha256 = "sha256-jpdFUff+MdXSt+iZdEb2dA//TKf8WQoqykXyEXz8UVY=";
    };
  };
  microsoft-edge-dev = {
    ...
    src = fetchurl {
      url = "https://packages.microsoft.com/repos/edge/pool/main/m/microsoft-edge-dev/microsoft-edge-dev_102.0.1245.3-1_amd64.deb";
      sha256 = "sha256-22ckWkIafw4VJ0hMrVELbjMikLvRqI5XQYEIrWxBMsg=";
    };
  };
  minecraft-wayland = {
  ...
  retroarch = {
    pname = "retroarch";
    version = "8475bcbab35ee1d912f498b5e5b56e6c0019fbdd";
    src = fetchFromGitHub ({
      owner = "libretro";
      repo = "retroarch";
      rev = "8475bcbab35ee1d912f498b5e5b56e6c0019fbdd";
      fetchSubmodules = false;
      sha256 = "sha256-Eyqr/xCAxOOh0HAeHvim3bylvC/68EOUMkpc3uWkaEU=";
    });
  };
  rofi-wayland = {
    pname = "rofi-wayland";
  ...
  rustdesk = {
    pname = "rustdesk";
    version = "12ff1e316ef86d6204dd97347974def632926417";
    src = fetchFromGitHub ({
      owner = "rustdesk";
      repo = "rustdesk";
      rev = "12ff1e316ef86d6204dd97347974def632926417";
      fetchSubmodules = false;
      sha256 = "sha256-9UBOcSCbk6VDIsVVlbWArQhoXyj7NWZSVutwmHuunog=";
    });
    cargoLock = {
      lockFile = ./rustdesk-12ff1e316ef86d6204dd97347974def632926417/Cargo.lock;
      outputHashes = {
  ...
  snui = {
    pname = "snui";
    version = "7ab195f80d6ed134db9b24067fbd54067fff81f1";
    src = fetchgit {
      url = "https://gitlab.com/snakedye/snui";
      rev = "7ab195f80d6ed134db9b24067fbd54067fff81f1";
      fetchSubmodules = false;
      deepClone = false;
      leaveDotGit = false;
      sha256 = "sha256-DJaW0s1El0HM+ruS6XANzRqQ7TH1Br0ki7eWb8S0g98=";
    };
  };
  spicetify-cli = {
    pname = "spicetify-cli";
  ...
  spicetify-themes = {
    ...
    version = "d48ae5ebfbd9f5d8762efa20d0e0678f76c5083c";
    src = fetchFromGitHub ({
      owner = "morpheusthewhite";
      repo = "spicetify-themes";
      rev = "d48ae5ebfbd9f5d8762efa20d0e0678f76c5083c";
      fetchSubmodules = false;
      sha256 = "sha256-sXQgkC+Ns/EsxVocMXJM2X2+83Cn05L3yKhMrixmSnY=";
    });
  };
  spotify = {
    pname = "spotify";
  ...
  tailscale = {
    pname = "tailscale";
    version = "741ae9956e674177687062b5499a80db83505076";
    src = fetchFromGitHub ({
      owner = "tailscale";
      repo = "tailscale";
      rev = "741ae9956e674177687062b5499a80db83505076";
      fetchSubmodules = false;
      sha256 = "sha256-1dhKAn358KX5yuP3aQH9zHP39xuBHMRlwE/k6V3j2tY=";
    });
  };
  tailscale-systray = {
  ...
  whitesur-gtk-theme = {
    ...
    version = "918e3fbc5d782538a5cbb45f7b0aad0dd30cc5af";
    src = fetchFromGitHub ({
      owner = "vinceliuice";
      repo = "whitesur-gtk-theme";
      rev = "918e3fbc5d782538a5cbb45f7b0aad0dd30cc5af";
      fetchSubmodules = false;
      sha256 = "sha256-4qCgTUnflgoiX8Y5EHPoMSoAVPH9e1qfhv0RJFCAa2g=";
    });
  };
  whitesur-icon-theme = {
