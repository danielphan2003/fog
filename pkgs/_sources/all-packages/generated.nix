...
{ fetchgit, fetchurl, fetchFromGitHub }:
{
  ...
  eww = {
    pname = "eww";
    version = "33a4f459bb41dc02b8c582f3eb587a99d5827fee";
    src = fetchFromGitHub ({
      owner = "elkowar";
      repo = "eww";
      rev = "33a4f459bb41dc02b8c582f3eb587a99d5827fee";
      fetchSubmodules = false;
      sha256 = "sha256-T8NS8yOzOVNJE/FUHEubvKiER8VpCfT6tUOfvcr5PVc=";
    });
    cargoLock = {
      lockFile = ./eww-33a4f459bb41dc02b8c582f3eb587a99d5827fee/Cargo.lock;
      outputHashes = { };
    };
  };
  ...
  jitsi-meet = {
    ...
    version = "1.0.6169";
    src = fetchurl {
      url = "https://download.jitsi.org/jitsi-meet/src/jitsi-meet-1.0.6169.tar.bz2";
      sha256 = "sha256-Hq/TueUTSvEsW75deHpUvb6QHUBZOkz3qxm3ZWxjaoA=";
    };
  };
  jitsi-meet-prosody = {
    ...
    version = "1.0.6169";
    src = fetchurl {
      url = "https://download.jitsi.org/unstable/jitsi-meet-prosody_1.0.6169-1_all.deb";
      sha256 = "sha256-Egje7d7dfha9avbCSSiGa9+XidsoH4AkNq7usQDyDXU=";
    };
  };
  jitsi-videobridge2 = {
