...
{ fetchgit, fetchurl, fetchFromGitHub }:
{
  ...
  bottles = {
    pname = "bottles";
    version = "d60a202a95715c82b64d63998efd99b9793a5b67";
    src = fetchFromGitHub ({
      owner = "bottlesdevs";
      repo = "Bottles";
      rev = "d60a202a95715c82b64d63998efd99b9793a5b67";
      fetchSubmodules = false;
      sha256 = "sha256-DrOwYNNFIespRMkIx+HMU1HI2pn8nKV7YI8RACs3Aio=";
    });
  };
  caddy = {
    pname = "caddy";
  ...
  doggo = {
    pname = "doggo";
    version = "8d705245a1d2dc31d8c586cce943404f48ee191d";
    src = fetchFromGitHub ({
      owner = "mr-karan";
      repo = "doggo";
      rev = "8d705245a1d2dc31d8c586cce943404f48ee191d";
      fetchSubmodules = false;
      sha256 = "sha256-0YBAJmKkzY3G6p8AF3zVA7bGv6z5RMBLv5GMdoD5vEU=";
    });
  };
  ...
  hyprland = {
    pname = "hyprland";
    version = "df2215cef76773249d5267b018a4ff9c3079bdd7";
    src = fetchFromGitHub ({
      owner = "vaxerski";
      repo = "hyprland";
      rev = "df2215cef76773249d5267b018a4ff9c3079bdd7";
      fetchSubmodules = false;
      sha256 = "sha256-H16m4UbXM2B+bIk+fhFEwna0VEUJ17p93a+DqhGmWUg=";
    });
  };
  ibus = {
    pname = "ibus";
  ...
  jitsi-meet = {
    ...
    version = "1.0.6184";
    src = fetchurl {
      url = "https://download.jitsi.org/jitsi-meet/src/jitsi-meet-1.0.6184.tar.bz2";
      sha256 = "sha256-LemLHmAwJhWMz1Xkj4SLdSAr4RHOQZLbK2nOinsODnI=";
    };
  };
  jitsi-meet-prosody = {
    ...
    version = "1.0.6184";
    src = fetchurl {
      url = "https://download.jitsi.org/unstable/jitsi-meet-prosody_1.0.6184-1_all.deb";
      sha256 = "sha256-qTgTi3OkaYTvxq2s9AtApBYb1pz5jCQXZ6BI5doIS+g=";
    };
  };
  jitsi-videobridge2 = {
  ...
  retroarch = {
    pname = "retroarch";
    version = "7eb9f6b49bd4c34e5c2264d22384868e9da8e04a";
    src = fetchFromGitHub ({
      owner = "libretro";
      repo = "retroarch";
      rev = "7eb9f6b49bd4c34e5c2264d22384868e9da8e04a";
      fetchSubmodules = false;
      sha256 = "sha256-jYk0EyqiryS1Wh+na4ILzXXxin6b5BQMGy/ITwDvlNE=";
    });
  };
  rofi-wayland = {
    pname = "rofi-wayland";
  ...
  rustdesk = {
    pname = "rustdesk";
    version = "7c2db5a83559ed9190abc5ceb717983d6fc15cff";
    src = fetchFromGitHub ({
      owner = "rustdesk";
      repo = "rustdesk";
      rev = "7c2db5a83559ed9190abc5ceb717983d6fc15cff";
      fetchSubmodules = false;
      sha256 = "sha256-SOk1W+MeKs+xuoHgXCsUQ/IX1YAE1ZRMtu7MaqPtbyY=";
    });
    cargoLock = {
      lockFile = ./rustdesk-7c2db5a83559ed9190abc5ceb717983d6fc15cff/Cargo.lock;
      outputHashes = {
  ...
  snui = {
    pname = "snui";
    version = "264d1a03e9634427ce4b5a0a71d427f798fba730";
    src = fetchgit {
      url = "https://gitlab.com/snakedye/snui";
      rev = "264d1a03e9634427ce4b5a0a71d427f798fba730";
      fetchSubmodules = false;
      deepClone = false;
      leaveDotGit = false;
      sha256 = "sha256-1OB+QlGsPeS03qQuiUOps5ytLZTLcyYcIE59BscVejo=";
    };
  };
  spicetify-cli = {
    pname = "spicetify-cli";
  ...
  tailscale = {
    pname = "tailscale";
    version = "48d43134d748f56f658721cc780649d5ec1e22fb";
    src = fetchFromGitHub ({
      owner = "tailscale";
      repo = "tailscale";
      rev = "48d43134d748f56f658721cc780649d5ec1e22fb";
      fetchSubmodules = false;
      sha256 = "sha256-2pDmEjPDMQTCxW7C7fsylMfJXmzZgEnmjfAMBa/oJNs=";
    });
  };
  tailscale-systray = {
