...
{ fetchgit, fetchurl, fetchFromGitHub }:
{
  ...
  bottles = {
    pname = "bottles";
    version = "26ccca93c7d664ce54e8dbc36b39e23b6f1143a1";
    src = fetchFromGitHub ({
      owner = "bottlesdevs";
      repo = "Bottles";
      rev = "26ccca93c7d664ce54e8dbc36b39e23b6f1143a1";
      fetchSubmodules = false;
      sha256 = "sha256-O9JAqXKMYL8Dgf9PAidkRfvaMauLEcsMr+yr60Co/5Y=";
    });
  };
  caddy = {
    pname = "caddy";
  ...
  duf = {
    pname = "duf";
    version = "b03aef5d5569b13eb69c5e69f2b6a212a26e604d";
    src = fetchFromGitHub ({
      owner = "muesli";
      repo = "duf";
      rev = "b03aef5d5569b13eb69c5e69f2b6a212a26e604d";
      fetchSubmodules = false;
      sha256 = "sha256-f3pCfI4f5f6OkuRlfXoO0gP5P7oWVxUxSGKXDLBjZfU=";
    });
  };
  eww = {
    pname = "eww";
  ...
  flameshot = {
    pname = "flameshot";
    version = "4affa92b91f5471391d0b365c127d99c28ec8818";
    src = fetchFromGitHub ({
      owner = "flameshot-org";
      repo = "flameshot";
      rev = "4affa92b91f5471391d0b365c127d99c28ec8818";
      fetchSubmodules = false;
      sha256 = "sha256-2SHgOvm1IyaqNUoUZ+T0IY09qtqY/pg0yjDVCI7oPMw=";
    });
  };
  flyingfox = {
    pname = "flyingfox";
  ...
  picom = {
    pname = "picom";
    version = "928963721c8789fc5f27949e8b0730771aab940d";
    src = fetchFromGitHub ({
      owner = "yshui";
      repo = "picom";
  ...
  retroarch = {
    pname = "retroarch";
    version = "2febc16e2e65d440e28e06f856729c9edc95dca9";
    src = fetchFromGitHub ({
      owner = "libretro";
      repo = "retroarch";
      rev = "2febc16e2e65d440e28e06f856729c9edc95dca9";
      fetchSubmodules = false;
      sha256 = "sha256-NsrBHe3imSsmSBmyljfaGUpXfx5GWFNEjwzkLF4kMXI=";
    });
  };
  rofi-wayland = {
    pname = "rofi-wayland";
  ...
  rustdesk = {
    pname = "rustdesk";
    version = "3ec69b6d97b2486fe4fa53a348c0110aec589000";
    src = fetchFromGitHub ({
      owner = "rustdesk";
      repo = "rustdesk";
      rev = "3ec69b6d97b2486fe4fa53a348c0110aec589000";
      fetchSubmodules = false;
      sha256 = "sha256-SVir1aOrEkJDTAJxa9PI6Z6fi+5ftVLYlmhLMWmlNiY=";
    });
    cargoLock = {
      lockFile = ./rustdesk-3ec69b6d97b2486fe4fa53a348c0110aec589000/Cargo.lock;
      outputHashes = {
  ...
  spicetify-cli = {
    pname = "spicetify-cli";
    version = "6e884a87c9f5ca55a76f3e9b7e5db9ad0a9bdc53";
    src = fetchFromGitHub ({
      owner = "khanhas";
      repo = "spicetify-cli";
      rev = "6e884a87c9f5ca55a76f3e9b7e5db9ad0a9bdc53";
      fetchSubmodules = false;
  ...
  whitesur-icon-theme = {
    ...
    version = "38436daabe84bd3f58b6feb23f1f48561b9a21ba";
    src = fetchFromGitHub ({
      owner = "vinceliuice";
      repo = "whitesur-icon-theme";
      rev = "38436daabe84bd3f58b6feb23f1f48561b9a21ba";
      fetchSubmodules = false;
      sha256 = "sha256-lMt8+U1vgJhx7RWv03OQ1WWUX81nn+De0xSUxwmveds=";
    });
  };
  widevine-cdm = {
    pname = "widevine-cdm";
