...
{ fetchgit, fetchurl, fetchFromGitHub }:
{
  ...
  hyprland = {
    pname = "hyprland";
    version = "31a429899b3132a704211eb5bffb5cde3ec3c9fc";
    src = fetchFromGitHub ({
      owner = "vaxerski";
      repo = "hyprland";
      rev = "31a429899b3132a704211eb5bffb5cde3ec3c9fc";
      fetchSubmodules = false;
      sha256 = "sha256-jFi6ArM2NZ8Go18FKqS8bAkJUSL1UqlV/NTVfUSob6g=";
    });
  };
  ibus = {
    pname = "ibus";
  ...
  jibri = {
    pname = "jibri";
    version = "8.0-129-g4bc0bf2";
    src = fetchurl {
      url = "https://download.jitsi.org/unstable/jibri_8.0-129-g4bc0bf2-1_all.deb";
      sha256 = "sha256-1YNAqxgyxzAEfP5bI33FCMwcf4enT18t15zEfJVyBlk=";
    };
  };
  jicofo = {
    pname = "jicofo";
  ...
  jitsi-meet = {
    ...
    version = "1.0.6134";
    src = fetchurl {
      url = "https://download.jitsi.org/jitsi-meet/src/jitsi-meet-1.0.6134.tar.bz2";
      sha256 = "sha256-RaZhpw0TFTTL4zzSr2/bIuzdfR4v6Xhd15oGlxG/C9s=";
    };
  };
  jitsi-meet-prosody = {
    ...
    version = "1.0.6134";
    src = fetchurl {
      url = "https://download.jitsi.org/unstable/jitsi-meet-prosody_1.0.6134-1_all.deb";
      sha256 = "sha256-Q6CcX3r482SHk9tzQrNCYXh1LifRv0bfpZGn9YUeExA=";
    };
  };
  jitsi-videobridge2 = {
  ...
  retroarch = {
    pname = "retroarch";
    version = "7c3dfa5e3a82b1134324bbd549b0d3f93861fab6";
    src = fetchFromGitHub ({
      owner = "libretro";
      repo = "retroarch";
      rev = "7c3dfa5e3a82b1134324bbd549b0d3f93861fab6";
      fetchSubmodules = false;
      sha256 = "sha256-s6J/4yq6XMsDQCqHEJFhelDJC2+zc5jPvUqCO2YY+Cs=";
    });
  };
  rofi-wayland = {
    pname = "rofi-wayland";
  ...
  rustdesk = {
    pname = "rustdesk";
    version = "f90f83fbda92d6def3b0d6acc5ac12b12af48e14";
    src = fetchFromGitHub ({
      owner = "rustdesk";
      repo = "rustdesk";
      rev = "f90f83fbda92d6def3b0d6acc5ac12b12af48e14";
      fetchSubmodules = false;
      sha256 = "sha256-t+IYvV3J7dAhICERgOVw48R/fcibUdFnsryXz14dQX4=";
    });
    cargoLock = {
      lockFile = ./rustdesk-f90f83fbda92d6def3b0d6acc5ac12b12af48e14/Cargo.lock;
      outputHashes = {
  ...
  snui = {
    pname = "snui";
    version = "0407b964f2c32d9d0b0bbe001755ed1f08f4f902";
    src = fetchgit {
      url = "https://gitlab.com/snakedye/snui";
      rev = "0407b964f2c32d9d0b0bbe001755ed1f08f4f902";
      fetchSubmodules = false;
      deepClone = false;
      leaveDotGit = false;
      sha256 = "sha256-6sDqQpGUhYfkdOGXsylu8DRN4ipxP+w5xlIuaoErAaY=";
    };
  };
  spicetify-cli = {
    pname = "spicetify-cli";
    version = "5a5088ffcad091efc72eae044b6bab0ce17b6b83";
    src = fetchFromGitHub ({
      owner = "khanhas";
      repo = "spicetify-cli";
      rev = "5a5088ffcad091efc72eae044b6bab0ce17b6b83";
      fetchSubmodules = false;
      sha256 = "sha256-sSWi2IqeSiRD+BUet6PrIUqVMGUbKs8apsxiha40JWI=";
    });
  };
  spicetify-themes = {
    ...
    src = fetchFromGitHub ({
      ...
      fetchSubmodules = false;
      sha256 = "sha256-oxX4ivacopIwdx9YbUThJZgr5YayylBlMZoO4VJDcMk=";
    });
  };
  spotify = {
    pname = "spotify";
  ...
  tailscale = {
    pname = "tailscale";
    version = "deb56f276e3a1bba746c7f532fff6099559319cd";
    src = fetchFromGitHub ({
      owner = "tailscale";
      repo = "tailscale";
      rev = "deb56f276e3a1bba746c7f532fff6099559319cd";
      fetchSubmodules = false;
      sha256 = "sha256-CBhbSqd3c0e5nnlUdlRH2obNwVylt8vR+Bg5Ut2EumI=";
    });
  };
  tailscale-systray = {
  ...
  ulauncher = {
    pname = "ulauncher";
    version = "228527fc3caa10cf46b1aa1d6cd9cec6481bc95e";
    src = fetchFromGitHub ({
      owner = "Ulauncher";
      repo = "Ulauncher";
      rev = "228527fc3caa10cf46b1aa1d6cd9cec6481bc95e";
      fetchSubmodules = false;
      sha256 = "sha256-9+MCvRfEWlRH0EX9SjtQ2oiynL2Emvfl/8r1nhi+QP8=";
    });
  };
  ultimmc = {
    pname = "ultimmc";
