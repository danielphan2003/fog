...
{ fetchgit, fetchurl, fetchFromGitHub }:
{
  ...
  bottles = {
    pname = "bottles";
    version = "fbacc65d4bc08fd7380e0af04c7235569900fa58";
    src = fetchFromGitHub ({
      owner = "bottlesdevs";
      repo = "Bottles";
      rev = "fbacc65d4bc08fd7380e0af04c7235569900fa58";
      fetchSubmodules = false;
      sha256 = "sha256-8VVvS/bpzAy2Fkdl2wNpP4NDDUDUo0QT61ym95ojppk=";
    });
  };
  caddy = {
    pname = "caddy";
  ...
  cinny = {
    ...
    version = "1.8.1";
    src = fetchurl {
      url = "https://github.com/ajbura/cinny/releases/download/v1.8.1/cinny-v1.8.1.tar.gz";
      sha256 = "sha256-33CwKz6kPiV4/QWKouU3O5gesfmnhAoko3bwCSM8TY4=";
    };
  };
  conduit = {
    pname = "conduit";
  ...
  jicofo = {
    ...
    version = "1.0-866";
    src = fetchurl {
      url = "https://download.jitsi.org/unstable/jicofo_1.0-866-1_all.deb";
      sha256 = "sha256-uWW6gm/SlvqCB9yrZzzRwLJAOyN/V4oisTxfyvtz1zk=";
    };
  };
  jitsi-meet = {
    pname = "jitsi-meet";
    version = "1.0.5949";
    src = fetchurl {
      url = "https://download.jitsi.org/jitsi-meet/src/jitsi-meet-1.0.5949.tar.bz2";
      sha256 = "sha256-zI230wdDgNhfJFwefXDN/bRl/132u/p8mzm8A0R/bDk=";
    };
  };
  jitsi-meet-prosody = {
    ...
    version = "1.0.5949";
    src = fetchurl {
      url = "https://download.jitsi.org/unstable/jitsi-meet-prosody_1.0.5949-1_all.deb";
      sha256 = "sha256-pXt8n4t74D6zuHn/eBVskh6jtAOSFCi3EtMOJHAoHp8=";
    };
  };
  jitsi-videobridge2 = {
  ...
  retroarch = {
    pname = "retroarch";
    version = "28145abde9157c518fdd2e229ec2d241d36c6669";
    src = fetchFromGitHub ({
      owner = "libretro";
      repo = "retroarch";
      rev = "28145abde9157c518fdd2e229ec2d241d36c6669";
      fetchSubmodules = false;
      sha256 = "sha256-5lQ3MDp67+9hSqOuqmEQDRtPXy3FSX7wYB1NTpBu7q4=";
    });
  };
  rofi-wayland = {
    pname = "rofi-wayland";
  ...
  rustdesk = {
    pname = "rustdesk";
    version = "b350fbdb9c9002667b1bdff4a7aa4f452a7118fe";
    src = fetchFromGitHub ({
      owner = "rustdesk";
      repo = "rustdesk";
      rev = "b350fbdb9c9002667b1bdff4a7aa4f452a7118fe";
      fetchSubmodules = false;
      sha256 = "sha256-tbZfT12RWr/TOJVfg4H9oFusruyA1VYMBqm4vOhCizs=";
    });
    cargoLock = {
      lockFile = ./rustdesk-b350fbdb9c9002667b1bdff4a7aa4f452a7118fe/Cargo.lock;
      outputHashes = {
  ...
  tailscale = {
    pname = "tailscale";
    version = "5f529d135993ef327aa822522031999eb7d963f2";
    src = fetchFromGitHub ({
      owner = "tailscale";
      repo = "tailscale";
      rev = "5f529d135993ef327aa822522031999eb7d963f2";
      fetchSubmodules = false;
      sha256 = "sha256-wwcyAvg64uamDyYwqEji57o/AXY1ticI5883yLJzv+0=";
    });
  };
  tailscale-systray = {
  ...
  xdg-desktop-portal = {
    ...
    version = "942b13194cdd9e49b8a6772c20b405e8b538b0c1";
    src = fetchFromGitHub ({
      owner = "flatpak";
      repo = "xdg-desktop-portal";
      rev = "942b13194cdd9e49b8a6772c20b405e8b538b0c1";
      fetchSubmodules = false;
      sha256 = "sha256-17BRtLi8bSBjvln6DeUF/hFGF7UWdKcdWbM+Oc2plps=";
    });
  };
  ...
  xwayland = {
    pname = "xwayland";
    version = "102764b683df8932404c2a8f98061120a51b32b0";
    src = fetchgit {
      url = "git://anongit.freedesktop.org/xorg/xserver";
      rev = "102764b683df8932404c2a8f98061120a51b32b0";
      fetchSubmodules = false;
      deepClone = false;
      leaveDotGit = false;
      sha256 = "sha256-cGRDS7mmQqDNV7VeGEVUuR6rhyS18wa6rocKCZn4IwA=";
    };
  };
  ydotool = {
    pname = "ydotool";
