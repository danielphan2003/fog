...
{ fetchgit, fetchurl, fetchFromGitHub }:
{
  ...
  retroarch = {
    pname = "retroarch";
    version = "fe37647c8475a45d8fb1c3e20360be63e0adc21d";
    src = fetchFromGitHub ({
      owner = "libretro";
      repo = "retroarch";
      rev = "fe37647c8475a45d8fb1c3e20360be63e0adc21d";
      fetchSubmodules = false;
      sha256 = "sha256-3jKspxdGQp4A2HfQZSmT+XXqSV6E/ONGM/oQy9s80HE=";
    });
  };
  rofi-wayland = {
    pname = "rofi-wayland";
  ...
  rustdesk = {
    pname = "rustdesk";
    version = "6de6d6c7a7db28f92f109a64ceb8e64f67299602";
    src = fetchFromGitHub ({
      owner = "rustdesk";
      repo = "rustdesk";
      rev = "6de6d6c7a7db28f92f109a64ceb8e64f67299602";
      fetchSubmodules = false;
      sha256 = "sha256-XzdPbRxYOnncJevKKlK36afepU5032BeLRqnyPM6g4g=";
    });
    cargoLock = {
      lockFile = ./rustdesk-6de6d6c7a7db28f92f109a64ceb8e64f67299602/Cargo.lock;
      outputHashes = {
  ...
  tailscale = {
    pname = "tailscale";
    version = "53f6c3f9f25523bfe42878fc049b891e6207101f";
    src = fetchFromGitHub ({
      owner = "tailscale";
      repo = "tailscale";
      rev = "53f6c3f9f25523bfe42878fc049b891e6207101f";
      fetchSubmodules = false;
      sha256 = "sha256-3goM31X6ndNPka0wb4tHLX7+HZJ2wSffsI2vdR0Ptj0=";
    });
  };
  tailscale-systray = {
