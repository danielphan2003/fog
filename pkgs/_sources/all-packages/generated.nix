...
{ fetchgit, fetchurl, fetchFromGitHub }:
{
  ...
  retroarch = {
    pname = "retroarch";
    version = "37c56d0d09a1d455353c14a3e0860b7834f9c4b8";
    src = fetchFromGitHub ({
      owner = "libretro";
      repo = "retroarch";
      rev = "37c56d0d09a1d455353c14a3e0860b7834f9c4b8";
      fetchSubmodules = false;
      sha256 = "sha256-a2Wj58gafcBnftLNi9TtTOM4TosE+1ITbCPebotSzy0=";
    });
  };
  rofi-wayland = {
    pname = "rofi-wayland";
  ...
  rustdesk = {
    pname = "rustdesk";
    version = "0b6155bab82b75d2f6d8a57d48e960453973eb68";
    src = fetchFromGitHub ({
      owner = "rustdesk";
      repo = "rustdesk";
      rev = "0b6155bab82b75d2f6d8a57d48e960453973eb68";
      fetchSubmodules = false;
      sha256 = "sha256-SKG8qLCNfr6anOYnu9iolM5OW+A7O0SDt4hqPyoYAKc=";
    });
    cargoLock = {
      lockFile = ./rustdesk-0b6155bab82b75d2f6d8a57d48e960453973eb68/Cargo.lock;
      outputHashes = {
