...
{ fetchgit, fetchurl, fetchFromGitHub }:
{
  adguardhome-darwin-amd64 = {
    ...
    version = "0.108.0-b.8";
    src = fetchurl {
      url = "https://github.com/AdguardTeam/AdGuardHome/releases/download/v0.108.0-b.8/AdGuardHome_darwin_amd64.zip";
      sha256 = "sha256-NpuxQe2SHqHclhnkptkAOVUisvlDEmAvdnfeQ9REC20=";
    };
  };
  adguardhome-linux-386 = {
    ...
    version = "0.108.0-b.8";
    src = fetchurl {
      url = "https://github.com/AdguardTeam/AdGuardHome/releases/download/v0.108.0-b.8/AdGuardHome_linux_386.tar.gz";
      sha256 = "sha256-femT348SmjQfmV0Ri2y2Q5RKERPF8q00MbBwEWgcTXs=";
    };
  };
  adguardhome-linux-amd64 = {
    ...
    version = "0.108.0-b.8";
    src = fetchurl {
      url = "https://github.com/AdguardTeam/AdGuardHome/releases/download/v0.108.0-b.8/AdGuardHome_linux_amd64.tar.gz";
      sha256 = "sha256-cWLLCCKDd2aX6iuSejftQPm6z5fUajguCSjKahN5CQQ=";
    };
  };
  adguardhome-linux-arm64 = {
    ...
    version = "0.108.0-b.8";
    src = fetchurl {
      url = "https://github.com/AdguardTeam/AdGuardHome/releases/download/v0.108.0-b.8/AdGuardHome_linux_arm64.tar.gz";
      sha256 = "sha256-TqjASf0SzKIX0w/LC0DyFpsvYrczCzR0mcWM4AG4mIw=";
    };
  };
  adl = {
    pname = "adl";
  ...
  flameshot = {
    pname = "flameshot";
    version = "65e3a013605c9aacaecfaffc65423311d41b2a7f";
    src = fetchFromGitHub ({
      owner = "flameshot-org";
      repo = "flameshot";
      rev = "65e3a013605c9aacaecfaffc65423311d41b2a7f";
      fetchSubmodules = false;
      sha256 = "sha256-8A2kXFNm3up80wXOZklov14S5f9h/0IONtUyiLeR0yc=";
    });
  };
  flyingfox = {
    pname = "flyingfox";
  ...
  hyprland = {
    pname = "hyprland";
    version = "7b568d7ad8989718a3f1fa9e23d366154ff1962b";
    src = fetchFromGitHub ({
      owner = "vaxerski";
      repo = "hyprland";
      rev = "7b568d7ad8989718a3f1fa9e23d366154ff1962b";
      fetchSubmodules = false;
      sha256 = "sha256-9OLOV253iTtirIdha1KP7RzD7rqnYDogwG+PABDtz+o=";
    });
  };
  ibus = {
    pname = "ibus";
    version = "16df64edadc21f50906e5442b73425b9256fbf65";
    src = fetchFromGitHub ({
      owner = "ibus";
      repo = "ibus";
      rev = "16df64edadc21f50906e5442b73425b9256fbf65";
      fetchSubmodules = false;
      sha256 = "sha256-jYNwBa7qhhJZRU6M3AFLlOkm8D2DcOhUH48IbiU6/MM=";
    });
  };
  ibus-bamboo = {
    pname = "ibus-bamboo";
  ...
  jitsi-meet-prosody = {
    ...
    version = "1.0.6215";
    src = fetchurl {
      url = "https://download.jitsi.org/unstable/jitsi-meet-prosody_1.0.6215-1_all.deb";
      sha256 = "sha256-uWa2exayVLQmbGqgSgXHAd+hr+pux0eLF+xM+5D2FvM=";
    };
  };
  jitsi-videobridge2 = {
    pname = "jitsi-videobridge2";
    version = "2.1-1878-g8a2713d0";
    src = fetchurl {
      url = "https://download.jitsi.org/unstable/jitsi-videobridge2_2.1-1878-g8a2713d0-1_all.deb";
      sha256 = "sha256-FbYAWMUdT3f7LmoY8vLJppyL/sn6VLm0+ul7L3ZEbl0=";
    };
  };
  layout-machi = {
    pname = "layout-machi";
  ...
  microsoft-edge-beta = {
    ...
    src = fetchurl {
      url = "https://packages.microsoft.com/repos/edge/pool/main/m/microsoft-edge-beta/microsoft-edge-beta_103.0.1264.13-1_amd64.deb";
      sha256 = "sha256-H0rLoQmnAKpVysYmCZhTRrRbE5thgLFBIWWxXZ5AZ8s=";
    };
  };
  microsoft-edge-dev = {
  ...
  ouch = {
    pname = "ouch";
    version = "be0b68aee521b656a37a75035a25ff09f00fb68f";
    src = fetchFromGitHub ({
      owner = "ouch-org";
      repo = "ouch";
      rev = "be0b68aee521b656a37a75035a25ff09f00fb68f";
      fetchSubmodules = false;
  ...
  pmbootstrap-test = {
    ...
    version = "cc90bc81f09a56be35de8bee2eed61651bc78e86";
    src = fetchgit {
      url = "https://gitlab.com/postmarketOS/pmbootstrap";
      rev = "cc90bc81f09a56be35de8bee2eed61651bc78e86";
      fetchSubmodules = false;
      deepClone = false;
      leaveDotGit = false;
      sha256 = "sha256-Gb9jMLYZ0N2LynKlAA/0HFLE9hu+IK7zcCZDPzXLnDk=";
    };
  };
  pure = {
    pname = "pure";
  ...
  retroarch = {
    pname = "retroarch";
    version = "9ea46f34fb58847c457466854287b6ba8f0bbe4c";
    src = fetchFromGitHub ({
      owner = "libretro";
      repo = "retroarch";
      rev = "9ea46f34fb58847c457466854287b6ba8f0bbe4c";
      fetchSubmodules = false;
      sha256 = "sha256-mwFYNv7Rr8lU8H8bNAPXmaM5DfKXMpd6vRn9fbe8D9g=";
    });
  };
  rofi-wayland = {
    pname = "rofi-wayland";
  ...
  rustdesk = {
    pname = "rustdesk";
    version = "25ca2042130aff6b943cbc548eab48088ca4e3be";
    src = fetchFromGitHub ({
      owner = "rustdesk";
      repo = "rustdesk";
      rev = "25ca2042130aff6b943cbc548eab48088ca4e3be";
      fetchSubmodules = false;
      sha256 = "sha256-kwKJh9i8OPs77Wx8o1ynkQUIb3g2230mWsD72tmHtXA=";
    });
    cargoLock = {
      lockFile = ./rustdesk-25ca2042130aff6b943cbc548eab48088ca4e3be/Cargo.lock;
      outputHashes = {
  ...
  tailscale = {
    pname = "tailscale";
    version = "80157f3f371d66bae253d1e62c1c5bb332d78430";
    src = fetchFromGitHub ({
      owner = "tailscale";
      repo = "tailscale";
      rev = "80157f3f371d66bae253d1e62c1c5bb332d78430";
      fetchSubmodules = false;
      sha256 = "sha256-brOhiOd0IVGRZ+dom5Ke1BVY0f+9xpJNOL2geHn/yMI=";
    });
  };
  tailscale-systray = {
  ...
  ulauncher = {
    pname = "ulauncher";
    version = "807c4499e56c26c28a7ed4a15d4a83fba12feaac";
    src = fetchFromGitHub ({
      owner = "Ulauncher";
      repo = "Ulauncher";
      rev = "807c4499e56c26c28a7ed4a15d4a83fba12feaac";
      fetchSubmodules = false;
      sha256 = "sha256-XBIk5kf1yYhQ9c3dn+h7NCCelH+Y7VmoqQwS9dPMyhY=";
    });
  };
  ultimmc = {
    pname = "ultimmc";
  ...
  whitesur-gtk-theme = {
    ...
    version = "08f51658ec8cb4c83fcddf7d94db8a3c0578f21a";
    src = fetchFromGitHub ({
      owner = "vinceliuice";
      repo = "whitesur-gtk-theme";
      rev = "08f51658ec8cb4c83fcddf7d94db8a3c0578f21a";
      fetchSubmodules = false;
      sha256 = "sha256-DcTvCIeCgPselEv9be+/yHbZaEOcfe2aV4dwzdCBfv0=";
    });
  };
  whitesur-icon-theme = {
    pname = "whitesur-icon-theme";
    version = "3be90b736a551b7c544ff5e591c4a6d92a9c77bf";
    src = fetchFromGitHub ({
      owner = "vinceliuice";
      repo = "whitesur-icon-theme";
      rev = "3be90b736a551b7c544ff5e591c4a6d92a9c77bf";
      fetchSubmodules = false;
      sha256 = "sha256-TAM4+6SEdR+7zeEWeu5RFmRNm9P8itc+G8a1iJiOtZU=";
    });
  };
  widevine-cdm = {
    pname = "widevine-cdm";
