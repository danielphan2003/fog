...
{ fetchgit, fetchurl, fetchFromGitHub }:
{
  ...
  jitsi-meet = {
    ...
    version = "1.0.6011";
    src = fetchurl {
      url = "https://download.jitsi.org/jitsi-meet/src/jitsi-meet-1.0.6011.tar.bz2";
      sha256 = "sha256-FDCGyA5hL4+8PkMy3dJRwTpOBS5+FugwSSdZWtqtg0o=";
    };
  };
  jitsi-meet-prosody = {
    ...
    version = "1.0.6011";
    src = fetchurl {
      url = "https://download.jitsi.org/unstable/jitsi-meet-prosody_1.0.6011-1_all.deb";
      sha256 = "sha256-7m3ljv42DES36SxvVoMbmhRNAOOgS2tSSPIiNoTRWAU=";
    };
  };
  jitsi-videobridge2 = {
  ...
  retroarch = {
    pname = "retroarch";
    version = "1cd6413e246a9a8d43257088b88c01222e0b7cae";
    src = fetchFromGitHub ({
      owner = "libretro";
      repo = "retroarch";
      rev = "1cd6413e246a9a8d43257088b88c01222e0b7cae";
      fetchSubmodules = false;
      sha256 = "sha256-FH0sT29T0amWsLZLA9TPUpP0CZXb+cmxkwZ3yB3GZCg=";
    });
  };
  rofi-wayland = {
    pname = "rofi-wayland";
  ...
  spicetify-themes = {
    ...
    version = "565c810f1e46f49eed3c0f83dcfc254654919939";
    src = fetchFromGitHub ({
      owner = "morpheusthewhite";
      repo = "spicetify-themes";
      rev = "565c810f1e46f49eed3c0f83dcfc254654919939";
      fetchSubmodules = false;
      sha256 = "sha256-qDnShKahlFcG/+50eBLtbXn1tHsGRhPDpekSExG7o6g=";
    });
  };
  spotify = {
    pname = "spotify";
  ...
  tailscale = {
    pname = "tailscale";
    version = "309ddef85205c341c3eb0afdcb886e0c738d833e";
    src = fetchFromGitHub ({
      owner = "tailscale";
      repo = "tailscale";
      rev = "309ddef85205c341c3eb0afdcb886e0c738d833e";
      fetchSubmodules = false;
      sha256 = "sha256-m704JlhP32PidERJ4jCXY3/UMNBiSdNSWJ3oIBF6rvg=";
    });
  };
  tailscale-systray = {
  ...
  ulauncher = {
    pname = "ulauncher";
    version = "65654f1e9cfc6cb691b228840d27c18b18ee3cc5";
    src = fetchFromGitHub ({
      owner = "Ulauncher";
      repo = "Ulauncher";
      rev = "65654f1e9cfc6cb691b228840d27c18b18ee3cc5";
      fetchSubmodules = false;
      sha256 = "sha256-2pHhIsZevcgFC5nSgymVKEPlOi6riekSmMA9Atx9UH4=";
    });
  };
  ultimmc = {
    pname = "ultimmc";
