...
{ fetchgit, fetchurl, fetchFromGitHub }:
{
  ...
  bottles = {
    pname = "bottles";
    version = "ff9052a69ab85d896623168778c2633dfc38fcba";
    src = fetchFromGitHub ({
      owner = "bottlesdevs";
      repo = "Bottles";
      rev = "ff9052a69ab85d896623168778c2633dfc38fcba";
      fetchSubmodules = false;
      sha256 = "sha256-aIen+8imQRkPONaC1WbwxHfiBPUyiqWKZeFYdetIhvc=";
    });
  };
  caddy = {
    pname = "caddy";
  ...
  jitsi-meet = {
    ...
    version = "1.0.5923";
    src = fetchurl {
      url = "https://download.jitsi.org/jitsi-meet/src/jitsi-meet-1.0.5923.tar.bz2";
      sha256 = "sha256-Vo7NCA1Whb0O4ZwEQd4Ln/D4iUgFkfL69k24aRGT0uE=";
    };
  };
  jitsi-meet-prosody = {
    ...
    version = "1.0.5923";
    src = fetchurl {
      url = "https://download.jitsi.org/unstable/jitsi-meet-prosody_1.0.5923-1_all.deb";
      sha256 = "sha256-QHXanzYpE/36zD1O2eDcD5IWYdCabiFQiQ5mW5aDgbc=";
    };
  };
  jitsi-videobridge2 = {
    pname = "jitsi-videobridge2";
    version = "2.1-640-ga61d65f9";
    src = fetchurl {
      url = "https://download.jitsi.org/unstable/jitsi-videobridge2_2.1-640-ga61d65f9-1_all.deb";
      sha256 = "sha256-I/daFrK8uXQvEJYPNSHenw9a0qmtScwt3pcXNyOLSww=";
    };
  };
  layout-machi = {
    pname = "layout-machi";
  ...
  retroarch = {
    pname = "retroarch";
    version = "9bcee062ff0f24bcbfc7ba64674e4244924e6b90";
    src = fetchFromGitHub ({
      owner = "libretro";
      repo = "retroarch";
      rev = "9bcee062ff0f24bcbfc7ba64674e4244924e6b90";
      fetchSubmodules = false;
      sha256 = "sha256-hR1BLictL3fj71zv6dtbFpxaWSZTC6EPXLpFiTxUc6g=";
    });
  };
  rofi-wayland = {
    pname = "rofi-wayland";
  ...
  rustdesk = {
    pname = "rustdesk";
    version = "88ac9e9d117a65fcdfd7b9cec7c7ef92640135da";
    src = fetchFromGitHub ({
      owner = "rustdesk";
      repo = "rustdesk";
      rev = "88ac9e9d117a65fcdfd7b9cec7c7ef92640135da";
      fetchSubmodules = false;
      sha256 = "sha256-/EP5bBol3eSc6GGLSv4dEWreN/wfFUcMBtyHsEEuMSs=";
    });
    cargoLock = {
      lockFile = ./rustdesk-88ac9e9d117a65fcdfd7b9cec7c7ef92640135da/Cargo.lock;
      outputHashes = {
  ...
  tailscale = {
    pname = "tailscale";
    version = "0588ca5d8ba0acd24b40109c792619cb4af8854e";
    src = fetchFromGitHub ({
      owner = "tailscale";
      repo = "tailscale";
      rev = "0588ca5d8ba0acd24b40109c792619cb4af8854e";
      fetchSubmodules = false;
      sha256 = "sha256-MvjXu/xllmI4QZNpbj+Y1WgmCcU3tIMM4t8jGF9S5Ig=";
    });
  };
  tailscale-systray = {
  ...
  xdg-desktop-portal = {
    ...
    version = "0eaacbada1b7da1ae4a82ff440aaf7d58e532dd3";
    src = fetchFromGitHub ({
      owner = "flatpak";
      repo = "xdg-desktop-portal";
      rev = "0eaacbada1b7da1ae4a82ff440aaf7d58e532dd3";
      fetchSubmodules = false;
      sha256 = "sha256-DXTCHN4iHXujZFixUo2dKiVQTiivErBtViHz6/pzJB4=";
    });
  };
