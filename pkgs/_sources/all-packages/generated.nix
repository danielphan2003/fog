...
{ fetchgit, fetchurl, fetchFromGitHub }:
{
  ...
  bottles = {
    pname = "bottles";
    version = "7420955fa00fcb30a66e67a8a9fad748d3365be6";
    src = fetchFromGitHub ({
      owner = "bottlesdevs";
      repo = "Bottles";
      rev = "7420955fa00fcb30a66e67a8a9fad748d3365be6";
      fetchSubmodules = false;
      sha256 = "sha256-mkkueAPwuMEy5aCicuZ8E0yobkAM7K3mxP9uzBEE3Wc=";
    });
  };
  caddy = {
    pname = "caddy";
  ...
  jitsi-meet = {
    ...
    version = "1.0.5921";
    src = fetchurl {
      url = "https://download.jitsi.org/jitsi-meet/src/jitsi-meet-1.0.5921.tar.bz2";
      sha256 = "sha256-aAvXxbXjjjzDNz+RflBma3STI7GzwsqwK6GHZsMoBe8=";
    };
  };
  jitsi-meet-prosody = {
    ...
    version = "1.0.5921";
    src = fetchurl {
      url = "https://download.jitsi.org/unstable/jitsi-meet-prosody_1.0.5921-1_all.deb";
      sha256 = "sha256-6wWUhZAT6Kr/QRx184WEir9U5U7oyyf5Cj5GtHyGi6Q=";
    };
  };
  jitsi-videobridge2 = {
  ...
  retroarch = {
    pname = "retroarch";
    version = "c11a798467201f4d44a20e18c11259022c51a551";
    src = fetchFromGitHub ({
      owner = "libretro";
      repo = "retroarch";
      rev = "c11a798467201f4d44a20e18c11259022c51a551";
      fetchSubmodules = false;
      sha256 = "sha256-FXxIR78uKBYiS/yp8t7WNj2E+90OdWxA5kkEHYZ1IqQ=";
    });
  };
  rofi-wayland = {
    pname = "rofi-wayland";
  ...
  rustdesk = {
    pname = "rustdesk";
    version = "dfd128c817c20081673fd0b82bd2b51f6f90919a";
    src = fetchFromGitHub ({
      owner = "rustdesk";
      repo = "rustdesk";
      rev = "dfd128c817c20081673fd0b82bd2b51f6f90919a";
      fetchSubmodules = false;
      sha256 = "sha256-ft5G9dZa1KNAfV2mY1r7unK1no5MDRZhNQqM/weyn4A=";
    });
    cargoLock = {
      lockFile = ./rustdesk-dfd128c817c20081673fd0b82bd2b51f6f90919a/Cargo.lock;
      outputHashes = {
  ...
  tailscale = {
    pname = "tailscale";
    version = "d5f8f38ac629beb0c0ae4f63582be4de60828041";
    src = fetchFromGitHub ({
      owner = "tailscale";
      repo = "tailscale";
      rev = "d5f8f38ac629beb0c0ae4f63582be4de60828041";
      fetchSubmodules = false;
      sha256 = "sha256-7G9uKTaHpvKu7ADomVVe91skEK1x3cL+YspaR8vW7g8=";
    });
  };
  tailscale-systray = {
  ...
  xdg-desktop-portal = {
    ...
    version = "60aabc423b3f4105dc154a00470abaf9dccd204f";
    src = fetchFromGitHub ({
      owner = "flatpak";
      repo = "xdg-desktop-portal";
      rev = "60aabc423b3f4105dc154a00470abaf9dccd204f";
      fetchSubmodules = false;
      sha256 = "sha256-yZ30B4Ec7pX9DWry4AbP/FzBu6IbWCswaeViV4ilNcg=";
    });
  };
